...
基于源码编译与安装pypto.whl：<br>
python build_ci.py -f=python3 <br>
pip install build_out/pypto*whl --force-reinstall --no-deps <br>
构建编包完整指导可参考[build_and_install.md](../docs/context/build_and_install.md)里的说明，使用python3 -m pip install -e.<br>
