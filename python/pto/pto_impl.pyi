import enum
from typing import Iterator, overload, Union, List, Dict, Tuple
...
@overload
def reshape(a: Tensor, shape: List[int], valid_shape: Union[List[int], List[SymbolicScalar]] = [], inplace: bool = False) -> Tensor: ...
@overload
