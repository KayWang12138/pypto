...
def parse(code: str, filename: str = "<string>") -> ir.Function | ir.Program:
    ...
    pypto_block.language as pl if not already present.
    ...
    Examples:
        ...
        MyProgram
    """
    # Import pypto_block.language here to avoid circular imports
    import pypto_block.language as pl  # noqa: PLC0415
