...
class VecModule():
    ...
    def __init__(self, *args: Var):
        ...
        self.out_empty = DEvent(PIPE.MTE3, PIPE.V)
    ...
    def set_in_ready(self):
        self.in_ready.set()

    def wait_in_empty(self):
        self.in_empty.wait()

    def set_in_empty(self):
        self.in_empty.set()
    ...
    def gen_code(self, filename: str):
        ...
        for p in [Position.UB, Position.L1]:
