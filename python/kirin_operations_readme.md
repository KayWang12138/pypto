...
|----------|------------------|------------------|---------------|-------|--------------------------------|
| fp16_001 | (112)            | (112)            | (50)          | fp16  | 1D 尾轴对齐，w 切分            |
| fp16_002 | (64)             | (1,)             | (32)          | fp16  | 1D 张量 + 标量广播，w 切分     |
| fp16_003 | (32)             | (32)             | (16)          | fp16  | 1D 无广播，纯 w 切分           |
| fp16_004 | (1,)             | (16，16)             | (8)          | fp16  | 1D 标量 + 张量广播，w 切分     |
| fp16_005 | (4, 80)          | (4, 80)          | (2, 40)       | fp16  | 2D 大尺寸，h+w 切分            |
| fp16_006 | (2, 96)          | (1, 96)          | (1, 48)       | fp16  | 2D 一维广播，h+w 切分          |
| fp16_007 | (5, 1)           | (5, 32)          | (5, 16)       | fp16  | 2D 一维广播，h+w 切分          |
| fp16_008 | (3, 128)         | (3, 128)         | (2, 64)       | fp16  | 2D 无广播，h+w 切分            |
| fp16_009 | (64, 1)          | (64, 64)         | (32, 1)       | fp16  | 2D 一维广播，仅 h 切分         |
| fp16_010 | (1, 64)          | (64, 64)         | (1, 32)       | fp16  | 2D 一维广播，仅 w 切分         |
| fp16_011 | (1, 64, 64)      | (1, 64, 64)      | (1, 32, 32)   | fp16  | 3D 无广播，c+h+w 切分          |
| fp16_012 | (2, 1, 48)       | (2, 3, 48)       | (2, 1, 24)    | fp16  | 3D 一维广播，c+h+w 切分        |
| fp16_013 | (3, 64, 1)       | (3, 64, 48)      | (3, 32, 1)    | fp16  | 3D 一维广播，c+h+w 切分        |
| fp16_014 | (1, 48, 48)      | (1, 1, 48)       | (1, 24, 24)   | fp16  | 3D 广播，仅 c 切分             |
| fp16_015 | (2, 64, 48)      | (2, 64, 48)      | (2, 32, 24)   | fp16  | 3D 无广播，仅 h 切分           |
| fp16_016 | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)   | fp16  | 3D 无广播，仅 w 切分           |
| fp16_017 | (2, 32, 1)       | (2, 32, 64)      | (2, 16, 1)    | fp16  | 3D 广播，c+h 切分              |
| fp16_018 | (1, 48, 64)      | (48, 48, 64)     | (1, 24, 32)   | fp16  | 3D 广播，h+w 切分              |
| int16_001 | (1, 1, 32, 32)   | (1, 1, 32, 32)   | (1,1,16,16)   | int16 | 4D 无广播，n+c+h+w 切分        |
| int16_002 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,8)     | int16 | 4D 一维广播，n+c+h+w 切分      |
| int16_003 | (2, 1, 24, 24)   | (2, 3, 24, 24)   | (2,1,12,12)   | int16 | 4D 一维广播，n+c+h+w 切分      |
| int16_004 | (1, 2, 40, 40)   | (1, 2, 1, 40)    | (1,1,20,20)   | int16 | 4D 一维广播，n+c+h+w 切分      |
| int16_005 | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,3,8,8)     | int16 | 4D 标准尺寸，n+c+h+w 切分      |
| int16_006 | (8, 1)           | (1,)             | (4, 1)        | int16 | 跨维度广播，h+w 切分           |
| int16_007 | (4, 1, 32, 32)   | (4, 1, 32, 32)   | (2,1,32,32)   | int16 | 4D 无广播，仅 n 切分           |
| int16_008 | (1, 8, 16, 16)   | (1, 8, 16, 16)   | (1,4,16,16)   | int16 | 4D 无广播，仅 c 切分           |
| int16_009 | (2, 2, 48, 48)   | (2, 2, 48, 48)   | (2,2,24,48)   | int16 | 4D 无广播，仅 h 切分           |
| int16_010 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1,4,32,32)   | int16 | 4D 无广播，仅 w 切分           |
| int16_011 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,4,16,16)   | int16 | 4D 广播，n+c 切分              |
| int16_012 | (1, 2, 32, 32)   | (1, 2, 1, 32)    | (1,2,16,32)   | int16 | 4D 广播，n+h 切分              |
| int16_013 | (2, 3, 24, 1)    | (2, 3, 24, 48)   | (2,3,24,24)   | int16 | 4D 广播，n+w 切分              |
| int16_014 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,16)    | int16 | 4D 广播，c+h 切分              |
| int16_015 | (2, 2, 32, 1)    | (2, 2, 32, 64)   | (2,2,32,32)   | int16 | 4D 广播，c+w 切分              |
| int16_016 | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)   | int16 | 4D 无广播，h+w 切分            |
| fp32_001 | (112)            | (112)            | (50)          | fp32  | 1D 尾轴对齐，w 切分            |
| fp32_002 | (16, 16, 16, 16)             | (1,)             | (8)          | fp32  | 1D 张量 + 标量广播，w 切分     |
| fp32_003 | (32)             | (32)             | (16)          | fp32  | 1D 无广播，纯 w 切分           |
| fp32_004 | (1,)             | (8, 8, 8)             | (4)          | fp32  | 1D 标量 + 张量广播，w 切分     |
| fp32_005 | (4, 80)          | (4, 80)          | (2, 40)       | fp32  | 2D 大尺寸，h+w 切分            |
| fp32_006 | (2, 96)          | (1, 96)          | (1, 48)       | fp32  | 2D 一维广播，h+w 切分          |
| fp32_007 | (5, 1)           | (5, 32)          | (5, 16)       | fp32  | 2D 一维广播，h+w 切分          |
| fp32_008 | (3, 128)         | (3, 128)         | (2, 64)       | fp32  | 2D 无广播，h+w 切分            |
| fp32_009 | (64, 1)          | (64, 64)         | (32, 1)       | fp32  | 2D 一维广播，仅 h 切分         |
| fp32_010 | (1, 64)          | (64, 64)         | (1, 32)       | fp32  | 2D 一维广播，仅 w 切分         |
| fp32_011 | (1, 64, 64)      | (1, 64, 64)      | (1, 32, 32)   | fp32  | 3D 无广播，c+h+w 切分          |
| fp32_012 | (2, 1, 48)       | (2, 3, 48)       | (2, 1, 24)    | fp32  | 3D 一维广播，c+h+w 切分        |
| fp32_013 | (3, 64, 1)       | (3, 64, 48)      | (3, 32, 1)    | fp32  | 3D 一维广播，c+h+w 切分        |
| fp32_014 | (1, 48, 48)      | (1, 1, 48)       | (1, 24, 24)   | fp32  | 3D 广播，仅 c 切分             |
| fp32_015 | (2, 64, 48)      | (2, 64, 48)      | (2, 32, 24)   | fp32  | 3D 无广播，仅 h 切分           |
| fp32_016 | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)   | fp32  | 3D 无广播，仅 w 切分           |
| fp32_017 | (2, 32, 1)       | (2, 32, 64)      | (2, 16, 1)    | fp32  | 3D 广播，c+h 切分              |
| fp32_018 | (1, 48, 64)      | (48, 48, 64)     | (1, 24, 32)   | fp32  | 3D 广播，h+w 切分              |
| int32_001 | (1, 1, 32, 32)   | (1, 1, 32, 32)   | (1,1,16,16)   | int32 | 4D 无广播，n+c+h+w 切分        |
| int32_002 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,8)     | int32 | 4D 一维广播，n+c+h+w 切分      |
| int32_003 | (2, 1, 24, 24)   | (2, 3, 24, 24)   | (2,1,12,12)   | int32 | 4D 一维广播，n+c+h+w 切分      |
| int32_004 | (1, 2, 40, 40)   | (1, 2, 1, 40)    | (1,1,20,20)   | int32 | 4D 一维广播，n+c+h+w 切分      |
| int32_005 | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,3,8,8)     | int32 | 4D 标准尺寸，n+c+h+w 切分      |
| int32_006 | (8, 1)           | (1,)             | (4, 1)        | int32 | 跨维度广播，h+w 切分           |
| int32_007 | (4, 1, 32, 32)   | (4, 1, 32, 32)   | (2,1,32,32)   | int32 | 4D 无广播，仅 n 切分           |
| int32_008 | (1, 8, 16, 16)   | (1, 8, 16, 16)   | (1,4,16,16)   | int32 | 4D 无广播，仅 c 切分           |
| int32_009 | (2, 2, 48, 48)   | (2, 2, 48, 48)   | (2,2,24,48)   | int32 | 4D 无广播，仅 h 切分           |
| int32_010 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1,4,32,32)   | int32 | 4D 无广播，仅 w 切分           |
| int32_011 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,4,16,16)   | int32 | 4D 广播，n+c 切分              |
| int32_012 | (1, 2, 32, 32)   | (1, 2, 1, 32)    | (1,2,16,32)   | int32 | 4D 广播，n+h 切分              |
| int32_013 | (2, 3, 24, 1)    | (2, 3, 24, 48)   | (2,3,24,24)   | int32 | 4D 广播，n+w 切分              |
| int32_014 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,16)    | int32 | 4D 广播，c+h 切分              |
| int32_015 | (2, 2, 32, 1)    | (2, 2, 32, 64)   | (2,2,32,32)   | int32 | 4D 广播，c+w 切分              |
| int32_016 | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)   | int32 | 4D 无广播，h+w 切分            |
| int32_017 | (2, 4, 32, 48)   | (2, 4, 32, 48)   | (1, 2, 16, 24) | int32 | 4D 无广播，n+c+h 切分        |
| int32_018 | (2, 4, 32, 64)   | (2, 4, 32, 64)   | (1, 2, 16, 32) | int32 | 4D 无广播，n+c+w 切分        |
| int32_019 | (4, 2, 32, 64)   | (4, 2, 32, 64)   | (2, 1, 16, 32) | int32 | 4D 无广播，n+h+w 切分        |
| int32_020 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1, 2, 16, 32) | int32 | 4D 无广播，c+h+w 切分        |
## 2. 二元数学运算
...
| concat_010 | (8,10,6,16) <br> (8,4,6,16) | (2,10,9,8) | INT8 | 4d，n,w切分，尾轴对齐 |
| concat_011 | (6,20,9,31) <br> (6,20,23,31) | (3,40,4,40) | INT16 | 4d，n,h切分，尾轴不对齐 |
| concat_012 | (6,9,21,10) <br> (6,9,21,13) | (3,3,30,20) | INT32 | 4d，n,c切分，尾轴对齐 |
| concat_013 | (6,9,21,10) <br> (9,9,21,10) <br> (17,9,21,10) | (5,10,5,5) | FP16 | 4d，n,h,w切分，尾轴对齐 |
| concat_014 | (6,9,21,10) <br> (6,21,21,10) <br> (6,16,21,10) | (3,3,40,5) | FP32 | 4d，n,c,w切分，尾轴对齐 |
| concat_015 | (6,9,21,10) <br> (6,9,14,10) <br> (6,9,19,10) | (5,5,12,20) | INT8 | 4d，n,c,h切分，尾轴对齐 |
| concat_016 | (6,9,21,10) <br> (6,9,21,40) <br> (6,9,21,21) <br> (6,9,21,9) | (5,8,12,5) | INT16 | 4d，n,c,h,w切分，尾轴对齐 |
...
| --------- | -------------- | -------------- | ---------------- | --------------- | --------- | ---- |
| fp16_001  | (2, 64)        | (2, 64)        | (2, 8)           | (1, 64)         | fp16      | 2D 双张量，N单轴切分 |
| fp16_002  | (4, 32)        | (4, 32)        | (4, 4)           | (4, 16)         | fp16      | 2D 双张量，W单轴切分 |
| fp16_003  | (2, 64)        | (1, 64)        | (2, 8)           | (2, 32)         | fp16      | 2D 广播，W单轴切分 |
| fp16_004  | (4, 32)        | 标量           | (4, 4)           | (2, 32)         | fp16      | 2D Tensor+标量，N单轴切分 |
| fp16_005  | (2, 40)        | (2, 40)        | (2, 5)           | (1, 40)         | fp16      | 2D 双张量，NC双轴切分（新增） |
| fp16_006  | (2, 32, 32)    | (2, 32, 32)    | (2, 1, 4)        | (2, 16, 32)     | fp16      | 3D 双张量，H单轴切分 |
| fp16_007  | (2, 32, 32)    | (2, 32, 32)    | (2, 1, 4)        | (2, 32, 16)     | fp16      | 3D 双张量，W单轴切分 |
| fp16_008  | (2, 24, 24)    | (2, 24, 24)    | (2, 1, 3)        | (1, 24, 24)     | fp16      | 3D 双张量，N单轴切分 |
| fp16_009  | (3, 16, 48)    | 标量           | (3, 1, 6)        | (3, 8, 48)      | fp16      | 3D Tensor+标量，H单轴切分 |
| fp16_010  | (2, 32, 40)    | (2, 32, 40)    | (2, 1, 5)        | (2, 16, 40)     | fp16      | 3D 双张量，HC双轴切分（新增） |
| fp16_011  | (2, 32, 40)    | (2, 32, 40)    | (2, 32, 5)        | (2, 16, 32)     | fp16      | 3D 双张量，WC双轴切分（新增） |
...
| fp16_016  | (2, 2, 24, 40) | (2, 2, 24, 40) | (2,2,24,5)        | (1,2,16,16)     | fp16      | 4D 双张量，H+W双轴切分 |
| fp16_017  | (2, 32, 40)    | (2, 32, 40)    | (2,32,5)          | (1,16,24)       | fp16      | 3D 双张量，N+H双轴切分 |
...
| fp16_025  | (2, 3, 32, 40) | (2, 3, 32, 40) | (2,3,32,5)        | (1,1,16,16)     | fp16      | 4D 双张量，NCW三轴切分（新增） |
| fp16_026  | 标量           | 标量           | (2, 8)           | (1, 8)          | fp16      | 2D 双标量，N+W占位切分 |
| fp16_027  | 标量           | 标量           | (1, 1, 8)        | (1, 4, 8)       | fp16      | 3D 双标量，N+H+W占位切分 |
| fp16_028  | 标量           | 标量           | (1,1,1,8)        | (1,1,2,8)       | fp16      | 4D 双标量，N+C+H+W占位切分 |
| fp32_001  | (2, 64)        | (2, 64)        | (2, 8)           | (1, 64)         | fp32      | 2D 双张量，N单轴切分 |
| fp32_002  | (4, 32)        | (4, 32)        | (4, 4)           | (4, 16)         | fp32      | 2D 双张量，W单轴切分 |
| fp32_003  | (2, 64)        | (1, 64)        | (2, 8)           | (2, 32)         | fp32      | 2D 广播，W单轴切分 |
| fp32_004  | (4, 32)        | 标量           | (4, 4)           | (2, 32)         | fp32      | 2D Tensor+标量，N单轴切分 |
| fp32_005  | (2, 40)        | (2, 40)        | (2, 5)           | (1, 40)         | fp32      | 2D 双张量，NC双轴切分（新增） |
| fp32_006  | (2, 32, 32)    | (2, 32, 32)    | (2, 32, 4)        | (2, 16, 32)     | fp32      | 3D 双张量，H单轴切分 |
| fp32_007  | (2, 32, 32)    | (2, 32, 32)    | (2, 32, 4)        | (2, 32, 16)     | fp32      | 3D 双张量，W单轴切分 |
| fp32_008  | (2, 24, 24)    | (2, 24, 24)    | (2, 24, 3)        | (1, 24, 24)     | fp32      | 3D 双张量，N单轴切分 |
| fp32_009  | (3, 16, 48)    | 标量           | (3, 16, 6)        | (3, 8, 48)      | fp32      | 3D Tensor+标量，H单轴切分 |
| fp32_010  | (2, 32, 40)    | (2, 32, 40)    | (2, 32, 5)        | (2, 16, 40)     | fp32      | 3D 双张量，HC双轴切分（新增） |
| fp32_011  | (2, 32, 40)    | (2, 32, 40)    | (2, 32, 5)        | (2, 32, 16)     | fp32      | 3D 双张量，WC双轴切分（新增） |
...
| fp32_017  | (2, 32, 40)    | (2, 32, 40)    | (2,32,5)          | (1,16,16)       | fp32      | 3D 双张量，N+H双轴切分 |
...
| fp32_025  | (2, 3, 32, 40) | (2, 3, 32, 40) | (2,3,32,5)        | (1,1,16,16)     | fp32      | 4D 双张量，NCW三轴切分（新增） |
| fp32_026  | 标量           | 标量           | (2, 8)           | (1, 8)          | fp32      | 2D 双标量，N+W占位切分 |
| fp32_027  | 标量           | 标量           | (1, 1, 8)        | (1, 4, 8)       | fp32      | 3D 双标量，N+H+W占位切分 |
| fp32_028  | 标量           | 标量           | (1,1,1,8)        | (1,1,2,8)       | fp32      | 4D 双标量，N+C+H+W占位切分 |
