...
|----------|------------------|------------------|---------------|-------|--------------------------------|
| fp16_001 | (112)            | (112)            | (50)          | fp16  | 1D 尾轴对齐，w 切分            |
| fp16_002 | (64)             | 标量             | (32)          | fp16  | 1D 张量 + 标量广播，w 切分     |
| fp16_003 | (32)             | (32)             | (16)          | fp16  | 1D 无广播，纯 w 切分           |
| fp16_004 | (16, 16)         | 标量              | (16, 8)          | fp16  | 1D 标量 + 张量广播，w 切分     |
| fp16_005 | (4, 80)          | (4, 80)          | (2, 40)       | fp16  | 2D 大尺寸，h+w 切分            |
| fp16_006 | (2, 96)          | (1, 96)          | (1, 48)       | fp16  | 2D 一维广播，h+w 切分          |
| fp16_007 | (5, 1)           | (5, 32)          | (5, 16)       | fp16  | 2D 一维广播，h+w 切分          |
| fp16_008 | (3, 128)         | (3, 128)         | (2, 64)       | fp16  | 2D 无广播，h+w 切分            |
| fp16_009 | (64, 1)          | (64, 64)         | (32, 64)       | fp16  | 2D 一维广播，仅 h 切分         |
| fp16_010 | (1, 64)          | (64, 64)         | (64, 32)       | fp16  | 2D 一维广播，仅 w 切分         |
| fp16_011 | (2, 64, 64)      | (2, 64, 64)      | (1, 32, 32)   | fp16  | 3D 无广播，c+h+w 切分          |
| fp16_012 | (2, 1, 48)       | (2, 3, 48)       | (1, 1, 24)    | fp16  | 3D 一维广播，c+h+w 切分        |
| fp16_013 | (3, 64, 1)       | (3, 64, 48)      | (1, 32, 24)    | fp16  | 3D 一维广播，c+h+w 切分        |
| fp16_014 | (1, 48, 48)      | (1, 1, 48)       | (1, 24, 24)   | fp16  | 3D 广播， h+w 切分             |
| fp16_015 | (2, 64, 48)      | (2, 64, 48)      | (1, 32, 24)   | fp16  | 3D 无广播，c+h+w切分           |
| fp16_016 | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)   | fp16  | 3D 无广播，仅 w 切分           |
| fp16_017 | (2, 32, 1)       | (2, 32, 64)      | (1, 32, 32)    | fp16  | 3D 广播，c+w 切分              |
| fp16_018 | (1, 48, 64)      | (48, 48, 64)     | (48, 24, 32)   | fp16  | 3D 广播，c+w 切分              |
| fp16_019 | (2, 2, 32, 32)   | (2, 2, 32, 32)   | (1,1,16,16)   | fp16  | 4D 无广播，n+c+h+w 切分        |
| fp16_020 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,8,8)     | fp16  | 4D 一维广播，n+c+h+w 切分      |
| fp16_021 | (2, 1, 24, 24)   | (2, 3, 24, 24)   | (1,1,12,12)   | fp16  | 4D 一维广播，n+c+h+w 切分      |
| fp16_022 | (2, 2, 40, 40)   | (2, 2, 1, 40)    | (1,1,20,20)   | fp16  | 4D 一维广播，n+c+h+w 切分      |
| fp16_023 | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,1,8,8)     | fp16  | 4D 标准尺寸，n+c+h+w 切分      |
| fp16_024 | (8, 4)           | 标量             | (4, 1)        | fp16  | 标量+2D张量，h+w 切分           |
| fp16_025 | (4, 1, 32, 32)   | (4, 1, 32, 32)   | (2,1,32,32)   | fp16  | 4D 无广播，仅 n 切分           |
| fp16_026 | (1, 8, 16, 16)   | (1, 8, 16, 16)   | (1,4,16,16)   | fp16  | 4D 无广播，仅 c 切分           |
| fp16_027 | (2, 2, 48, 48)   | (2, 2, 48, 48)   | (2,2,24,48)   | fp16  | 4D 无广播，仅 h 切分           |
| fp16_028 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1,4,32,32)   | fp16  | 4D 无广播，仅 w 切分           |
| fp16_029 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,16,16)   | fp16  | 4D 广播，n+c 切分              |
| fp16_030 | (2, 2, 32, 32)   | (2, 2, 1, 32)    | (1,2,16,32)   | fp16  | 4D 广播，n+h 切分              |
| fp16_031 | (2, 3, 24, 1)    | (2, 3, 24, 48)   | (1,3,24,24)   | fp16  | 4D 广播，n+w 切分              |
| fp16_032 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,16)    | fp16  | 4D 广播，c+h 切分              |
| fp16_033 | (2, 2, 32, 1)    | (2, 2, 32, 64)   | (2,1,32,32)   | fp16  | 4D 广播，c+w 切分              |
| fp16_034 | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)   | fp16  | 4D 无广播，h+w 切分            |
| fp32_001 | (112)            | (112)            | (50)          | fp32  | 1D 尾轴对齐，w 切分            |
| fp32_002 | (8, 8, 8, 8)             | 标量             | (8, 8, 8, 4)          | fp32  | 1D 张量 + 标量广播，w 切分     |
| fp32_003 | (32)             | (32)             | (16)          | fp32  | 1D 无广播，纯 w 切分           |
| fp32_004 | (8, 8, 8)            |   标量           | (8，8，4)          | fp32  | 1D 标量 + 张量广播，w 切分     |
| fp32_005 | (4, 80)          | (4, 80)          | (2, 40)       | fp32  | 2D 大尺寸，h+w 切分            |
| fp32_006 | (2, 96)          | (1, 96)          | (1, 48)       | fp32  | 2D 一维广播，h+w 切分          |
| fp32_007 | (5, 1)           | (5, 32)          | (2, 16)       | fp32  | 2D 一维广播，h+w 切分          |
| fp32_008 | (3, 128)         | (3, 128)         | (2, 64)       | fp32  | 2D 无广播，h+w 切分            |
| fp32_009 | (64, 1)          | (64, 64)         | (32, 64)       | fp32  | 2D 一维广播，仅 h 切分         |
| fp32_010 | (1, 64)          | (64, 64)         | (64, 32)       | fp32  | 2D 一维广播，仅 w 切分         |
| fp32_011 | (2, 64, 64)      | (2, 64, 64)      | (1, 32, 32)   | fp32  | 3D 无广播，c+h+w 切分          |
| fp32_012 | (2, 1, 48)       | (2, 3, 48)       | (1, 1, 24)    | fp32  | 3D 一维广播，c+h+w 切分        |
| fp32_013 | (3, 64, 1)       | (3, 64, 48)      | (1, 32, 24)    | fp32  | 3D 一维广播，c+h+w 切分        |
| fp32_014 | (16, 1, 48)      | (1, 1, 48)       | (8, 1, 48)   | fp32  | 3D 广播，仅 c 切分             |
| fp32_015 | (2, 64, 48)      | (2, 64, 48)      | (1, 64, 24)   | fp32  | 3D 无广播，c+w 切分           |
| fp32_016 | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)   | fp32  | 3D 无广播，仅 w 切分           |
| fp32_017 | (2, 32, 1)       | (2, 32, 64)      | (2, 16, 16)    | fp32  | 3D 广播，h+w 切分              |
| fp32_018 | (1, 48, 64)      | (48, 48, 64)     | (24, 24, 32)   | fp32  | 3D 广播，c+h+w 切分              |
| fp32_019 | (2, 2, 32, 32)   | (2, 2, 32, 32)   | (1,1,16,16)   | fp32  | 4D 无广播，n+c+h+w 切分        |
| fp32_020 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,8,8)     | fp32  | 4D 一维广播，n+c+h+w 切分      |
| fp32_021 | (2, 1, 24, 24)   | (2, 3, 24, 24)   | (1,1,12,12)   | fp32  | 4D 一维广播，n+c+h+w 切分      |
| fp32_022 | (2, 2, 40, 40)   | (2, 2, 1, 40)    | (1,1,20,20)   | fp32  | 4D 一维广播，n+c+h+w 切分      |
| fp32_023 | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,1,8,8)     | fp32  | 4D 标准尺寸，n+c+h+w 切分      |
| fp32_024 | (8, 4)           | 标量             | (4, 1)        | fp32  | 标量+2D张量，h+w 切分           |
| fp32_025 | (4, 1, 32, 32)   | (4, 1, 32, 32)   | (2,1,32,32)   | fp32  | 4D 无广播，仅 n 切分           |
| fp32_026 | (1, 8, 16, 16)   | (1, 8, 16, 16)   | (1,4,16,16)   | fp32  | 4D 无广播，仅 c 切分           |
| fp32_027 | (2, 2, 48, 48)   | (2, 2, 48, 48)   | (2,2,24,48)   | fp32  | 4D 无广播，仅 h 切分           |
| fp32_028 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1,4,32,32)   | fp32  | 4D 无广播，仅 w 切分           |
| fp32_029 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,16,16)   | fp32  | 4D 广播，n+c 切分              |
| fp32_030 | (2, 2, 32, 32)   | (2, 2, 1, 32)    | (1,2,16,32)   | fp32  | 4D 广播，n+h 切分              |
| fp32_031 | (2, 3, 24, 1)    | (2, 3, 24, 48)   | (1,3,24,24)   | fp32  | 4D 广播，n+w 切分              |
| fp32_032 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,16)    | fp32  | 4D 广播，c+h 切分              |
| fp32_033 | (2, 2, 32, 1)    | (2, 2, 32, 64)   | (2,1,32,32)   | fp32  | 4D 广播，c+w 切分              |
| fp32_034 | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)   | fp32  | 4D 无广播，h+w 切分            |
| fp32_035 | (2, 4, 32, 48)   | (2, 4, 32, 48)   | (1, 2, 16, 48) | fp32  | 4D 无广播，n+c+h 切分        |
| fp32_036 | (2, 4, 32, 64)   | (2, 4, 32, 64)   | (1, 2, 32, 32) | fp32  | 4D 无广播，n+c+w 切分        |
| fp32_037 | (4, 2, 32, 64)   | (4, 2, 32, 64)   | (2, 2, 16, 32) | fp32  | 4D 无广播，n+h+w 切分        |
| fp32_038 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1, 2, 16, 32) | fp32  | 4D 无广播，c+h+w 切分        |
...
| fp16_005 | (4, 80)          | (4, 80)          | (2, 40)       | fp16  | 2D 大尺寸，h+w 切分            |
| fp16_006 | (2, 96)          | (1, 96)          | (1, 48)       | fp16  | 2D 一维广播，h+w 切分          |
| fp16_007 | (5, 1)           | (5, 32)          | (2, 16)       | fp16  | 2D 一维广播，h+w 切分          |
| fp16_008 | (3, 128)         | (3, 128)         | (2, 64)       | fp16  | 2D 无广播，h+w 切分            |
| fp16_009 | (64, 1)          | (64, 64)         | (32, 64)       | fp16  | 2D 一维广播，仅 h 切分         |
| fp16_010 | (1, 64)          | (64, 64)         | (64, 32)       | fp16  | 2D 一维广播，仅 w 切分         |
| fp16_011 | (2, 64, 64)      | (2, 64, 64)      | (1, 32, 32)   | fp16  | 3D 无广播，c+h+w 切分          |
| fp16_012 | (2, 1, 48)       | (2, 3, 48)       | (1, 1, 24)    | fp16  | 3D 一维广播，c+h+w 切分        |
| fp16_013 | (3, 64, 1)       | (3, 64, 48)      | (1, 32, 24)    | fp16  | 3D 一维广播，c+h+w 切分        |
| fp16_014 | (2, 48, 48)      | (2, 1, 48)       | (1, 48, 48)   | fp16  | 3D 广播，仅 c 切分             |
| fp16_015 | (2, 64, 48)      | (2, 64, 48)      | (2, 32, 48)   | fp16  | 3D 无广播，仅 h 切分           |
| fp16_016 | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)   | fp16  | 3D 无广播，仅 w 切分           |
| fp16_017 | (2, 32, 1)       | (2, 32, 64)      | (1, 16, 64)    | fp16  | 3D 广播，c+h 切分              |
| fp16_018 | (1, 48, 64)      | (48, 48, 64)     | (48, 24, 32)   | fp16  | 3D 广播，h+w 切分              |
| int16_001 | (2, 2, 32, 32)   | (2, 2, 32, 32)   | (1,1,16,16)   | int16 | 4D 无广播，n+c+h+w 切分        |
| int16_002 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,8,8)     | int16 | 4D 一维广播，n+c+h+w 切分      |
| int16_003 | (2, 1, 24, 24)   | (2, 3, 24, 24)   | (2,1,12,12)   | int16 | 4D 一维广播，n+c+h+w 切分      |
| int16_004 | (2, 2, 40, 40)   | (2, 2, 1, 40)    | (1,1,20,20)   | int16 | 4D 一维广播，n+c+h+w 切分      |
| int16_005 | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,1,8,8)     | int16 | 4D 标准尺寸，n+c+h+w 切分      |
| int16_006 | (8, 2)           | 标量             | (4, 1)        | int16 | 标量和二维张量 h+w 切分           |
...
| int16_011 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,16,16)   | int16 | 4D 广播，n+c 切分              |
| int16_012 | (2, 2, 32, 32)   | (2, 2, 1, 32)    | (1,2,16,32)   | int16 | 4D 广播，n+h 切分              |
| int16_013 | (2, 3, 24, 1)    | (2, 3, 24, 48)   | (1,3,24,24)   | int16 | 4D 广播，n+w 切分              |
| int16_014 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,16)    | int16 | 4D 广播，c+h 切分              |
| int16_015 | (2, 2, 32, 1)    | (2, 2, 32, 64)   | (2,1,32,32)   | int16 | 4D 广播，c+w 切分              |
| int16_016 | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)   | int16 | 4D 无广播，h+w 切分            |
| fp32_001 | (112)            | (112)            | (50)          | fp32  | 1D 尾轴对齐，w 切分            |
| fp32_002 | (16, 16, 16, 16)             | 标量             | (16, 16, 16, 8)          | fp32  | 1D 张量 + 标量广播，w 切分     |
| fp32_003 | (32)             | (32)             | (16)          | fp32  | 1D 无广播，纯 w 切分           |
| fp32_004 | (8, 8, 8)              | 标量             | (8, 8, 4)          | fp32  | 1D 标量 + 张量广播，w 切分     |
| fp32_005 | (4, 80)          | (4, 80)          | (2, 40)       | fp32  | 2D 大尺寸，h+w 切分            |
| fp32_006 | (2, 96)          | (1, 96)          | (1, 48)       | fp32  | 2D 一维广播，h+w 切分          |
| fp32_007 | (5, 1)           | (5, 32)          | (1, 16)       | fp32  | 2D 一维广播，h+w 切分          |
| fp32_008 | (3, 128)         | (3, 128)         | (2, 64)       | fp32  | 2D 无广播，h+w 切分            |
| fp32_009 | (64, 1)          | (64, 64)         | (32, 64)       | fp32  | 2D 一维广播，仅 h 切分         |
| fp32_010 | (1, 64)          | (64, 64)         | (64, 32)       | fp32  | 2D 一维广播，仅 w 切分         |
| fp32_011 | (2, 64, 64)      | (2, 64, 64)      | (1, 32, 32)   | fp32  | 3D 无广播，c+h+w 切分          |
| fp32_012 | (2, 1, 48)       | (2, 3, 48)       | (1, 1, 24)    | fp32  | 3D 一维广播，c+h+w 切分        |
| fp32_013 | (3, 64, 1)       | (3, 64, 48)      | (1, 32, 24)    | fp32  | 3D 一维广播，c+h+w 切分        |
| fp32_014 | (2, 48, 48)      | (2, 1, 48)       | (1, 48, 48)   | fp32  | 3D 广播，仅 c 切分             |
| fp32_015 | (2, 64, 48)      | (2, 64, 48)      | (2, 32, 48)   | fp32  | 3D 无广播，仅 h 切分           |
| fp32_016 | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)   | fp32  | 3D 无广播，仅 w 切分           |
| fp32_017 | (2, 32, 1)       | (2, 32, 64)      | (1, 16, 64)    | fp32  | 3D 广播，c+h 切分              |
| fp32_018 | (1, 48, 64)      | (48, 48, 64)     | (48, 24, 32)   | fp32  | 3D 广播，h+w 切分              |
| int32_001 | (2, 2, 32, 32)   | (2, 2, 32, 32)   | (1,1,16,16)   | int32 | 4D 无广播，n+c+h+w 切分        |
| int32_002 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,8,8)     | int32 | 4D 一维广播，n+c+h+w 切分      |
| int32_003 | (2, 1, 24, 24)   | (2, 3, 24, 24)   | (1,1,12,12)   | int32 | 4D 一维广播，n+c+h+w 切分      |
| int32_004 | (2, 2, 40, 40)   | (2, 2, 1, 40)    | (1,1,20,20)   | int32 | 4D 一维广播，n+c+h+w 切分      |
| int32_005 | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,1,8,8)     | int32 | 4D 标准尺寸，n+c+h+w 切分      |
| int32_006 | (8, 4)           | 标量            | (4, 1)        | int32 | 标量+二维张量，h+w 切分           |
| int32_007 | (4, 1, 32, 32)   | (4, 1, 32, 32)   | (2,1,32,32)   | int32 | 4D 无广播，仅 n 切分           |
| int32_008 | (1, 8, 16, 16)   | (1, 8, 16, 16)   | (1,4,16,16)   | int32 | 4D 无广播，仅 c 切分           |
| int32_009 | (2, 2, 48, 48)   | (2, 2, 48, 48)   | (2,2,24,48)   | int32 | 4D 无广播，仅 h 切分           |
| int32_010 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1,4,32,32)   | int32 | 4D 无广播，仅 w 切分           |
| int32_011 | (2, 4, 16, 16)   | (2, 1, 16, 16)   | (1,2,16,16)   | int32 | 4D 广播，n+c 切分              |
| int32_012 | (2, 2, 32, 32)   | (2, 2, 1, 32)    | (1,2,16,32)   | int32 | 4D 广播，n+h 切分              |
| int32_013 | (2, 3, 24, 1)    | (2, 3, 24, 48)   | (1,3,24,24)   | int32 | 4D 广播，n+w 切分              |
| int32_014 | (1, 4, 16, 16)   | (1, 1, 16, 16)   | (1,2,8,16)    | int32 | 4D 广播，c+h 切分              |
| int32_015 | (2, 2, 32, 1)    | (2, 2, 32, 64)   | (2,1,32,32)   | int32 | 4D 广播，c+w 切分              |
| int32_016 | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)   | int32 | 4D 无广播，h+w 切分            |
| int32_017 | (2, 4, 32, 48)   | (2, 4, 32, 48)   | (1, 2, 16, 48) | int32 | 4D 无广播，n+c+h 切分        |
| int32_018 | (2, 4, 32, 64)   | (2, 4, 32, 64)   | (1, 2, 32, 32) | int32 | 4D 无广播，n+c+w 切分        |
| int32_019 | (4, 2, 32, 64)   | (4, 2, 32, 64)   | (2, 2, 16, 32) | int32 | 4D 无广播，n+h+w 切分        |
| int32_020 | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1, 2, 16, 32) | int32 | 4D 无广播，c+h+w 切分        |
### 1.8. pypto.minimum
...
| mul_005  | (112) | (0)   | (100) | FP32  | 1d，w切分，尾轴对齐，单维度广播 |
| mul_006  | (101) | (0)   | (100) | FP16  | 1d，w切分，尾轴不对齐，单维度广播|
| mul_007  | (160) | (1)   | (120) | INT32 | 1d，无切分，尾轴对齐，单维度广播 |
| mul_008  | (100) | (1)   | (112) | INT16 | 1d，无切分，尾轴对齐，单维度广播 |
| mul_009  | (32,20) | (0)     | (64,32) | FP32  | 2d，无切分，尾轴对齐，单维度广播 |
...
| mul_013  | (32,20) | (1,20)  | (64,32) | INT32 | 2d，无切分，尾轴对齐，单维度广播 |
| mul_014  | (31,21) | (31,1)  | (32,10) | INT16 | 2d，w切分，尾轴不对齐，单维度广播 |
| mul_015  | (31,19) | (31,1)  | (10,20) | FP32  | 2d，h切分，尾轴对齐，单维度广播 |
| mul_016  | (1,19)  | (31,1)  | (10,16) | FP16  | 2d，h,w切分，尾轴不对齐，多维度广播 |
| mul_017  | (10,32,23) | (0)        | (5,32,30)  | FP32  | 3d，c切分，尾轴对齐，单维度广播 |
| mul_018  | (10,32,23) | (0)        | (7,32,22)  | FP16  | 3d，c,w切分，尾轴不对齐，单维度广播 |
| mul_019  | (21,19,33) | (21,19,33) | (5,12,40)  | INT32 | 3d，c,h切分，尾轴对齐，无广播 |
| mul_020  | (10,32,23) | (10,32,23) | (5,64,22)  | INT16 | 3d，h,w切分，尾轴不对齐，无广播 |
| mul_021  | (63,43,27) | (63,1,27)  | (23,20,17) | INT32 | 3d，c,h,w切分，尾轴对齐，单维度广播 |
| mul_022  | (63,1,27)  | (63,43,27) | (23,20,20) | INT16 | 3d，c,h,w切分，尾轴不对齐，单维度广播 |
| mul_023  | (63,43,27) | (1,1,27)   | (23,20,17) | FP32  | 3d，c,h,w切分，尾轴对齐，多维度广播 |
| mul_024  | (63,1,27)  | (1,43,1)   | (23,20,20) | FP16  | 3d，c,h,w切分，尾轴不对齐，多维度广播 |
| mul_025  | (5,16,11,12)  | (0)           | (5,20,15,12)  | FP32  | 4d，无切分，尾轴对齐，单维度广播 |
| mul_026  | (10,15,16,10) | (0)           | (7,16,20,10)  | FP16  | 4d，n切分，尾轴对齐，单维度广播 |
| mul_027  | (21,12,15,16) | (21,12,15,16) | (11,12,16,6)  | INT32 | 4d，n,w切分，尾轴对齐，无广播 |
| mul_028  | (21,19,33,12) | (21,19,33,12) | (10,20,5,12)  | INT16 | 4d，n,h切分，尾轴对齐，无广播 |
| mul_029  | (21,11,13,17) | (1,11,13,17)  | (15,12,11,6)  | INT32 | 4d，n,h,w切分，尾轴对齐，单维度广播 |
| mul_030  | (25,11,15,1)  | (25,11,15,17) | (23,5,17,10)  | INT16 | 4d，n,c,w切分，尾轴不对齐，单维度广播 |
| mul_031  | (13,16,1,17)  | (13,16,17,1)  | (10,15,5,17)  | FP32  | 4d，n,c,h切分，尾轴对齐，多维度广播 |
| mul_032  | (15,1,1,13)   | (1,35,27,1)   | (13,12,11,10) | FP16  | 4d，n,c,h,w切分，尾轴不对齐，多维度广播 |
| mul_033  | (1,16,13,18)  | (22,1,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_034  | (1,16,13,18)  | (22,16,1,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_035  | (1,16,13,18)  | (22,16,13,1)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_036  | (1,16,13,18)  | (22,1,1,18)   | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_037  | (1,16,13,18)  | (22,1,13,1)   | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_038  | (1,16,13,18)  | (22,1,1,1)    | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_039  | (22,1,13,18)  | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_040  | (22,16,1,18)  | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_041  | (22,16,13,1)  | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_042  | (22,1,1,18)   | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_043  | (22,1,13,1)   | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_044  | (22,1,1,1)    | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_045  | (22,16,13,18) | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_046  | (1,1,1,1)     | (22,16,13,18) | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_047  | (22,16,13,18) | (1,1,1,1)     | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_048  | (1,1,1,18)    | (22,16,13,18) | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_049  | (22,16,13,18) | (22,1,1,1)    | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| mul_050  | (1,1,13,18)   | (22,16,1,1)   | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
...
| add_005  | (112) | (0)   | (100) | FP32  | 1d，w切分，尾轴对齐，单维度广播 |
| add_006  | (101) | (0)   | (100) | FP16  | 1d，w切分，尾轴不对齐，单维度广播|
| add_007  | (160) | (1)   | (120) | INT32 | 1d，无切分，尾轴对齐，单维度广播 |
| add_008  | (100) | (1)   | (112) | INT16 | 1d，无切分，尾轴对齐，单维度广播 |
| add_009  | (32,20) | (0)     | (64,32) | FP32  | 2d，无切分，尾轴对齐，单维度广播 |
...
| add_013  | (32,20) | (1,20)  | (64,32) | INT32 | 2d，无切分，尾轴对齐，单维度广播 |
| add_014  | (31,21) | (31,1)  | (32,10) | INT16 | 2d，w切分，尾轴不对齐，单维度广播 |
| add_015  | (31,19) | (31,1)  | (10,20) | FP32  | 2d，h切分，尾轴对齐，单维度广播 |
| add_016  | (1,19)  | (31,1)  | (10,16) | FP16  | 2d，h,w切分，尾轴不对齐，多维度广播 |
| add_017  | (10,32,23) | (0)        | (5,32,30)  | FP32  | 3d，c切分，尾轴对齐，单维度广播 |
| add_018  | (10,32,23) | (0)        | (7,32,22)  | FP16  | 3d，c,w切分，尾轴不对齐，单维度广播 |
| add_019  | (21,19,33) | (21,19,33) | (5,12,40)  | INT32 | 3d，c,h切分，尾轴对齐，无广播 |
| add_020  | (10,32,23) | (10,32,23) | (5,64,22)  | INT16 | 3d，h,w切分，尾轴不对齐，无广播 |
| add_021  | (63,43,27) | (63,1,27)  | (23,20,17) | INT32 | 3d，c,h,w切分，尾轴对齐，单维度广播 |
| add_022  | (63,1,27)  | (63,43,27) | (23,20,20) | INT16 | 3d，c,h,w切分，尾轴不对齐，单维度广播 |
| add_023  | (63,43,27) | (1,1,27)   | (23,20,17) | FP32  | 3d，c,h,w切分，尾轴对齐，多维度广播 |
| add_024  | (63,1,27)  | (1,43,1)   | (23,20,20) | FP16  | 3d，c,h,w切分，尾轴不对齐，多维度广播 |
| add_025  | (5,16,11,12)  | (0)           | (5,20,15,12)  | FP32  | 4d，无切分，尾轴对齐，单维度广播 |
| add_026  | (10,15,16,10) | (0)           | (7,16,20,10)  | FP16  | 4d，n切分，尾轴对齐，单维度广播 |
| add_027  | (21,12,15,16) | (21,12,15,16) | (11,12,16,6)  | INT32 | 4d，n,w切分，尾轴对齐，无广播 |
| add_028  | (21,19,33,12) | (21,19,33,12) | (10,20,5,12)  | INT16 | 4d，n,h切分，尾轴对齐，无广播 |
| add_029  | (21,11,13,17) | (1,11,13,17)  | (15,12,11,6)  | INT32 | 4d，n,h,w切分，尾轴对齐，单维度广播 |
| add_030  | (25,11,15,1)  | (25,11,15,17) | (23,5,17,10)  | INT16 | 4d，n,c,w切分，尾轴不对齐，单维度广播 |
| add_031  | (13,16,1,17)  | (13,16,17,1)  | (10,15,5,17)  | FP32  | 4d，n,c,h切分，尾轴对齐，多维度广播 |
| add_032  | (15,1,1,13)   | (1,35,27,1)   | (13,12,11,10) | FP16  | 4d，n,c,h,w切分，尾轴不对齐，多维度广播 |
| add_033  | (1,16,13,18)  | (22,1,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_034  | (1,16,13,18)  | (22,16,1,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_035  | (1,16,13,18)  | (22,16,13,1)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_036  | (1,16,13,18)  | (22,1,1,18)   | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_037  | (1,16,13,18)  | (22,1,13,1)   | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_038  | (1,16,13,18)  | (22,1,1,1)    | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_039  | (22,1,13,18)  | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_040  | (22,16,1,18)  | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_041  | (22,16,13,1)  | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_042  | (22,1,1,18)   | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_043  | (22,1,13,1)   | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_044  | (22,1,1,1)    | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_045  | (22,16,13,18) | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_046  | (1,1,1,1)     | (22,16,13,18) | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_047  | (22,16,13,18) | (1,1,1,1)     | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_048  | (1,1,1,18)    | (22,16,13,18) | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_049  | (22,16,13,18) | (22,1,1,1)    | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| add_050  | (1,1,13,18)   | (22,16,1,1)   | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
...
| div_005  | (112) | (0)   | (100) | FP32 | 1d，w切分，尾轴对齐，单维度广播 |
| div_006  | (101) | (0)   | (100) | FP16 | 1d，w切分，尾轴不对齐，单维度广播|
| div_007  | (160) | (1)   | (120) | FP32 | 1d，无切分，尾轴对齐，单维度广播 |
| div_008  | (100) | (1)   | (112) | FP16 | 1d，无切分，尾轴对齐，单维度广播 |
| div_009  | (32,20) | (0)     | (64,32) | FP32 | 2d，无切分，尾轴对齐，单维度广播 |
...
| div_013  | (32,20) | (1,20)  | (64,32) | FP32 | 2d，无切分，尾轴对齐，单维度广播 |
| div_014  | (31,21) | (31,1)  | (32,10) | FP16 | 2d，w切分，尾轴不对齐，单维度广播 |
| div_015  | (31,19) | (31,1)  | (10,20) | FP32 | 2d，h切分，尾轴对齐，单维度广播 |
| div_016  | (1,19)  | (31,1)  | (10,16) | FP16 | 2d，h,w切分，尾轴不对齐，多维度广播 |
| div_017  | (10,32,23) | (0)        | (5,32,30)  | FP32 | 3d，c切分，尾轴对齐，单维度广播 |
| div_018  | (10,32,23) | (0)        | (7,32,22)  | FP16 | 3d，c,w切分，尾轴不对齐，单维度广播 |
| div_019  | (21,19,33) | (21,19,33) | (5,12,40)  | FP32 | 3d，c,h切分，尾轴对齐，无广播 |
| div_020  | (10,32,23) | (10,32,23) | (5,64,22)  | FP16 | 3d，h,w切分，尾轴不对齐，无广播 |
| div_021  | (63,43,27) | (63,1,27)  | (23,20,17) | FP32 | 3d，c,h,w切分，尾轴对齐，单维度广播 |
| div_022  | (63,1,27)  | (63,43,27) | (23,20,20) | FP16 | 3d，c,h,w切分，尾轴不对齐，单维度广播 |
| div_023  | (63,43,27) | (1,1,27)   | (23,20,17) | FP32 | 3d，c,h,w切分，尾轴对齐，多维度广播 |
| div_024  | (63,1,27)  | (1,43,1)   | (23,20,20) | FP16 | 3d，c,h,w切分，尾轴不对齐，多维度广播 |
| div_025  | (5,16,11,12)  | (0)           | (5,20,15,12)  | FP32 | 4d，无切分，尾轴对齐，单维度广播 |
| div_026  | (10,15,16,10) | (0)           | (7,16,20,10)  | FP16 | 4d，n切分，尾轴对齐，单维度广播 |
| div_027  | (21,12,15,16) | (21,12,15,16) | (11,12,16,6)  | FP32 | 4d，n,w切分，尾轴对齐，无广播 |
| div_028  | (21,19,33,12) | (21,19,33,12) | (10,20,5,12)  | FP16 | 4d，n,h切分，尾轴对齐，无广播 |
| div_029  | (21,11,13,17) | (1,11,13,17)  | (15,12,11,6)  | FP32 | 4d，n,h,w切分，尾轴对齐，单维度广播 |
| div_030  | (25,11,15,1)  | (25,11,15,17) | (23,5,17,10)  | FP16 | 4d，n,c,w切分，尾轴不对齐，单维度广播 |
| div_031  | (13,16,1,17)  | (13,16,17,1)  | (10,15,5,17)  | FP32 | 4d，n,c,h切分，尾轴对齐，多维度广播 |
| div_032  | (15,1,1,13)   | (1,35,27,1)   | (13,12,11,10) | FP16 | 4d，n,c,h,w切分，尾轴不对齐，多维度广播 |
| div_033  | (1,16,13,18)  | (22,1,13,18)  | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_034  | (1,16,13,18)  | (22,16,1,18)  | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_035  | (1,16,13,18)  | (22,16,13,1)  | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_036  | (1,16,13,18)  | (22,1,1,18)   | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_037  | (1,16,13,18)  | (22,1,13,1)   | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_038  | (1,16,13,18)  | (22,1,1,1)    | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_039  | (22,1,13,18)  | (1,16,13,18)  | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_040  | (22,16,1,18)  | (1,16,13,18)  | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_041  | (22,16,13,1)  | (1,16,13,18)  | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_042  | (22,1,1,18)   | (1,16,13,18)  | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_043  | (22,1,13,1)   | (1,16,13,18)  | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_044  | (22,1,1,1)    | (1,16,13,18)  | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_045  | (22,16,13,18) | (1,16,13,18)  | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_046  | (1,1,1,1)     | (22,16,13,18) | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_047  | (22,16,13,18) | (1,1,1,1)     | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_048  | (1,1,1,18)    | (22,16,13,18) | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_049  | (22,16,13,18) | (22,1,1,1)    | (11,12,13,10) | FP16 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| div_050  | (1,1,13,18)   | (22,16,1,1)   | (11,12,13,10) | FP32 | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
...
| sub_005  | (112) | (0)   | (100) | FP32  | 1d，w切分，尾轴对齐，单维度广播 |
| sub_006  | (101) | (0)   | (100) | FP16  | 1d，w切分，尾轴不对齐，单维度广播|
| sub_007  | (160) | (1)   | (120) | INT32 | 1d，无切分，尾轴对齐，单维度广播 |
| sub_008  | (100) | (1)   | (112) | INT16 | 1d，无切分，尾轴对齐，单维度广播 |
| sub_009  | (32,20) | (0)     | (64,32) | FP32  | 2d，无切分，尾轴对齐，单维度广播 |
...
| sub_013  | (32,20) | (1,20)  | (64,32) | INT32 | 2d，无切分，尾轴对齐，单维度广播 |
| sub_014  | (31,21) | (31,1)  | (32,10) | INT16 | 2d，w切分，尾轴不对齐，单维度广播 |
| sub_015  | (31,19) | (31,1)  | (10,20) | FP32  | 2d，h切分，尾轴对齐，单维度广播 |
| sub_016  | (1,19)  | (31,1)  | (10,16) | FP16  | 2d，h,w切分，尾轴不对齐，多维度广播 |
| sub_017  | (10,32,23) | (0)        | (5,32,30)  | FP32  | 3d，c切分，尾轴对齐，单维度广播 |
| sub_018  | (10,32,23) | (0)        | (7,32,22)  | FP16  | 3d，c,w切分，尾轴不对齐，单维度广播 |
| sub_019  | (21,19,33) | (21,19,33) | (5,12,40)  | INT32 | 3d，c,h切分，尾轴对齐，无广播 |
| sub_020  | (10,32,23) | (10,32,23) | (5,64,22)  | INT16 | 3d，h,w切分，尾轴不对齐，无广播 |
| sub_021  | (63,43,27) | (63,1,27)  | (23,20,17) | INT32 | 3d，c,h,w切分，尾轴对齐，单维度广播 |
| sub_022  | (63,1,27)  | (63,43,27) | (23,20,20) | INT16 | 3d，c,h,w切分，尾轴不对齐，单维度广播 |
| sub_023  | (63,43,27) | (1,1,27)   | (23,20,17) | FP32  | 3d，c,h,w切分，尾轴对齐，多维度广播 |
| sub_024  | (63,1,27)  | (1,43,1)   | (23,20,20) | FP16  | 3d，c,h,w切分，尾轴不对齐，多维度广播 |
| sub_025  | (5,16,11,12)  | (0)           | (5,20,15,12)  | FP32  | 4d，无切分，尾轴对齐，单维度广播 |
| sub_026  | (10,15,16,10) | (0)           | (7,16,20,10)  | FP16  | 4d，n切分，尾轴对齐，单维度广播 |
| sub_027  | (21,12,15,16) | (21,12,15,16) | (11,12,16,6)  | INT32 | 4d，n,w切分，尾轴对齐，无广播 |
| sub_028  | (21,19,33,12) | (21,19,33,12) | (10,20,5,12)  | INT16 | 4d，n,h切分，尾轴对齐，无广播 |
| sub_029  | (21,11,13,17) | (1,11,13,17)  | (15,12,11,6)  | INT32 | 4d，n,h,w切分，尾轴对齐，单维度广播 |
| sub_030  | (25,11,15,1)  | (25,11,15,17) | (23,5,17,10)  | INT16 | 4d，n,c,w切分，尾轴不对齐，单维度广播 |
| sub_031  | (13,16,1,17)  | (13,16,17,1)  | (10,15,5,17)  | FP32  | 4d，n,c,h切分，尾轴对齐，多维度广播 |
| sub_032  | (15,1,1,13)   | (1,35,27,1)   | (13,12,11,10) | FP16  | 4d，n,c,h,w切分，尾轴不对齐，多维度广播 |
| sub_033  | (1,16,13,18)  | (22,1,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_034  | (1,16,13,18)  | (22,16,1,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_035  | (1,16,13,18)  | (22,16,13,1)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_036  | (1,16,13,18)  | (22,1,1,18)   | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_037  | (1,16,13,18)  | (22,1,13,1)   | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_038  | (1,16,13,18)  | (22,1,1,1)    | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_039  | (22,1,13,18)  | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_040  | (22,16,1,18)  | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_041  | (22,16,13,1)  | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_042  | (22,1,1,18)   | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_043  | (22,1,13,1)   | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_044  | (22,1,1,1)    | (1,16,13,18)  | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_045  | (22,16,13,18) | (1,16,13,18)  | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_046  | (1,1,1,1)     | (22,16,13,18) | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_047  | (22,16,13,18) | (1,1,1,1)     | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_048  | (1,1,1,18)    | (22,16,13,18) | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_049  | (22,16,13,18) | (22,1,1,1)    | (11,12,13,10) | FP16  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
| sub_050  | (1,1,13,18)   | (22,16,1,1)   | (11,12,13,10) | FP32  | 4d，n,c,h,w切分，尾轴对齐，多维度广播 |
...
| 用例名称  | 输入维度 | 切分 | 输入dtype | 说明 |
|----------|---------|-----------|------|------|
| Neg_INT16_001  | (112) | (50) | INT16 | 1d尾轴对齐，w切分 |
| Neg_INT16_002  | (100) | (100) | INT16 | 1d尾轴不对齐，无切分 |
| Neg_INT16_003  | (4,128) | (2,32) | INT16 | 2d尾轴对齐，h,w切分 |
| Neg_INT16_004  | (4,130) | (1,130) | INT16 | 2d尾轴不对齐，h切分 |
| Neg_INT16_005  | (2,4,160) | (1,2,32) | INT16 | 3d尾轴对齐，c,h,w切分 |
| Neg_INT16_006  | (2,4,140) | (1,2,140) | INT16 | 3d尾轴不对齐，c,h切分 |
| Neg_INT16_007  | (2,5,152) | (1,5,32) | INT16 | 3d尾轴不对齐，c,w切分 |
| Neg_INT16_008  | (2,3,170) | (1,3,170) | INT16 | 3d尾轴不对齐，c切分 |
| Neg_INT32_009  | (5,2,4,176) | (2,1,2,16) | INT32 | 4d尾轴对齐，n,c,h,w切分 |
| Neg_INT32_010  | (5,2,4,130) | (1,1,1,130) | INT32 | 4d尾轴不对齐，n,c,h切分 |
| Neg_INT32_011  | (2,3,5,134) | (1,1,5,32) | INT32 | 4d尾轴不对齐，n,c,w切分 |
| Neg_INT32_012  | (4,2,6,135) | (2,2,3,32) | INT32 | 4d尾轴不对齐，n,h,w切分 |
| Neg_INT32_013  | (6,2,4,130) | (1,1,4,130) | INT32 | 4d尾轴不对齐，n,c切分 |
| Neg_INT32_014  | (3,2,3,139) | (1,2,1,139) | INT32 | 4d尾轴不对齐，n,h切分 |
| Neg_INT32_015  | (6,3,5,141) | (3,3,5,32) | INT32 | 4d尾轴不对齐，n,w切分 |
...
| concat_002 | (4,130) <br> (4,90) | (10,100) | INT32 | 2d，w切分，尾轴对齐 |
| concat_003 | (15,31) <br> (20,31) <br> (16,31) | (5,32) | FP16 | 2d，h切分，尾轴不对齐 |
| concat_004 | (4,140) <br> (4,23) <br> (4,4) | (2,70) | FP32 | 2d，h,w切分，尾轴对齐 |
| concat_005 | (10,5,12) <br> (5,5,12) | (5,5,32) | INT8 | 3d，c切分，尾轴对齐 |
| concat_006 | (7,3,170) <br> (7,20,170) | (5,5,100) | INT16 | 3d，c,w切分，尾轴对齐 |
| concat_007 | (9,8,100) <br> (9,8,40) | (5,4,120) | INT32 | 3d，c,h切分，尾轴对齐 |
| concat_008 | (20,40,10) <br> (9,40,10) <br> (12,40,10) | (10,10,4) | FP16 | 3d，c,h,w切分，尾轴对齐 |
...
| --------- | -------------- | -------------- | ---------------- | --------------- | --------- | ---- |
| fp16_001  | (2, 64)        | (2, 64)        | (2, 8)           | (1, 64)         | fp16      | 2D 双张量，H单轴切分 |
| fp16_002  | (4, 32)        | (4, 32)        | (4, 4)           | (4, 16)         | fp16      | 2D 双张量，W单轴切分 |
| fp16_003  | (2, 64)        | (1, 64)        | (2, 8)           | (2, 32)         | fp16      | 2D 广播，W单轴切分 |
| fp16_004  | (4, 32)        | 标量           | (4, 4)           | (2, 32)         | fp16      | 2D Tensor+标量，H单轴切分 |
| fp16_005  | (2, 40)        | (2, 40)        | (2, 5)           | (1, 20)         | fp16      | 2D 双张量，H+W双轴切分 |
| fp16_006  | (2, 32, 32)    | (2, 32, 32)    | (2, 1, 4)        | (2, 16, 32)     | fp16      | 3D 双张量，H单轴切分 |
| fp16_007  | (2, 32, 32)    | (2, 32, 32)    | (2, 1, 4)        | (2, 32, 16)     | fp16      | 3D 双张量，W单轴切分 |
| fp16_008  | (2, 24, 24)    | (2, 24, 24)    | (2, 1, 3)        | (1, 24, 24)     | fp16      | 3D 双张量，C单轴切分 |
| fp16_009  | (3, 16, 48)    | 标量           | (3, 1, 6)        | (3, 8, 48)      | fp16      | 3D Tensor+标量，H单轴切分 |
| fp16_010  | (2, 32, 40)    | (2, 32, 40)    | (2, 1, 5)        | (1, 16, 40)     | fp16      | 3D 双张量，HC双轴切分|
| fp16_011  | (2, 32, 40)    | (2, 32, 40)    | (2, 32, 5)        | (1, 32, 32)     | fp16      | 3D 双张量，WC双轴切分 |
| fp16_012  | (1, 2, 40, 40) | (1, 2, 40, 40) | (1,2,1,5)        | (1,2,20,40)     | fp16      | 4D 双张量，H单轴切分 |
| fp16_013  | (1, 2, 40, 40) | (1, 2, 40, 40) | (1,2,40,5)        | (1,2,40,16)     | fp16      | 4D 双张量，W单轴切分 |
| fp16_014  | (2, 3, 24, 24) | (2, 3, 24, 24) | (2,3,1,3)        | (1,3,24,24)     | fp16      | 4D 双张量，N单轴切分 |
| fp16_015  | (1, 4, 32, 32) | (1, 1, 32, 32) | (1,1,32,4)        | (1,2,32,32)     | fp16      | 4D 广播，C单轴切分 |
| fp16_016  | (2, 2, 24, 40) | (2, 2, 24, 40) | (2,2,24,5)        | (2,2,16,16)     | fp16      | 4D 双张量，H+W双轴切分 |
| fp16_017  | (2, 32, 40)    | (2, 32, 40)    | (2,32,5)          | (1,32,24)       | fp16      | 3D 双张量，C+W双轴切分 |
| fp16_018  | (2, 32, 40)    | (2, 32, 40)    | (2,32,5)          | (2,16,24)       | fp16      | 3D 双张量，H+W双轴切分 |
| fp16_019  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (1,4,12,8)     | fp16      | 4D 双张量，N+H+W三轴切分 |
| fp16_020  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (2,2,12,8)     | fp16      | 4D 双张量，C+H+W三轴切分 |
| fp16_021  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (1,2,12,24)     | fp16      | 4D 双张量，N+C+H三轴切分 |
| fp16_022  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (1,2,12,8)     | fp16      | 4D 双张量，N+C+H+W四轴切分 |
| fp16_023  | (2, 4, 32, 40) | 标量           | (2,4,32,5)        | (1,4,16,16)     | fp16      | 4D input+标量，N+H+W切分 |
| fp16_024  | (2, 4, 40, 40) | 标量           | (2,4,40,5)        | (2,2,20,16)     | fp16      | 4D input+标量，C+H+W切分 |
| fp16_025  | (2, 3, 32, 40) | (2, 3, 32, 40) | (2,3,32,5)        | (1,1,32,16)     | fp16      | 4D 双张量，NCW三轴切分 |
| fp16_026  | 标量           | 标量           | (2, 8)           | (1, 8)          | fp16      | 2D 双标量，H单轴切分 |
| fp16_027  | 标量           | 标量           | (1, 8, 16)        | (1, 4, 8)       | fp16      | 3D 双标量，H+W切分 |
| fp16_028  | 标量           | 标量           | (2, 2, 4, 8)        | (1,1,2,8)       | fp16      | 4D 双标量，N+C+H+W切分 |
| fp32_001  | (2, 64)        | (2, 64)        | (2, 8)           | (1, 64)         | fp32      | 2D 双张量，H单轴切分 |
| fp32_002  | (4, 32)        | (4, 32)        | (4, 4)           | (4, 16)         | fp32      | 2D 双张量，W单轴切分 |
| fp32_003  | (2, 64)        | (1, 64)        | (2, 8)           | (2, 32)         | fp32      | 2D 广播，W单轴切分 |
| fp32_004  | (4, 32)        | 标量           | (4, 4)           | (2, 32)         | fp32      | 2D Tensor+标量，H单轴切分 |
| fp32_005  | (2, 40)        | (2, 40)        | (2, 5)           | (1, 16)         | fp32      | 2D 双张量，H+W双轴切分 |
| fp32_006  | (2, 32, 32)    | (2, 32, 32)    | (2, 32, 4)        | (2, 16, 32)     | fp32      | 3D 双张量，H单轴切分 |
| fp32_007  | (2, 32, 32)    | (2, 32, 32)    | (2, 32, 4)        | (2, 32, 16)     | fp32      | 3D 双张量，W单轴切分 |
| fp32_008  | (2, 24, 24)    | (2, 24, 24)    | (2, 24, 3)        | (1, 24, 24)     | fp32      | 3D 双张量，C单轴切分 |
| fp32_009  | (3, 16, 48)    | 标量           | (3, 16, 6)        | (3, 8, 48)      | fp32      | 3D Tensor+标量，H单轴切分 |
| fp32_010  | (2, 32, 40)    | (2, 32, 40)    | (2, 32, 5)        | (1, 16, 40)     | fp32      | 3D 双张量，HC双轴切分 |
| fp32_011  | (2, 32, 40)    | (2, 32, 40)    | (2, 32, 5)        | (1, 32, 16)     | fp32      | 3D 双张量，WC双轴切分 |
| fp32_012  | (1, 2, 40, 40) | (1, 2, 40, 40) | (1,2,40,5)        | (1,2,20,40)     | fp32      | 4D 双张量，H单轴切分 |
| fp32_013  | (1, 2, 40, 40) | (1, 2, 40, 40) | (1,2,40,5)        | (1,2,40,16)     | fp32      | 4D 双张量，W单轴切分 |
| fp32_014  | (2, 3, 24, 24) | (2, 3, 24, 24) | (2,3,24,3)        | (1,3,24,24)     | fp32      | 4D 双张量，N单轴切分 |
| fp32_015  | (1, 4, 32, 32) | (1, 1, 32, 32) | (1,4,32,4)        | (1,2,32,32)     | fp32      | 4D 广播，C单轴切分 |
| fp32_016  | (2, 2, 24, 40) | (2, 2, 24, 40) | (2,2,24,5)        | (1,2,12,16)     | fp32      | 4D 双张量，H+W双轴切分 |
| fp32_017  | (2, 32, 40)    | (2, 32, 40)    | (2,32,5)          | (1,16,40)       | fp32      | 3D 双张量，C+H双轴切分 |
| fp32_018  | (2, 32, 40)    | (2, 32, 40)    | (2,32,5)          | (2,16,16)       | fp32      | 3D 双张量，H+W双轴切分 |
| fp32_019  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (1,4,12,8)     | fp32      | 4D 双张量，N+H+W三轴切分 |
| fp32_020  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (2,2,12,8)     | fp32      | 4D 双张量，C+H+W三轴切分 |
| fp32_021  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (1,2,12,24)     | fp32      | 4D 双张量，N+C+H三轴切分 |
| fp32_022  | (2, 4, 24, 24) | (2, 4, 24, 24) | (2,4,24,3)        | (1,2,12,16)     | fp32      | 4D 双张量，N+C+H+W四轴切分 |
| fp32_023  | (2, 4, 32, 40) | 标量           | (2,4,32,5)        | (1,4,16,16)     | fp32      | 4D input+标量，N+H+W切分 |
| fp32_024  | (2, 4, 40, 40) | 标量           | (2,4,40,5)        | (2,2,16,16)     | fp32      | 4D input+标量，C+H+W切分 |
| fp32_025  | (2, 3, 32, 40) | (2, 3, 32, 40) | (2,3,32,5)        | (1,1,32,16)     | fp32      | 4D 双张量，NCW三轴切分（新增） |
| fp32_026  | 标量           | 标量           | (2, 8)           | (1, 4)          | fp32      | 2D 双标量，N+W切分 |
| fp32_027  | 标量           | 标量           | (2, 8, 64)        | (1, 4, 8)       | fp32      | 3D 双标量，C+H+W切分 |
| fp32_028  | 标量           | 标量           | (2, 4, 16, 32)        | (1, 2, 4, 8)       | fp32      | 4D 双标量，N+C+H+W切分 |
