...
|-----------|------------------|------------------|-----------------|------------|--------------------------|
| fp16_001  | (112)            | (112)            | (50)            | fp16       | 无广播，w 单轴切分        |
| fp16_002  | (64)             | 标量             | (32)            | fp16       | 标量广播，w 单轴切分      |
| fp16_003  | (32)             | (32)             | (16)            | fp16       | 无广播，w 单轴切分        |
| fp16_004  | (16, 16)         | 标量             | (16, 8)         | fp16       | 标量广播，w 单轴切分      |
| fp16_005  | (4, 80)          | (4, 80)          | (2, 40)         | fp16       | 无广播，h+w 双轴切分      |
| fp16_006  | (2, 96)          | (1, 96)          | (1, 48)         | fp16       | h 广播，h+w 双轴切分      |
| fp16_007  | (5, 1)           | (5, 32)          | (5, 16)         | fp16       | w 广播，h+w 双轴切分      |
| fp16_008  | (3, 128)         | (3, 128)         | (2, 64)         | fp16       | 无广播，h+w 双轴切分      |
| fp16_009  | (64, 1)          | (64, 64)         | (32, 64)        | fp16       | w 广播，h 单轴切分        |
| fp16_010  | (1, 64)          | (64, 64)         | (64, 32)        | fp16       | h 广播，w 单轴切分        |
| fp16_011  | (2, 64, 64)      | (2, 64, 64)      | (1, 32, 32)     | fp16       | 无广播，c+h+w 三轴切分    |
| fp16_012  | (2, 1, 48)       | (2, 3, 48)       | (1, 1, 24)      | fp16       | h 广播，c+h+w 三轴切分    |
| fp16_013  | (3, 64, 1)       | (3, 64, 48)      | (1, 32, 24)     | fp16       | w 广播，c+h+w 三轴切分    |
| fp16_014  | (1, 48, 48)      | (1, 1, 48)       | (1, 24, 24)     | fp16       | h 广播，h+w 双轴切分      |
| fp16_015  | (2, 64, 48)      | (2, 64, 48)      | (1, 32, 24)     | fp16       | 无广播，c+h+w 三轴切分    |
| fp16_016  | (3, 32, 64)      | (3, 32, 64)      | (3, 32, 32)     | fp16       | 无广播，w 单轴切分        |
| fp16_017  | (2, 32, 1)       | (2, 1, 64)       | (1, 32, 32)     | fp16       | h+w 广播，h+w 双轴切分    |
| fp16_018  | (1, 48, 64)      | (48, 48, 64)     | (16, 16, 16)    | fp16       | c 广播，c+h+w 三轴切分    |
| fp16_019  | (2, 2, 32, 32)   | (2, 2, 32, 32)   | (1,1,16,16)     | fp16       | 无广播，n+c+h+w 四轴切分  |
| fp16_020  | (2, 4, 1, 16)    | (2, 1, 16, 16)   | (1,2,8,8)       | fp16       | c+h 广播，n+c+h+w 四轴切分|
| fp16_021  | (2, 1, 24, 24)   | (2, 3, 24, 1)    | (1,1,12,12)     | fp16       | c+w 广播，n+c+h+w 四轴切分|
| fp16_022  | (2, 2, 40, 1)    | (2, 2, 1, 40)    | (1,1,20,20)     | fp16       | h+w 广播，n+c+h+w 四轴切分|
| fp16_023  | (2, 3, 16, 16)   | (2, 3, 16, 16)   | (1,1,8,8)       | fp16       | 无广播，n+c+h+w 四轴切分  |
| fp32_001  | (8, 4)           | 标量             | (4, 1)          | fp32       | 标量广播，h+w 双轴切分    |
| fp32_002  | (4, 1, 32, 32)   | (4, 1, 32, 32)   | (2,1,32,32)     | fp32       | 无广播，n 单轴切分        |
| fp32_003  | (1, 8, 16, 16)   | (1, 8, 16, 16)   | (1,4,16,16)     | fp32       | 无广播，c 单轴切分        |
| fp32_004  | (2, 2, 48, 48)   | (2, 2, 48, 48)   | (2,2,24,48)     | fp32       | 无广播，h 单轴切分        |
| fp32_005  | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1,4,32,32)     | fp32       | 无广播，w 单轴切分        |
| fp32_006  | (2, 4, 16, 1)    | (2, 1, 16, 16)   | (1,2,16,16)     | fp32       | c+w 广播，n+c 双轴切分    |
| fp32_007  | (2, 1, 32, 32)   | (2, 2, 1, 32)    | (1,2,16,32)     | fp32       | c+h 广播，n+h 双轴切分    |
| fp32_008  | (2, 3, 24, 1)    | (1, 3, 24, 48)   | (1,3,24,24)     | fp32       | n+w 广播，n+w 双轴切分    |
| fp32_009  | (1, 4, 1, 16)    | (1, 1, 16, 16)   | (1,2,8,16)      | fp32       | c+h 广播，c+h 双轴切分    |
| fp32_010  | (2, 2, 32, 1)    | (2, 2, 1, 64)    | (2,1,32,32)     | fp32       | h+w 广播，c+w 双轴切分    |
| fp32_011  | (1, 1, 48, 64)   | (1, 1, 48, 64)   | (1,1,24,32)     | fp32       | 无广播，h+w 双轴切分      |
| fp32_012  | (8, 8, 8, 8)     | 标量             | (8, 8, 8, 4)    | fp32       | 标量广播，w 单轴切分      |
| fp32_013  | (8, 8, 8)        | 标量             | (8,8,4)         | fp32       | 标量广播，w 单轴切分      |
| fp32_014  | (16, 1, 48)      | (1, 1, 48)       | (8, 1, 48)      | fp32       | c 广播，h 单轴切分        |
| fp32_015  | (2, 64, 48)      | (2, 64, 48)      | (1, 64, 24)     | fp32       | 无广播，c+w 双轴切分      |
| fp32_016  | (2, 32, 1)       | (2, 32, 64)      | (2, 16, 16)     | fp32       | w 广播，h+w 双轴切分      |
| fp32_017  | (1, 48, 64)      | (48, 48, 64)     | (24, 24, 32)    | fp32       | c 广播，c+h+w 三轴切分    |
| fp32_018  | (2, 4, 32, 48)   | (2, 4, 32, 48)   | (1, 2, 16, 48)  | fp32       | 无广播，n+c+h 三轴切分    |
| fp32_019  | (2, 4, 32, 64)   | (2, 4, 32, 64)   | (1, 2, 32, 32)  | fp32       | 无广播，n+c+w 三轴切分    |
| fp32_020  | (4, 2, 32, 64)   | (4, 2, 32, 64)   | (2, 2, 16, 32)  | fp32       | 无广播，n+h+w 三轴切分    |
| fp32_021  | (1, 4, 32, 64)   | (1, 4, 32, 64)   | (1, 2, 16, 32)  | fp32       | 无广播，c+h+w 三轴切分    |
| fp32_022  | (8)              | (8, 4)           | (4, 2)          | fp32       | w 广播，h+w 双轴切分      |
| fp32_023  | (24,16)          | (32,24,16)       | (16,12,8)       | fp32       | c 广播，c+h+w 三轴切分    |
| fp32_024  | (32, 32, 16)     | (16,32,32,16)    | (8, 8, 8, 8)    | fp32       | n 广播，n+c+h+w 四轴切分  |
...
| fp16_018  | (1, 48, 64)      | (48, 48, 64)     | (48, 24, 32)  | fp16      | n 广播，h+w 切分            |
...
| fp32_008  | (32, 32, 16)     | (16, 32, 32, 16)    | (8, 8, 8, 8)    | fp32       | n 广播，n+c+h+w 切分   |
| fp32_009  | (1, 1, 16)       | (4, 4, 16)       | (2, 2, 8)     | fp32      | c+h 广播，c+h+w 切分        |
| fp32_010  | (1, 1, 1)        | (4, 4, 4)        | (2, 2, 2)     | fp32      | c+h+w 广播，c+h+w 切分      |
| fp32_011  | (16, 1, 1)       | (16, 4, 4)       | (8, 2, 2)     | fp32      | h+w 广播，c+h+w 切分        |
| fp32_012  | (1, 1, 1, 1)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | n+c+h+w 广播，n+c+h+w 切分  |
| fp32_013  | (1, 1, 4, 4)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | n+c 广播，n+c+h+w 切分      |
| fp32_014  | (1, 4, 1, 4)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | n+h 广播，n+c+h+w 切分      |
| fp32_015  | (1, 4, 4, 1)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | n+w 广播，n+c+h+w 切分      |
| fp32_016  | (4, 1, 1, 4)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | c+w 广播，n+c+h+w 切分      |
| fp32_017  | (4, 1, 4, 1)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | c+h 广播，n+c+h+w 切分      |
| fp32_018  | (4, 4, 1, 1)     | (4, 4, 4, 4)     | (2, 2, 2, 2)  | fp32      | h+w 广播，n+c+h+w 切分      |
...
| --------- | -------------- | -------------- | ---------------- | --------------- | --------- | ---- |
| fp16_001  | (2, 64)        | (2, 64)        | (2, 1)           | (1, 64)         | fp16      | 无广播，H单轴切分 |
| fp16_002  | (4, 32)        | (4, 32)        | (4, 1)           | (4, 16)         | fp16      | 无广播，W单轴切分 |
| fp16_003  | (2, 64)        | (1, 64)        | (2, 1)           | (2, 32)         | fp16      | H+W广播，W单轴切分 |
| fp16_004  | (4, 32)        | 标量           | (4, 1)           | (2, 32)         | fp16      | 标量广播，H单轴切分 |
| fp16_005  | (2, 40)        | (2, 40)        | (2, 1)           | (1, 20)         | fp16      | 无广播，H+W双轴切分 |
| fp16_006  | (2, 1, 32)     | (2, 32, 32)    | (2, 1, 32)       | (2, 16, 32)     | fp16      | H广播，H单轴切分 |
| fp16_007  | (1, 32, 32)    | (2, 1, 32)     | (2, 32, 1)       | (2, 32, 16)     | fp16      | C+H+W广播，W单轴切分 |
| fp16_008  | (2, 24, 1)     | (1, 24, 24)    | (2, 1, 24)       | (1, 24, 24)     | fp16      | C+H+W广播，C单轴切分 |
| fp16_009  | (3, 16, 48)    | 标量           | (3, 1, 48)       | (3, 8, 48)      | fp16      | 标量广播，H单轴切分 |
| fp16_010  | (2, 32, 1)     | (1, 32, 40)    | (2, 1, 40)       | (1, 16, 40)     | fp16      | C+H+W广播，H+C双轴切分 |
| fp16_011  | (2, 32, 40)    | (2, 1, 40)     | (2, 32, 1)       | (1, 32, 32)     | fp16      | H+W广播，W+C双轴切分 |
| fp16_012  | (1, 2, 1, 40)  | (1, 2, 40, 40) | (1,2,1,40)       | (1,2,20,40)     | fp16      | H广播，H单轴切分 |
| fp16_013  | (1, 2, 40, 1)  | (1, 1, 40, 40) | (1,2,40,1)       | (1,2,40,16)     | fp16      | C+W广播，W单轴切分 |
| fp16_014  | (2, 3, 1, 24)  | (2, 3, 24, 24) | (2,3,1,24)       | (1,3,24,24)     | fp16      | H广播，N单轴切分 |
| fp16_015  | (1, 4, 1, 32)  | (1, 1, 32, 32) | (1,1,32,1)       | (1,2,32,32)     | fp16      | C+H+W广播，C单轴切分 |
| fp16_016  | (2, 2, 1, 40)  | (2, 2, 24, 40) | (2,2,24,1)       | (2,2,16,16)     | fp16      | H+W广播，H+W双轴切分 |
| fp16_017  | (2, 1, 40)     | (2, 32, 40)    | (2,1,40)         | (1,32,24)       | fp16      | H广播，C+W双轴切分 |
| fp16_018  | (2, 32, 40)    | (2, 1, 40)     | (2,32,1)         | (2,16,24)       | fp16      | H+W广播，H+W双轴切分 |
| fp16_019  | (2, 4, 1, 24)  | (2, 4, 24, 24) | (2,4,24,1)       | (1,4,12,8)      | fp16      | H+W广播，N+H+W三轴切分 |
| fp16_020  | (2, 1, 24, 24) | (2, 4, 24, 1)  | (2,4,1,24)       | (2,2,12,8)      | fp16      | C+H+W广播，C+H+W三轴切分 |
| fp16_021  | (2, 4, 1, 24)  | (2, 4, 24, 1)  | (2,1,24,24)      | (1,2,12,24)     | fp16      | C+H+W广播，N+C+H三轴切分 |
| fp16_022  | (2, 4, 24, 1)  | (2, 4, 1, 24)  | (2,4,24,24)      | (1,2,12,8)      | fp16      | H+W广播，N+C+H+W四轴切分 |
| fp16_023  | (2, 4, 1, 40)  | 标量           | (2,4,32,1)       | (1,4,16,16)     | fp16      | 标量广播，N+H+W三轴切分 |
| fp16_024  | (2, 4, 1, 40)  | 标量           | (2,4,40,1)       | (2,2,20,16)     | fp16      | 标量广播，C+H+W三轴切分 |
| fp16_025  | (2, 3, 1, 40)  | (2, 3, 32, 1)  | (2,3,1,40)       | (1,1,32,16)     | fp16      | H+W广播，N+C+W三轴切分 |
| fp16_026  | 标量           | 标量           | (2, 8)           | (1, 8)          | fp16      | 标量广播，H单轴切分 |
| fp16_027  | 标量           | 标量           | (1, 8, 16)       | (1, 4, 8)       | fp16      | 标量广播，H+W双轴切分 |
| fp16_028  | 标量           | 标量           | (2, 2, 4, 8)     | (1,1,2,8)       | fp16      | 标量广播，N+C+H+W四轴切分 |
| fp32_001  | (2, 64)        | (2, 64)        | (1, 64)          | (1, 64)         | fp32      | 无广播，H单轴切分 |
| fp32_002  | (4, 32)        | (4, 32)        | (1, 32)          | (4, 16)         | fp32      | 无广播，W单轴切分 |
| fp32_003  | (2, 64)        | (1, 64)        | (2, 1)           | (2, 32)         | fp32      | H广播，W单轴切分 |
| fp32_004  | (4, 32)        | 标量           | (4, 1)           | (2, 32)         | fp32      | 标量广播，H单轴切分 |
| fp32_005  | (2, 40)        | (2, 40)        | (2, 1)           | (1, 16)         | fp32      | 无广播，H+W双轴切分 |
| fp32_006  | (2, 32, 32)    | (2, 32, 1)     | (2, 1, 32)       | (2, 16, 32)     | fp32      | H+W广播，H单轴切分 |
| fp32_007  | (2, 1, 32)     | (2, 32, 1)     | (2, 32, 1)       | (2, 32, 16)     | fp32      | C+W广播，W单轴切分 |
| fp32_008  | (1, 24, 24)    | (2, 1, 24)     | (2, 24, 1)       | (1, 24, 24)     | fp32      | N+C+W广播，C单轴切分 |
| fp32_009  | (1, 16, 48)    | 标量           | (3, 1, 48)       | (3, 8, 48)      | fp32      | 标量广播，H单轴切分 |
| fp32_010  | (2, 32, 40)    | (2, 1, 40)     | (2, 32, 1)       | (1, 16, 40)     | fp32      | H+W广播，H+C双轴切分 |
| fp32_011  | (2, 32, 1)     | (2, 1, 40)     | (2, 1, 32)       | (1, 32, 16)     | fp32      | H+W广播，W+C双轴切分 |
| fp32_012  | (1, 2, 40, 1)  | (1, 2, 1, 40)  | (1,2,40,1)       | (1,2,20,40)     | fp32      | H+W广播，H单轴切分 |
| fp32_013  | (1, 2, 40, 40) | (1, 2, 40, 1)  | (1,2,1,40)       | (1,2,40,16)     | fp32      | H+W广播，W单轴切分 |
| fp32_014  | (2, 3, 1, 24)  | (2, 3, 24, 1)  | (2,3,24,1)       | (1,3,24,24)     | fp32      | H+W广播，N单轴切分 |
| fp32_015  | (1, 4, 1, 32)  | (1, 1, 32, 32) | (1,4,32,1)       | (1,2,32,32)     | fp32      | C+H+W广播，C单轴切分 |
| fp32_016  | (2, 2, 24, 1)  | (2, 2, 1, 40)  | (2,2,24,1)       | (1,2,12,16)     | fp32      | H+W广播，N+H+W双轴切分 |
| fp32_017  | (2, 32, 1)     | (2, 32, 40)    | (2,32,1)         | (1,16,40)       | fp32      | W广播，H+C双轴切分 |
| fp32_018  | (2, 1, 40)     | (2, 32, 40)    | (2,1,40)         | (2,16,16)       | fp32      | H广播，H+W双轴切分 |
| fp32_019  | (2, 4, 1, 24)  | (2, 4, 24, 1)  | (2,4,24,1)       | (1,4,12,8)      | fp32      | H+W广播，N+H+W三轴切分 |
| fp32_020  | (2, 4, 24, 1)  | (2, 1, 24, 24) | (2,4,1,24)       | (2,2,12,8)      | fp32      | C+W广播，C+H+W三轴切分 |
| fp32_021  | (2, 1, 24, 24) | (1, 4, 24, 24) | (2,4,24,24)      | (1,2,12,24)     | fp32      | N+C广播，N+C+H三轴切分 |
| fp32_022  | (2, 4, 1, 24)  | (2, 4, 24, 1)  | (2,1,24,24)      | (1,2,12,16)     | fp32      | C+H+W广播，N+C+H+W四轴切分 |
| fp32_023  | (2, 4, 1, 40)  | 标量           | (2,4,32,1)       | (1,4,16,16)     | fp32      | 标量广播，N+H+W三轴切分 |
| fp32_024  | (2, 4, 40, 40) | 标量           | (2,4,40,1)       | (2,2,16,16)     | fp32      | 标量广播，C+H+W三轴切分 |
| fp32_025  | (1, 3, 32, 40) | (2, 3, 1, 40)  | (2,3,32,1)       | (1,1,32,16)     | fp32      | N+H+W广播，N+C+W三轴切分 |
| fp32_026  | 标量           | 标量           | (2, 8)           | (1, 4)          | fp32      | 标量广播，H+W双轴切分 |
| fp32_027  | 标量           | 标量           | (2, 8, 64)       | (1, 4, 8)       | fp32      | 标量广播，C+H+W三轴切分 |
| fp32_028  | 标量           | 标量           | (2, 4, 16, 32)   | (1, 2, 4, 8)    | fp32      | 标量广播，N+C+H+W四轴切分 |
| fp32_029  | (8)            | (8, 8)         | (8, 8)           | (4, 4)          | fp32      | W广播，H+W双轴切分 |
| fp32_030  | (24,16)        | (32, 24, 16)   | (32,24,16)       | (16,12,8)       | fp32      | C广播，C+H+W三轴切分 |
| fp32_031  | (32, 32, 16)   | (16, 32, 32, 16)| (16,32,24,16)   | (8, 8, 8, 8)    | fp32      | N广播，N+C+H+W四轴切分 |
