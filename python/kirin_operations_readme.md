...
| 用例名称 | 输入维度 | tileshape | 输入dtype | 说明 |
|----------|---------|-----------|-----------|------|
| transpose_fp16_001 | (2, 3) | (1, 16) | fp16 | 2d转置，交换0和1轴，h切分 |
| transpose_fp16_002 | (3, 4) | (1, 16) | fp16 | 2d转置，交换0和1轴，h切分 |
| transpose_fp16_003 | (3, 4, 5) | (1, 2, 16) | fp16 | 3d转置，交换1和2轴，h,w切分 |
| transpose_fp16_004 | (2, 3, 4) | (1, 3, 16) | fp16 | 3d转置，交换0和2轴，c,w切分 |
| transpose_fp16_005 | (2, 3, 4, 5) | (1, 1, 2, 16) | fp16 | 4d转置，交换2和3轴，h,w切分 |
| transpose_fp16_006 | (2, 3, 4, 5) | (1, 3, 1, 16) | fp16 | 4d转置，交换1和2轴，c,h切分 |
| transpose_fp16_007 | (2, 3, 4, 5, 6) | (1, 1, 1, 2, 16) | fp16 | 5d转置，交换3和4轴，w切分 |
| transpose_fp16_008 | (4, 5) | (2, 16) | fp16 | 2d转置，交换0和1轴，h切分 |
| transpose_fp16_009 | (2, 5, 6) | (1, 5, 16) | fp16 | 3d转置，交换1和2轴，c,w切分 |
| transpose_fp16_010 | (3, 2, 4, 5) | (1, 2, 2, 16) | fp16 | 4d转置，交换2和3轴，c,h,w切分 |
| transpose_fp32_001 | (2, 3) | (1, 8) | fp32 | 2d转置，交换0和1轴，h切分 |
| transpose_fp32_002 | (3, 4) | (1, 8) | fp32 | 2d转置，交换0和1轴，h切分 |
| transpose_fp32_003 | (3, 4, 5) | (1, 2, 8) | fp32 | 3d转置，交换1和2轴，h,w切分 |
| transpose_fp32_004 | (2, 3, 4) | (1, 3, 8) | fp32 | 3d转置，交换0和2轴，c,w切分 |
| transpose_fp32_005 | (2, 3, 4, 5) | (1, 1, 2, 8) | fp32 | 4d转置，交换2和3轴，h,w切分 |
| transpose_fp32_006 | (2, 3, 4, 5) | (1, 3, 1, 8) | fp32 | 4d转置，交换1和2轴，c,h切分 |
| transpose_fp32_007 | (2, 3, 4, 5, 6) | (1, 1, 1, 2, 8) | fp32 | 5d转置，交换3和4轴，w切分 |
| transpose_fp32_008 | (4, 5) | (2, 8) | fp32 | 2d转置，交换0和1轴，h切分 |
| transpose_fp32_009 | (2, 5, 6) | (1, 5, 8) | fp32 | 3d转置，交换1和2轴，c,w切分 |
| transpose_fp32_010 | (3, 2, 4, 5) | (1, 2, 2, 8) | fp32 | 4d转置，交换2和3轴，c,h,w切分 |
| transpose_int32_001 | (2, 3) | (1, 8) | int32 | 2d转置，交换0和1轴，h切分 |
| transpose_int32_002 | (3, 4) | (1, 8) | int32 | 2d转置，交换0和1轴，h切分 |
| transpose_int32_003 | (3, 4, 5) | (1, 2, 8) | int32 | 3d转置，交换1和2轴，h,w切分 |
| transpose_int32_004 | (2, 3, 4, 5) | (1, 1, 2, 8) | int32 | 4d转置，交换2和3轴，h,w切分 |
| transpose_int32_005 | (4, 5) | (2, 8) | int32 | 2d转置，交换0和1轴，h切分 |
| transpose_int16_001 | (2, 3) | (1, 16) | int16 | 2d转置，交换0和1轴，h切分 |
| transpose_int16_002 | (3, 4) | (1, 16) | int16 | 2d转置，交换0和1轴，h切分 |
| transpose_int16_003 | (3, 4, 5) | (1, 2, 16) | int16 | 3d转置，交换1和2轴，h,w切分 |
| transpose_int16_004 | (2, 3, 4) | (1, 3, 16) | int16 | 3d转置，交换0和2轴，c,w切分 |
| transpose_int16_005 | (2, 3, 4, 5) | (1, 1, 2, 16) | int16 | 4d转置，交换2和3轴，h,w切分 |
| transpose_int16_006 | (2, 3, 4, 5) | (1, 3, 1, 16) | int16 | 4d转置，交换1和2轴，c,h切分 |
| transpose_int16_007 | (2, 3, 4, 5, 6) | (1, 1, 1, 2, 16) | int16 | 5d转置，交换3和4轴，w切分 |
| transpose_int16_008 | (4, 5) | (2, 16) | int16 | 2d转置，交换0和1轴，h切分 |
| transpose_int16_009 | (2, 5, 6) | (1, 5, 16) | int16 | 3d转置，交换1和2轴，c,w切分 |
| transpose_int16_010 | (3, 2, 4, 5) | (1, 2, 2, 16) | int16 | 4d转置，交换2和3轴，c,h,w切分 |
### 6.2. pypto.reshape
#### 6.2.1. 算子计算原理
