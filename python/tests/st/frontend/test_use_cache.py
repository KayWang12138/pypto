...
def test_use_cache_false_compiles_twice():
    ...
    print(f"Time ratio (second/first): {ratio:.2f}")
    ...
    print("✓ Verified: Both calls compiled (use_cache=False working correctly)")
...
def test_use_cache_true_compiles_once():
    ...
    print(f"✓ Verified: Second call reused cache (speedup: {1/ratio:.1f}x)")


if __name__ == "__main__":
    print("=" * 70)
    print("Testing @pypto.frontend.jit decorator use_cache parameter")
    print("=" * 70)
