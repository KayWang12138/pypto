...
a_tensor_format = pypto.TileOpFormat.TILEOP_ND
b_tensor_format = pypto.TileOpFormat.TILEOP_ND
is_a_trans = False
is_b_trans = False
...
def set_matmul_format_trans(shape_info: ShapeConfig):
    global a_tensor_format, b_tensor_format, is_a_trans, is_b_trans
    if shape_info.a_format_nz:
        a_tensor_format = pypto.TileOpFormat.TILEOP_NZ
    else:
        a_tensor_format = pypto.TileOpFormat.TILEOP_ND
    if shape_info.b_format_nz:
        b_tensor_format = pypto.TileOpFormat.TILEOP_NZ
    else:
        b_tensor_format = pypto.TileOpFormat.TILEOP_ND

    is_a_trans = shape_info.a_trans
    is_b_trans = shape_info.b_trans
...
def matmul_kernel_with_mn_split(
    a_tensor: pypto.Tensor([pypto.STATIC, pypto.STATIC], pypto.DT_FP16, format=a_tensor_format, a_trans=is_a_trans),
    b_tensor: pypto.Tensor([pypto.STATIC, pypto.STATIC], pypto.DT_FP16, format=b_tensor_format, b_trans=is_b_trans),
...
def test_mm_with_mn_split():
    ...
    set_matmul_format_trans(shape_info)
