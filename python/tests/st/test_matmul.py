...
def matmul_kernel_with_mn_split(
    a_tensor: pypto.Tensor([pypto.STATIC, pypto.STATIC], pypto.DT_FP16, format=a_tensor_format),
    b_tensor: pypto.Tensor([pypto.STATIC, pypto.STATIC], pypto.DT_FP16, format=b_tensor_format),
