        ...
        for m_idx in pypto.loop(0, m_loop, 1, name="LOOP_L0_mIdx", idx_name="m_idx"):
            for n_idx in pypto.loop(0, n_loop, 1, name="LOOP_L0_nIdx", idx_name="n_idx"):
                ...
                out_view = pypto.scaled_mm(a_view, b_view, tile_config.out_dtype, scale_a_view, scale_b_view,
                            extend_params=extend_params, a_trans=tile_config.a_trans, b_trans=tile_config.b_trans,
                            scale_a_trans=tile_config.scale_a_trans, scale_b_trans=tile_config.scale_b_trans)
...
def test_scaled_mm_with_gmacc():
    tile_config = ShapeConfig([3, 512, 32], [64, 64], [64, 256], [256, 256], [3, 32], pypto.DataType.DT_FP8E5M2,
                              pypto.DataType.DT_FP32, False, True, True, False, False, True, False, True)
