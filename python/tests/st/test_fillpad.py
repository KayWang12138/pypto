...
def op_fillpad(params, a, b):
    ...
    for b_idx in pypto.loop(1, name="LOOP_FILLPAD_L0", idx_name="b_idx"):
        for s_idx in pypto.loop(1, name="LOOP_FILLPAD_L1", idx_name="s_idx"):
            offset_x = 0
            offset_y = 0
...
if __name__ == "__main__":
    print("Running test_fillpad...")
    test()
    print("test_fillpad passed!")
    
    print("\nRunning test_partial_valid...")
    test_partial_valid()
    print("test_partial_valid passed!")
    
    print("\nRunning test_small_valid...")
    test_small_valid()
    print("test_small_valid passed!")
