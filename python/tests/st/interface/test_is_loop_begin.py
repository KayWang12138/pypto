...
def create_dyn_loop_with_loop_begin(shape_in, shape_out, b, s, n1, d):
    @pypto.frontend.jit()
...
def test_is_loop_begin():
    ...
    kernel = create_dyn_loop_with_loop_begin(shape_in, shape_out, b, s, n1, d)
...
def create_dyn_loop_with_loop_end(shape_in, shape_out, b, s, n1, d):
    @pypto.frontend.jit()
...
def test_is_loop_end():
    ...
    # Create kernel and execute
    kernel = create_dyn_loop_with_loop_end(shape_in, shape_out, b, s, n1, d)
    kernel(input_torch, output_torch)
