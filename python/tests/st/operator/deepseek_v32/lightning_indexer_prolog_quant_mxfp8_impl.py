...
class IndexerPrologQuantInput:
    ...
    w_qb: torch.tensor  # MXFP8.E4M3, (headNum * headDim // NZ_B8_C0, qLoraRank // NZ_FIRST_DIM, NZ_FIRST_DIM, NZ_B8_C0), NZ
...
def lightning_indexer_prolog_quant_compute(x_in, q_norm_in, q_norm_scale_in, w_qb_in,
    ...
    Args:
        ...
        w_qb_in: Query projection weight matrix, MXFP8.E4M3 format with NZ layout
    ...
    for t_idx, unroll_length in pypto.loop_unroll(0, t, 1, name="IndexerPrologQuantQuantLoop", idx_name="t_idx",
        ...
        q_norm_scale = pypto.view(q_norm_scale_in, [t_tile, q_lora_rank // 64, 2], [t_idx, 0, 0], valid_shape=[t_tile, q_lora_rank // 64, 2])
        ...
        q_cast = pypto.scaled_mm(q_norm, w_qb_in, pypto.DT_BF16, q_norm_scale, w_qb_scale_in, scale_b_trans=True)  # (t_tile, head_num * head_dim)
