...
def test_ffn_router() -> None:
    ...
    for b in [1]:
        ...
        print("hidden_states_scale shape: ", hidden_states_scale.shape)
        print("group_list shape: ", group_list.shape)
        print("group_list_cumsum shape: ", group_list_cumsum.shape)
        print("w13 shape: ", w13.shape)
        print("w13_scale shape: ", w13_scale.shape)
        print("w2 shape: ", w2.shape)
        print("w2_scale shape: ", w2_scale.shape)
        print("ffn_res shape: ", ffn_res.shape)
        inputs = {
            hidden_states: [0],
