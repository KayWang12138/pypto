...
def test_vector_operation_1d_argsort():
    ...
    b_loop_num = int(math.ceil(n / view_shape[0]))
...
def test_vector_operation_1d_index_put():
    ...
    b_loop_num = int(math.ceil(values_size / view_shape[0]))
    ...
    a_tensor = torch.rand(n, dtype=torch.float32) * 100
    indices_tensor = torch.randint(0, n, (values_size,), dtype=torch.int32)
