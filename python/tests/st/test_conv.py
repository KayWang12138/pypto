...
def create_conv_kernel_no_bias(fmap_shape, weight_shape, out_shape, dtype, tile_l1_info, tile_l0_info, strides, pads, 
    dilations, groups=1):
    @pypto.frontend.jit(
        debug_options={"runtime_debug_mode": 0, "compile_debug_mode": 0}
    )
...
def case_conv2d_fp16_basic_with_bias():
    ...
    output_npu = create_conv_kernel(fmap_shape, weight_shape, bias_shape, out_shape, dtype, tile_l1_info, tile_l0_info,
        strides, pads, dilations)(a, b, c)
...
def case_conv2d_bf16_group_2():
    ...
    output_npu = create_conv_kernel_no_bias(fmap_shape, weight_shape, out_shape, dtype, tile_l1_info, tile_l0_info,
        strides, pads, dilations, 2)(a, b)
    golden = torch.nn.functional.conv2d(a, b, stride=1, padding=0, groups=2)

    assert torch.allclose(output_npu.cpu().to(dtype_torch), golden.cpu().to(dtype_torch), atol=1e-3, rtol=1e-3)


def case_conv2d_fp32_strides_2():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv2d_fp32_pad_1_w32():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv1d_fp16_basic_with_bias():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv1d_fp32_strides_2():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv1d_fp16_dilation2():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv1d_fp32_pad_1_w32():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv3d_fp16_basic_with_bias():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv3d_fp32_strides_2():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
def case_conv3d_fp32_pad_1_w32():
    device_id = os.environ.get('TILE_FWK_DEVICE_ID', 0)
    torch.npu.set_device(int(device_id))
...
@pytest.mark.soc("950")
def test_run_conv_cases():
    test_cases = [
        case_conv2d_fp16_basic_with_bias,
        case_conv2d_bf16_group_2,
        case_conv2d_fp32_strides_2,
        case_conv2d_fp16_dilation2,
        case_conv2d_fp32_pad_1_w32,
        case_conv1d_fp16_basic_with_bias,
        case_conv1d_bf16_group_2,
        case_conv1d_fp32_strides_2,
        case_conv1d_fp16_dilation2,
        case_conv1d_fp32_pad_1_w32,
        case_conv3d_fp16_basic_with_bias,
        case_conv3d_bf16_group_2,
        case_conv3d_fp32_strides_2,
        case_conv3d_fp32_pad_1_w32
    ]
