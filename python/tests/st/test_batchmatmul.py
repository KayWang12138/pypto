...
def test_bmm3D_with_mn_split():
    ...
    m_view = 64
    n_view = 128
    tile_config = ShapeConfig([b, m, k, n], [tile_m, tile_m], [tile_k, 2 * tile_k], [tile_n, tile_n], [m_view, n_view], FP16, FP32,
    ...
    c = create_bmm3D_kernel_with_mn_split(tile_config)(a_tensor.npu(), b_tensor.npu())
...
def test_bmm4D_with_mn_split():
    ...
    m_view = 64
    n_view = 128
    tile_config = ShapeConfig([b1, b2, m, k, n], [tile_m, tile_m], [tile_k, 2 * tile_k], [tile_n, tile_n], [m_view, n_view], FP16, FP32,
                                False, False, False, False, False, True, False)
