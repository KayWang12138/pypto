...
def test_matrix_matmul_with_trans_mode_cast_rint():
    ...
    with pypto.function("MATMUL", a, b):
        pypto.set_cube_tile_shapes([64, 64], [64, 64], [64, 64])
        c = pypto.matmul(a, b, dtype, extend_params={"trans_mode": pypto.TransMode.CAST_RINT})
...
def test_matrix_matmul_with_trans_mode_cast_rint():
    ...
    with pypto.function("MATMUL", a, b):
        pypto.set_cube_tile_shapes([64, 64], [64, 64], [64, 64])
        c = pypto.matmul(a, b, dtype, extend_params={"trans_mode": pypto.TransMode.CAST_ROUND})
