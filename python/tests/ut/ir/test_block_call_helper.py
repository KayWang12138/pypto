...
def block_function_add(args):
    ...
    with block.function_scope(func):
        ...
        # 插入同步 MTE2_TO_V
        block.call_3_ret_void(pipe_mte2, pipe_v, event_id0, void_value, "set_flag")
        block.call_3_ret_void(pipe_mte2, pipe_v, event_id0, void_value, "wait_flag")

        # 计算Add
        block.add(ubt0, ubt1, ubt0)

        # 插入同步 V_TO_MTE3
        block.call_3_ret_void(pipe_v, pipe_mte3, event_id0, void_value, "set_flag")
        block.call_3_ret_void(pipe_v, pipe_mte3, event_id0, void_value, "wait_flag")
