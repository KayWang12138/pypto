...
def test_block_call_1(a, b, c):
    with pypto.function("test_block_call", a, b, c):
        loop_count = 4
        for idx in pypto.loop(0, loop_count, 1, name="LOOP_L0", idx_name="idx"):
            c = BlockCallHelper.call(test_block_function, [a, b], [c], [idx])[0]
...
if __name__ == "__main__":
    ...
    test_block_call_1(pto_a, pto_b, pto_c)