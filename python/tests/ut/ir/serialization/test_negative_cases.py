...
class TestDeserializationErrors:
    ...
    @staticmethod
    def test_corrupted_bytes_deserialize_raises_exception():
    ...
    @staticmethod
    def test_partially_corrupted_msgpack_raises_exception():
    ...
    @staticmethod
    def test_invalid_msgpack_structure_raises_exception():
    ...
    @staticmethod
    def test_empty_bytes_raises_clear_error():
...
class TestSerializationErrors:
    ...
    @staticmethod
    def test_none_input_serialize_raises_error():
    ...
    @staticmethod
    def test_invalid_object_type_serialize_raises_error():
    ...
    @staticmethod
    def test_builtin_type_serialize_raises_error():
...
class TestRoundTripValidation:
    ...
    @staticmethod
    def test_modified_serialized_data_fails_deserialization():
    ...
    @staticmethod
    def test_truncated_serialized_data_fails_deserialization():
