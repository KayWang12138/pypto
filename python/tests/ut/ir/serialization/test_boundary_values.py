...
This file tests extreme values, special floating-point numbers, and other edge cases
...
class TestExtremeIntegerValues:
    """Test serialization of extreme integer values."""
    ...
    def test_int32_extreme_values(self):
    ...
    def test_int_arithmetic_with_extreme_values(self):
        """Test arithmetic expressions with extreme values."""
        span = ir.Span.unknown()
    ...
    def test_extreme_int_in_binary_expression(self):
        """Test binary expression with extreme integers."""
        span = ir.Span.unknown()
