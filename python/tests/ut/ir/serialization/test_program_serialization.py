...
class TestProgramRealWorldScenarios:
    ...
    def test_program_like_real_compiler_output(self):
        ...
        # Main processing function: process_array(data, size)
        data = ir.Var("data", ir.TensorType([], DataType.INT64), span)
        ...
        process_func = ir.Function("process_array", [data, size], [ir.ScalarType(DataType.INT64)], process_body, span)
