...
def test_dtype():
    ...
    for (dtype, name, bits, bytes, is_fp) in dtypes:
...
def test_control_flow():
    ...
    assert then_comp.get_var("outputX") == res_if_x
    ...
    ifs_in_for = fs.stmts().stmts()[1] # Accessing the second statement in the for compound
