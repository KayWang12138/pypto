...
def test_pil_parser_lambda():
    ...
    with TestParser():
        ...
        # --- 宓屽 lambda: outer 杩斿洖 lambda, inner 涓嶅姞 var_ ---
...
def test_pil_parser_call():
    ...
    with TestParser():
        ...
        # --- 甯告暟: constant literals as positional call arguments ---
        ...
        # --- named arg 浼犲父鏁? named argument with constant value ---
        ...
        # --- 榛樿鍙傛暟: keyword arguments overriding defaults ---
        ...
        # --- name only 鍙傛暟: keyword-only parameters ---
        ...
        # --- 鍑芥暟璋冪敤宓屽鍦烘櫙: nested function calls as arguments ---
