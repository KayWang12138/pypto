...
# ---------------------------------------------------------------------------
# Mock torch before any pypto_block imports so jit.py's top-level 'import torch'
...
from pypto_block import DataType  # noqa: E402,I001
from pypto_block.frontend.jit import (  # noqa: E402
    ParamSpec,
    _args_to_ctypes,
    _collect_dyn_vars,
    _validate_args,
