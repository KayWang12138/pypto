...
"""Simplified frontend runtime example for plm.store(..., relu_pre_mode=...) on A5 CCE."""
...
def test_store_relu_cce():
    compiled_lib = fe.compile(store_relu_cce_kernel, arch="a5", codegen_mode="cce")
    if compiled_lib is None:
        raise RuntimeError("compile failed for store_relu_cce_kernel")
    ...
    print(raw_out[:8, :8])
    print("***********cce relu store output (top-left 8x8)***********")
    print(relu_out[:8, :8])
    print("***********cce golden raw output (top-left 8x8)***********")
    print(raw_ref[:8, :8])
    print("***********cce golden relu output (top-left 8x8)***********")
    print(relu_ref[:8, :8])
