...
class TestFlashAttention:
    ...
    def test_flash_attention_serializes(self):
        ...
        data = pypto_block.ir.serialize(flash_attn)
        assert len(data) > 0
    ...
    def test_flash_attention_round_trip(self):
        ...
        data1 = pypto_block.ir.serialize(flash_attn)
        restored = pypto_block.ir.deserialize(data1)
        data2 = pypto_block.ir.serialize(restored)

        # Second restoration
        restored2 = pypto_block.ir.deserialize(data2)
