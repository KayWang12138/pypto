...
import pytest
from pypto_block import ir
from pypto_block.language.parser.diagnostics import ParserTypeError
from pypto_block.language.parser.diagnostics.exceptions import (
    ParserSyntaxError,
...
class TestFunctionDecorator:
    ...
    def test_function_serialization(self):
        ...
        data = pypto_block.ir.serialize(simple)
        assert len(data) > 0

        # Should be able to deserialize
        restored = pypto_block.ir.deserialize(data)
...
class TestProgramRoundTrip:
    ...
    def test_roundtrip_simple_program(self):
        ...
        # Print to code
        code = pypto_block.ir.python_print(Original)
        ...
        # Verify structural equivalence
        pypto_block.ir.assert_structural_equal(reparsed, Original)
    ...
    def test_roundtrip_with_cross_function_calls(self):
        ...
        # Print to code
        code = pypto_block.ir.python_print(WithCalls)
...
class TestFunctionDecoratorSourceUnavailable:
    ...
    def test_function_without_source_gives_clear_error(self):
        ...
        code = textwrap.dedent("""\
            import pypto_block.language as pl
            from pypto_block.language.parser.diagnostics.exceptions import ParserSyntaxError
