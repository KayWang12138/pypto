...
"""
    ...
    def test_parse_from_import_variant(self):
        """Test parsing with 'from pypto_block import language as pl' variant."""
        code = """
from pypto_block import language as pl
...
"""
        ...
        data = pypto_block.ir.serialize(func)
        assert len(data) > 0
...
class TestScalarRangeRoundTrip:
    ...
    def test_scalar_stop_roundtrip(self):
        ...
        printed = pypto_block.ir.python_print(Before)
