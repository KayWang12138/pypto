...
class TestPrinterIntegration:
    ...
    def test_tensor_type_printed_with_subscript(self):
        ...
        result = pypto_block.ir.python_print(tensor_type)
    ...
    def test_tile_type_printed_with_subscript(self):
        ...
        result = pypto_block.ir.python_print(tile_type)
    ...
    def test_function_printed_with_subscript_types(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(test_func)
    ...
    def test_parsed_function_printer_round_trip(self):
        ...
        printed = pypto_block.ir.python_print(round_trip)
    ...
    def test_yield_type_annotation_in_if_statement(self):
        ...
        printed = pypto_block.ir.python_print(func_with_if_yield)
    ...
    def test_tuple_yield_no_type_annotation(self):
        ...
        printed = pypto_block.ir.python_print(func_with_tuple_yield)
...
class TestWhileLoopRoundTrip:
    ...
    def test_while_loop_natural_syntax(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(while_natural)
    ...
    def test_while_loop_with_multiple_variables(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(while_multi)
    ...
    def test_nested_while_loops_round_trip(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(nested_while)
    ...
    def test_while_in_for_round_trip(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(while_in_for)
    ...
    def test_for_in_while_round_trip(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(for_in_while)
    ...
    def test_while_with_tensor_operations_round_trip(self):
        ...
        # Print the function
        printed = pypto_block.ir.python_print(while_tensors)
