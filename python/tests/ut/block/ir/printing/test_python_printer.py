...
from pypto_block.ir import MemorySpace
...
def test_python_print_program():
    ...
    assert "# pypto_block.program: test_program" in result
    assert "import pypto_block.language as pl" in result
...
def test_python_print_program_with_multiple_functions():
    ...
    assert "# pypto_block.program: multi_func_program" in result
    assert "import pypto_block.language as pl" in result
...
def test_python_print_custom_prefix():
    ...
    # Default "pl" should use "import pypto_block.language as pl"
