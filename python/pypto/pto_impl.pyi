...
def OperatorBegin(inputs: List[Tensor], outputs: List[Tensor]) -> int: ...
...
class PassConfigs:
    ...
    dumpTileGraph = ...
    dumpBlockGraph = ...
    dumpFunctionGraphBeforePass = ...
    dumpFunctionGraphAfterPass = ...
    dumpPassTimeCost = ...
    preCheck = ...
    postCheck = ...
    expectedValueCheck = ...
...
def GetPassDefaultConfig(key: PassConfigKey, default_value: Union[int, str, bool]) -> Union[int, str, bool]: ...
def SetPassDefaultConfig(key: PassConfigKey, value: bool): ...

def GetPassConfig(strategy: str, identifier: str, key: PassConfigKey, default_value: Union[int, str, bool]) -> Union[int, str, bool]: ...
