...
class DistReduceType(enum.Enum):
    DIST_REDUCE_ADD = ...
    DIST_REDUCE_MAX = ...
    DIST_REDUCE_MIN = ...
...
class MoeConfig:
    routedExpertNum: int
    expertNumPerRank: int
    rankNum: int
    def __init__(self): ...


def CreateShmemTensor(rankSize: int, group: str, dataType: DataType, shape: List[int], memType: int = 0) -> Tensor: ...

def ShmemBarrier(predToken: Tensor, shmemSignal: Tensor, group: str, out: Tensor): ...

def ShmemSet(predToken: Tensor, shmemTensor: Tensor) -> Tensor: ...

def ShmemAllGather(in_tensor: Tensor, barrierDummy: Tensor, group: str, out: Tensor): ...

def TwoShotShmemAllReduce(in_tensor: Tensor, group: str, out: Tensor): ...

def OneShotShmemAllReduce(in_tensor: Tensor, group: str, out: Tensor): ...

def ShmemReduceScatter(in_tensor: Tensor, group: str, reduce_type: DistReduceType, out: Tensor): ...

def MoeDispatch(tokenTensor: Tensor, tokenExpertTable: Tensor, expand_x: Tensor, valid_cnt: Tensor, combine_info: Tensor, group: str, moeConfig: MoeConfig): ...

def ShmemMoeCombine(in_tensor: Tensor, combine_info: Tensor, scale: Tensor, group: str, rank_size: int, total_expert_num: int, out: Tensor): ...

def ShmemPut(in_tensor: Tensor, shmem_data_tile: Tensor, barrier_dummy: Tensor, tile_count: int, atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...

def ShmemPutUb2Gm(in_tensor: Tensor, shmem_data_tile: Tensor, barrier_dummy: Tensor, tile_count: int, atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...

def ShmemGet(dummy: Tensor, shmem_data_tile: Tensor, non_shmem_data_type: DataType = DataType.DT_BOTTOM, atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...

def ShmemGetGm2Ub(dummy: Tensor, shmem_data_tile: Tensor, non_shmem_data_type: DataType = DataType.DT_BOTTOM, atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...

def ShmemReduce(in_tensor: Tensor, shm_data: Tensor, dummy: Tensor, out: Tensor): ...

def ShmemSignal(dummy: Tensor, shmem_signal_tile: Tensor, atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...

def WaitUntil(dummy_in: Tensor, shmem_signal_tile: Tensor, tile_count: int, expected_sum: int, reset_signal: bool = False) -> Tensor: ...
