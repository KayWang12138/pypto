...
def CreateShmemTensor(rankSize: int, group: str, dataType: DataType, shape: List[int]) -> Tensor: ...

# def CreateShmem(rankSize: int, expertNumPerRank: int, shmemCol: int, hcclGroupIndex: int, dataType: DataType, memType: int) -> Tensor: ...

def Barrier(in_tensor: Tensor, group: str) -> Tensor: ...

def ShmemAllGather(in_tensor: Tensor, dummy: Tensor, group: str) -> Tensor: ...
...
# def MoeCombine(in_tensor: Tensor, scale: Tensor, combine_info: Tensor, group: str) -> Tensor: ...
...
def ShmemPut(in_tensor: Tensor, shmem_data_tile: Tensor, barrier_dummy: Tensor, tile_count: int, atomic_type: AtomicType) -> Tensor: ...

def ShmemGet(dummy: Tensor, shmem_data_tile: Tensor, non_shmem_data_type: DataType, atomic_type: AtomicType) -> Tensor: ...

def ShmemReduce(in_tensor: Tensor, shm_data: Tensor, dummy: Tensor, out: Tensor): ...

def ShmemSignal(dummy: Tensor, shmem_signal_tile: Tensor, atomic_type: AtomicType) -> Tensor: ...

def ShmemClearSignal(in_tensor: Tensor, shmem_signal_tile: Tensor, tile_count: int) -> Tensor: ...

def WaitUntil(dummy_in: Tensor, shmem_signal_tile: Tensor, tile_count: int, group: str, expected_sum: int) -> Tensor: ...
