...
def ShmemPut(pred_token: Tensor, input: Tensor, shmem_data: Tensor, atomic_type: AtomicType) -> Tensor: ...


def ShmemPutUb2Gm(input: Tensor, shmem_data_tile: Tensor, pred_token: Tensor, atomic_type: AtomicType) -> Tensor: ...


def ShmemGet(pred_token: Tensor, shmem_data: Tensor, non_shmem_dtype: DataType.DT_BOTTOM, 
...
def WaitUntil(pred_token: Tensor, shmem_signal: Tensor, expected_sum: int, reset_signal: bool = False) -> Tensor: ...
