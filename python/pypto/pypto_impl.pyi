...
# def CreateShmemTensor(rankSize: int, hcclGroupIndex: int, dataType: DataType, shape: List[int]) -> Tensor: ...
...
def MoeDispatch(tokenTensor: Tensor, tokenExpertTable: Tensor, expand_x: Tensor, valid_cnt: Tensor, combine_info: Tensor, group: str, moeConfig: MoeConfig) -> Tuple[Tensor, Tensor, Tensor]: ...
