...
def CreateShmemData(group: str, world_size: int, dtype: DataType, shape: List[int], shmem_tensor: Tensor, mem_type: int): ...


def CreateShmemSignal(group: str, shmem_data: Tensor, shmem_signal: Tensor): ...


def ShmemBarrier(pred_token: Tensor, shmem_signal: Tensor, group: str, world_size: int) -> Tensor: ...


def ShmemDataSet(pred_token: Tensor, shmem_data: Tensor): ...


def ShmemSignalSet(pred_token: Tensor, shmem_signal: Tensor): ...


def ShmemPut(input: Tensor, shmem_data_tile: Tensor, pred_token: Tensor, atomic_type: AtomicType) -> Tensor: ...


def ShmemPutUb2Gm(input: Tensor, shmem_data_tile: Tensor, pred_token: Tensor, atomic_type: AtomicType) -> Tensor: ...


def ShmemGet(dummy: Tensor, shmem_data_tile: Tensor, non_shmem_dtype: DataType.DT_BOTTOM, 
             atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...


def ShmemGetGm2Ub(dummy: Tensor, shmem_data_tile: Tensor, non_shmem_dtype: DataType.DT_BOTTOM, 
             atomic_type: AtomicType = AtomicType.SET) -> Tensor: ...
...
def WaitUntil(dummyIn: Tensor, shmem_signal_tile: Tensor, expected_sum: int, reset_signal: bool = False) -> Tensor: ...


def GetSymbolicScalarRankId(group: str) -> SymbolicScalar: ...
