...
def compare_eq(h: CodeHelper, inst: Instruction):
...
def compare_neq(h: CodeHelper, inst: Instruction):
    check_inst_src_dtype2(inst)
...
def compare_gt(h: CodeHelper, inst: Instruction):
...
def compare_ge(h: CodeHelper, inst: Instruction):
    check_inst_src_dtype3(inst)
