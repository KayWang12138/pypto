...
class RemainderAlgorithm(enum.Enum):
    INTRINSIC = ...
    HIGH_PRECISION = ...
...
def Remainder(a: Tensor, b: Union[Tensor, Element], precision_type: RemainderAlgorithm = RemainderAlgorithm.HIGH_PRECISION) -> Tensor: ...
