...
class _JIT:
    def __init__(self, dyn_func, codegen_options=None, host_options=None,
                 pass_options=None, runtime_options=None, verify_options=None, debug_options=None, infer_controlflow_shape=None):
    ...
    def get_argtype(self, tensors: List[pypto.Tensor]):
        argtype = _ArgType()
    ...
    def get_controlflow_shape(self, tensors: List[pypto.Tensor]):
        if self.infer_controlflow_shape:
            ...
            return _ControlflowShape(inferred)
    ...
    def run_npu(self, device, kernel, start_args):
        import torch
    ...
    def get_cached_kernel(self, tensors: List[pypto.Tensor], argtype: _ArgType, cfshape: _ControlflowShape, *args, **kwargs):
