...
class Var():
    ...
    def __mul__(self, other: Union[int, float, 'Var']):
        ...
        context.active_module.add_inst(Instruction('var_mul', [self, other], new_var))
        return new_var
    ...
    def __rmul__(self, other: Union[int, float, 'Var']):
        ...
        context.active_module.add_inst(Instruction('var_mul', [other, self], new_var))
        return new_var

    def __imul__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_mul', [self, other], self))
        return self
    ...
    def __eq__(self, other: Union['Var', int, float, str]):
        ...
        context.active_module.add_inst(Instruction('var_compare_eq', [self, other], new_var))
        return new_var
    ...
    def __ne__(self, other: Union['Var', int, float, str]):
        ...
        new_var = context.active_module.create_var(dtype='bool')
        context.active_module.add_inst(Instruction('var_compare_neq', [self, other], new_var))
        return new_var
    ...
    def __gt__(self, other: Union['Var', int, float]):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='bool')
        context.active_module.add_inst(Instruction('var_compare_gt', [self, other], new_var))
        return new_var
    ...
    def __ge__(self, other: Union['Var', int, float]):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='bool')
        context.active_module.add_inst(Instruction('var_compare_ge', [self, other], new_var))
        return new_var
    ...
    def __lt__(self, other: Union['Var', int, float]):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='bool')
        context.active_module.add_inst(Instruction('var_compare_gt', [other, self], new_var))
        return new_var
    ...
    def __le__(self, other: Union['Var', int, float]):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='bool')
        context.active_module.add_inst(Instruction('var_compare_ge', [other, self], new_var))
        return new_var
    ...
    def __add__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype=get_obj_dtype(self))
        context.active_module.add_inst(Instruction('var_add', [self, other], new_var))
        return new_var
    ...
    def __iadd__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_add', [self, other], self))
        return self
    ...
    def __sub__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype=get_obj_dtype(self))
        context.active_module.add_inst(Instruction('var_sub', [self, other], new_var))
        return new_var
    ...
    def __rsub__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype=get_obj_dtype(other))
        context.active_module.add_inst(Instruction('var_sub', [other, self], new_var))
        return new_var

    def __isub__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_sub', [self, other], self))
        return self
    ...
    def __truediv__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype=get_obj_dtype(self))
        context.active_module.add_inst(Instruction('var_true_div', [self, other], new_var))
        return new_var
    ...
    def __rtruediv__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype=get_obj_dtype(other))
        context.active_module.add_inst(Instruction('var_true_div', [other, self], new_var))
        return new_var

    def __itruediv__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_true_div', [self, other], self))
        return self
    ...
    def __floordiv__(self, other: Union[int, float, 'Var']):
        ...
        context.active_module.add_inst(Instruction('var_floor_div', [self, other], new_var))
        return new_var
    ...
    def __rfloordiv__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='int')
        context.active_module.add_inst(Instruction('var_floor_div', [other, self], new_var))
        return new_var

    def __ifloordiv__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_floor_div', [self, other], self))
        return self
    ...
    def __mod__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='int')
        context.active_module.add_inst(Instruction('var_mod', [self, other], new_var))
        return new_var

    def __imod__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_mod', [self, other], self))
        return self
    ...
    def __pow__(self, other: Union[int, float, 'Var']):
        ...
        context.active_module.add_inst(Instruction('var_pow', [self, other], new_var))
        return new_var
    ...
    def __rpow__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        new_var = context.active_module.create_var(dtype='float')
        context.active_module.add_inst(Instruction('var_pow', [other, self], new_var))
        return new_var

    def __ipow__(self, other: Union[int, float, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_inplace_pow', [self, other], self))
        return self
    ...
    def eq(self, expr: Union[int, float, str, 'Var']):
        if context.active_module is None:
            raise Exception()
        context.active_module.add_inst(Instruction('var_assign', [self.dtype, self, expr], None))
        return expr