...
class JitCallableWrapper:
    ...
    def __init__(
        ...
        self._set_run_mode()
        self.kwargs = None
        self._cached_signature = self.get_signature_high_performance()
    ...
    def _compute_cache_hashes(self) -> Any:
        ...
        def is_defined_globally(func):
            ...
            has_closure = any((closure_vars.unbound, getattr(closure_vars, 'freevars', []), getattr(closure_vars, 'cellvars', [])))
            if has_closure:
                return False
