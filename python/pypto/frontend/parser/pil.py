...
from pypto.error import FrontendError
...
class PILBuilder(ast.NodeVisitor):
    ...
    def create_pil_expr(self,
        ...
        raise FrontendError(TypeError(f"Expected ast.Constant or str, but got {type(value).__name__}"))
    ...
    def create_pil_maybe_starred(self,
        ...
        if starred:
            if not isinstance(expr, str):
                raise FrontendError(TypeError(f"Expected str for starred expr, but got {type(expr).__name__}"))
    ...
    def create_pil_assign_identifier(self,
        ...
        if not isinstance(target_name, str):
            raise FrontendError(TypeError(f"Expected str for target_name, but got {type(target_name).__name__}"))
        return ast.Assign(
...
class PythonParser(PILBuilder, ast.NodeVisitor):
    ...
    def visit_lhs(self, target: ast.expr, source_expr: PILExprOrNone) -> list[ast.stmt]:
        ...
        raise FrontendError(NotImplementedError(f"LHS target type {type(target).__name__} is not supported"))
    ...
    def visit_async_function_def(self,
         ...
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("AsyncFunctionDef is not supported"))
    ...
    def visit_class_def(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("ClassDef is not supported"))
    ...
    def visit_delete(self,
        ...
        for target in targets:
            if isinstance(target, ast.Name):
                ...
                raise FrontendError(NotImplementedError(f"Delete target type {type(target).__name__} is not supported"))
    ...
    def visit_aug_assign(self,
        ...
        raise FrontendError(NotImplementedError(f"AugAssign target type {type(target).__name__} is not supported"))
    ...
    def visit_async_for(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("AsyncFor is not supported"))
    ...
    def visit_async_with(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("AsyncWith is not supported"))
    ...
    def visit_match(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("Match is not supported"))
    ...
    def visit_try_star(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("TryStar is not supported"))
    ...
    def visit_bool_op(self,
        ...
        raise FrontendError(NotImplementedError(f"BoolOp {type(op).__name__} is not supported"))
    ...
    def visit_named_expr(self,
        ...
        if not isinstance(target, ast.Name):
            raise FrontendError(TypeError('Python native ast parser should guarantee that the target of NamedExpr is always ast.Name'))
        value_stmt_list, value_name = self.visit(value)
    ...
    def visit_await(
        ...
        raise FrontendError(NotImplementedError("Await is not supported"))
    ...
    def visit_interpolation(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("Interpolation is not supported"))
    ...
    def visit_template_str(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("TemplateStr is not supported"))
    ...
    def visit_attribute(self,
        ...
        if not isinstance(ctx, ast.Load):
            raise FrontendError(TypeError(f"Expected ast.Load for ctx, but got {type(ctx).__name__}"))
        value_stmts, value_name = self.visit(value)
        temp_name = self.create_temp_identifier()
    ...
    def visit_starred(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(RuntimeError("Starred should not be directly accessed"))
    ...
    def visit_slice(self,
         ...
         node_attr: PILAttr = NOATTR) -> tuple[list[ast.stmt],
         PILExprOrNone]:
        raise FrontendError(NotImplementedError("Slice is not supported"))
