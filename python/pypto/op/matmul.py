    ...
    *,
    ...
    extend_params : dict, optional
        ...
        - 'trans_mode': TransMode
            The rounding mode for converting FP32 to TF32 (e.g., TransMode.CAST_RINT):
...
def __validate_trans_mode(mat_a, mat_b, extend_params):
    trans_mode = extend_params.get('trans_mode', pypto_impl.TransMode.CAST_NONE)
    if (trans_mode != pypto_impl.TransMode.CAST_NONE and 
