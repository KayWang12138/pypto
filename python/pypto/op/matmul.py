...
def __validate_inputs(input_tensor1, input_tensor2, out_dtype, optional_param) -> None:
    ...
    if (input1_dtype == pypto_impl.DataType.DT_FP32 and input1_format == pypto_impl.TileOpFormat.TILEOP_NZ) or \
    ...
    if (input1_dtype == pypto_impl.DataType.DT_FP8E5M2 and input1_format == pypto_impl.TileOpFormat.TILEOP_NZ) or \
