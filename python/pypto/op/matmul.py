...
def __validate_shape(input_tensor1: Tensor, input_tensor2: Tensor, a_trans: bool, b_trans: bool) -> None:
    ...
    get_valid_shape = lambda tensor: [SymbolicScalar.from_base(n) for n in tensor.GetValidShape()]
    input_valid_shape = get_valid_shape(input_tensor1)
    mat2_valid_shape = get_valid_shape(input_tensor2)
...
def __validate_inputs(input_tensor1, input_tensor2, out_dtype, a_trans, b_trans, is_out_nz, extend_params) -> None:
