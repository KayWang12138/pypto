...
@op_wrapper
def div(input: Tensor, other: Union[Tensor, float], precision_type: DivAlgorithm = DivAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    precision_type : DivAlgorithm, optional
        ...
        HIGH_PRECISION is recommended for FP16 and BF16 types to reduce precision loss.
        Use DivAlgorithm.DEFAULT for lower precision but potentially faster computation.
