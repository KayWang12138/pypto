...
def pow(input: Tensor, other: Union[Tensor, int, float], precision_type: PowAlgorithm = PowAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    if isinstance(other, int):
        return pypto_impl.Pow(input, pypto_impl.Element(DataType.DT_INT32, other), precision_type)
    return pypto_impl.Pow(input, pypto_impl.Element(DataType.DT_FP32, other), precision_type)
