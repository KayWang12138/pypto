...
def reciprocal(a: Tensor, precision_type: RecipAlgorithm = RecipAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    precision_type : RecipAlgorithm, optional
        The precision algorithm for reciprocal. Default is RecipAlgorithm.HIGH_PRECISION.
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use RecipAlgorithm.INTRINSIC to directly use chip instructions.
...
def rsqrt(input: Tensor, precision_type: RsqrtAlgorithm = RsqrtAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    precision_type : RsqrtAlgorithm, optional
        ...
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use RsqrtAlgorithm.INTRINSIC to directly use chip instructions.
...
def log(input: Tensor, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    precision_type : LogAlgorithm, optional
        ...
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use LogAlgorithm.INTRINSIC to directly use chip instructions.
