...
from ..enum import DataType, DivAlgorithm, ExpAlgorithm, SqrtAlgorithm, RsqrtAlgorithm, LogAlgorithm
...
@op_wrapper
def reciprocal(a: Tensor, precision_type: ReciprocalAlgorithm = ReciprocalAlgorithm.DEFAULT) -> Tensor:
    """
    ...
    input : Tensor
        The input tensor.
    precision_type : ReciprocalAlgorithm, optional
        The precision algorithm for reciprocal. Default is ReciprocalAlgorithm.DEFAULT.
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use ReciprocalAlgorithm.DEFAULT to directly use chip instructions.
    ...
    y = pypto.reciprocal(x, pypto.ReciprocalAlgorithm.HIGH_PRECISION)
    """
    return pypto_impl.Reciprocal(a, precision_type.value)
...
@op_wrapper
def rsqrt(input: Tensor, precision_type: RsqrtAlgorithm = RsqrtAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    precision_type : RsqrtAlgorithm, optional
        The precision algorithm for reciprocal square-root. Default is RsqrtAlgorithm.HIGH_PRECISION.
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use RsqrtAlgorithm.DEFAULT to directly use chip instructions.
    ...
    """
    return pypto_impl.Rsqrt(input, precision_type.value)
...
@op_wrapper
def log(input: Tensor, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    precision_type : LogAlgorithm, optional
        The precision algorithm for logarithm. Default is LogAlgorithm.HIGH_PRECISION.
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use LogAlgorithm.DEFAULT to directly use chip instructions.
    ...
    return pypto_impl.Log(input, pypto_impl.LogBaseType.LOG_E, precision_type.value)


@op_wrapper
def log2(input: Tensor, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    """
    return pypto_impl.Log(input, pypto_impl.LogBaseType.LOG_2, precision_type.value)


@op_wrapper
def log10(input: Tensor, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> Tensor:
    ...
    # Output y: [0.0000   1.0000   2.0000]
    """
    return pypto_impl.Log(input, pypto_impl.LogBaseType.LOG_10, precision_type.value)
