...
from ..enum import (
    ...
    RsqrtAlgorithm, LogAlgorithm, RecipAlgorithm, RemainderAlgorithm
)
...
def remainder(
    ...
    precision_type: RemainderAlgorithm = RemainderAlgorithm.HIGH_PRECISION
) -> Tensor:
    ...
    precision_type : RemainderAlgorithm, optional
        The precision algorithm for remainder. Default is RemainderAlgorithm.HIGH_PRECISION.
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use RemainderAlgorithm.INTRINSIC to directly use chip instructions.
    ...
    a = pypto.tensor([1, 3], pypto.DT_FP16)
    b = pypto.tensor([1, 3], pypto.DT_FP16)
    out = pypto.remainder(a, b, pypto.RemainderAlgorithm.HIGH_PRECISION)
    """
