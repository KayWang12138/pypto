...
def quant_mx(
    ...
    `performance_mode` uses a performance-oriented internal TQuant layout and requires the
    runtime input shape on the quantization axis to be 128-element aligned. The view/tile shape
    still must be 256-byte aligned.
    """
