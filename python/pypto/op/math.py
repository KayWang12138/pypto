...
@op_wrapper
def reciprocal(a: Tensor, precision_type: RecipAlgorithm = RecipAlgorithm.DEFAULT) -> Tensor:
    """
    ...
    precision_type : RecipAlgorithm, optional
        The precision algorithm for reciprocal. Default is RecipAlgorithm.DEFAULT.
        HIGH_PRECISION uses higher precision calculation to reduce precision loss.
        Use RecipAlgorithm.DEFAULT to directly use chip instructions.
