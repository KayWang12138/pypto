...
def gathermask(input: Tensor, pattern_mode: int) -> Tensor:
    ...
    Tensor
        ...
        - pattern_mode <= 2, the output shape's trailing axis is input.shape's trailing axis / 2, 
            while other axes match the input shape.
        - When 2 < pattern_mode < 7, the output shape's trailing axis is input.shape's trailing axis divided by 4, 
            while other axes remain consistent with the input shape.
