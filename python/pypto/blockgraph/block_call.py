...
# -----------------------------------------------------------------------------------------------------------
'''
BlockCallHelper - Temporarily Disabled
...
raise ImportError(
    "BlockCallHelper is temporarily disabled because the IR module is not available.\n"
    "The bindings/ir.cpp file has been disabled in CMakeLists.txt.\n"
    "Please enable bindings/ir.cpp if you need this functionality."
)

# Original code commented out below - will be restored when IR module is re-enabled
