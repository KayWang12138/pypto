...
class Tensor:
    ...
    @source_location
    def rsqrt(self, precision_type: 'RsqrtAlgorithm' = pypto.RsqrtAlgorithm.HIGH_PRECISION) -> 'Tensor':
    ...
    @source_location
    def reciprocal(self, precision_type: 'ReciprocalAlgorithm' = pypto.ReciprocalAlgorithm.DEFAULT) -> 'Tensor':
