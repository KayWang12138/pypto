...
class Tensor:
    ...
    def __init__(self, shape=None, dtype: Union[DataType, None] = None, name: str = "",
                 ...
                 device=None, ori_shape=None, readyOnAicoreStart: bool = False):
        self.ori_shape = None
        ...
        if shape is None or dtype is None:
            ...
            self._base = pypto_impl.Tensor(dtype, nshape, name, format, readyOnAicoreStart)
            ...
            self._base = pypto_impl.Tensor(dtype, sym_shape, name, format, readyOnAicoreStart)
    ...
    def SetReadyOnAicoreStart(self, readyOnAicoreStart: bool) -> None:
        """
        Set the depend type of Tensor.

        Parameters
        ----------
        readyOnAicoreStart : bool
            Whether the tensor depends on const.
        """
        self._base.SetReadyOnAicoreStart(readyOnAicoreStart)

    def GetReadyOnAicoreStart(self) -> bool:
        """
        Get the depend type of Tensor.
        ...
        bool
            Whether the tensor depends on const.
        """
        return self._base.GetReadyOnAicoreStart()
