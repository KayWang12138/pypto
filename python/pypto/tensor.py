...
class Tensor:
    ...
    @source_location
    def exp(self, precision_type: ExpAlgorithm = ExpAlgorithm.HIGH_PRECISION) -> 'Tensor':
    ...
    @source_location
    def log(self, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> 'Tensor':
    ...
    @source_location
    def log10(self, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> 'Tensor':
        return pypto.log10(self, precision_type)

    @source_location
    def log2(self, precision_type: LogAlgorithm = LogAlgorithm.HIGH_PRECISION) -> 'Tensor':
    ...
    @source_location
    def rsqrt(self, precision_type: RsqrtAlgorithm = RsqrtAlgorithm.HIGH_PRECISION) -> 'Tensor':
        return pypto.rsqrt(self, precision_type)

    @source_location
    def sqrt(self, precision_type: SqrtAlgorithm = SqrtAlgorithm.HIGH_PRECISION) -> 'Tensor':
    ...
    @source_location
    def reciprocal(self, precision_type: RecipAlgorithm = RecipAlgorithm.HIGH_PRECISION) -> 'Tensor':
