...
def set_compiler_monitor_options(enable=True, interval_sec=60, timeout_sec=-1, total_timeout_sec=600):
    """Set compiler monitor options.

    Args:
        enable: Whether to enable the monitor. Default True.
        interval_sec: Progress print interval in seconds. Default 60.
