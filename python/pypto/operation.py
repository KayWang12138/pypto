...
@op_wrapper
def one_shot_shmem_all_reduce(in_tensor, group, out_tensor):
    pypto_impl.one_shot_shmem_all_reduce(in_tensor, group, out_tensor)


@op_wrapper
def two_shot_shmem_all_reduce(in_tensor, group, out_tensor):
    pypto_impl.two_shot_shmem_all_reduce(in_tensor, group, out_tensor)
