...
@op_wrapper
def one_shot_all_reduce(pred_token, in_tensor, group, ranksie, out_tensor):
    pypto_impl.one_shot_all_reduce(pred_token, in_tensor, group, ranksie, out_tensor)


@op_wrapper
def two_shot_all_reduce(pred_token, in_tensor, group, ranksie, out_tensor):
    pypto_impl.two_shot_all_reduce(pred_token, in_tensor, group, ranksie, out_tensor)
