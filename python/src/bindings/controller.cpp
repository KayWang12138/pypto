...
void bind_controller_config(py::module &m) {
    ...
    m.def("GetPlatformConfig",
        [](const std::string &key, const std::string &defaultValue) {
            return py::cast(config::GetPlatformConfig<std::string>(key, defaultValue));
        }, py::arg("key"), py::arg("default_value"));
    m.def("GetPlatformConfig",
        [](const std::string &key, const bool &defaultValue) {
            return py::cast(config::GetPlatformConfig<bool>(key, defaultValue));
        }, py::arg("key"), py::arg("default_value"));
}
