...
void bind_controller_function(nb::module_ &m) {
    ...
    nb::class_<RecordFunc>(m, "RecordFunc")
        ...
        // .def(nb::init<const std::string &, const ref_tensors &>(), nb::arg("name"), nb::arg("args"))
        // .def(
        //     nb::init<const std::string &, const ref_tensors &, const ref_tensors &,
        //         const std::vector<std::pair<std::reference_wrapper<const Tensor>, std::reference_wrapper<const Tensor>>>
        //             &>(),
        //     nb::arg("name"), nb::arg("inputs"), nb::arg("outputs"),
        //     nb::arg("in_place_args"))
