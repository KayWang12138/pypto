...
#undef BIND_UNARY_EXPR
  ...
  ir.def("structural_hash", static_cast<uint64_t (*)(const IRNodePtr &, bool)>(&StructuralHash),
         py::arg("node"), py::arg("enable_auto_mapping") = false);
  ir.def("structural_hash", static_cast<uint64_t (*)(const TypePtr &, bool)>(&StructuralHash),
         py::arg("type"), py::arg("enable_auto_mapping") = false);
  ir.def("structural_equal",
         static_cast<bool (*)(const IRNodePtr &, const IRNodePtr &, bool)>(&StructuralEqual),
         py::arg("lhs"), py::arg("rhs"), py::arg("enable_auto_mapping") = false);
  ir.def("structural_equal",
         static_cast<bool (*)(const TypePtr &, const TypePtr &, bool)>(&StructuralEqual),
         py::arg("lhs"), py::arg("rhs"), py::arg("enable_auto_mapping") = false);
  ir.def("assert_structural_equal",
         static_cast<void (*)(const IRNodePtr &, const IRNodePtr &, bool)>(&AssertStructuralEqual),
         py::arg("lhs"), py::arg("rhs"), py::arg("enable_auto_mapping") = false);
  ir.def("assert_structural_equal",
         static_cast<void (*)(const TypePtr &, const TypePtr &, bool)>(&AssertStructuralEqual),
         py::arg("lhs"), py::arg("rhs"), py::arg("enable_auto_mapping") = false);
