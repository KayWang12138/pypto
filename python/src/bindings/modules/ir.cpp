...
#undef BIND_UNARY_EXPR
    ...
    ir.def("structural_hash", static_cast<uint64_t (*)(const IRNodePtr &, bool)>(&structural_hash), py::arg("node"),
        py::arg("enable_auto_mapping") = false);
    ir.def("structural_hash", static_cast<uint64_t (*)(const TypePtr &, bool)>(&structural_hash), py::arg("type"),
        py::arg("enable_auto_mapping") = false);
