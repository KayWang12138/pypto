...
/**
 * \file ir.cpp
 * \brief Python bindings for IR types, spans, expressions, and statements
 */
...
void BindField(PyClassType &pyClass, const FieldDesc &desc) {
    pyClass.def_readonly(desc.name, desc.fieldPtr);
}
...
void BindIR(py::module_ &m) {
    ...
    py::class_<Span>(ir, "Span")
        ...
        .def("to_string", &Span::ToString)
        .def("is_valid", &Span::IsValid)
    ...
    typeClass.def("__eq__", [](const TypePtr &self, const TypePtr &other) { return StructuralEqual(self, other); });
    ...
    tensorTypeClass.def(py::init<const std::vector<ExprPtr> &, DataType, std::optional<MemRefPtr>>(), py::arg("shape"),
        py::arg("dtype"), py::arg("memref") = py::none());
    tensorTypeClass.def(py::init<const std::vector<int64_t> &, DataType, std::optional<MemRefPtr>>(), py::arg("shape"),
        py::arg("dtype"), py::arg("memref") = py::none());
    ...
    ir.def(
        "create_op_call",
        [](const std::string &opName, const std::vector<ExprPtr> &args, const py::dict &kwargsDict, const Span &span) {
    ...
    ir.def(
        "is_op_registered", [](const std::string &opName) { return OpRegistry::GetInstance().IsRegistered(opName); },
        py::arg("op_name"));
    ir.def(
        "get_op", [](const std::string &opName) { return OpRegistry::GetInstance().GetOp(opName); },
        py::arg("op_name"));

    // Var
    auto varClass = py::class_<Var, Expr, std::shared_ptr<Var>>(ir, "Var");
    varClass.def(py::init<const std::string &, const TypePtr &, const Span &>(), py::arg("name"), py::arg("type"),
        py::arg("span"));
    BindFields<Var>(varClass);

    // IterArg
    auto iterargClass = py::class_<IterArg, Var, std::shared_ptr<IterArg>>(ir, "IterArg");
    iterargClass.def(py::init<const std::string &, const TypePtr &, const ExprPtr &, const Span &>(), py::arg("name"),
    ...
    constintClass.def(py::init<int64_t, DataType, const Span &>(), py::arg("value"), py::arg("dtype"), py::arg("span"));
    ...
    callClass.def(py::init<const OpPtr &, const std::vector<ExprPtr> &, const Span &>(), py::arg("op"), py::arg("args"),
        py::arg("span"));
    callClass.def(py::init<const OpPtr &, const std::vector<ExprPtr> &, const TypePtr &, const Span &>(), py::arg("op"),
        py::arg("args"), py::arg("type"), py::arg("span"));
    callClass.def(
        py::init([](const OpPtr &op, const std::vector<ExprPtr> &args, const py::dict &kwargsDict, const Span &span) {
            auto kwargs = ConvertKwargsDict(kwargsDict);
    ...
    makeTupleClass.def(py::init<const std::vector<ExprPtr> &, const Span &>(), py::arg("elements"), py::arg("span"));
    BindFields<MakeTuple>(makeTupleClass);

    // TupleGetItemExpr
    auto tupleGetItemClass =
        py::class_<TupleGetItemExpr, Expr, std::shared_ptr<TupleGetItemExpr>>(ir, "TupleGetItemExpr");
    tupleGetItemClass.def(
        py::init<const ExprPtr &, int, const Span &>(), py::arg("tuple"), py::arg("index"), py::arg("span"));
...
#undef BIND_UNARY_EXPR
    ...
    ir.def("structural_hash", static_cast<uint64_t (*)(const IRNodePtr &, bool)>(&StructuralHash), py::arg("node"),
        py::arg("enable_auto_mapping") = false);
    ir.def("structural_hash", static_cast<uint64_t (*)(const TypePtr &, bool)>(&StructuralHash), py::arg("type"),
        py::arg("enable_auto_mapping") = false);
    ir.def("structural_equal", static_cast<bool (*)(const IRNodePtr &, const IRNodePtr &, bool)>(&StructuralEqual),
        py::arg("lhs"), py::arg("rhs"), py::arg("enable_auto_mapping") = false);
    ir.def("structural_equal", static_cast<bool (*)(const TypePtr &, const TypePtr &, bool)>(&StructuralEqual),
        py::arg("lhs"), py::arg("rhs"), py::arg("enable_auto_mapping") = false);
    ir.def("assert_structural_equal",
        static_cast<void (*)(const IRNodePtr &, const IRNodePtr &, bool)>(&AssertStructuralEqual), py::arg("lhs"),
        py::arg("rhs"), py::arg("enable_auto_mapping") = false);
    ir.def("assert_structural_equal",
        static_cast<void (*)(const TypePtr &, const TypePtr &, bool)>(&AssertStructuralEqual), py::arg("lhs"),
        py::arg("rhs"), py::arg("enable_auto_mapping") = false);
    ...
    yieldStmtClass.def(py::init<const std::vector<ExprPtr> &, const Span &>(), py::arg("value"), py::arg("span"));
    ...
    returnStmtClass.def(py::init<const std::vector<ExprPtr> &, const Span &>(), py::arg("value"), py::arg("span"));
    ...
    forStmtClass.def(py::init<const VarPtr &, const ExprPtr &, const ExprPtr &, const ExprPtr &,
                         const std::vector<IterArgPtr> &, const StmtPtr &, const std::vector<VarPtr> &, const Span &>(),
    ...
    seqStmtsClass.def(py::init<const std::vector<StmtPtr> &, const Span &>(), py::arg("stmts"), py::arg("span"));
    BindFields<SeqStmts>(seqStmtsClass);

    auto opStmtsClass = py::class_<OpStmts, Stmt, std::shared_ptr<OpStmts>>(ir, "OpStmts");
    opStmtsClass.def(py::init<const std::vector<StmtPtr> &, const Span &>(), py::arg("stmts"), py::arg("span"));
    ...
    programClass.def_property_readonly("functions", [](const std::shared_ptr<const Program> &self) {
        py::dict result;
