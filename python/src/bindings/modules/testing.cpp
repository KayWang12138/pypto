...
[[noreturn]] static void raise_value_error(const std::string &message) {
    throw ir::ValueError(message);
}
[[noreturn]] static void raise_type_error(const std::string &message) {
    throw ir::TypeError(message);
}
[[noreturn]] static void raise_runtime_error(const std::string &message) {
    throw ir::RuntimeError(message);
}
[[noreturn]] static void raise_not_implemented_error(const std::string &message) {
    throw ir::NotImplementedError(message);
}
[[noreturn]] static void raise_index_error(const std::string &message) {
    throw ir::IndexError(message);
}
[[noreturn]] static void raise_generic_error(const std::string &message) {
    throw ir::Error(message);
}
[[noreturn]] static void raise_assertion_error(const std::string &message) {
    throw ir::AssertionError(message);
}
[[noreturn]] static void raise_internal_error(const std::string &message) {
