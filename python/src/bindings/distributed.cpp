...
void BindDistributed(py::module& m) {
    ...
    m.def(
        "ShmemSignal",
        [](const ShmemTensor& dst, const SymbolicScalar &dstRank, const SymbolicScalar &notifyRank, int32_t signal,
            Distributed::AtomicType sigOp, const Tensor& pred) {
            return Distributed::ShmemSignal(dst, dstRank, notifyRank, signal, sigOp, pred);
        },
        py::arg("dst"), py::arg("dstRank"), py::arg("notifyRank"), py::arg("signal"), py::arg("sigOp"), py::arg("pred"),
