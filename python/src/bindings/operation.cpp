...
void bind_operation(py::module& m)
{
    ...
    m.def(
        "Pow", [](const Tensor& self, const Tensor& other, PowAlgorithm precisionType) {
            return npu::tile_fwk::Pow(self, other);
        }, py::arg("self"), py::arg("other"), py::arg("precision_type") = PowAlgorithm::HIGH_PRECISION, "Tensor pow.");
    m.def(
        "Pow", [](const Tensor& self, const Element& other, PowAlgorithm precisionType) {
            return npu::tile_fwk::Pow(self, other);
        }, py::arg("self"), py::arg("other"), py::arg("precision_type") = PowAlgorithm::HIGH_PRECISION, "Tensor pow scalar.");
    m.def(
        "Cast",
