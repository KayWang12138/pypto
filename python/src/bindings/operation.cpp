...
void bind_operation(py::module& m)
{
    ...
    m.def(
        "Remainder", 
        [](const Tensor& self, const Tensor& other, RemainderAlgorithm precisionType) {
            return npu::tile_fwk::Remainder(self, other, precisionType);
        },
        py::arg("self"), py::arg("other"), py::arg("precision_type") = RemainderAlgorithm::HIGH_PRECISION, "Tensor remainder.");
    m.def(
        "Remainder", 
        [](const Tensor& self, const Element& other, RemainderAlgorithm precisionType) {
            return npu::tile_fwk::Remainder(self, other, precisionType);
        },
        py::arg("self"), py::arg("other"), py::arg("precision_type") = RemainderAlgorithm::HIGH_PRECISION, "Tensor remainder scalar.");
    m.def(
        "Remainder", 
        [](const Element& self, const Tensor& other, RemainderAlgorithm precisionType) {
            return npu::tile_fwk::Remainder(self, other, precisionType);
        },
        py::arg("self"), py::arg("other"), py::arg("precision_type") = RemainderAlgorithm::HIGH_PRECISION, "Scalar remainder tensor.");
    m.def(
