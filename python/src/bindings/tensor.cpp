...
void BindTensor(py::module &m) {
    py::class_<Tensor>(m, "Tensor")
        .def(py::init<>())
        .def(py::init([](DataType dtype, const py::sequence &shape, const std::string &name, TileOpFormat format, bool dependConst) {
            ...
            if (has_symbolic) {
                ...
                return std::make_unique<Tensor>(dtype, symbolic_shape, name, format, dependConst);
            } else {
                ...
                return std::make_unique<Tensor>(dtype, int_shape, name, format, dependConst);
            }
        }),
            py::arg("dtype"), py::arg("shape"), py::arg("name") = "", py::arg("format") = TileOpFormat::TILEOP_ND, py::arg("dependConst") = false)
        .def(py::init<DataType, std::vector<int64_t>, uint8_t *, std::string, TileOpFormat, bool>(), py::arg("dtype"),
            py::arg("shape"), py::arg("data_ptr"), py::arg("name"), py::arg("format") = TileOpFormat::TILEOP_ND, py::arg("dependConst") = false)
        ...
        .def(py::init<DataType, std::vector<int64_t>, std::string, TileOpFormat, bool>(), py::arg("dtype"), py::arg("shape"),
            py::arg("name") = "", py::arg("format") = TileOpFormat::TILEOP_ND, py::arg("dependConst") = false)
        ...
        .def("Id", &Tensor::Id)
        .def("SetDependConst", &Tensor::SetDependConst, py::arg("dependConst"))
        .def("GetDependType", &Tensor::GetDependType)
        .def("GetDataType",
