...
void BindMonitor(py::module &m) {
    ...
    m.def("SetCompilerMonitorOptions", [](bool enable, int interval_sec) {
        MonitorManager::Instance().SetCompilerMonitorOptions(enable, interval_sec);
    }, py::arg("enable") = true, py::arg("interval_sec") = 30,
