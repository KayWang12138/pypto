...
class DataDiffAnalyzer:
    ...
    def usage_exit(self, err_info='', err_no=-1):
        if err_info:
    ...
    # calc ideal diff
    def gen_ideal_diff(self, data_a, data_b, dtype=np.float32):
    ...
    def calc_canb_dist_elemwise(self, data_a, data_b):
    ...
    def calc_cosine_dist(self, data_a, data_b):
        if False:
    ...
    def calc_js_dist(self, data_a, data_b):
        import scipy.spatial as sp_spatial
    ...
    def prepare_data(self):
        ...
        if f_a == f_b:
            my_is_same_ab = True
        f_out_fig = f_b + '--sort-diff.' + self.conf_fig_format if self.is_sort else f_b + '--diff.' + self.conf_fig_format
        _f_type = sys.argv[3]
    ...
    def fix_input_and_compute(self, a, b, f_type, sort):
        ...
        g_aa_pos_max_s, g_aa_pos_min_s, g_aa_pos_avg_s, g_aa_pos_max_avg_s, g_aa_pos_min_avg_s = self.gen_max_min_avg(g_aa, mode='pos4')
        g_aa_neg_max_s, g_aa_neg_min_s, g_aa_neg_avg_s, g_aa_neg_max_avg_s, g_aa_neg_min_avg_s = self.gen_max_min_avg(g_aa, mode='neg4')
        ...
        g_bb_pos_max_s, g_bb_pos_min_s, g_bb_pos_avg_s, g_bb_pos_max_avg_s, g_bb_pos_min_avg_s = self.gen_max_min_avg(g_bb, mode='pos4')
        g_bb_neg_max_s, g_bb_neg_min_s, g_bb_neg_avg_s, g_bb_neg_max_avg_s, g_bb_neg_min_avg_s = self.gen_max_min_avg(g_bb, mode='neg4')
        ...
        if self.is_calc_inc:
            ...
            g_diff_inc_pos_max_s, g_diff_inc_pos_min_s, g_diff_inc_pos_avg_s = self.gen_max_min_avg(g_diff_inc, mode='pos')
            g_diff_inc_neg_max_s, g_diff_inc_neg_min_s, g_diff_inc_neg_avg_s = self.gen_max_min_avg(g_diff_inc, mode='neg')
