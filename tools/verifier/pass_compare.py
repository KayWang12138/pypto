...
class PassComparator:
    ...
    def add_comparison_record(self, 
        ...
        if diff_conf is not None:
            recored["AB>fail_cnt/warn_cnt/tol_cnt"] = f"{diff_conf[4]}/{diff_conf[3]}/{diff_conf[2]}"
            recored["AB>total_cnt/zero_cnt/infnan_cnt"] = f"{diff_conf[0]}/{diff_conf[1]}/{diff_conf[5]}"
