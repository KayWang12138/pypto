...
message(STATUS "TraCR: ENABLE_FEATURE_PYTHON_FRONT_END: ${ENABLE_FEATURE_PYTHON_FRONT_END}")

if(ENABLE_FEATURE_PYTHON_FRONT_END)
    set(REAL_SOURCE_DIR "$ENV{PROJECT_SOURCE_DIR_OVERRIDE}/build/output/bin/")
else()
    set(REAL_SOURCE_DIR "${CMAKE_CURRENT_BINARY_DIR}/output/bin/")
endif()

message(STATUS "TraCR: REAL_SOURCE_DIR: ${REAL_SOURCE_DIR}")

# Paraver format configuration file
configure_file(
    ${CMAKE_CURRENT_LIST_DIR}/paraver/state.cfg
    ${REAL_SOURCE_DIR}/state.cfg
    COPYONLY
)
...
if(ENABLE_FEATURE_PYTHON_FRONT_END)
    set_target_properties(tracr_process PROPERTIES
        RUNTIME_OUTPUT_DIRECTORY "${REAL_SOURCE_DIR}"
    )
endif()