...
# -----------------------------------------------------------------------------------------------------------
"""Static dependency completeness.

Every dependency edge declared at compile time must still be observed at
runtime. A violation here means a producer/consumer ordering written by the
operator author has been silently dropped.
"""
