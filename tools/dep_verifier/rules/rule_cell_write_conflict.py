...
# -----------------------------------------------------------------------------------------------------------
"""Concurrent write overlap detection (rule 4-alpha).

If multiple kernel instances write to the same memory region of a tensor
without a fully-determined order between them, later writes may overwrite
earlier ones in unpredictable ways. This rule reports such regions.
"""
