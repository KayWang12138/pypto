...
#NCLUDING BUT NOT LIMITED TO NON-INFRINGEMENT, MERCHANTABILITY, OR FITNESS FOR A PARTICULAR PURPOSE.
...
from perf_analyzer_script import analyze_perf
...
def check_json(json_config):
    ...
    if duplicates:
        raise NameError(f"Parameters {dups} are not unique in your json config")
