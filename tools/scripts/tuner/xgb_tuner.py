...
error_performance = 1000000 #performance time if test crashes
...
def main():
    ...
    print(f"Best result: {result.fun:.2f} us")
    print("Parameter values: ", vec_to_run_values(result.x, original_run_values))
