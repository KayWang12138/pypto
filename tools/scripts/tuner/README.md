...
Example of insertion, script modificates your file. After tune finish, your file will be returned to initial state:
...
1. Tuning nbuffer or L1 reuse

```
"files": [
    {
        "framework/src/operator/models/deepseek/attention.cpp": [
            {
                "line": 235,
                "string": "config::SetPassOption(CUBE_NBUFFER_SETTING, std::map<int64_t, int64_t>{nbuffer});",
                "nbuffer": [
                    "{{1, 1}}",
                    "{{1, 3}}"
                ]
...
2. Tuninig parameters in many files. 

In this example tool set tileShape = {128, 1, 1, 128} in attention.cpp file, then
set TileShape::Current().SetCubeTile({ 32, 32 }, { 256, 256 }, { 128, 128 }); in dynamic_mla.cpp and
after that run your test with these modification. 
...
"files": [
    ...
    {
        "framework/src/operator/models/deepseek/dynamic_mla.cpp": [
            {
                "line": 69,
                "string": "TileShape::Current().SetCubeTile({{ {mm1[0]}, {mm1[1]} }}, {{ {mm1[2]}, {mm1[3]} }}, {{ {mm1[4]}, {mm1[5]} }});",
                "mm1": [
                    [32, 32, 256, 256, 128, 128],
                    [32, 32, 512, 512, 128, 128],
                    [32, 32, 256, 256, 64, 64]
                ]
            }
        ]
