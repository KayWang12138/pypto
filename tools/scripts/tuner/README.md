...
2. In your code find line where you call operation matmul, or any operation/(variable) which requires tiles 
...
30  res = pypto.matmul(matrix_a, matrix_b, datatype)
31  ....
```
...
4. Run the tuner.py script. Script will insert all your tiles one by one in source code and for every tile run your kernel and save performance:
