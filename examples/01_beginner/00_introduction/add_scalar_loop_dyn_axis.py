...
@pypto.jit
def add_scalar_loop_dynamic_axis_kernel_npu(input0: pypto.Tensor, input1: pypto.Tensor, output: pypto.Tensor, val: int) -> None:
...
def add_scalar_loop_dynamic_axis_kernel_sim(input0: pypto.Tensor, input1: pypto.Tensor, output: pypto.Tensor, val: int) -> None:
    tensor_shape = input0.shape
    pypto.set_vec_tile_shapes(1, 4, 1, 64)
