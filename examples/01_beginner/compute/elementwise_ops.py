...
def create_add_broadcast_op_kernel(a_shape: tuple, b_shape: tuple, run_mode: str = "npu", dynamic: bool = False) -> torch.Tensor:
    if dynamic:
...
def create_clip_op_kernel(a_shape: tuple, min_shape: tuple, max_shape: tuple, run_mode: str = "npu", dynamic: bool = False) -> torch.Tensor:
    if dynamic:
        M = pypto.frontend.dynamic("M")
        N = a_shape[1]
...
def create_clip_broadcast_op_kernel(a_shape: tuple, min_shape: tuple, max_shape: tuple, run_mode: str = "npu", dynamic: bool = False) -> torch.Tensor:
    if dynamic:
        M = pypto.frontend.dynamic("M")
        N = a_shape[1]
...
def create_div_broadcast_op_kernel(a_shape: tuple, b_shape: tuple, run_mode: str = "npu", dynamic: bool = False) -> torch.Tensor:
    if dynamic:
        M = pypto.frontend.dynamic("M")
        N = a_shape[1]
        b_shape = pypto.frontend.dynamic("b_shape")
