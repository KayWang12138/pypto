...
@pypto.jit
def scaled_dot_product_attention_dynamic(q, k, v, out, params, config: AttentionConfig):
...
@pypto.jit
def attention_with_projection(hidden_states, q_weight, k_weight, v_weight, out_weight, out, config: AttentionConfig):
