...
def select_experts_kernel(shapes, renormalize_flag, topk_group, num_expert_group):
    ...
    def kernel(
        logits_input: pypto.tensor(router_logits_shape, pypto.DT_FP32),
        ...
        ids_k = pypto.tensor(topk_ids_shape, pypto.DT_INT32)
...
def test_select_experts():
    ...
    for i in range(0, 2):
        ...
        with torch.npu.graph(g):
            ...
            topk_weights, topk_ids = select_experts_kernel(shapes, renormalize, topk_group, num_expert_group)(router_logits, e_score_bias)
        g.replay()
