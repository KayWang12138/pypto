...
def test_attention():
    ...
    attention_output, q_r, k_r, v_g, residual_g, *_ = attn_golden.attention_golden(
        hidden_states=hidden_states,
        residual=residual,
        input_layernorm_weight=input_layernorm_weight,
        input_layernorm_bias=input_layernorm_bias,
...
if __name__ == "__main__":
    torch._logging.set_logs(graph_code=True, recompiles=True, guards=True)
    test_attention()
