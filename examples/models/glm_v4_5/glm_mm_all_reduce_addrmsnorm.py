    ...
    for bs_idx in pypto.loop(bs_loop, name="LOOP_MM_ALLREDUCE_ADDRMSNORM", idx_name="bs_idx"):
        ...
        for ar_idx in pypto.loop(1, name="LOOP_MM_AR_ARMS_L0", idx_name="ar_idx"):
            ...
            for dyn_idx in range(WORLD_SIZE):
                ...
                dummy = pypto.shmem_put(matmul_result, shmem_data_tile, matmul_result, pypto.Atomic.ADD)
                pypto.shmem_signal(dummy, shmem_signal_tile, pypto.Atomic.ADD)
            ...
            x_tile = pypto.shmem_get_gm2ub(local_dummy, local_data_tile, input_dtype, pypto.Atomic.SET)
