...
def _get_common_tile_config(nq):
    cube_tile = 128
    m_tile = 128
    s2_tile = 512  # 修改为128，与block_size一致，避免读取无效数据
...
def pfa_func(q_shape, kv_shape, block_table_shape):
    ...
    def pfa_func_kernel(
        ...
        nkv = shape_k[2]
        dn = shape_k[3]
        b_scalar = query_act_seqs.shape[0]
