...
def add_scalar(input_data0, input_data1, output_data, val):
...
def test_add_scalar(device_id=-1):
    if (device_id == -1):
    ...
    add_scalar(input_data0, input_data1, output_data, val)
