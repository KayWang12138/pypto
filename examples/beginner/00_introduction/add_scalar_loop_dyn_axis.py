...
def add_scalar_loop_dynamic_axis(input_data0, input_data1, output_data, val, dynamic_axis=False):
...
def test_add_scalar_loop_dynamic_axis(device_id=-1):
    if (device_id == -1):
    ...
    add_scalar_loop_dynamic_axis(input_data0, input_data1, output_data, val, True)
...
if __name__ == "__main__":
    device_id = 5
    test_add_scalar_loop_dynamic_axis(device_id)
