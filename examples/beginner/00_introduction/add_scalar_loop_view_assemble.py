...
def add_scalar_loop_view_assemble(input_data0, input_data1, output_data):
...
def test_add_scalar_loop_view_assemble(device_id=-1):
    if (device_id == -1):
    ...
    add_scalar_loop_view_assemble(input_data0, input_data1, output_data)
...
if __name__ == "__main__":
    device_id = 5
    test_add_scalar_loop_view_assemble(device_id)
