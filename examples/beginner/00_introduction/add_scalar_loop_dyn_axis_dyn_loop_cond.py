...
def add_scalar_loop_dynamic_axis_dynamic_loop_cond(input_data0, input_data1, output_data, val=0, dynamic_axis=False):
...
def test_add_add_scalar_loop_dynamic_axis_dynamic_loop_cond(device_id=-1):
    if (device_id == -1):
    ...
    add_scalar_loop_dynamic_axis_dynamic_loop_cond(input_data0, input_data1, output_data, val, True)
...
if __name__ == "__main__":
    device_id = 5
    test_add_add_scalar_loop_dynamic_axis_dynamic_loop_cond(device_id)
