...
def select_experts_pto(router_logits: torch.Tensor,
    ...
    topk_weights = torch.zeros((bs, top_k), dtype=router_logits.dtype, device=device_info)
    ...
    graph_select_experts_glm(inputs, outputs, renormalize, topk_group, num_expert_group, row_ids_flag)
