...
@pypto.jit
def silu_activation_kernel(x: pypto.tensor, y: pypto.tensor) -> None:
    """
...
def silu_activation(x: torch.Tensor, dynamic: bool = True) -> torch.Tensor:
    ...
    # launch the kernel
    silu_activation_kernel(x_pto, y_pto)

    return y


def test_silu(device_id = None, dynamic: bool = False) -> None:
    ...
    # Execute
    out_torch = silu_activation(x_torch, dynamic)
...
@pypto.jit
def gelu_activation_kernel(x: pypto.tensor, y: pypto.tensor) -> None:
    """
...
def gelu_activation(x: torch.Tensor, dynamic: bool = True) -> torch.Tensor:
    y = torch.empty_like(x)
    ...
    # launch the kernel
    gelu_activation_kernel(x_pto, y_pto)

    return y


def test_gelu(device_id = None, dynamic: bool = False) -> None:
    ...
    # Execute
    out_torch = gelu_activation(x_torch, dynamic)
...
@pypto.jit
def swiglu_activation_kernel(gate: pypto.tensor, up: pypto.tensor, y: pypto.tensor) -> None:
    """
...
def swiglu_activation(gate: pypto.tensor, up: pypto.tensor, dynamic: bool = True) -> torch.Tensor:
    ...
    # launch the kernel
    swiglu_activation_kernel(gate_pto, up_pto, y_pto)

    return y


def test_swiglu(device_id = None, dynamic: bool = False) -> None:
    ...
    # Execute
    out_torch = swiglu_activation(gate_torch, up_torch, dynamic)
...
@pypto.jit
def geglu_activation_kernel(gate: pypto.tensor, up: pypto.tensor, y: pypto.tensor) -> None:
    """
...
def geglu_activation(gate: pypto.tensor, up: pypto.tensor, dynamic: bool = True) -> torch.Tensor:
    y = torch.empty_like(gate)
    ...
    # launch the kernel
    geglu_activation_kernel(gate_pto, up_pto, y_pto)

    return y


def test_geglu(device_id = None, dynamic: bool = False) -> None:
    ...
    # Execute
    out_torch = geglu_activation(gate_torch, up_torch, dynamic)
