...
def add_kernel(
    ...
    """
    Example demonstrating dynamic conditional branching in loops.

    This function adds two tensors and conditionally adds an extra value
    to the first two batch elements based on a runtime condition.
    """
...
def test_add_scalar_loop_dynamic_axis_dynamic_cond():
    shape = (32, W, N, C)
