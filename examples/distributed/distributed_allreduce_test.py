...
def run_all_reduce_test(rank, world_size):
    ...
    def all_reduce_kernel_v1(input_tensor: pypto.Tensor, output_tensor: pypto.Tensor,
    ...
    @pypto.jit(distributed_options=distributed_options)
    def all_reduce_kernel_v2(input_tensor: pypto.Tensor, output_tensor: pypto.Tensor,
                             group_name: str, world_size: int) -> None:
        h, w = input_tensor.shape
        tileNum1 = 1
        tileNum2 = 1
    ...
    @pypto.jit(distributed_options=distributed_options)
    def all_reduce_kernel_v3(input_tensor: pypto.Tensor, output_tensor: pypto.Tensor,
                             group_name: str, world_size: int) -> None:
        h, w = input_tensor.shape
        tileNum1 = 1
        tileNum2 = 1
    ...
    @pypto.jit(distributed_options=distributed_options)
    def all_reduce_kernel_two_shot(input_tensor: pypto.Tensor, output_tensor: pypto.Tensor,
                                   group_name: str, world_size: int) -> None:
        h, w = input_tensor.shape
        tileNum1 = 1
        tileNum2 = 1
    ...
    @pypto.jit(distributed_options=distributed_options)
    def all_reduce_kernel_one_shot(input_tensor: pypto.Tensor, output_tensor: pypto.Tensor,
                                   group_name: str, world_size: int) -> None:
        h, w = input_tensor.shape
        tileNum1 = 1
        tileNum2 = 1
