...
OP_TYPE="${OP_TYPE:-AttentionPyptoCustomOp}"
KERNEL_BUILD="${KERNEL_BUILD:-/tmp/pypto_session/build_op_kernel_lib_attention}"
PROBE_BUILD="${PROBE_BUILD:-/tmp/pypto_session/op_probe_attention_cpp}"
