...
OP_TYPE="${OP_TYPE:-DualPyptoCustomOp}"
KERNEL_BUILD="${KERNEL_BUILD:-/tmp/pypto_session/build_op_kernel_lib_dual_output}"
PROBE_BUILD="${PROBE_BUILD:-/tmp/pypto_session/op_probe_dual_output_cpp}"
