...
OP_TYPE="${OP_TYPE:-SoftmaxPyptoCustomOp}"
KERNEL_BUILD="${KERNEL_BUILD:-/tmp/pypto_session/build_op_kernel_lib_combined_softmax}"
PROBE_BUILD="${PROBE_BUILD:-/tmp/pypto_session/op_probe_combined_softmax_cpp}"
