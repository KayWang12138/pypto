...
tile_fwk_rt_path=$5
export TILE_FWK_RUNTIME_PATH=$tile_fwk_rt_path
echo "tile_fwk_rt_path is $tile_fwk_rt_path"
...
{
    bin_param_file=$1
    opc $adapter_py_file --main_func=ascendcpp_compile_op --input_param=$bin_param_file --soc_version=$soc_version \
