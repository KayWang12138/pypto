# Skill Review Report: pypto-pass-module-analyzer

**Review Date**: 2026-03-11
**Skill Path**: `.agents/skills/pypto-pass/pypto-pass-module-analyzer/`
...
{
  "name": "pypto-pass-module-analyzer",
  "description": "PyPTO Pass 模块代码分析技能。用于分析 PyPTO pass 的代码，并结合输入文档中的相应内容，生成Pass模块分析文档。帮助开发者理解各个模块的接口、功能与特殊场景。"
}
---
```
...
pypto-pass-module-analyzer 是一个结构良好的 skill，唯一问题是 S0 级的 frontmatter 格式。
