# Skill Review Report: pypto-operator-perf-analyzer

**Review Date**: 2026-03-11
**Skill Path**: `.agents/skills/pypto-operator-perf-analyzer/`
...
{
  "name": "pypto-operator-perf-analyzer",
  "description": "PyPTO 性能分析技能 - 解析泳道图(merged_swimlane.json)和计算图JSON，识别性能瓶颈，提供优化建议。"
}
---
```
...
pypto-operator-perf-analyzer 是一个高质量的 skill，唯一问题是 S0 级的 frontmatter 格式。
