# Skill Review Report: gitcode-mcp-install

**Review Date**: 2026-03-11
**Skill Path**: `.agents/skills/gitcode-mcp-install/`
...
{
  "name": "gitcode-mcp-install",
  "description": "安装和配置 GitCode MCP Server，使 AI 客户端能与 GitCode 平台交互（仓库/分支/Issue/PR 管理）。"
}
---
```
...
gitcode-mcp-install 是一个结构良好的 skill，唯一问题是 S0 级的 frontmatter 格式。
