...
def read_cce_file(cce_path: str) -> Tuple[str, Dict[int, str]]:
...
def get_cce_op(line_code_map: Dict[int, str]) -> Dict[int, str]:
    cce_op = {}
...
def extract_operation_type(cce_op_val: List[str]) -> List[str]:
    cce_op_type = []
