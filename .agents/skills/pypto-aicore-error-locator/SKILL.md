...
**⚠️ 注意：当 2.3 运行验证有 aicore error 时跳过此步骤**
...
**⚠️ 重要提示**：
- **若2.3无aicore error且2.6有 aicore error**: 说明是 machine 调度框架的问题，已找到问题原因，**停止执行后续步骤！**
- **若2.3无aicore error且2.6无 aicore error**: 不适用于该 SKILL，**停止执行后续步骤！**
