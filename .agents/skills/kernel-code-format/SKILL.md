...
- **Mandatory skeleton:** Every deliverable must use `pypto_kernel_template.py` as the starting layout (`skills/lead-orchestrator/references/rules.md` rule 17)
- **No `for...in range` in Layer K** (`pypto_function`): kernel iteration belongs in Layer I using `pypto.loop` (`skills/lead-orchestrator/references/rules.md` rule 18)
