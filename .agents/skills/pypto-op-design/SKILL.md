...
│     - 复杂度：简单（≤5 步）/ 中等（5-15 步）/ 复杂（>15 步或分块）│
│     - Loop 判断：按 references/quick_ref.md §2.1 判据表逐条检查 │
│     - 动态 shape：检查 spec.md §7 是否声明动态轴                │
└─────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌─────────────────────────────────────────────────────────────────┐
...
│ 阶段 6：输出文件                                                │
├─────────────────────────────────────────────────────────────────┤
│  自检通过后输出：design.md，路径由调用者决定                    │
│  如回修后仍有关键未决项，再向用户确认缺口                       │
