...
**修正**：用 `-w` 参数指定工作目录
```bash
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py -w /path/to/operator -v
```
...
```bash
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py \
    --rtol 0.0078125 \
    --atol 0.001 \
    -v
```
...
```bash
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py -v
```
...
python3 .agents/skills/pypto-precision/scripts/plot_accuracy.py /path/to/operator/operator_verify_result.log
```
...
# 列出所有检查点
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py --list

# 显示详细对比
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py --verbose

# 指定工作目录
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py -w /path/to/operator -v

# 指定 golden 文件所在目录（推荐）
python3 .agents/skills/pypto-precision/scripts/compare_accuracy.py -w /path/to/operator -g /path/to/operator/golden_data -v
```
