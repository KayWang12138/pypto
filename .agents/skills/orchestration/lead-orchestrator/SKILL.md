...
|-----------|-------|----------------------|
| Planning | 0 | `development/pypto-intent-understand` |
| Algorithm | 1 | `development/pypto-golden-generate` |
| Architecture | 1–2 boundary | `development/pypto-op-design` |
| Design | 2 | `workflow/phase2-phase3-construction` |
| Coding | 3–5 | `development/pypto-op-develop` |
| Verification | 3–5 gates + Phase 6 | `workflow/validation-and-deliverables` |
| Optimization | 6 | `performance/pypto-op-perf-tune` |
...
`skills/workflow/plan-template/plan.template.md`.
...
1. Do not hand debug sub-skills directly to the Coding Agent — route through
   Verification.
2. Do not load `performance/tune-*` skills before GATE 4.
