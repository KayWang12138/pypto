...
- Kernel code format and per-file invariants: `.agents/skills/pypto-op-develop/SKILL.md`
- Pipe-class conventions (vector vs cube vs mixed): `skills/pypto-op-design/references/quick_ref.md`
- Numerical stability reformulation patterns: `skills/pypto-op-design/references/numerical-stability-patterns.md`
