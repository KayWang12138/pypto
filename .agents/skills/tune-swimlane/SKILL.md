...
## Optimization Suggestion Library and FAQ

Read `references/swimlane-examples.md` for:
- Performance optimization suggestion library (common patterns)
- Tuning workflow templates
