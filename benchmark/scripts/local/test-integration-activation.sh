...
#
# 用法:
#   bash benchmark/scripts/local/test-integration-activation.sh
#   FULL=0 bash benchmark/scripts/local/test-integration-activation.sh
#   BENCHMARK_LOG_DIR=/tmp/bench_activation bash benchmark/scripts/local/test-integration-activation.sh
