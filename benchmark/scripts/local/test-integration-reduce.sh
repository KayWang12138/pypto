...
#
# 用法:
#   bash benchmark/scripts/local/test-integration-reduce.sh
#   FULL=0 bash benchmark/scripts/local/test-integration-reduce.sh
#   BENCHMARK_LOG_DIR=/tmp/bench_reduce bash benchmark/scripts/local/test-integration-reduce.sh
