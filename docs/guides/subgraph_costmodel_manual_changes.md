...
| # | 文件 | 改动类型 | 行数 |
|---|------|----------|------|
| 1 | `framework/.../backend.h` | 新增 3 行声明 | +3 |
| 2 | `framework/.../backend.cpp` | 新增 include + 2 个方法 | +139 |
| 3 | `framework/.../cost_model_launcher.h` | 新增 3 个方法 | +89 |
| 4 | `python/src/bindings/cost_model.cpp` | 新增函数 + 修复 + 注册 | +28 |
| 5 | `python/pypto/cost_model.py` | 新增函数 + 导出 | +33 |
| 6 | `framework/.../ModelTop.h` + `ModelTop.cpp` | pipeline_summary.csv（可选） | +43 |
