...
DEV_ERROR(SchedErr::TAIL_TASK_WAIT_TIMEOUT, "hand shake timeout.");
```

效果
[ERROR] AICPU(xxx,aicpu_scheduler):xxx [aicore_manager.h:344]xxx RunManager "ErrCode: F70004! hand shake timeout."
