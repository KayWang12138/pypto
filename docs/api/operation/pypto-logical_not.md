...
4. 由于存在临时内存使用，当输入数据类型为DT_FP32，TileShape大小有额外约束，假设TileShape为[a,b,c,d]，那么a*b*c*d*sizeof(self) + a*b*c*d*sizeof(BOOL) + 20.25KB<UB。其他输入数据类型应该满足，a*b*c*d*sizeof(self) + a*b*c*d*sizeof(BOOL) + 12.54KB<UB。
