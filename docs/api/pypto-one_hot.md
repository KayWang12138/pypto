# pypto.one\_hot<a name="ZH-CN_TOPIC_0000002516953389"></a>
...
将整数张量转换为对应的 one-hot 编码，其中每个整数被转换为一个向量，只有对应位置为1，其余为0。
...
<p id="p1872462420360"><a name="p1872462420360"></a><a name="p1872462420360"></a>支持的数据类型为：DT_INT8、DT_INT16、DT_INT32、DT_INT64。</p>
<p id="p935616261332"><a name="p935616261332"></a><a name="p935616261332"></a>支持维度1-3维</p>
<p id="p8800649173112"><a name="p8800649173112"></a><a name="p8800649173112"></a>内部元素需为非负数。</p>
<p id="p517314131419"><a name="p517314131419"></a><a name="p517314131419"></a>不支持空Tensor，且Shape Size不大于2147483647（即INT32_MAX）。</p>
</td>
</tr>
<tr id="row35518476279"><td class="cellrowborder" valign="top" width="17.29%" headers="mcps1.1.4.1.1 "><p id="p45512479274"><a name="p45512479274"></a><a name="p45512479274"></a>num_classes</p>
</td>
<td class="cellrowborder" valign="top" width="9.84%" headers="mcps1.1.4.1.2 "><p id="p4551144714275"><a name="p4551144714275"></a><a name="p4551144714275"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="72.87%" headers="mcps1.1.4.1.3 "><p id="p8551134712270"><a name="p8551134712270"></a><a name="p8551134712270"></a>one-hot编码长度。</p>
<p id="p10110132513302"><a name="p10110132513302"></a><a name="p10110132513302"></a>需大于input中最大元素。</p>
</td>
</tr>
</tbody>
</table>
...
返回一个形状为\(input, num\_classes\)、数据类型为DT\_INT64的Tensor。

## 约束说明<a name="section19363131416381"></a>

outputshape、viewshape 和 tileshape 的尾轴需与 num\_classes 一致。
