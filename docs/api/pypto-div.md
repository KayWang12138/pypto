# pypto.div<a name="ZH-CN_TOPIC_0000002470438114"></a>
...
![](figures/zh-cn_formulaimage_0000002473115074.png)

## 函数原型<a name="section8786125214915"></a>

```
div(input: Tensor,other: Union[Tensor, int, float]) -> Tensor
```
...
<tr id="row149451451161117"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p136651821163"><a name="p136651821163"></a><a name="p136651821163"></a>other</p>
</td>
