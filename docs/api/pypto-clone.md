# pypto.clone<a name="ZH-CN_TOPIC_0000002516833399"></a>
...
<td class="cellrowborder" valign="top" width="72.87%" headers="mcps1.1.4.1.3 "><p id="p143831254134218"><a name="p143831254134218"></a><a name="p143831254134218"></a>源操作数。</p>
<p id="p14383054104219"><a name="p14383054104219"></a><a name="p14383054104219"></a>支持的数据类型为：PyPTO支持的数据类型</p>
