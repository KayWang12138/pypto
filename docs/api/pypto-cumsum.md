# pypto.cumsum<a name="ZH-CN_TOPIC_0000002498245040"></a>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p12845598191"><a name="p12845598191"></a><a name="p12845598191"></a>Tensor类型，源操作数；</p>
<p id="p16444423204"><a name="p16444423204"></a><a name="p16444423204"></a>支持的数据类型为：DT_FP32，DT_INT16，DT_INT32，形状支持1-4维。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.4.1.2 "><p id="p712641982210"><a name="p712641982210"></a><a name="p712641982210"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p2043517376157"><a name="p2043517376157"></a><a name="p2043517376157"></a>源操作数；int 类型</p>
<p id="p11261919202218"><a name="p11261919202218"></a><a name="p11261919202218"></a>指定累加维度。</p>
</td>
</tr>
</tbody>
</table>
...
输出Tensor形状、类型与输入input一致。

## 约束说明<a name="section753174210543"></a>

1. dim：指定计算累积和的维度，必须在张量的有效维度范围内，其值需满足 -input.dim <= dim < input.dim，对应轴不切分。
