# pypto.sum<a name="ZH-CN_TOPIC_0000002471104337"></a>
...
**图 1**  sum按第一个维度计算示例<a name="fig1757220381044"></a>  
![](figures/sum按第一个维度计算示例.png "sum按第一个维度计算示例")

**图 2**  sum按最后一个维度计算示例<a name="fig7643113101220"></a>  
...
<tr id="row203041547112814"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p17589840111120"><a name="p17589840111120"></a><a name="p17589840111120"></a>keepdim</p>
</td>
