# pypto.cond<a name="ZH-CN_TOPIC_0000002470278106"></a>
...
<tbody><tr id="row42461942101815"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p1817713411812"><a name="p1817713411812"></a><a name="p1817713411812"></a>scalar</p>
</td>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p1891715019415"><a name="p1891715019415"></a><a name="p1891715019415"></a>条件表达式，可以是整数或SymbolicScalar（符号标量），用于判断条件是否为真</p>
</td>
</tr>
</tbody>
</table>
