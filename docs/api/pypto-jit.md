...
| codegen_options   | 输入      | 类型为dict[str, any]，用于设置codegen配置项，配置项参数见[参数说明](pypto-set_codegen_options.md#section27141942204919) |
| host_options      | 输入      | 类型为dict[str, any]，用于设置host配置项，配置项参数见[参数说明](pypto-set_host_options.md#section27141942204919) |
| pass_options      | 输入      | 类型为dict[str, any]，用于设置Pass配置项，配置项参数见[参数说明](pypto-set_pass_options.md#section644919345515) |
| runtime_options   | 输入      | 类型为dict[str, any]，用于设置runtime配置项，配置项参数见[参数说明](pypto-set_runtime_options.md#section27141942204919) |
