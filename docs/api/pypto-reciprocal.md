# pypto.reciprocal<a name="ZH-CN_TOPIC_0000002530289607"></a>
...
计算输入Tensor中每个元素的倒数，逐元素运算，返回与输入形状相同的Tensor。
...
<td class="cellrowborder" valign="top" width="72.87%" headers="mcps1.1.4.1.3 "><p id="p142211842102"><a name="p142211842102"></a><a name="p142211842102"></a>源操作数。</p>
<p id="p18621176171013"><a name="p18621176171013"></a><a name="p18621176171013"></a>支持的数据类型为：DT_FP32，</p>
<p id="p19417719618"><a name="p19417719618"></a><a name="p19417719618"></a>不支持空Tensor，且Shape仅支持2-4维，且Shape Size不大于2147483647（即INT32_MAX）。</p>
</td>
</tr>
</tbody>
</table>
...
返回一个与输入形状相同、数据类型一致的Tensor，其元素为输入张量对应元素的倒数。
