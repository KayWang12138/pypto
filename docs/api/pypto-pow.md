# pypto.pow<a name="ZH-CN_TOPIC_0000002498353570"></a>
...
计算输入 Tensor 中每个元素的 other 次幂，逐元素运算，返回与输入形状相同的Tensor。
...
<p id="p1872462420360"><a name="p1872462420360"></a><a name="p1872462420360"></a>支持的数据类型为：DT_FP16、DT_FP32。</p>
<p id="p935616261332"><a name="p935616261332"></a><a name="p935616261332"></a>支持维度2-4维</p>
<p id="p517314131419"><a name="p517314131419"></a><a name="p517314131419"></a>不支持空Tensor，且Shape Size不大于2147483647（即INT32_MAX）。</p>
</td>
</tr>
<tr id="row35518476279"><td class="cellrowborder" valign="top" width="17.29%" headers="mcps1.1.4.1.1 "><p id="p45512479274"><a name="p45512479274"></a><a name="p45512479274"></a>other</p>
</td>
...
<td class="cellrowborder" valign="top" width="72.87%" headers="mcps1.1.4.1.3 "><p id="p8551134712270"><a name="p8551134712270"></a><a name="p8551134712270"></a>指数。</p>
<p id="p10110132513302"><a name="p10110132513302"></a><a name="p10110132513302"></a>支持的类型为int或float。</p>
</td>
</tr>
</tbody>
</table>
...
返回一个与输入形状相同、数据类型一致的Tensor，其元素为输入张量对应元素的other次幂。
