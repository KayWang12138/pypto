# TileOpFormat<a name="ZH-CN_TOPIC_0000002473494864"></a>
...
## 功能说明<a name="section3513545668"></a>

TileOpFormat 定义了Tensor的瓦片操作格式，用于优化不同计算模式下的内存访问和计算效率。主要区分密集计算和稀疏计算的瓦片格式。

## 原型定义<a name="section19898234716"></a>
