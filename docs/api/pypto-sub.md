# pypto.sub<a name="ZH-CN_TOPIC_0000002471104333"></a>
...
逐元素从 input 中减去 按 alpha 进行缩放的 other 值。计算公式如下：

![](figures/zh-cn_formulaimage_0000002504338965.png)
...
<td class="cellrowborder" valign="top" width="71.41999999999999%" headers="mcps1.1.4.1.3 "><p id="p6328717191013"><a name="p6328717191013"></a><a name="p6328717191013"></a>源操作数。</p>
...
<tr id="row79591846343"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p136651821163"><a name="p136651821163"></a><a name="p136651821163"></a>other</p>
</td>
<td class="cellrowborder" valign="top" width="10.040000000000001%" headers="mcps1.1.4.1.2 "><p id="p4665102116613"><a name="p4665102116613"></a><a name="p4665102116613"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.41999999999999%" headers="mcps1.1.4.1.3 "><p id="p1870217211112"><a name="p1870217211112"></a><a name="p1870217211112"></a>源操作数。</p>
<p id="p6578181114"><a name="p6578181114"></a><a name="p6578181114"></a>支持 Tensor 与 数字。</p>
...
<td class="cellrowborder" valign="top" width="10.040000000000001%" headers="mcps1.1.4.1.2 "><p id="p35899291346"><a name="p35899291346"></a><a name="p35899291346"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.41999999999999%" headers="mcps1.1.4.1.3 "><p id="p1458942911410"><a name="p1458942911410"></a><a name="p1458942911410"></a>other输入的缩放因子，默认值为1.0。</p>
</td>
</tr>
</tbody>
</table>
