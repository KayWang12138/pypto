# pypto.ne<a name="ZH-CN_TOPIC_0000002530117275"></a>
...
<tbody><tr id="row42461942101815"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p57634810538"><a name="p57634810538"></a><a name="p57634810538"></a>input、other</p>
</td>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p142211842102"><a name="p142211842102"></a><a name="p142211842102"></a>源操作数。</p>
<p id="p18621176171013"><a name="p18621176171013"></a><a name="p18621176171013"></a>支持的数据类型为：DT_FP16, DT_FP32，且两个源操作数的数据类型必须保持一致。</p>
<p id="p19417719618"><a name="p19417719618"></a><a name="p19417719618"></a>不支持空Tensor，且Shape仅支持2-4维。两者形状需要相同，不支持广播，且Shape Size不大于2147483647（即INT32_MAX）。</p>
</td>
</tr>
</tbody>
</table>
...
返回一个布尔张量，当 input 不等于 other 的值为 True，其余值为 False。返回的布尔张量与输入张量形状相同。
