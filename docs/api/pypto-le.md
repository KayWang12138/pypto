# pypto.le<a name="ZH-CN_TOPIC_0000002498517304"></a>
...
<p id="p18621176171013"><a name="p18621176171013"></a><a name="p18621176171013"></a>支持的数据类型为：DT_FP16, DT_FP32，且两个源操作数的数据类型应保持一致。</p>
...
返回一个布尔张量，当input的值小于等于other时返回True，否则返回False。输出张量与输入张量形状相同。
