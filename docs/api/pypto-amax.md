# pypto.amax<a name="ZH-CN_TOPIC_0000002437346100"></a>
...
**图 1**  amax按第一个维度计算示例<a name="fig1757220381044"></a>  
![](figures/amax按第一个维度计算示例.png "amax按第一个维度计算示例")

**图 2**  amax按最后一个维度计算示例<a name="fig197381580573"></a>  
...
<td class="cellrowborder" valign="top" width="71.41999999999999%" headers="mcps1.1.4.1.3 "><p id="p652854125310"><a name="p652854125310"></a><a name="p652854125310"></a>源操作数。</p>
...
<td class="cellrowborder" valign="top" width="10.040000000000001%" headers="mcps1.1.4.1.2 "><p id="p13432181975917"><a name="p13432181975917"></a><a name="p13432181975917"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.41999999999999%" headers="mcps1.1.4.1.3 "><p id="p589219055415"><a name="p589219055415"></a><a name="p589219055415"></a>源操作数。</p>
<p id="p10580548171413"><a name="p10580548171413"></a><a name="p10580548171413"></a>支持任意单轴。</p>
</td>
</tr>
<tr id="row858934013117"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p17589840111120"><a name="p17589840111120"></a><a name="p17589840111120"></a>keepdim</p>
</td>
<td class="cellrowborder" valign="top" width="10.040000000000001%" headers="mcps1.1.4.1.2 "><p id="p5589174081118"><a name="p5589174081118"></a><a name="p5589174081118"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.41999999999999%" headers="mcps1.1.4.1.3 "><p id="p175898405116"><a name="p175898405116"></a><a name="p175898405116"></a>源操作数</p>
...
3. tileshape次尾轴要小于255，即 tileshape\[-2\]<=255.
