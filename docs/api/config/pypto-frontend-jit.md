...
| verify_options | 输入 | 类型为 `dict[str, any]`，用于设置验证配置项，配置项参数见[参数说明](./pypto-set_verify_options.md) |
| debug_options | 输入 | 类型为 `dict[str, any]`，用于设置调试配置项，配置项参数见[参数说明](./pypto-set_debug_options.md) |
