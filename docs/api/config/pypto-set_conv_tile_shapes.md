...
| 参数名            | 输入/输出 | 说明                                                                 |
|-------------------|-----------|----------------------------------------------------------------------|
| tileL1Info                      | 输入      | L1上的TileShape（切片形状）的切分大小 |
| tileL0Info                      | 输入      | L0上的TileShape（切片形状）的切分大小 |
...
```python
pypto.set_conv_tile_shapes([128, 128], [128, 128], [128, 128], False, True)
```
