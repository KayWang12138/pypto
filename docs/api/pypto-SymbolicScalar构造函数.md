# pypto.SymbolicScalar构造函数<a name="ZH-CN_TOPIC_0000002505494931"></a>
...
<tbody><tr id="row7701226183719"><td class="cellrowborder" valign="top" width="15.541554155415543%" headers="mcps1.1.4.1.1 "><p id="p1701172673715"><a name="p1701172673715"></a><a name="p1701172673715"></a>self</p>
</td>
<td class="cellrowborder" valign="top" width="11.731173117311732%" headers="mcps1.1.4.1.2 "><p id="p370112610376"><a name="p370112610376"></a><a name="p370112610376"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="72.72727272727272%" headers="mcps1.1.4.1.3 "><p id="p6701162633717"><a name="p6701162633717"></a><a name="p6701162633717"></a>实例对象引用，Python自动传递</p>
</td>
</tr>
<tr id="row20701172623718"><td class="cellrowborder" valign="top" width="15.541554155415543%" headers="mcps1.1.4.1.1 "><p id="p4701132610372"><a name="p4701132610372"></a><a name="p4701132610372"></a>arg0</p>
</td>
<td class="cellrowborder" valign="top" width="11.731173117311732%" headers="mcps1.1.4.1.2 "><p id="p157018260378"><a name="p157018260378"></a><a name="p157018260378"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="72.72727272727272%" headers="mcps1.1.4.1.3 "><p id="p16701152610376"><a name="p16701152610376"></a><a name="p16701152610376"></a>符号标量的值或名称，可以是：</p>
<a name="ul6630204918345"></a><a name="ul6630204918345"></a><ul id="ul6630204918345"><li>int：整数值，创建一个常量符号标量</li><li>str：符号名称，创建一个符号标量</li><li>SymbolicScalar：另一个符号标量，用于复制</li></ul>
</td>
</tr>
<tr id="row14388201810339"><td class="cellrowborder" valign="top" width="15.541554155415543%" headers="mcps1.1.4.1.1 "><p id="p1838891843311"><a name="p1838891843311"></a><a name="p1838891843311"></a>arg1</p>
</td>
<td class="cellrowborder" valign="top" width="11.731173117311732%" headers="mcps1.1.4.1.2 "><p id="p1338921803319"><a name="p1338921803319"></a><a name="p1338921803319"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="72.72727272727272%" headers="mcps1.1.4.1.3 "><p id="p83891218173319"><a name="p83891218173319"></a><a name="p83891218173319"></a>符号标量的值，仅在arg0为字符串时可选择使用</p>
</td>
</tr>
</tbody>
</table>
...
## 约束说明<a name="section14402202213510"></a>
