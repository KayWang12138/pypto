# pypto.mul<a name="ZH-CN_TOPIC_0000002471024489"></a>
...
![](figures/zh-cn_formulaimage_0000002504285713.png)

## 函数原型<a name="section8786125214915"></a>

```
mul(input: Tensor, other: Union[Tensor, int, float]) -> Tensor
```
...
<tr id="row129410292718"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p149592132710"><a name="p149592132710"></a><a name="p149592132710"></a>other</p>
</td>
<td class="cellrowborder" valign="top" width="10.05%" headers="mcps1.1.4.1.2 "><p id="p1519417216281"><a name="p1519417216281"></a><a name="p1519417216281"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p19513215276"><a name="p19513215276"></a><a name="p19513215276"></a>当other为Tensor时：支持的数据类型为：DT_FP32，不支持空Tensor，且Shape仅支持2-4维，并支持按照单个维度广播到相同形状，且Shape Size不大于2147483647（即INT32_MAX）。</p>
