# pypto.function<a name="ZH-CN_TOPIC_0000002470278104"></a>
...
```
function(name: str, *args, **kwargs) -> Iterator[pypto_impl.RecordFunc]
```
...
<tbody><tr id="row42461942101815"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p1817713411812"><a name="p1817713411812"></a><a name="p1817713411812"></a>name</p>
</td>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p17896121192912"><a name="p17896121192912"></a><a name="p17896121192912"></a>函数的名称，用于标识该计算图。</p>
</td>
</tr>
<tr id="row14954102915200"><td class="cellrowborder" valign="top" width="18.54%" headers="mcps1.1.4.1.1 "><p id="p1095410297200"><a name="p1095410297200"></a><a name="p1095410297200"></a>*args</p>
</td>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.1.4.1.3 "><p id="p1579741612915"><a name="p1579741612915"></a><a name="p1579741612915"></a>从中获取传入的Tensor</p>
</td>
</tr>
</tbody>
</table>
