# pypto.minimum<a name="ZH-CN_TOPIC_0000002498507384"></a>
...
<td class="cellrowborder" valign="top" width="72.87%" headers="mcps1.1.4.1.3 "><p id="p652854125310"><a name="p652854125310"></a><a name="p652854125310"></a>源操作数一。</p>
<p id="p94058291712"><a name="p94058291712"></a><a name="p94058291712"></a>支持的类型为 int, float, Element 以及 Tensor 类型，当为 int 或者 float 类型时会自动转换为 Element 类型，其中 int 对应 DT_INT_32，float 对应 DT_FP32。当需要使用其他数据类型时，可以通过 Element 构建。</p>
<p id="p1872462420360"><a name="p1872462420360"></a><a name="p1872462420360"></a>支持的数据类型为：DT_FP32/DT_FP16/DT_INT32/DT_INT16</p>
<p id="p13241214204"><a name="p13241214204"></a><a name="p13241214204"></a>不支持空Tensor，Shape仅支持2-4维，且Shape Size不大于2147483647（即INT32_MAX）。</p>
</td>
</tr>
<tr id="row49032035143315"><td class="cellrowborder" valign="top" width="17.29%" headers="mcps1.1.4.1.1 "><p id="p7903133516337"><a name="p7903133516337"></a><a name="p7903133516337"></a>other</p>
</td>
...
<td class="cellrowborder" valign="top" width="72.87%" headers="mcps1.1.4.1.3 "><p id="p89031135183311"><a name="p89031135183311"></a><a name="p89031135183311"></a>源操作数二。</p>
<p id="p1267119353918"><a name="p1267119353918"></a><a name="p1267119353918"></a>支持的类型为 int, float, Element 以及 Tensor 类型，当为 int 或者 float 类型时会自动转换为 Element 类型，其中 int 对应 DT_INT_32，float 对应 DT_FP32。当需要使用其他数据类型时，可以通过 Element 构建。</p>
<p id="p126717351698"><a name="p126717351698"></a><a name="p126717351698"></a>支持的数据类型为：DT_FP32/DT_FP16/DT_INT32/DT_INT16</p>
<p id="p66711135398"><a name="p66711135398"></a><a name="p66711135398"></a>不支持空Tensor，Shape仅支持2-4维，且Shape Size不大于2147483647（即INT32_MAX）。</p>
<p id="p7921091123"><a name="p7921091123"></a><a name="p7921091123"></a>类型和数据类型必须与源操作数一保持一致。</p>
</td>
</tr>
</tbody>
</table>

源操作数一与源操作数二之间至少一者为张量。

## 返回值说明<a name="section522291184"></a>

当两个源操作数均为张量时，两个张量必须满足广播关系。该接口返回一个与源操作数一和源操作数二广播后形状相同的张量，数据类型与源操作数相同，其元素为源操作数一和源操作数二的逐元素最小值。且源操作数为张量时，源操作数一和源操作数二均仅支持单轴广播。

当两个源操作数之中存在一个张量时，返回与输入张量相同形状的张量，其元素为源操作数一和源操作数二的逐元素最小值。
