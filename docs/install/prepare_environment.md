...
2. **安装CANN ops包**
    ...
    - <a href="https://ascend-repo.obs.cn-east-2.myhuaweicloud.com/CANN/CANN%208.5.T63/Ascend-cann-910b-ops_8.5.0_linux-x86_64.run" target = "_blank" rel="noopener noreferrer nofllow" referrerpolicy="no-referrer">CANN_A2-OPS-8.5.0.x86</a>
