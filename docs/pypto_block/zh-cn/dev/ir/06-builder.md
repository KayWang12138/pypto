...
参见 `python/tests/ut/block/ir/test_builder.py` 和 `python/tests/ut/block/ir/test_flash_attention_builder.py` 获取完整示例。

## 实现细节

### 文件

- `framework/include/block/ir/builder.h` - C++ 头文件
- `framework/src/interface/block/builder.cpp` - C++ 实现
- `python/pypto_block/ir/builder.py` - Python 封装
