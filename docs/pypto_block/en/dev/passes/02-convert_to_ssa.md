...
**Header**: `framework/include/block/ir/transforms/passes.h`

```cpp
Pass ConvertToSSA();
```

**Implementation**: `framework/src/interface/block/transforms/convert_to_ssa.cpp`
...
**Tests**: `python/tests/ut/block/ir/transforms/test_convert_to_ssa_pass.py`
