...
| -------- | ----- | -------- | ------------- |
| **TensorOp** | TensorType | N-D tensor operations with broadcasting | `framework/src/interface/block/op/tensor_ops/` |
| **BlockOp** | TileType | Hardware-optimized block operations | `framework/src/interface/block/op/block_ops/` |
| **SyncOp** | UnknownType/PipeType | Pipeline barriers and synchronization | `framework/src/interface/block/op/sync_ops/` |
| **PtrOp** | PtrType / TensorType | Pointer arithmetic and tensor-view construction | `framework/src/interface/block/op/ptr_ops.cpp` |
...
```cpp
// framework/src/interface/block/op/tensor_ops/elementwise.cpp
...
```cpp
// framework/src/interface/block/op/tensor_ops/matmul.cpp
...
**Location**: `framework/src/interface/block/op/tensor_ops/`
...
**Location**: `framework/src/interface/block/op/block_ops/`
...
**Location**: `framework/src/interface/block/op/sync_ops/`
...
**C++ Registration (`framework/src/interface/block/op/sync_ops/sync.cpp`):**
...
| -------------- | -------- |
| `framework/src/interface/block/op/type_inference.cpp` | Shared type inference utilities |
...
1. **Choose category file**: `framework/src/interface/block/op/tensor_ops/elementwise.cpp`, `matmul.cpp`, `reduction.cpp`, or `framework/src/interface/block/op/block_ops/memory.cpp`, `unary.cpp`
...
4. **Python wrapper** (`python/pypto_block/ir/op/tensor_ops.py`):
...
5. **Add tests** in `python/tests/ut/block/ir/` and update `CMakeLists.txt` if needed

## References

- Common constants: `framework/include/block/core/common.h`
- Type definitions: `framework/include/block/ir/type.h`
- Operator registry: `framework/include/block/ir/op_registry.h`
- Type inference utilities: `framework/include/block/ir/type_inference.h`
- Type inference implementation: `framework/src/interface/block/op/type_inference.cpp`
- Operator registry implementation: `framework/src/interface/block/op_registry.cpp`
- Tensor operator implementations: `framework/src/interface/block/op/tensor_ops/`
- Block operator implementations: `framework/src/interface/block/op/block_ops/`
- Sync operator implementations: `framework/src/interface/block/op/sync_ops/`
