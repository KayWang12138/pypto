...
See `python/tests/ut/block/ir/test_builder.py` and `python/tests/ut/block/ir/test_flash_attention_builder.py` for comprehensive examples.

## Implementation Details

### Files

- `framework/include/block/ir/builder.h` - C++ header
- `framework/src/interface/block/builder.cpp` - C++ implementation
- `python/pypto_block/ir/builder.py` - Python wrapper
