...
| --------- | ------- | -------- |
| `CCECodegen` | Main orchestrator, extends IRVisitor | `framework/include/block/codegen/cce/cce_codegen.h` |
| `CodeEmitter` | Structured output with indentation | `framework/include/block/codegen/cce/code_emitter.h` |
| `CodeContext` | Variable name mapping and pointer tracking | `framework/include/block/codegen/cce/code_context.h` |
| `TypeConverter` | IR types → pto-isa C++ types | `framework/include/block/codegen/cce/type_converter.h` |
| `ISAMapper` | IR operations → pto-isa instructions | `framework/include/block/codegen/cce/isa_mapper.h` |
...
```python
from pypto_block.pypto_core import codegen
...
**Location:** `python/tests/ut/block/codegen/`
...
```bash
pytest python/tests/ut/block/codegen/          # All tests
pytest python/tests/ut/block/codegen/test_type_converter.py  # Specific file
pytest -v python/tests/ut/block/codegen/       # Verbose
```
...
- Visitor Pattern: `framework/include/block/ir/transform/base/visitor.h`
