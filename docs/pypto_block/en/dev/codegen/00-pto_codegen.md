...
**Header**: `framework/include/block/codegen/pto/pto_codegen.h`
...
```python
from pypto_block.ir import compile, OptimizationStrategy
...
**Module**: `python/pypto_block/ir/pto_codegen.py`
