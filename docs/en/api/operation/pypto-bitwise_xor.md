...
Performs a bitwise XOR operation element-wise on input and other. The formula is:
...
4.  Due to temporary memory usage, TileShape has additional constraints. Assuming TileShape is \[a,b,c,d\], then a\*b\*c\*d\*sizeof\(self\) + a\*b\*c\*d\*sizeof\(other\) + a\*b\*c\*d\*sizeof\(self\) < UB.
