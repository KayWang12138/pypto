...
4. **获取pto-isa源码**
    ...
    > 方法一: 安装CANN pto-isa包
    > 根据实际环境下载对应的安装包, 下载链接如下:
    > - x86: http://container-obsfs-filesystem.obs.cn-north-4.myhuaweicloud.com/package/cann/pto-isa/version_compile/master/202601/20260112/ubuntu_x86/cann-pto-isa_8.5.0_linux-x86_64.run
    > - aarch64: http://container-obsfs-filesystem.obs.cn-north-4.myhuaweicloud.com/package/cann/pto-isa/version_compile/master/202601/20260112/ubuntu_aarch64/cann-pto-isa_8.5.0_linux-aarch64.run
    > ```
    > # 确保安装包有可执行权限
