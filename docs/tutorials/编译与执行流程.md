# 编译与执行流程<a name="ZH-CN_TOPIC_0000002527468213"></a>
...
## 图编译流程<a name="section20242038132417"></a>
...
具体Pass列表请参见代码仓库中的_\{code\_path\}_/framework/src/passes/pass\_mgr/pass\_manager.cpp文件。

**图 1**  计算图编译流程<a name="fig9712193702515"></a>  
...
## 图执行流程<a name="section18840550122414"></a>
...
**图 2**  计算图执行流程<a name="fig242151818494"></a>  
...
**图 3**  执行态运行示意图<a name="fig18488927184915"></a>  
