...
## 矩阵运算<a name="section1284801918434"></a>
...
-   out\_dtype：输出数据类型
-   a\_trans：转置左矩阵（默认：False）
-   b\_trans：转置右矩阵（默认：False）
-   c\_matrix\_nz：以NZ格式输出（默认值：False）
-   extend\_params：扩展特征（偏置、去量化等）。

## 组合操作<a name="section1393421754410"></a>
