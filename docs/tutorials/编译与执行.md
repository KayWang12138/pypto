...
## JIT编译<a name="section164693583143"></a>
...
## 条件编译<a name="section199641777457"></a>
...
## 定义多个JIT函数<a name="section09425493555"></a>
...
完整样例请参考：examples/01\_beginner/00\_introduction/add\_scalar\_multi\_jit.py
