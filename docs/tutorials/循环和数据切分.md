# 循环和数据切分<a name="ZH-CN_TOPIC_0000002495188598"></a>
...
## 基础循环结构<a name="section1159965105115"></a>
...
slicing语法糖的完整样例请参考：examples/b01\_eginner/00\_introduction/add\_scalar\_loop.py

## 使用view/assemble接口处理循环结构<a name="section53513549212"></a>
...
## 数据依赖与循环顺序<a name="section4573340102"></a>
