...
|-------|-------------------|------------|:------------------------:|
| 1. Frontend | `.agents/skills/pypto-op-perf-tune/tune-frontend/SKILL.md` | GATE 4 passed, baseline measured | ✅ |
| 2. Swimlane | `.agents/skills/pypto-op-perf-tune/tune-swimlane/SKILL.md` | Stage 1 exited | ✅ |
| 3. Incore | `.agents/skills/pypto-op-perf-tune/tune-incore/SKILL.md` | Stage 2 exited | ✅ |
...
For every change:
1. Apply change N
2. Hand to Verification Agent → tensor compare + layout check + perf delta
3. Outcome:
