   ...
   <col style="width: 145px">   
    ...
    <tbody>
      <tr>
        ...
        <td>输入</td>
        <td>公式中的输入Q。</td>
         <td>仅支持query的S轴等于1。</td>
        <td>bfloat16</td>
        <td>ND</td>
        <td>[num_tokens, num_head, head_size]</td>
      </tr>
      <tr>
        <td>key</td>
        <td>输入</td>
        ...
        <td>bfloat16</td>
        <td>ND</td>
        <td>[block_nums, kv_head_num, block_size, head_size]</td>
      </tr>
      <tr>
        <td>value</td>
        <td>输入</td>
      ...
      <tr>
        ...
        <td>int</td>
        <td>ND</td>
        <td> [batch_size, max_num_blocks_per_query]</td>
      </tr>
      <tr>
        <td>num_heads</td>
        <td>输入</td>
        ...
        <td>
          <ul>
            <li>num_heads是num_key_value_heads的倍数关系</li>
            <li>当前支持12</li>
          </ul>
        </td>
        <td>int</td>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>用于支持GQA（Grouped-Query Attention，分组查询注意力）场景</li>
            <li>当前支持1</li>
          </ul>
        </td>
        <td>int</td>
        ...
        <td>
          <ul>
            <li>page attention中KV存储每个block中最大的token个数</li>
            <li>当前支持128</li>
          </ul>
        </td>
        <td>-</td>
