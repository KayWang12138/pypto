#!/usr/bin/env python3
"""Test: forward pattern with submit_before_loop=True."""
...
def test_with_submit(
    ...
    for b_idx in pypto.loop(B_val, name="LOOP_B", idx_name="b_idx"):
        for h_idx in pypto.loop(2, name="LOOP_H", idx_name="h_idx"):
            ...
            for i_idx in pypto.loop(NT_val, name="LOOP_C", idx_name="i_idx",
                                    unroll_list=[16, 1], submit_before_loop=True):
                c = NT_val - 1 - i_idx
