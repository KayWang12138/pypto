#!/usr/bin/env python3
"""
PyTPO Performance Tuning Loop for embedding_head_quant operator.
Follows systematic parameter sweep with stop criteria.
"""
import os
import time
import pypto
...
def create_tunable_kernel(shape, vec_tile_x, vec_tile_y, eps=1e-4, min_v=-128.0, max_v=127.0):
...
def benchmark_config(vec_tile_x, vec_tile_y, device_id):
    ...
    kernel = create_tunable_kernel(shape, vec_tile_x, vec_tile_y)
...
def main():
    ...
    print("="*70)
    print("PyPTO Performance Tuning Loop - embedding_head_quant")
    print("="*70)
