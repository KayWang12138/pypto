...
def engram_backward_kernel(
    grad_out: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    hidden_states: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    embeddings: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    ...
    key_lineared: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    value_lineared: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    gate: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    score: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    d_hidden: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    d_embeddings: pypto.Tensor([pypto.DYNAMIC, pypto.DYNAMIC, ...], pypto.DT_FP32),
    ...
    # d_embeddings_tmp = pypto.full(size=[1, 4096, 1, 256], fill_value=0.0, dtype=d_embeddings.dtype)
...
if __name__ == '__main__':
    ...
    test_engram_backward(1, 1024 * 8, 16)