...
INSTANTIATE_TEST_SUITE_P(BlockElementwise, BlockOpsElementwiseTest,
                         ::testing::Values("block.mul", "block.add", "block.div", "block.sub", "block.maximum",
                                           "block.minimum", "block.muls", "block.adds", "block.divs", "block.subs",
                                           "block.cmp", "block.cmps", "block.col_expand", "block.col_expand_mul",
                                           "block.col_expand_div", "block.col_expand_sub", "block.expands"));
...
INSTANTIATE_TEST_SUITE_P(BlockUnary, BlockOpsUnaryTest,
                         ::testing::Values("block.neg", "block.exp", "block.recip", "block.sqrt", "block.rsqrt",
                                           "block.cast", "block.log", "block.abs", "block.relu"));
...
INSTANTIATE_TEST_SUITE_P(BlockReduction, BlockOpsReductionTest,
                         ::testing::Values("block.sum", "block.max", "block.min", "block.row_max", "block.row_sum",
                                           "block.row_min"));
...
INSTANTIATE_TEST_SUITE_P(BlockBroadcast, BlockOpsBroadcastTest,
                         ::testing::Values("block.row_expand_sub", "block.row_expand_div", "block.row_expand_mul",
...
INSTANTIATE_TEST_SUITE_P(BlockMemory, BlockOpsMemoryTest,
                         ::testing::Values("block.get_block_idx", "block.load", "block.store", "block.l0c_store",
                                           "block.move", "block.alloc", "block.zeros"));
...
INSTANTIATE_TEST_SUITE_P(BlockTransform, BlockOpsTransformTest,
                         ::testing::Values("block.view", "block.reshape", "block.transpose"));
...
INSTANTIATE_TEST_SUITE_P(TensorElementwise, TensorOpsElementwiseTest,
                         ::testing::Values("tensor.add", "tensor.add_scalar", "tensor.sub", "tensor.sub_scalar",
                                           "tensor.mul", "tensor.mul_scalar", "tensor.div", "tensor.div_scalar",
                                           "tensor.maximum"));
...
INSTANTIATE_TEST_SUITE_P(TensorMemory, TensorOpsMemoryTest,
                         ::testing::Values("tensor.create", "tensor.view", "tensor.assemble"));
...
TEST(OpCreateTest, CreateTensorCast) {
  ...
  auto a = MakeTensorVar("a", {4, 8}, DataType::FP32);
  std::vector<ExprPtr> args = {a};
  std::vector<std::pair<std::string, std::any>> kwargs = {{"target_type", std::any(DataType::FP16)}};
...
TEST(OpCreateTest, CreateBlockSum) {
  ...
  auto a = MakeTileVar("a", {16, 16}, DataType::FP16);
  std::vector<ExprPtr> args = {a};
  std::vector<std::pair<std::string, std::any>> kwargs = {{"axis", std::any(0)}, {"keepdim", std::any(false)}};
...
TEST(OpCreateTest, CreateBlockCast) {
  ...
  auto a = MakeTileVar("a", {16, 16}, DataType::FP16);
  std::vector<ExprPtr> args = {a};
  std::vector<std::pair<std::string, std::any>> kwargs = {{"target_dtype", std::any(0)}};
...
TEST(OpCreateTest, CreateSyncSrc) {
  ...
  std::vector<std::pair<std::string, std::any>> kwargs = {
      {"set_pipe", std::any(1)}, {"wait_pipe", std::any(2)}, {"event_id", std::any(0)}};
