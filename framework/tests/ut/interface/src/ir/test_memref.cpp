...
TEST(IRMemRefTest, TestMemRefWithDifferentSpaces)
{
    ...
    ASSERT_EQ(ddrRef.memory_space_, MemorySpace::DDR);
    ASSERT_EQ(ubRef.memory_space_, MemorySpace::Vec);
    ASSERT_EQ(l1Ref.memory_space_, MemorySpace::Mat);
    ASSERT_EQ(l0aRef.memory_space_, MemorySpace::Left);
}
...
TEST(IRMemRefTest, TestMemRefWithL0Spaces)
{
    ...
    ASSERT_EQ(l0aRef.memory_space_, MemorySpace::Left);
    ASSERT_EQ(l0bRef.memory_space_, MemorySpace::Right);
    ASSERT_EQ(l0cRef.memory_space_, MemorySpace::Acc);
}
...
TEST(IRMemRefTest, TestMemRefForTileAllocation)
{
    ...
    ASSERT_EQ(memref.memory_space_, MemorySpace::Left);
...
TEST(IRMemRefTest, TestMemRefForBufferAllocation)
{
    ...
    ASSERT_EQ(memref.memory_space_, MemorySpace::Vec);
...
TEST(IRMemRefTest, TestMemRefWithOffsetAddress)
{
    ...
    ASSERT_EQ(memref.memory_space_, MemorySpace::Mat);
