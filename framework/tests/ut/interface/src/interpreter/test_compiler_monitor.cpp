...
TEST_F(CompilerMonitor, CompilerMonitorPassProcessingAndWarning)
{
    MonitorManager::Instance().SetProcessingThresholdSec(2);
    MonitorManager::Instance().Initialize(true, 1, 3, 600);
    MonitorManager::Instance().SetTotalFunctionCount(4);
...
TEST_F(CompilerMonitor, CompilerMonitorNonPassStageProcessing)
{
    MonitorManager::Instance().SetProcessingThresholdSec(2);
...
TEST_F(CompilerMonitor, CompilerMonitorSingleFunctionStageProcessing)
{
    MonitorManager::Instance().SetProcessingThresholdSec(2);
    MonitorManager::Instance().Initialize(true, 1, 3, 600);
...
{
    MonitorManager::Instance().Initialize(true, 2, 0, 0);
    MonitorManager::Instance().SetTotalFunctionCount(2);
    MonitorManager::Instance().SetRootFuncCount(2);
    MonitorManager::Instance().SetCurrentFunctionIndex(1);
