...
void TestMlaPrologV2(std::vector<int> &params, bool isQuant = false, bool hasSmooth = false, int blockSize = 128,
    ...
    PROGRAM("MlaProlog") {
        ...
        if (isQuant) {
            ...
            FUNCTION("MlaPrologUt", {x, wDq, wUqQr, w_qb_scale, smooth_cq, wUk, wDkvKr, gammaCq, gammaCkv, sin, cos,
            ...
            config::SetBuildStatic(true);
            FUNCTION("MlaPrologUt", {x, wDq, wUqQr, wUk, wDkvKr, gammaCq, gammaCkv, sin, cos, kv_len, kv_cache,
