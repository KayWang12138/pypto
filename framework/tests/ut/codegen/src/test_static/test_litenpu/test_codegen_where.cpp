...
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
                ...
                Tensor output;
<<<<<<< HEAD
                FUNCTION("WHERE_001") { output = Where(condition, input, other); }
                == == == = FUNCTION("WHERE_001") { output = Where(condition, input, other); }
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
            }
...
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
                                    ...
                                    auto function =
                                        Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "WHERE_001");
                                    npu::tile_fwk::CodeGenCtx ctx;
                                    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
                                    codeGen.GenCode(*function, {});
                                }
...
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
                                                    ...
                                                    auto function = Program::GetInstance().GetFunctionByRawName(
                                                        FUNCTION_PREFIX + "WHERE_fp16_001");
                                                    npu::tile_fwk::CodeGenCtx ctx;
                                                    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
                                                    codeGen.GenCode(*function, {});
                                                }
...
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
                                                            ...
                                                            auto function = Program::GetInstance().GetFunctionByRawName(
                                                                FUNCTION_PREFIX + "WHERE_fp16_002");
                                                            npu::tile_fwk::CodeGenCtx ctx;
                                                            npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
                                                            codeGen.GenCode(*function, {});
                                                        }
...
<<<<<<< HEAD
                                                        TEST_F(LiteNPUCodeGenWhere, test_where_tt_fp16_003)
                                                        {
                                                            PROGRAM("WHERE_fp16_003")
                                                            {
                                                                == == ==
                                                                    = TEST_F(
                                                                        LiteNPUCodeGenWhere, test_where_tt_fp16_003)
                                                                {
                                                                    PROGRAM("WHERE_fp16_003")
                                                                    {
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
...
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
                                                                    ...
                                                                    auto function =
                                                                        Program::GetInstance().GetFunctionByRawName(
                                                                            FUNCTION_PREFIX + "WHERE_fp16_003");
                                                                    npu::tile_fwk::CodeGenCtx ctx;
                                                                    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
                                                                    codeGen.GenCode(*function, {});
                                                                }
...
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
                                                                            ...
                                                                            auto function = Program::GetInstance()
...
<<<<<<< HEAD
                                                                        TEST_F(
                                                                            LiteNPUCodeGenWhere, test_where_tt_fp16_005)
                                                                        {
                                                                            PROGRAM("WHERE_fp16_005")
                                                                            {
                                                                                == == == = TEST_F(
                                                                                             LiteNPUCodeGenWhere,
                                                                                             test_where_tt_fp16_005)
                                                                                {
                                                                                    PROGRAM("WHERE_fp16_005")
                                                                                    {
>>>>>>> 7eb5107b3132f71277db6ee374fffa12949f5481
