...
// fp16 test cases
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_001) {
    PROGRAM("RESHAPE_FP16_001") {
        TileShape::Current().SetVecTile({1, 16});
        Tensor operand(DT_FP16, {2, 2}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_001") {
            result = Reshape(operand, {1, 2, 1, 2});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_002) {
    PROGRAM("RESHAPE_FP16_002") {
        TileShape::Current().SetVecTile({2, 16});
        Tensor operand(DT_FP16, {4, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_002") {
            result = Reshape(operand, {16});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_003) {
    PROGRAM("RESHAPE_FP16_003") {
        TileShape::Current().SetVecTile({1, 1, 16});
        Tensor operand(DT_FP16, {2, 3, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_003") {
            result = Reshape(operand, {2, 12});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_004) {
    PROGRAM("RESHAPE_FP16_004") {
        TileShape::Current().SetVecTile({1, 1, 1, 16});
        Tensor operand(DT_FP16, {2, 2, 2, 2}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_004") {
            result = Reshape(operand, {4, 4});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_005) {
    PROGRAM("RESHAPE_FP16_005") {
        TileShape::Current().SetVecTile({16});
        Tensor operand(DT_FP16, {8}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_005") {
            result = Reshape(operand, {2, 4});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_006) {
    PROGRAM("RESHAPE_FP16_006") {
        TileShape::Current().SetVecTile({1, 16});
        Tensor operand(DT_FP16, {3, 9}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_006") {
            result = Reshape(operand, {3, 3, 3});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_007) {
    PROGRAM("RESHAPE_FP16_007") {
        TileShape::Current().SetVecTile({1, 1, 16});
        Tensor operand(DT_FP16, {2, 2, 6}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_007") {
            result = Reshape(operand, {2, 2, 2, 3});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_008) {
    PROGRAM("RESHAPE_FP16_008") {
        TileShape::Current().SetVecTile({2, 2, 2, 16});
        Tensor operand(DT_FP16, {4, 4, 4, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_008") {
            result = Reshape(operand, {256});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_009) {
    PROGRAM("RESHAPE_FP16_009") {
        TileShape::Current().SetVecTile({16});
        Tensor operand(DT_FP16, {12}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_009") {
            result = Reshape(operand, {2, 2, 3});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp16_010) {
    PROGRAM("RESHAPE_FP16_010") {
        TileShape::Current().SetVecTile({1, 16});
        Tensor operand(DT_FP16, {2, 6}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP16_010") {
            result = Reshape(operand, {2, 2, 3, 1});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp32_006) {
    PROGRAM("RESHAPE_FP32_006") {
        TileShape::Current().SetVecTile({1, 8});
        Tensor operand(DT_FP32, {3, 9}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP32_006") {
            result = Reshape(operand, {3, 3, 3});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp32_007) {
    PROGRAM("RESHAPE_FP32_007") {
        TileShape::Current().SetVecTile({1, 1, 8});
        Tensor operand(DT_FP32, {2, 2, 6}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP32_007") {
            result = Reshape(operand, {2, 2, 2, 3});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp32_009) {
    PROGRAM("RESHAPE_FP32_009") {
        TileShape::Current().SetVecTile({8});
        Tensor operand(DT_FP32, {12}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP32_009") {
            result = Reshape(operand, {2, 2, 3});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_fp32_010) {
    PROGRAM("RESHAPE_FP32_010") {
        TileShape::Current().SetVecTile({1, 8});
        Tensor operand(DT_FP32, {2, 6}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_FP32_010") {
            result = Reshape(operand, {2, 2, 3, 1});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_inplace_fp32_001) {
    PROGRAM("RESHAPE_INPLACE_FP32_001") {
        TileShape::Current().SetVecTile({1, 8});
        Tensor operand(DT_FP32, {2, 2}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INPLACE_FP32_001") {
            result = Reshape(operand, {1, 2, 1, 2}, true);
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_inplace_fp32_002) {
    PROGRAM("RESHAPE_INPLACE_FP32_002") {
        TileShape::Current().SetVecTile({2, 8});
        Tensor operand(DT_FP32, {4, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INPLACE_FP32_002") {
            result = Reshape(operand, {16}, true);
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_inplace_fp32_003) {
    PROGRAM("RESHAPE_INPLACE_FP32_003") {
        TileShape::Current().SetVecTile({1, 1, 8});
        Tensor operand(DT_FP32, {2, 3, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INPLACE_FP32_003") {
            result = Reshape(operand, {2, 12}, true);
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_inplace_fp32_004) {
    PROGRAM("RESHAPE_INPLACE_FP32_004") {
        TileShape::Current().SetVecTile({1, 1, 1, 8});
        Tensor operand(DT_FP32, {2, 2, 2, 2}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INPLACE_FP32_004") {
            result = Reshape(operand, {4, 4}, true);
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_inplace_fp32_005) {
    PROGRAM("RESHAPE_INPLACE_FP32_005") {
        TileShape::Current().SetVecTile({8});
        Tensor operand(DT_FP32, {8}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INPLACE_FP32_005") {
            result = Reshape(operand, {2, 4}, true);
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int8_005) {
    PROGRAM("RESHAPE_INT8_005") {
        TileShape::Current().SetVecTile({32});
        Tensor operand(DT_INT8, {12}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT8_005") {
            result = Reshape(operand, {2, 2, 3});
        }
    }
...
// int16 test cases
TEST_F(LiteNPUCodeGenReshape, test_reshape_int16_001) {
    PROGRAM("RESHAPE_INT16_001") {
        TileShape::Current().SetVecTile({1, 16});
        Tensor operand(DT_INT16, {2, 2}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT16_001") {
            result = Reshape(operand, {1, 2, 1, 2});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int16_002) {
    PROGRAM("RESHAPE_INT16_002") {
        TileShape::Current().SetVecTile({2, 16});
        Tensor operand(DT_INT16, {4, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT16_002") {
            result = Reshape(operand, {16});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int16_003) {
    PROGRAM("RESHAPE_INT16_003") {
        TileShape::Current().SetVecTile({16});
        Tensor operand(DT_INT16, {8}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT16_003") {
            result = Reshape(operand, {2, 4});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int16_004) {
    PROGRAM("RESHAPE_INT16_004") {
        TileShape::Current().SetVecTile({1, 1, 16});
        Tensor operand(DT_INT16, {2, 3, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT16_004") {
            result = Reshape(operand, {2, 12});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int16_005) {
    PROGRAM("RESHAPE_INT16_005") {
        TileShape::Current().SetVecTile({16});
        Tensor operand(DT_INT16, {12}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT16_005") {
            result = Reshape(operand, {2, 2, 3});
        }
    }
...
// int32 test cases
TEST_F(LiteNPUCodeGenReshape, test_reshape_int32_001) {
    PROGRAM("RESHAPE_INT32_001") {
        TileShape::Current().SetVecTile({1, 8});
        Tensor operand(DT_INT32, {2, 2}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT32_001") {
            result = Reshape(operand, {1, 2, 1, 2});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int32_002) {
    PROGRAM("RESHAPE_INT32_002") {
        TileShape::Current().SetVecTile({2, 8});
        Tensor operand(DT_INT32, {4, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT32_002") {
            result = Reshape(operand, {16});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int32_003) {
    PROGRAM("RESHAPE_INT32_003") {
        TileShape::Current().SetVecTile({8});
        Tensor operand(DT_INT32, {8}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT32_003") {
            result = Reshape(operand, {2, 4});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int32_004) {
    PROGRAM("RESHAPE_INT32_004") {
        TileShape::Current().SetVecTile({1, 1, 8});
        Tensor operand(DT_INT32, {2, 3, 4}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT32_004") {
            result = Reshape(operand, {2, 12});
        }
    }
...
TEST_F(LiteNPUCodeGenReshape, test_reshape_int32_005) {
    PROGRAM("RESHAPE_INT32_005") {
        TileShape::Current().SetVecTile({8});
        Tensor operand(DT_INT32, {12}, "operand");
        Tensor result;
        FUNCTION("RESHAPE_INT32_005") {
            result = Reshape(operand, {2, 2, 3});
        }
    }
