...
// int16 系列测试用例
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_001) {
    PROGRAM("COMPARE_EQ_INT16_001") {
        ...
        FUNCTION("COMPARE_EQ_INT16_001") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_001");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_002) {
    PROGRAM("COMPARE_EQ_INT16_002") {
        ...
        FUNCTION("COMPARE_EQ_INT16_002") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_002");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_003) {
    PROGRAM("COMPARE_EQ_INT16_003") {
        ...
        FUNCTION("COMPARE_EQ_INT16_003") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_003");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_004) {
    PROGRAM("COMPARE_EQ_INT16_004") {
        ...
        FUNCTION("COMPARE_EQ_INT16_004") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_004");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_005) {
    PROGRAM("COMPARE_EQ_INT16_005") {
        ...
        FUNCTION("COMPARE_EQ_INT16_005") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_005");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_006) {
    PROGRAM("COMPARE_EQ_INT16_006") {
        TileShape::Current().SetVecTile({4, 1});
        Tensor input(DT_INT16, {8, 4}, "input");
        Element other(DataType::DT_INT16, 1.0f);
        auto output = Tensor(DT_BOOL, {8, 4}, "output");
        FUNCTION("COMPARE_EQ_INT16_006") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_006");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_007) {
    PROGRAM("COMPARE_EQ_INT16_007") {
        ...
        FUNCTION("COMPARE_EQ_INT16_007") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_007");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_008) {
    PROGRAM("COMPARE_EQ_INT16_008") {
        ...
        FUNCTION("COMPARE_EQ_INT16_008") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_008");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_009) {
    PROGRAM("COMPARE_EQ_INT16_009") {
        ...
        FUNCTION("COMPARE_EQ_INT16_009") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_009");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int16_010) {
    PROGRAM("COMPARE_EQ_INT16_010") {
        ...
        FUNCTION("COMPARE_EQ_INT16_010") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT16_010");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}
...
// int32 系列测试用例
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_001) {
    PROGRAM("COMPARE_EQ_INT32_001") {
        TileShape::Current().SetVecTile({1,2,16,16});
        Tensor input(DT_INT32, {2, 4, 16, 1}, "input");
        Tensor other(DT_INT32, {2, 1, 16, 16}, "other");
        auto output = Tensor(DT_BOOL, {2, 4, 16, 16}, "output");
        FUNCTION("COMPARE_EQ_INT32_001") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_001");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_002) {
    PROGRAM("COMPARE_EQ_INT32_002") {
        TileShape::Current().SetVecTile({1,2,16,32});
        Tensor input(DT_INT32, {2, 1, 32, 32}, "input");
        Tensor other(DT_INT32, {2, 2, 1, 32}, "other");
        auto output = Tensor(DT_BOOL, {2, 2, 32, 32}, "output");
        FUNCTION("COMPARE_EQ_INT32_002") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_002");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_003) {
    PROGRAM("COMPARE_EQ_INT32_003") {
        ...
        FUNCTION("COMPARE_EQ_INT32_003") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_003");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_004) {
    PROGRAM("COMPARE_EQ_INT32_004") {
        ...
        FUNCTION("COMPARE_EQ_INT32_004") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_004");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_005) {
    PROGRAM("COMPARE_EQ_INT32_005") {
        TileShape::Current().SetVecTile({2,1,32,32});
        Tensor input(DT_INT32, {2, 2, 32, 1}, "input");
        Tensor other(DT_INT32, {2, 2, 1, 64}, "other");
        auto output = Tensor(DT_BOOL, {2, 2, 32, 64}, "output");
        FUNCTION("COMPARE_EQ_INT32_005") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_005");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_006) {
    PROGRAM("COMPARE_EQ_INT32_006") {
        ...
        FUNCTION("COMPARE_EQ_INT32_006") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_006");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_007) {
    PROGRAM("COMPARE_EQ_INT32_007") {
        ...
        FUNCTION("COMPARE_EQ_INT32_007") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_007");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_008) {
    PROGRAM("COMPARE_EQ_INT32_008") {
        ...
        FUNCTION("COMPARE_EQ_INT32_008") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_008");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_009) {
    PROGRAM("COMPARE_EQ_INT32_009") {
        ...
        FUNCTION("COMPARE_EQ_INT32_009") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_009");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}

TEST_F(LiteNPUCodeGenCompare, test_compare_eq_int32_010) {
    PROGRAM("COMPARE_EQ_INT32_010") {
        TileShape::Current().SetVecTile({1, 2, 16, 32});
        Tensor input(DT_INT32, {1, 4, 32, 64}, "input");
        Tensor other(DT_INT32, {1, 4, 32, 64}, "other");
        auto output = Tensor(DT_BOOL, {1, 4, 32, 64}, "output");
        FUNCTION("COMPARE_EQ_INT32_010") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
    auto function = Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + "COMPARE_EQ_INT32_010");
    npu::tile_fwk::CodeGenCtx ctx;
    npu::tile_fwk::CodeGenLiteNPU codeGen(ctx);
    codeGen.GenCode(*function, {});
}
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp16_002) {
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp16_014) {
    PROGRAM("COMPARE_EQ_FP16_014") {
        ...
        auto output = Tensor(DT_BOOL, {2, 48, 48}, "output");
        FUNCTION("COMPARE_EQ_FP16_014") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_002) {
    PROGRAM("COMPARE_EQ_FP32_002") {
        ...
        auto output = Tensor(DT_BOOL, {8, 8}, "output");
        FUNCTION("COMPARE_EQ_FP32_002") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_003) {
    PROGRAM("COMPARE_EQ_FP32_003") {
        ...
        auto output = Tensor(DT_BOOL, {16, 8, 8}, "output");
        FUNCTION("COMPARE_EQ_FP32_003") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_004) {
    PROGRAM("COMPARE_EQ_FP32_004") {
        ...
        auto output = Tensor(DT_BOOL, {4, 16, 8, 8}, "output");
        FUNCTION("COMPARE_EQ_FP32_004") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_006) {
    PROGRAM("COMPARE_EQ_FP32_006") {
        ...
        auto output = Tensor(DT_BOOL, {4, 32, 24, 16}, "output");
        FUNCTION("COMPARE_EQ_FP32_006") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_009) {
    PROGRAM("COMPARE_EQ_FP32_009") {
        ...
        auto output = Tensor(DT_BOOL, {4, 4, 16}, "output");
        FUNCTION("COMPARE_EQ_FP32_009") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_010) {
    PROGRAM("COMPARE_EQ_FP32_010") {
        ...
        auto output = Tensor(DT_BOOL, {4, 4, 4}, "output");
        FUNCTION("COMPARE_EQ_FP32_010") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_011) {
    PROGRAM("COMPARE_EQ_FP32_011") {
        ...
        auto output = Tensor(DT_BOOL, {16, 4, 4}, "output");
        FUNCTION("COMPARE_EQ_FP32_011") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
...
TEST_F(LiteNPUCodeGenCompare, test_compare_eq_fp32_012) {
    PROGRAM("COMPARE_EQ_FP32_012") {
        ...
        auto output = Tensor(DT_BOOL, {4, 4, 4, 4}, "output");
        FUNCTION("COMPARE_EQ_FP32_012") {
            output = Compare(input, other, OpType::EQ, OutType::BOOL);
        }
    }
