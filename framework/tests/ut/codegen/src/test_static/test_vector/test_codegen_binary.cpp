...
GMTileTensorFP32Dim4_2 gmTensor_4((__gm__ float*)((__gm__ GMTensorInfo*)(param) + 1)->Addr, DynLayout4Dim(Shape4Dim(1, 1, 16, 16), Stride4Dim(256, 256, 16, 1)));
UBTileTensorFP32Dim4_1 ubTensor_3((uint64_t)UB_S0_E1024_T);
GMTileTensorFP32Dim4_2 gmTensor_2((__gm__ float*)((__gm__ GMTensorInfo*)(param) + 0)->Addr, DynLayout4Dim(Shape4Dim(1, 1, 16, 16), Stride4Dim(256, 256, 16, 1)));
UBTileTensorFP32Dim4_1 ubTensor_1((uint64_t)UB_S1024_E2048_T);
SUBKERNEL_PHASE1
...
TAdd<LastUse3Dim<0, 0, 0>>(ubTensor_1, ubTensor_3, ubTensor_1);
pipe_barrier(PIPE_V);
TMul<LastUse3Dim<0, 0, 0>>(ubTensor_1, ubTensor_3, ubTensor_1);
set_flag(PIPE_V, PIPE_MTE3, EVENT_ID0);
wait_flag(PIPE_V, PIPE_MTE3, EVENT_ID0);
TStore(gmTensor_11, ubTensor_1, Coord4Dim(0, 0, 0, 0));
}
)!!!";
