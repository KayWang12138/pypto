...
GMTileTensorINT32Dim2_6 gmTensor_15((__gm__ int32_t*)((__gm__ GMTensorInfo*)(param) + 2)->Addr, DynLayout2Dim(Shape2Dim(128, 32), Stride2Dim(32, 1)));
...
UBTileTensorINT32Dim2_5 ubTensor_11((uint64_t)UB_S49664_E66048_T);
UBTileTensorFP32Dim2_1 ubTensor_9((uint64_t)UB_S66048_E82432_T);
