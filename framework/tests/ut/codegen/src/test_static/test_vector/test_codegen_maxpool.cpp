...
TEST_F(TestCodegenMaxPool, TestOpMaxPool) {
    ...
    std::string funcName = "TestOpMaxPool";
    ...
    auto &op = function->AddOperation(Opcode::OP_MAX_POOL, {localTensorSrc}, {localTensorDst});
    op.SetAttribute(ConvOpAttributeKey::paddingLeft, 0);
    op.SetAttribute(ConvOpAttributeKey::paddingTop, 0);
    op.SetAttribute(ConvOpAttributeKey::paddingRight, 0);
    op.SetAttribute(ConvOpAttributeKey::paddingBottom, 0);
    op.SetAttribute(ConvOpAttributeKey::strideh, 0);
    op.SetAttribute(ConvOpAttributeKey::stridew, 0);
    op.SetAttribute(PoolOpAttributeKey::poolh, 0);
    op.SetAttribute(PoolOpAttributeKey::poolw, 0);
