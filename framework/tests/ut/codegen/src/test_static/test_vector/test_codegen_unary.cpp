...
TEST_F(TestCodegenUnary, TestExpDefaultPrecision)
{
    ...
    CodeGenOpCloudNPU cop(opCtx);
    std::string res = cop.GenOpCode();
    std::string expect = R"!!!(TExp<pto::ExpAlgorithm::DEFAULT>(UB_S0_E0, UB_S0_E0);
)!!!";
    CheckStringExist(expect, res);
}
...
TEST_F(TestCodegenUnary, TestExpHighPrecision)
{
    ...
    CodeGenOpCloudNPU cop(opCtx);
    std::string res = cop.GenOpCode();
    std::string expect = R"!!!(TExp<pto::ExpAlgorithm::HIGH_PRECISION>(UB_S0_E0, UB_S0_E0);
)!!!";
    CheckStringExist(expect, res);
}
...
TEST_F(TestCodegenUnary, TestSqrtDefaultPrecision)
{
    ...
    CodeGenOpCloudNPU cop(opCtx);
    std::string res = cop.GenOpCode();
    std::string expect = R"!!!(TSqrt<pto::SqrtAlgorithm::DEFAULT>(UB_S0_E0, UB_S0_E0);
)!!!";
    CheckStringExist(expect, res);
}
...
TEST_F(TestCodegenUnary, TestSqrtHighPrecision)
{
    ...
    CodeGenOpCloudNPU cop(opCtx);
    std::string res = cop.GenOpCode();
    std::string expect = R"!!!(TSqrt<pto::SqrtAlgorithm::HIGH_PRECISION>(UB_S0_E0, UB_S0_E0);
)!!!";
    CheckStringExist(expect, res);
}
...
TEST_F(TestCodegenUnary, TestLogDefaultPrecision)
{
    ...
    CodeGenOpCloudNPU cop(opCtx);
    std::string res = cop.GenOpCode();
    std::string expect = R"!!!(TLog<pto::LogAlgorithm::DEFAULT>(UB_S0_E0, UB_S0_E0);
)!!!";
    CheckStringExist(expect, res);
}
