...
TEST_F(TestCodegenForLoop, TestForLoop) {
    ...
    const std::string expect1 = R"(
        ...
        TSub<LastUse3Dim<0, 0, 0>>(ubTensor_5_low2DimInLoop, ubTensor_3_low2DimInLoop, ubTensor_1_low2DimInLoop);
        TAdd<LastUse3Dim<0, 0, 0>>(ubTensor_11_low2DimInLoop, ubTensor_3_low2DimInLoop, ubTensor_1_low2DimInLoop);
    }
  }
})";
    ...
    const std::string expect2 = R"(
        ...
        ubTensor_5_low2DimInLoop.SetAddr(ubTensor_5.GetLinearAddr(tileOffsets));
        ubTensor_11_low2DimInLoop.SetAddr(ubTensor_11.GetLinearAddr(tileOffsets));
        TMul<LastUse3Dim<0, 0, 0>>(ubTensor_11_low2DimInLoop, ubTensor_11_low2DimInLoop, ubTensor_5_low2DimInLoop);
    }
  }
})";
