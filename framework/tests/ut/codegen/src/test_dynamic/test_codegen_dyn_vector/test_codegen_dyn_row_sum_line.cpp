...
uint64_t sym_46_dim_0 = 2; //GET_PARAM_VALID_SHAPE_BY_IDX(param, 0, 1, 3, 0);
uint64_t sym_46_dim_1 = 8; //GET_PARAM_VALID_SHAPE_BY_IDX(param, 0, 1, 3, 1);
uint64_t sym_46_dim_2 = 512; //GET_PARAM_VALID_SHAPE_BY_IDX(param, 0, 1, 3, 2);
