...
TEST_F(TestCodegenDynSinCos, SinLayout)
{
    ...
    std::string expect = R"(TSin(ubTensor_9, ubTensor_4, ubTensor_10, ubTensor_11);)";
...
TEST_F(TestCodegenDynSinCos, CosLayout)
{
    ...
    std::string res = GetResultFromCpp(*function);
    std::string expect = R"(TCos(ubTensor_7, ubTensor_2, ubTensor_8, ubTensor_9);)";
    CheckStringExist(expect, res);
}
