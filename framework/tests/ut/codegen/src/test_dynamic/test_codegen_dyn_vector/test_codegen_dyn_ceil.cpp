 ...
 * \brief Unit test for codegen (Ceil operation).
 */
...
TEST_F(TestCodegenDynCeil, CeilLayout) {  
    ...
    auto &op = function->AddOperation(Opcode::OP_CEIL, {localTensorSrc}, {localTensorRes, localTensorTmp});
