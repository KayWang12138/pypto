...
TEST_F(TestCodegenDynUna, TestPadDynamic)
{
    ...
    std::string expect = R"!!!(TPad<pto::PadValueCustom((float)2.0f)>(ubTensor_2, ubTensor_0);)!!!";
...
TEST_F(TestCodegenDynUna, TestFillPadDynamicBF16)
{
    ...
    codeGen.GenCode(*function, {});
    const std::string res = GetResultFromCpp(*function);
    std::string expect = R"!!!(TFillPad<pto::PadValueCustom((bfloat16_t)0.0f)>(ubTensor_2, ubTensor_0);)!!!";
    CheckStringExist(expect, res);
}
...
TEST_F(TestCodegenDynUna, TestFillPadDynamic)
{
    ...
    codeGen.GenCode(*function, {});
    const std::string res = GetResultFromCpp(*function);
    std::string expect = R"!!!(TFillPad<pto::PadValueCustom((float)0.0f)>(ubTensor_2, ubTensor_0);)!!!";
    CheckStringExist(expect, res);
}
