...
TEST_F(TestCodegenDynIndexAdd, TestDynOpIndexAdd) {
    ...
    std::string funcName = "TestDynOpIndexAdd";
    ...
    auto &op = function->AddOperation(
        Opcode::OP_INDEX_ADD, {localTensorSelf, localTensorSrc, localTensorIdx}, {localTensorDst});
    ...
    std::string expect =
        R"!!!(TileOp::DynTindexAdd<float, float, 1, 64, 64, 1, 64, 64, 2>((__ubuf__ float*)UB_S0_E0, (__ubuf__ float*)UB_S0_E0, (__ubuf__ float*)UB_S0_E0, (__ubuf__ float*)UB_S0_E0, (float)1, 1, 1, 64, 64);
)!!!";
