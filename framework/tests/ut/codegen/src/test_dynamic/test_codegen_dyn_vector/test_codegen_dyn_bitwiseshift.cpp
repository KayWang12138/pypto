...
TEST_F(TestCodegenDynBitwiseShift, TestCodegenBitwiseRightShiftDim2) {
    std::vector<int64_t> shape{64, 64};
    TileShape::Current().SetVecTile(shape);
    std::string name = "BitwiseRightShift";
    Tensor input_a(DT_FP16, shape, "A");
    Tensor input_b(DT_FP16, shape, "B");
...
TEST_F(TestCodegenDynBitwiseShift, TestCodegenBitwiseLeftShiftDim2) {
    std::vector<int64_t> shape{64, 64};
    TileShape::Current().SetVecTile(shape);
    std::string name = "BitwiseLeftShift";
    Tensor input_a(DT_FP16, shape, "A");
    Tensor input_b(DT_FP16, shape, "B");
    Tensor output(DT_FP16, shape, "C");
