...
/*!
 * \file test_codegen_dyn_trunc.cpp
 * \brief Unit test for codegen (Trunc operation).
 */
...
class TestCodegenDynTrunc : public ::testing::Test {
public:
...
TEST_F(TestCodegenDynTrunc, TestDynOpTrunc) {
    ...
    auto &op = function->AddOperation(Opcode::OP_TRUNC, {localTensorSrc}, {localTensorRes, localTensorTmp});
