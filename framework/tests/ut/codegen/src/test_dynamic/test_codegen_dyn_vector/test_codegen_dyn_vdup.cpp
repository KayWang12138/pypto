...
TEST_F(TestCodegenDynVdup, TestDynVdupInt8)
{
    std::vector<int64_t> shape{2, 256, 7};
    ...
    std::string funcName = "TestDynVdupInt8";
    ...
    FUNCTION(funcName, {output})
    {
        ...
        {
            (void)i;
            output = npu::tile_fwk::Full(src, DataType::DT_INT8, shape);
        }
    }
    auto function =
        Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + funcName + SUB_FUNC_SUFFIX + HIDDEN_FUNC_SUFFIX);
...
TEST_F(TestCodegenDynVdup, TestDynVdupUInt8)
{
    std::vector<int64_t> shape{2, 256, 7};
    ...
    std::string funcName = "TestDynVdupUInt8";
    ...
    FUNCTION(funcName, {output})
    {
        ...
        {
            (void)i;
            output = npu::tile_fwk::Full(src, DataType::DT_UINT8, shape);
        }
    }
    auto function =
        Program::GetInstance().GetFunctionByRawName(FUNCTION_PREFIX + funcName + SUB_FUNC_SUFFIX + HIDDEN_FUNC_SUFFIX);
