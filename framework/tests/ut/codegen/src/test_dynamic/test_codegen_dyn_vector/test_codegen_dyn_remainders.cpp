...
TEST_F(TestCodegenDynRemainderS, TestRemainderS)
{
    ...
    std::string expect = R"!!!(TRemainderS<int16_t>(ubTensor_4, ubTensor_2, 2.0f, ubTensor_5);)!!!";
...
TEST_F(TestCodegenDynRemainderS, TestRemainderRS)
{
    ...
    codeGen.GenCode(*function, {});
    std::string res = GetResultFromCpp(*function);
    std::string expect = R"!!!(TRemainderRS<float>(ubTensor_2, ubTensor_0, 10.0f, ubTensor_3);)!!!";
    CheckStringExist(expect, res);
}
} // namespace npu::tile_fwk
