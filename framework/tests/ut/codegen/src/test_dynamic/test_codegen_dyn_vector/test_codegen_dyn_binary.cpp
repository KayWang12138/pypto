...
TEST_F(TestCodegenDynBinary, TestAddSTileTensorInfNan) {
    std::vector<std::string> expect = { 
        R"!!!(union FP32Int"
        R"!!!(TAddS<LastUse2Dim<0, 1>, float>(ubTensor_1, ubTensor_1, 1.5); )!!!"
    };
    TestAddSDynBody("TestAddsDynamic", 1.5, true, expect);
}
