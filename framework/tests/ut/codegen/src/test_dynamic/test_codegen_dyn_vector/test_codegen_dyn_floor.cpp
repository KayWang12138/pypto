...
/*!
 * \file test_codegen_dyn_floor.cpp
 * \brief Unit test for codegen (Floor operation).
 */
...
class TestCodegenDynFloor : public ::testing::Test {
public:
...
TEST_F(TestCodegenDynFloor, TestDynOpFloor) {
    ...
    auto &op = function->AddOperation(Opcode::OP_FLOOR, {localTensorSrc}, {localTensorRes, localTensorTmp});
