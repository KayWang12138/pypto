...
TEST_F(TestCodegenDynSpillOut, L1SpillTileTensorConv2D) {
    ...
    auto gmTensor = CreateConvTensor(*function, DataType::DT_FP16, gmShape, MemoryType::MEM_DEVICE_DDR);
    auto l0cTensor = CreateConvTensor(*function, DataType::DT_FP16, shape, MemoryType::MEM_L0C);
...
TEST_F(TestCodegenDynSpillOut, L1SpillTileTensorConv3D) {
    ...
    auto gmTensor = CreateConvTensor(*function, DataType::DT_FP32, gmShape, MemoryType::MEM_DEVICE_DDR);
    auto l0cTensor = CreateConvTensor(*function, DataType::DT_FP32, shape, MemoryType::MEM_L0C);
