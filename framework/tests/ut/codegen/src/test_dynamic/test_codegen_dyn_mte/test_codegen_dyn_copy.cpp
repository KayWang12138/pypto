...
TEST_F(TestCodegenDynCopy, L1CopyInTileTensorFmapConv3D) {
    ...
    std::string expect =
        R"!!!(TLoadConv<CopyInMode::DN2NZ, 1, 1>(l1Tensor_10, gmTensor_11, 0, 0, 0, 0, 0, 1, 16, 0, 1, 16);
)!!!";
    EXPECT_EQ(res, expect);
}
...
TEST_F(TestCodegenDynCopy, L1CopyInTileTensorWeightConv3D) {
    ...
    std::string expect =
        R"!!!(TLoadConv<CopyInMode::DN2NZ, 1, 0>(l1Tensor_10, gmTensor_11, 0, 0, 0, 0, 0, 1, 16, 0, 1, 1);
)!!!";
    EXPECT_EQ(res, expect);
}
