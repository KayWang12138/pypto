...
void SetConvL1CopyInOp(Operation &op, const bool &isFmap, const bool &isConv3D, const int64_t &copyInMode,
    std::vector<int64_t> gmShape, std::vector<SymbolicScalar> dstL1Shape) {
...
std::string TestConvL1CopyInBody(std::vector<int64_t> gmShape, bool isFmap = true, int64_t copyInMode = 3,
    ...
    SetConvL1CopyInOp(op,isFmap, isConv3D, copyInMode, gmShape, dstL1Shape);
