...
TEST_F(TestSetHeuristicTileShapes, TestVector)
{
    ...
    std::vector<int64_t> gatherShape = {8, 16, 64};
    ...
    auto ubTensor10 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, gatherShape);
    ...
    currFunctionPtr->AddOperation(Opcode::OP_GATHER, {ubTensor7, ubTensor9}, {ubTensor10});
    currFunctionPtr->AddOperation(Opcode::OP_ROWSUM, {ubTensor10}, {outCast});
