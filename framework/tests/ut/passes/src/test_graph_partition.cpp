...
TEST_F(GraphPartitionTest, TestScopeIdAllowCrossScopeMerge) { RunScopeTest(true, 1); }
...
void RunScopeAllowParallelMergeTest(bool allowParallelMerge, int expectedSubGraphNum)
{
    ComputationalGraphBuilder G;
    ...
    Operation::ScopeInfo info;
    info.scopeId = 1;
    info.allowParallelMerge = allowParallelMerge;
    ...
    EXPECT_EQ(subgraphIds.size(), expectedSubGraphNum);
}

TEST_F(GraphPartitionTest, TestAllowParallelMergeTrue) { RunScopeAllowParallelMergeTest(true, 1); }

TEST_F(GraphPartitionTest, TestAllowParallelMergeFalse) { RunScopeAllowParallelMergeTest(false, 4); }
