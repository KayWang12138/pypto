...
TEST_F(ReplaceTensorTest, TestNotInsertCopy) {
    auto currFunctionPtr = std::make_shared<Function>(Program::GetInstance(), "TestNotInsertCopy","TestNotInsertCopy", nullptr);
