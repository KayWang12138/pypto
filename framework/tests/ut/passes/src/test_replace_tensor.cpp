...
public:
    ...
    void BuildViewAssemble(std::shared_ptr<Function> currFunctionPtr) {
        ...
        */
        ...
        copyInOp0.SetOpAttribute(std::make_shared<CopyOpAttribute>(
                    OpImmediate::Specified(offset0), MemoryType::MEM_UNKNOWN,
                    OpImmediate::Specified(shape1), OpImmediate::Specified(shape1)));
        copyInOp1.SetOpAttribute(std::make_shared<CopyOpAttribute>(
                    OpImmediate::Specified(offset0), MemoryType::MEM_UNKNOWN,
                    OpImmediate::Specified(shape1), OpImmediate::Specified(shape1)));
    ...
    void BuildBackView(std::shared_ptr<Function> currFunctionPtr) {
        ...
        // Init Attribute
        copyInOp0.SetOpAttribute(std::make_shared<CopyOpAttribute>(OpImmediate::Specified(offset0), MemoryType::MEM_UNKNOWN,
                    OpImmediate::Specified(shape1), OpImmediate::Specified(shape1)));
        copyInOp1.SetOpAttribute(std::make_shared<CopyOpAttribute>(OpImmediate::Specified(offset0), MemoryType::MEM_UNKNOWN,
                    OpImmediate::Specified(shape1), OpImmediate::Specified(shape1)));
        copyOutOp0.SetOpAttribute(std::make_shared<CopyOpAttribute>(MemoryType::MEM_UNKNOWN, OpImmediate::Specified(offset0),
                    OpImmediate::Specified(shape1), OpImmediate::Specified(shape1)));
        copyOutOp1.SetOpAttribute(std::make_shared<CopyOpAttribute>(MemoryType::MEM_UNKNOWN, OpImmediate::Specified(offset0),
                    OpImmediate::Specified(shape1), OpImmediate::Specified(shape1)));
