...
// 覆盖 loop_unroll.cpp 第642、657行: IsNoOverlapWAW 中 AssembleOpAttribute 为 nullptr
// AddOp 创建的 OP_ASSEMBLE 默认无 attribute，GetOpAttribute() 返回 nullptr，dynamic_pointer_cast 失败
