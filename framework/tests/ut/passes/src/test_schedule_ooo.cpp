...
// 覆盖 buffer_pool.cpp 第128行: MakeBufferSlice 对已分配的 tensor 再次分配
...
// 覆盖 buffer_pool.cpp 第195行: Allocate 无足够空闲区间
...
// 覆盖 buffer_rearrange.cpp 第173行: GroupBubbles 只选到一个气泡 (start+1>=end)
...
// 覆盖 scheduler.cpp 第386行: AllocTensorMemRange 中 viewOps 包含非 VIEW op
