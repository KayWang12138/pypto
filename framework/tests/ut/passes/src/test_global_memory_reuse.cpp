...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseNormal2) {
    ...
    BlockFunction leafFunc2(Program::GetInstance(), "leafFunc2", "leafFunc2", G.GetFunction());
    BlockFunction leafFunc3(Program::GetInstance(), "leafFunc3", "leafFunc3", G.GetFunction());
    BlockFunction leafFunc4(Program::GetInstance(), "leafFunc4", "leafFunc4", G.GetFunction());
    function->rootFunc_ = function;
    leafFunc1.rootFunc_ = function;
    leafFunc2.rootFunc_ = function;
    leafFunc3.rootFunc_ = function;
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseMultiOpSerialConn) {
    ...
    BlockFunction leafFunc3(Program::GetInstance(), "leafFunc3", "leafFunc3", G.GetFunction());
    BlockFunction leafFunc4(Program::GetInstance(), "leafFunc4", "leafFunc4", G.GetFunction());
    BlockFunction leafFunc5(Program::GetInstance(), "leafFunc5", "leafFunc5", G.GetFunction());
    BlockFunction leafFunc6(Program::GetInstance(), "leafFunc6", "leafFunc6", G.GetFunction());
    function->rootFunc_ = function;
    leafFunc1.rootFunc_ = function;
    leafFunc2.rootFunc_ = function;
    leafFunc3.rootFunc_ = function;
