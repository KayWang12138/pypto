...
TEST_F(RemoveAllocTest, RemoveAlloc) {
    ...
    auto currFunctionPtr = std::make_shared<BlockFunction>(Program::GetInstance(), "TestSaveGmTensorParamIdxToOpLeaf", "TestSaveGmTensorParamIdxToOpLeaf", rootFuncPtr.get());
