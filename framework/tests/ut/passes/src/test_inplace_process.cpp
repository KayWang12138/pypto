...
TEST_F(InplaceProcessTest, CopyInDirectAssemble) {
    ...
    auto attrCopyOut = std::make_shared<CopyOpAttribute>(MemoryType::MEM_UB, OpImmediate::Specified(offsetOut),
        OpImmediate::Specified(expOut->GetShape()), OpImmediate::Specified(expOut->tensor->GetRawShape()));
...
inline void InplaceAssembleAddOp(ComputationalGraphBuilder &G) {
    G.AddOp(Opcode::OP_COPY_IN, {"mat_a"}, {"mat_a_partial_0"}, "L1copyInA_0");
    auto L1copyInA_0 = G.GetOp("L1copyInA_0");
    auto attrCopyInA_0 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_L1,
        OpImmediate::Specified(G.GetTensor("mat_a")->GetShape()),
        OpImmediate::Specified(G.GetTensor("mat_a")->tensor->GetRawShape()));
    L1copyInA_0->SetOpAttribute(attrCopyInA_0);
    G.AddOp(Opcode::OP_COPY_IN, {"mat_a"}, {"mat_a_partial_1"}, "L1copyInA_1");
    auto L1copyInA_1 = G.GetOp("L1copyInA_1");
    auto attrCopyInA_1 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_L1,
        OpImmediate::Specified(G.GetTensor("mat_a")->GetShape()),
        OpImmediate::Specified(G.GetTensor("mat_a")->tensor->GetRawShape()));
    L1copyInA_1->SetOpAttribute(attrCopyInA_1);
    G.AddOp(Opcode::OP_COPY_IN, {"mat_b"}, {"mat_b_partial_0"}, "L1copyInB_0");
    auto L1copyInB_0 = G.GetOp("L1copyInB_0");
    auto attrCopyInB_0 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_L1,
        OpImmediate::Specified(G.GetTensor("mat_b")->GetShape()),
    ...
    auto attrCopyInB_1 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_L1,
        OpImmediate::Specified(G.GetTensor("mat_b")->GetShape()),
        OpImmediate::Specified(G.GetTensor("mat_b")->tensor->GetRawShape()));
    ...
    auto attrCopyOut = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_L0C,
        OpImmediate::Specified(G.GetTensor("out_c")->GetShape()),
...
inline void AssembleViewAddOp(ComputationalGraphBuilder &G) {
    ...
    auto attrCopy_0 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_DEVICE_DDR,
    ...
    auto attrCopy_1 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_DEVICE_DDR,
    ...
    auto attrCopy_2 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_DEVICE_DDR,
    ...
    auto attrCopy_3 = std::make_shared<CopyOpAttribute>(OpImmediate::Specified({0, 0}), MemoryType::MEM_DEVICE_DDR,
    ...
    std::vector<int64_t> offsetOut = {0, 0};
    auto attrCopyOut = std::make_shared<CopyOpAttribute>(MemoryType::MEM_DEVICE_DDR, OpImmediate::Specified(offsetOut),
