...
TEST(TestGetInputData, int32)
{
    ...
    ret = RUNTIME_GetInputData(0, 3, 1);
    EXPECT_EQ(ret, 1);

    devTensorList.shape.dimSize = 2;
    ret = RUNTIME_GetInputData(0, 3, 1, 1);
    EXPECT_EQ(ret, 5);

    devTensorList.shape.dimSize = 3;
    ret = RUNTIME_GetInputData(0, 3, 1, 1, 1);
    EXPECT_EQ(ret, 21);

    devTensorList.shape.dimSize = 4;
    ret = RUNTIME_GetInputData(0, 3, 1, 1, 1, 1);
    EXPECT_EQ(ret, 85);
}
...
TEST(TestGetInputData, int64)
{
    ...
    int ret;
    devTensorList.shape.dimSize = 1;
    ret = RUNTIME_GetInputData(0, 4, 1);
    EXPECT_EQ(ret, 1);

    devTensorList.shape.dimSize = 2;
    ret = RUNTIME_GetInputData(0, 4, 1, 1);
    EXPECT_EQ(ret, 5);

    devTensorList.shape.dimSize = 3;
    ret = RUNTIME_GetInputData(0, 4, 1, 1, 1);
    EXPECT_EQ(ret, 21);

    devTensorList.shape.dimSize = 4;
    ret = RUNTIME_GetInputData(0, 4, 1, 1, 1, 1);
    EXPECT_EQ(ret, 85);
}
