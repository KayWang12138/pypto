...
// and the code eventually crashes on nullptr dereference -> use death test
// ===================================================================
TEST_F(TestHostMachineLog, Compile_NullTaskWhenCurTaskNull) {
    ...
    // Line 274 MACHINE_LOGW is hit, then the code proceeds with nullptr compileTask
    // causing a crash (nullptr dereference) -> death test
    EXPECT_DEATH(hm.Compile(nullptr), "");
}
