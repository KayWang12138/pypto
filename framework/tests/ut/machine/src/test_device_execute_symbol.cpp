...
TEST(DeviceExecuteSymbolTest, SymbolHandlerIdToHandler_InvalidId_ReturnsNull) {
    auto *handler = DeviceExecuteContext::SymbolHandlerIdToHandler(static_cast<SymbolHandlerId>(99999ULL));
