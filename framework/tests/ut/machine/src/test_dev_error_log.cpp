...
TEST_F(TestDevErrorLog, SyncTimeout_TagFormatIsCorrect) {
    const std::string tag = "[sync_timeout]";
    ASSERT_EQ(tag[0], '[');
...
TEST_F(TestDevErrorLog, ExceptSignal_TagFormatIsCorrect) {
    const std::string tag = "[except_signal]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, ExceptReset_TagFormatIsCorrect) {
    const std::string tag = "[except_reset]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, DataValid_TagFormatIsCorrect) {
    const std::string tag = "[data_valid]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, InitResource_TagFormatIsCorrect) {
    const std::string tag = "[init_resource]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, TaskDispatch_TagFormatIsCorrect) {
    const std::string tag = "[task_dispatch]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, InitParams_TagFormatIsCorrect) {
    const std::string tag = "[init_params]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, KernelExec_TagFormatIsCorrect) {
    const std::string tag = "[kernel_exec]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, KernelLoad_TagFormatIsCorrect) {
    const std::string tag = "[kernel_load]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, MemAlloc_TagFormatIsCorrect) {
    const std::string tag = "[mem_alloc]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
...
TEST_F(TestDevErrorLog, PerfTrace_TagFormatIsCorrect) {
    const std::string tag = "[perf_trace]";
    ASSERT_EQ(tag[0], '[');
    ASSERT_EQ(tag[tag.size() - 1], ']');
    ASSERT_GT(tag.size(), 2u);
    ASSERT_EQ(tag.find(' '), std::string::npos);
