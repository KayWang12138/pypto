...
TEST_F(TestAdapterApi, test_hccl_api) {
    EXPECT_EQ(HcommGetCommName(nullptr, nullptr), HCCL_SUCCESS);
    EXPECT_EQ(HcommGetL0TopoTypeEx(nullptr, nullptr, 0), HCCL_SUCCESS);
    EXPECT_EQ(HcommGetCommHandleByGroup(nullptr, nullptr), HCCL_SUCCESS);
    EXPECT_EQ(HcommGetRootInfo(nullptr), HCCL_SUCCESS);
    EXPECT_EQ(HcommCommDestroy(nullptr), HCCL_SUCCESS);
    EXPECT_EQ(HcommCommInitRootInfo(0, nullptr, 0, nullptr), HCCL_SUCCESS);
    EXPECT_EQ(HcommAllocComResourceByTiling(nullptr, nullptr, nullptr, nullptr), HCCL_SUCCESS);
}
