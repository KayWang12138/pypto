...
TEST_F(TestHostLog, test_log_manager_case6) {
    ...
    EXPECT_NE(log_manager.hostLogDir_.find("/temp_process_log/host"), std::string::npos);
    EXPECT_NE(log_manager.deviceLogDir_.find("/temp_process_log/device-0"), std::string::npos);
}
...
TEST_F(TestHostLog, test_log_manager_case7) {
    ...
    LogManager log_manager;
    EXPECT_EQ(log_manager.maxLogFileNum_, 10);
    EXPECT_NE(log_manager.hostLogDir_.find("/temp_work_log/host"), std::string::npos);
    EXPECT_NE(log_manager.deviceLogDir_.find("/temp_work_log/device-0"), std::string::npos);
}
...
TEST_F(TestHostLog, test_log_manager_case8) {
    ...
    EXPECT_NE(log_manager.hostLogDir_.find("/temp_process_log/host"), std::string::npos);
    EXPECT_NE(log_manager.deviceLogDir_.find("/temp_process_log/device-0"), std::string::npos);
    EXPECT_EQ(log_manager.hostLogDir_.find("/temp_work_log/host"), std::string::npos);
    EXPECT_EQ(log_manager.deviceLogDir_.find("/temp_work_log/device-0"), std::string::npos);
}
