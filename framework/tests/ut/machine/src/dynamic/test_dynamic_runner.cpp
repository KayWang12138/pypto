...
TEST_F(TestDynamicDeviceRunner, test_cost_mode_no_run_mode) {
    CostModelAgent costModel;
    void *costModeData = nullptr;
    costModel.RunCostModel(costModeData);
...
TEST_F(TestDynamicDeviceRunner, test_cost_mode_no_dyn_run_mode) {
    CostModelAgent costModel;
    void *costModeData = nullptr;
    config::SetPlatformConfig("enable_dyn_cost_model", true);
    costModel.RunCostModel(costModeData);
    EXPECT_EQ(config::GetPlatformConfig("enable_dyn_cost_model", true), true);
}
