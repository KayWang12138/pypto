...
#include "machine/runtime/dump_device_pref.h"
...
TEST_F(TestDynamicDeviceRunner, test_dump_device_pref) {
    ...
    devKernelArgs.aicpuPerAddr = npu::tile_fwk::dynamic::PtrToValue(static_cast<void*>(aicpuMetPer));
    ...
    std::string jsonPath = npu::tile_fwk::config::LogTopFolder() + "/aicpu_dev_pref.json";
