...
// The FUNCTION macro creates a hierarchy with double TENSOR_ prefix and
// leaf sub-functions.  We prefer the "hiddenfunc" version (excluding
// leaf/root) to avoid double-counting.
