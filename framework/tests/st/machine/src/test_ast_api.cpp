...
TEST(OnBoardTestAstApi, test_add_sub_all2all_torchapi_multi_function) {
    ...
    machine::GetRA()->AllocDevAddr(&workspaceAddr_1, workspaceSize_1);

    uint8_t* outTensorAddr_1 = nullptr;
    machine::GetRA()->AllocDevAddr(&outTensorAddr_1, capacity * sizeof(float));
    ...
    machine::GetRA()->CopyFromTensor((uint8_t *)res_1.data(), (uint8_t *)outTensorAddr_1, capacity * sizeof(float));
