                           ...
                           const MatmulTestCaseParam &param, const Matrix::MatmulExtendParam &matmulExtendParam)
{
    return Matrix::MatmulMX(param.outDtype, tensorA, scaleA, tensorB, scaleB, matmulExtendParam, param.transA,
                          param.scaleTransA, param.transB, param.scaleTransB, param.isCMatrixNz);
}
...
static void MatmulOperationExeFuncNoSplit(
    ...
    bool scaleTransA = args->param_.scaleTransA;
    bool scaleTransB = args->param_.scaleTransB;
    ...
    FUNCTION("testNSplit",
        ...
        LOOP("nLoop", FunctionType::DYNAMIC_LOOP, nIdx, LoopRange(0, CeilDivSymbolicScalar(nDim, nView), 1)) {
            ...
            if (scaleTransA) {
                ...
                scaleA = View(
                    inputs[scaleAIndex], {mDim, kScaleDim, SHAPE_DIM_2}, {mDim, kScaleDim, SHAPE_DIM_2}, {0, 0, 0});
            }
            Tensor tensorB;
            Tensor scaleB;
            if (transB) {
