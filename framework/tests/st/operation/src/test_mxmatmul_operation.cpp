...
static void MatmulOperationExeFuncNoSplit(
    ...
    SymbolicScalar kScaleDim = CeilAlign(kDim, ALIGN_64)/ ALIGN_64;
    FUNCTION("testNoSplit",
        ...
        LOOP("mLoop", FunctionType::DYNAMIC_LOOP, mIdx, LoopRange(1)) {
            ...
            if (transA) {
                ...
                scaleA = View(inputs[scaleAIndex], {kScaleDim, mDim, SHAPE_DIM_2}, {kScaleDim, mDim, SHAPE_DIM_2}, {0, 0});
            } else {
                tensorA = View(inputs[0], {mDim, kDim}, {mDim, kDim}, {mIdx, 0});
                scaleA = View(inputs[scaleAIndex], {mDim, kScaleDim, SHAPE_DIM_2}, {mDim, kScaleDim, SHAPE_DIM_2}, {mIdx, 0, 0});
            }
            Tensor tensorB;
            Tensor scaleB;
            if (transB) {
                tensorB = View(inputs[1], {nDim, kDim}, {nDim, kDim}, {0, 0});
                scaleB = View(inputs[scaleBIndex], {nDim, kScaleDim, SHAPE_DIM_2}, {nDim, kScaleDim, SHAPE_DIM_2}, {0, 0});
            } else {
