...
struct CumOpFuncArgs : public OpFuncArgs {
    CumOpFuncArgs(int axis, const std::vector<int64_t> &viewShape, const std::vector<int64_t> tileShape, bool isSum)
...
TEST_P(CumSumOperationTest, TestCumSum) {
    ...
    auto args = CumOpFuncArgs(axis, GetViewShape(test_data), GetTileShape(test_data), isSum);
