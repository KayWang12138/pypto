...
private:
    ...
    static void init() { config::SetHostOption(COMPILE_STAGE, GEN_KERNEL_CODE); }
...
=======
        ...
        {   "bool",    DataType::DT_BOOL},
        { "double",  DataType::DT_DOUBLE},
>>>>>>> 0bf1224 (feat(Operation): Support cast fp8)
...
[[maybe_unused]] static std::vector<std::vector<int64_t>> GetL0CToL1TileShape(const string &shape) {
    std::vector<std::vector<int64_t>> tileShape;
