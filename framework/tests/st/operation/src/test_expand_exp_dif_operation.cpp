...
static void ExpandExpDifOperationExeFunc1Dims(
    ...
    FUNCTION("main", {inputs[0], inputs[1]}, {outputs[0]}) {
        ...
        SymbolicScalar secondTensorDim = inputs[0].GetShape()[0];
        ...
        LOOP("LOOP_L0_bIdx", FunctionType::DYNAMIC_LOOP, bIdx, LoopRange(0, bloop, 1)) {
            ...
            Tensor tileTensor1 = View(inputs[1], {firstViewShape},
    ...
    FUNCTION("main", {inputs[0], inputs[1]}, {outputs[0]}) {
        ...
        LOOP("LOOP_L0_bIdx", FunctionType::DYNAMIC_LOOP, bIdx, LoopRange(0, bloop, 1)) {
            LOOP("LOOP_L1_sIdx", FunctionType::DYNAMIC_LOOP, sIdx, LoopRange(0, sloop, 1)) {
                ...
                Tensor tileTensor1 = View(inputs[1], {firstViewShape, secondViewShape},
...
TEST_P(ExpandExpDifOperationTest, TestExpandExpDif) {
    ...
    testCase.opFunc = TestExecutor::runTest(testCase);
}
} // namespace
