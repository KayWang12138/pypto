...
struct AxpyOpFuncArgs : public OpFuncArgs {
    AxpyOpFuncArgs(const Element& alpha, const std::vector<int64_t>& viewShape, const std::vector<int64_t> tileShape)
...
TEST_P(AxpyOperationTest, TestAxpy)
{
    ...
    Element alpha(dtype, GetValueByName<float>(test_data, "alpha"));
