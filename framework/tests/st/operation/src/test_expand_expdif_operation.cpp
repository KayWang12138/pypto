...
INSTANTIATE_TEST_SUITE_P(TestExpandExpDif, ExpandExpDifOperationTest,
    ::testing::ValuesIn(GetOpMetaData<ExpandExpDifOpMetaData>(
        {ExpandExpDifOperationExeFunc2Dims, ExpandExpDifOperationExeFunc3Dims, ExpandExpDifOperationExeFunc4Dims},
        "ExpandExpDif")));
