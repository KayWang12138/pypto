...
/*!
 * \file test_moe_distributed_dispatch.cpp
 * \brief
 */
...
template void TestMoeDistributedDispatch<int32_t>(OpTestParam& testParam);
template void TestMoeDistributedDispatch<float>(OpTestParam& testParam);
template void TestMoeDistributedDispatch<float16>(OpTestParam& testParam);
template void TestMoeDistributedDispatch<bfloat16>(OpTestParam& testParam);
