...
void TestReduceScatter(OpTestParam& testParam, std::string& goldenDir)
{
    ...
    FUNCTION("ShmemReduceScatter", {in}, {out}) {
        ...
        LOOP("CreateShmemTensor", FunctionType::DYNAMIC_LOOP, index, LoopRange(1)) { 
            (void)index; 
            CreateShmemData(testParam.group, testParam.rankSize, shmemDataType, shmemDataShape, shmemTensor); 
        }
        // auto shmemTensor = CreateShmemData(testParam.group, testParam.rankSize, shmemDataType, shmemDataShape);
