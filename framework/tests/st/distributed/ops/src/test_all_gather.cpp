...
template void TestDynAllGather<int32_t>(OpTestParam &testParam, const nlohmann::json& testData);
template void TestDynAllGather<float>(OpTestParam &testParam, const nlohmann::json& testData);
template void TestDynAllGather<float16>(OpTestParam &testParam, const nlohmann::json& testData);
template void TestDynAllGather<bfloat16>(OpTestParam &testParam, const nlohmann::json& testData);
