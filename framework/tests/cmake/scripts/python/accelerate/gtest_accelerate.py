...
class GTestAccelerate(ABC):
    ...
    class ExecResult:
        ...
        def get_cntr_exec_info(self) -> Tuple[str, str]:
            ...
            """
            heads: List[str] = [f"{self.cntr_name}", "Total", "Success", "Failed", "Duration"]
            datas: List[List[Any]] = []
        ...
        def get_case_exec_terminate_info(self) -> Tuple[str, int]:
            ...
            :returns:
                Tuple[str, int]:
                    ...
                    - Case 终止执行数量
            """
            heads: List[str] = ["Idx", f"{self.cntr_name}", "CaseName", "Duration"]
            datas: List[Any] = []
        ...
        def get_case_exec_duration_info(self) -> str:
            ...
            """
            heads: List[str] = [f"{self.cntr_name}", "CaseName", "Duration",
    ...
    def brief(self) -> List[Any]:
        ...
        lst = [
            ...
            [f"{self.cntr_name}Lst", [p.cntr_id for p in self.exe_params]],
