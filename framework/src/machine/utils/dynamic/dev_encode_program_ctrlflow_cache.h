...
inline constexpr size_t MAX_CACHED_FUNC_NUM = 512;
inline constexpr size_t MAX_WRAP_FUNC_NUM = 512;
...
struct MixTaskDataCache {
    ...
    uint64_t wrapIdNum;
    uint64_t opWrapList[MAX_WRAP_FUNC_NUM];
...
#define CFGCACHE_ALIGN      8
    ...
    void MixTaskDataBackup(DynDeviceTaskBase *base) {
        ...
        memcpy_s(mixTaskDataBackup->opWrapList, MAX_WRAP_FUNC_NUM, base->devTask.mixTaskData.opWrapList, MAX_WRAP_FUNC_NUM);
    ...
    void MixTaskDataRestore(DynDeviceTaskBase *base) {
        ...
        memcpy_s(base->devTask.mixTaskData.opWrapList, MAX_WRAP_FUNC_NUM, mixTaskDataBackup->opWrapList, MAX_WRAP_FUNC_NUM);
