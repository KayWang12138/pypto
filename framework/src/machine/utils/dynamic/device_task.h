...
enum class AicpuTaskPrepareState : uint8_t { NOT_STARTED = 0, PREPARING = 1, COMPLETED = 2 };
...
struct DynDeviceTask : DynDeviceTaskBase {
    ...
    std::atomic<uint8_t> aicpuTaskPrepareState{static_cast<uint8_t>(AicpuTaskPrepareState::NOT_STARTED)};
