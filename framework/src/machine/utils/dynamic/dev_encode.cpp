...
static uint32_t ExpectedMaxCachedNum() {
    int innerMemAllowedNum = AlignUp((WorkspaceRecyclePeriod() + MAX_UNROLL_TIMES - 1) / MAX_UNROLL_TIMES, TENSOR_ADDR_ALIGNMENT);
    int outcastMemAllowedNum = AlignUp((EstimatedStitchingCount() + MAX_UNROLL_TIMES - 1) / MAX_UNROLL_TIMES, TENSOR_ADDR_ALIGNMENT);
