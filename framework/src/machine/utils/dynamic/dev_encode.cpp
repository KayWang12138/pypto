...
static uint32_t ExpectedMaxCachedNum() { return config::GetRuntimeOption<uint16_t>(STITCH_FUNCTION_MAX_NUM); }
...
void EncodeDevAscendProgram(Function* func, uint64_t& offset, DevAscendProgram* base)
{
    ...
    if (base == nullptr) {
        ...
        base->stitchFunctionNumInitial = 0;
        base->stitchFunctionNumStep = 0;
