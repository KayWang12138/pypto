...
void DevAscendProgram::DumpControlFlow(std::ostringstream& oss, int indent) const {
    std::string INDENTINNER(indent + IDENT_SIZE, ' ');
    std::string INDENTINNERINNER(indent + IDENT2_SIZE, ' ');
...
void DevAscendProgram::DumpExpressionTable(std::ostringstream& oss, int indent) const {
    std::string INDENTINNER(indent + IDENT_SIZE, ' ');
    std::string INDENTINNERINNER(indent + IDENT2_SIZE, ' ');
...
std::string DevAscendProgram::Dump(int indent, bool dumpAddr) const {
    std::string INDENTINNER(indent + IDENT_SIZE, ' ');
    std::string INDENTINNERINNER(indent + IDENT2_SIZE, ' ');
    ...
    DumpExpressionTable(oss, indent);

    DumpControlFlow(oss, indent);
