...
#define DEV_VERBOSE_DEBUG(fmt, args...) PYPTO_DEV_LOG(DLOG_DEBUG, "MACHINE", fmt, ##args)
#define DEV_DEBUG_SPLIT(fmt, args...)   PYPTO_DEV_LOG(DLOG_DEBUG, "MACHINE", fmt, ##args)
#define DEV_DEBUG(fmt, args...)         PYPTO_DEV_LOG(DLOG_DEBUG, "MACHINE", fmt, ##args)
#define DEV_INFO(fmt, args...)          PYPTO_DEV_LOG(DLOG_INFO, "MACHINE", fmt, ##args)
#define DEV_WARN(fmt, args...)          PYPTO_DEV_LOG(DLOG_WARN, "MACHINE", fmt, ##args)
#define DEV_ERROR(fmt, args...)         PYPTO_DEV_LOG(DLOG_ERROR, "MACHINE", fmt, ##args)
