...
#include "dlog_pub.h"
#else
#define SIMULATION_DEVICE
#include "tilefwk/tilefwk_log.h"
#undef SIMULATION_DEVICE
#endif
...
#define DEV_VERBOSE_DEBUG(fmt, args...) MACHINE_LOGD(fmt, ##args)
#define DEV_DEBUG_SPLIT(fmt, args...) MACHINE_LOGD(fmt, ##args)
#define DEV_DEBUG(fmt, args...)  MACHINE_LOGD(fmt, ##args)
#define DEV_INFO(fmt, args...)  MACHINE_LOGI(fmt, ##args)
#define DEV_WARN(fmt, args...)  MACHINE_LOGW(fmt, ##args)
#define DEV_ERROR(fmt, args...)  MACHINE_LOGE(fmt, ##args)
