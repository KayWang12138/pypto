...
#define DEV_VERBOSE_DEBUG(fmt, args...) PYPTO_SIM_LOG(DLOG_DEBUG, npu::tile_fwk::LogModule::MACHINE, fmt, ##args)
#define DEV_DEBUG_SPLIT(fmt, args...)   PYPTO_SIM_LOG(DLOG_DEBUG, npu::tile_fwk::LogModule::MACHINE, fmt, ##args)
#define DEV_DEBUG(fmt, args...)         PYPTO_SIM_LOG(DLOG_DEBUG, npu::tile_fwk::LogModule::MACHINE, fmt, ##args)
#define DEV_INFO(fmt, args...)          PYPTO_SIM_LOG(DLOG_INFO, npu::tile_fwk::LogModule::MACHINE, fmt, ##args)
#define DEV_WARN(fmt, args...)          PYPTO_SIM_LOG(DLOG_WARN, npu::tile_fwk::LogModule::MACHINE, fmt, ##args)
#define DEV_ERROR(fmt, args...)         PYPTO_SIM_LOG(DLOG_ERROR, npu::tile_fwk::LogModule::MACHINE, fmt, ##args)
