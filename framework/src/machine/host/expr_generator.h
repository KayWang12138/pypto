...
public:
    ...
    template<typename BuildExpressionFunc>
    void GenerateBatchFile(std::ostringstream &controlFlowOss, std::ostringstream &exprHeaderOss, ExprBatchInfo& batch,
        const std::string &expName, std::vector<std::string> &exprSrcFiles, int indent, int devRootKey, const BuildExpressionFunc& buildExpr) {
