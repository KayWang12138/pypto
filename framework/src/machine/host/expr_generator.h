...
public:
    ...
    void GenerateBatchFile(SymbolicExpressionTable *exprTable, std::ostringstream &controlFlowOss, std::ostringstream &exprHeaderOss, const std::string &expName,
        const ExpressionSet& expressions, std::vector<std::string> &exprSrcFiles, int indent, int devRootKey) {
