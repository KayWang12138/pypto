...
uint64_t ShmemWaitUntil::GetRawAddrV1(uint64_t groupIndex, uint64_t dstRankId, uint64_t offset, uint64_t memType)
{
...
uint64_t ShmemWaitUntil::GetRawAddrV2(uint64_t groupIndex, uint64_t dstRankId, uint64_t offset)
{
