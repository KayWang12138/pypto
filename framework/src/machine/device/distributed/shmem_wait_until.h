...
public:
    ...
    inline int32_t PrepareTask(uint64_t taskId, const npu::tile_fwk::dynamic::DevRelocVector<int32_t>& aicpuCode)
    {
        ...
        DEV_DEBUG(
            ...
            paramInfo_.rawShape[3], paramInfo_.rawShape[4], paramInfo_.tileShapeRow, paramInfo_.tileShapeCol,
            info.offset[3], info.offset[4], info.offset[MAX_TENSOR_DIM - info.dim], paramInfo_.rankNum, totalTileNum,
            info.offset[MAX_TENSOR_DIM - info.dim], tileIndex, paramInfo_.maxTileNum, paramInfo_.bufferStride);
