...
public:
    ...
    inline int32_t PrepareTask(uint64_t taskId, const npu::tile_fwk::dynamic::DevRelocVector<int32_t>& aicpuCode)
    {
        ...
        DEV_DEBUG( 
            ...
            info.offset[3], info.offset[4], info.offset[MAX_TENSOR_DIM - info.dim], 
            GetRankNum(hcclContextAddr_, info.vaddr), totalTileNum, info.offset[MAX_TENSOR_DIM - info.dim], tileIndex, 
