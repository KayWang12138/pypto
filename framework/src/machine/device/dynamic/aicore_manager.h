...
#include "machine/device/schema_trace_utils.h"
...
private:
    ...
    {
        SchemaDumpUtil::DumpSchemaOperationInfo(reinterpret_cast<DynDeviceTask*>(curDevTask_), GetDuppedData(newTask), coreIdx, newTask);
