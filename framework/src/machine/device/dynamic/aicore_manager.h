...
public:
    ...
    inline void SetCommonMembers(SchduleContext * context) {
    ...
    inline void InitDevTask(DeviceTaskCtrl *taskCtrl) {
        ...
        wrapManager_.Init(curDevTask_, context_->coreRunReadyCnt_, context_->runReadyCoreIdx_[CORE_IDX_AIV],
            context_->runReadyCoreIdx_[CORE_IDX_AIC], context_->corePendReadyCnt_, aicValidNum_,
...
private:
    ...
    inline void ResetCnt() {
        context_->waitTaskCnt_[static_cast<int>(CoreType::AIC)] = 0;
        context_->waitTaskCnt_[static_cast<int>(CoreType::AIV)] = 0;
        context_->readyCount[static_cast<int>(CoreType::AIC)] = 0;
        context_->readyCount[static_cast<int>(CoreType::AIV)] = 0;
        context_->sendCnt_[static_cast<int>(CoreType::AIC)] = 0;
        context_->sendCnt_[static_cast<int>(CoreType::AIV)] = 0;
    }
