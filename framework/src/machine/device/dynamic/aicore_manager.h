...
>>>>>>> c54cbc90 (fix(machine): Add macro to control LeafFunc info dumping)
...
private:
    ...
    */
    ...
    {
        SchemaDumpUtil::DumpSchemaOperationInfo(reinterpret_cast<DynDeviceTask*>(curDevTask_), coreIdx, newTask, curTaskCtrl_->taskId);
