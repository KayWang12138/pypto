...
public:
    ...
    inline void InitDevTask(DeviceTaskCtrl* taskCtrl)
    {
        ...
        memset_s(
            &context_->wrapCoreAvail_[aicStart_], sizeof(bool) * (aicEnd_ - aicStart_), true,
            sizeof(bool) * (aicEnd_ - aicStart_));
        memset_s(
            &context_->wrapCoreAvail_[aivStart_], sizeof(bool) * (aivEnd_ - aivStart_), true,
            sizeof(bool) * (aivEnd_ - aivStart_));
        wrapManager_.Init(
