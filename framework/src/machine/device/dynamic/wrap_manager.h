...
public:
    ...
    inline void UpdateWrapQueueForThread() {
        ...
        while (taskCount-- > 0) {
            ...
            wrapCoreAvail_[wrapInfo->aicCoreIdx] = false;
            wrapCoreAvail_[wrapInfo->aivCoreIdxZero] = false;
            wrapCoreAvail_[wrapInfo->aivCoreIdxOne] = false;
    ...
    inline void UpdateFinishIdForMixCore(uint32_t finishId) {
        ...
        if (wrapInfo->taskCnt == 0) { // all tasks for this wrap finish
            ...
            wrapCoreAvail_[wrapInfo->aicCoreIdx] = true;
            wrapCoreAvail_[wrapInfo->aivCoreIdxZero] = true;
            wrapCoreAvail_[wrapInfo->aivCoreIdxOne] = true;
