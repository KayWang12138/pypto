...
constexpr uint64_t PROF_TASK_TIME_L3 = 0x00000021ULL;

constexpr uint64_t PYPTO_PROF_TASK_TIME_L2_MASK = 0x00002000ULL;
constexpr uint64_t PYPTO_PROF_TASK_TIME_L3_MASK = 0x00008000ULL;
