...
inline const std::map<ArchInfo, ArchPmuConfig> kArchPmuConfigs = {
    {ArchInfo::DAV_2201,
     {{PMU_CNT0_IDX, PMU_CNT1_IDX, PMU_CNT2_IDX, PMU_CNT3_IDX, PMU_CNT4_IDX, PMU_CNT5_IDX, PMU_CNT6_IDX,
     PMU_CNT7_IDX},
     {PMU_CNT0, PMU_CNT1, PMU_CNT2, PMU_CNT3, PMU_CNT4, PMU_CNT5, PMU_CNT6, PMU_CNT7}, PMU_CNT_TOTAL0,
     PMU_CNT_TOTAL1, PMU_CTRL_0, 0, PMU_START_CNT_CYC_0, PMU_START_CNT_CYC_1, PMU_STOP_CNT_CYC_0,
     PMU_STOP_CNT_CYC_1, GLB_PMU_EN + (USER_PMU_MODE_EN << 1) + (SAMPLE_PMU_MODE_EN << NUM_TWO_PMU), 0}},
    {ArchInfo::DAV_3510,
     ...
     DAV_3510::PMU_CNT_TOTAL0, DAV_3510::PMU_CNT_TOTAL1, DAV_3510::PMU_CTRL_0, DAV_3510::PMU_CTRL_1,
     DAV_3510::PMU_START_CNT_CYC_0, DAV_3510::PMU_START_CNT_CYC_1, DAV_3510::PMU_STOP_CNT_CYC_0,
     DAV_3510::PMU_STOP_CNT_CYC_1, USER_PMU_MODE_EN + (SAMPLE_PMU_MODE_EN << 1), GLB_PMU_EN}           }
};
