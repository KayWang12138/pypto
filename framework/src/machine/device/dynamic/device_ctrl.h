...
private:
    static void DumpTask(int64_t taskId, DeviceTask *devTask, bool isDyn) {
        ...
        DEV_DEBUG("readyAicCoreFunctionQue: head=%lu, tail=%lu.",
            static_cast<unsigned long>(readyFunc->head),
            static_cast<unsigned long>(readyFunc->tail));
        ...
        DEV_DEBUG("readyAivCoreFunctionQue: head=%lu, tail=%lu.",
            static_cast<unsigned long>(readyFunc->head),
            static_cast<unsigned long>(readyFunc->tail));
        for (uint64_t i = readyFunc->head; i < readyFunc->tail; i++) {
        ...
        DEV_DEBUG("readyAicpuFunctionQue: head=%lu, tail=%lu.",
            static_cast<unsigned long>(readyFunc->head),
            static_cast<unsigned long>(readyFunc->tail));
        for (uint64_t i = readyFunc->head; i < readyFunc->tail; i++) {
