...
void* DeviceExecuteContext::DeviceExecuteRuntimeCallShmemAllocator(void* ctx_, uint64_t value)
{
    ...
    uint64_t vaddr = ctx->shmemAddrOffset[memType] | (maxTileNum << TileOp::VirtualAddr::TILE_NUM_SHIFT) |
                     (groupIndex << TileOp::VirtualAddr::GROUP_SHIFT) |
                     (memType << TileOp::VirtualAddr::MEMTYPE_SHIFT) |
                     (1UL << TileOp::VirtualAddr::FILL_SHIFT);
