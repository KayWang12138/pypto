...
int DeviceStitchContext::MoveTo(DynDeviceTask *dynTask, DevAscendProgram *devProg) {
    ...
    AllocOpWrapList (dynTask, isNeedWrap);
 	AllocOpWrapTaskNumList (dynTask, isNeedWrap);
