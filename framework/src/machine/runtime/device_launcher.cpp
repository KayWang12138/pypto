...
AclModeGuard::AclModeGuard(AclMdlRICaptureMode tmode) : mode(tmode) { AclMdlRICaptureThreadExchangeMode(&mode); }
...
int64_t DeviceLauncher::GetL2Offset() { return machine::GetRA()->GetL2Offset(); }
