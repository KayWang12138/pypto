...
extern "C" void DumpDevTaskPerfData(DeviceArgs &args, const std::vector<void *> &perfData) {
    uint64_t freq = (args.archInfo == ArchInfo::DAV_2201) ? npu::tile_fwk::dynamic::FREQ_DAV_2201 : npu::tile_fwk::dynamic::FREQ_DAV_3510;
...
void DumpAicpuPerfInfo(DeviceArgs &args, const std::vector<void *> &perfData, const uint32_t &freq) {
    ...
    MACHINE_LOGE("=========xxxx=========devAddr: %p, g_prof_turn: %u", devPtr, g_prof_turn);
