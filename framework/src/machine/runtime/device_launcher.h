...
public:
    ...
    static void PreparehcclContext(std::vector<uint64_t> hcclContext, const std::vector<uint8_t> &devProgData) {
    ...
    static void DeviceInitDistributedContextToHost(const std::vector<std::string> &groupNames,
        ...
        PreparehcclContext(std::vector<uint64_t> hcclContext, devProgData);
