...
public:
    ...
    static void PrepareDevProgArgs(DevAscendProgram *devProg, DeviceLauncherConfig &config, [[maybe_unused]] bool isDevice) {
...
#ifdef BUILD_WITH_CANN
        devProg->devArgs.validGetPgMask = machine::GetRA()->GetValidGetPgMask();
#endif
