...
int MachineAgent::PrepareReadyCoreFunction(DeviceAgentTask *task) {
    ...
    funcSetQue(task->deviceInfo.readyAicQueElmGmAddr, task->deviceInfo.readyAicQueGmAddr, task->compileInfo.readyAicIdVec.size());
    funcSetQue(task->deviceInfo.readyAivQueElmGmAddr, task->deviceInfo.readyAivQueGmAddr, task->compileInfo.readyAivIdVec.size());
    funcSetQue(task->deviceInfo.readyAicpuQueElmGmAddr, task->deviceInfo.readyAicpuQueGmAddr, task->compileInfo.readyAicpuIdVec.size());
#endif
