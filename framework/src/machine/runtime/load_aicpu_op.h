...
public:
    ...
    int LaunchBuiltInOp(rtStream_t stream, KernelArgs *kArgs, const int &aicpuNum, const std::string &funcName);
    int GetBuiltInOpBinHandle();
    int LaunchCustomOp(rtStream_t stream, KernelArgs *kArgs, std::string &OpType);
