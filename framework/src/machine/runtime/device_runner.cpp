...
int DeviceRunner::launchDynamicAiCore(rtStream_t aicoreStream, KernelArgs *kernelArgs) {
    rtArgsEx_t rtArgs;
    memset_s(&rtArgs, sizeof(rtArgs), 0, sizeof(rtArgs));
...
int DeviceRunner::launchDynamicAiCpu(rtStream_t aicpuStream, KernelArgs *kArgs) {
...
int DeviceRunner::launchDynamicAiCpuInit(rtStream_t aicpuStream, KernelArgs *kArgs) {
#ifdef BUILD_WITH_NEW_CANN
...
int DeviceRunner::DynamicKernelLaunch(rtStream_t aicpuStream, rtStream_t aicoreStream, KernelArgs *kernelArgs, int blockdim) {
...
int DeviceRunner::DynamicSeparateLaunch(rtStream_t aicpuStream, rtStream_t ctrlStream, rtStream_t aicoreStream,
    KernelArgs *kernelArgs, int blockdim) {
...
int DeviceRunner::DynamicLaunch(rtStream_t aicpuStream, rtStream_t ctrlStream, rtStream_t aicoreStream, int64_t taskId,
    KernelArgs *kernelArgs, int blockdim, int launchAicpuNum) {
...
int DeviceRunner::DynamicRun(rtStream_t aicpuStream, rtStream_t ctrlStream, rtStream_t aicoreStream, int64_t taskId, KernelArgs *kernelArgs, int blockdim, int launchAicpuNum) {
