...
constexpr int MAX_DIFF_AICPU_NUM = 2;
...
int DeviceRunner::InitDeviceArgs(DeviceArgs &args) {
    ...
    aicpuNum_ = args.archInfo == ArchInfo::DAV_2201 ? npu::tile_fwk::dynamic::DEVICE_MAX_AICPU_NUM - MAX_DIFF_AICPU_NUM :
        npu::tile_fwk::dynamic::DEVICE_MAX_AICPU_NUM;
