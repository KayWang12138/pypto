...
int DeviceRunner::launchDynamicAiCpu(rtStream_t aicpuStream, DeviceKernelArgs *kArgs) {
...
#endif
    auto args = reinterpret_cast<struct AiCpuArgs*>(kArgs.inputs);
    ...
    rtArgs.kernelNameAddrOffset = offsetof(struct AiCpuArgs, kernelName);
    rtArgs.soNameAddrOffset = offsetof(struct AiCpuArgs, soName);
