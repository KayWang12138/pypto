...
LaunchMode LauncherRouter::ResolveByDebugMode(int64_t debugMode)
{
    ...
    if (debugMode == CFG_DEBUG_E2E_HOST_SIM) {
        return LaunchMode::E2E_HOST_SIM;
    }
...
bool LauncherRouter::IsE2EHostSimEnabled() { return ResolveCurrent() == LaunchMode::E2E_HOST_SIM; }
