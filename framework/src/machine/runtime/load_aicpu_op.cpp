...
int LoadAicpuOp::AicpuKernelLaunch([[maybe_unused]]void* funcHandle, [[maybe_unused]]const rtStream_t &stream,
 	                                     [[maybe_unused]]KernelArgs *kArgs, [[maybe_unused]]const uint32_t &blockDim) {
#ifdef BUILD_WITH_NEW_CANN
    ...
    rtArgs.args = kArgs;
    rtArgs.argsSize = sizeof(KernelArgs);
...
int LoadAicpuOp::LaunchCustomOp([[maybe_unused]]rtStream_t stream, [[maybe_unused]]KernelArgs *kArgs, [[maybe_unused]]std::string &OpType) {
#ifdef BUILD_WITH_NEW_CANN
...
int LoadAicpuOp::LaunchBuiltInOp([[maybe_unused]]rtStream_t stream, [[maybe_unused]]KernelArgs *kArgs, [[maybe_unused]]const int &aicpuNum,
