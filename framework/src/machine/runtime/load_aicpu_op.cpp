...
int LoadAicpuOp::LaunchCustomOp(
    [[maybe_unused]] RtStream stream, [[maybe_unused]] DeviceKernelArgs* kArgs, [[maybe_unused]] std::string& OpType)
{
#ifdef BUILD_WITH_NEW_CANN
...
int LoadAicpuOp::LaunchBuiltInOp(
    [[maybe_unused]] RtStream stream, [[maybe_unused]] DeviceKernelArgs* kArgs, [[maybe_unused]] const int& aicpuNum,
