...
public:
  ...
  void HostProfReportCacheTaskInfo(const aclrtStream_t stream, const uint32_t numBlocks, const uint32_t taskType) const;
...
private:
  ...
  static bool IsCacheOpInfoEnable(const aclrtStream_t stream);
