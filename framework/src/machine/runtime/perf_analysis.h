...
enum class TracePhase {
    ...
    RUN_DEV_KERNEL_INIT_ERR_CALLBACK,
    RUN_DEV_KERNEL_INIT_AICPUSO,
    RUN_DEV_KERNEL_INIT_KERNEL_ARGS,
    RUN_DEV_KERNEL_INIT_H2D_MEMCPY,
    RUN_DEV_KERNEL_INIT_RUN_PREPARE,
...
inline const std::string TraceName[] = {
    ...
    "RunDevKernelInitErrCallBack",
    "RunDevKernelInitAicpuSo",
    "RunDevKernelInitKernelArgs",
    "RunDevKernelInitH2DMemCopy",
    "RunDevKernelInitRunPrepare",
