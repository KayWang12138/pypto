...
public:
    ...
    virtual uint8_t* AllocDev(uint64_t size) = 0;
    ...
    virtual void Run(npu::tile_fwk::DynFuncData *funcdata, int coreId, int funcId, int taskId, std::map<uint64_t, uint64_t> tensorAddr2SizeMap) = 0;
