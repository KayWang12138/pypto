...
const std::map<std::string, CorePipeType> SCHED_CORE_PIPE_TYPE { // Unary Vector
    ...
    {"CUBE_CONV_D2S", CorePipeType::PIPE_CUBE},
    {"CUBE_CONCAT_C", CorePipeType::PIPE_CUBE},
    // Ternary Vector
    ...
    // MTE
    {"L1_COPY_IN", CorePipeType::PIPE_MTE_IN},
    {"L1_COPY_IN_FRACTAL_Z", CorePipeType::PIPE_MTE_IN},
    ...
    {"UB_COPY_L1_ND", CorePipeType::PIPE_MTE_IN},
    {"L1_TO_L1", CorePipeType::PIPE_MTE_IN},
    {"L0C_TO_L1", CorePipeType::PIPE_MTE_OUT},
    {"L1_TO_L0_AT", CorePipeType::PIPE_MTE1},
    {"L1_TO_L0_BT", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX_QUANT_PRE", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX_RELU_PRE", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX_RELU_POST", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX_QUANT_POST", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX_ELT_ANTIQ", CorePipeType::PIPE_MTE1},
    {"L1_TO_FIX_MTE2_ANTIQ", CorePipeType::PIPE_MTE_IN},

    // Scala
    {"NOP", CorePipeType::TOTAL_CORE_PIPE_TYPE},
    {"PRINT", CorePipeType::PIPE_S},
    ...
    {"SHMEM_CLEAR_SIGNAL", CorePipeType::PIPE_S},
    ...
    {"COMPARE_SWAP", CorePipeType::PIPE_VECTOR_ALU},
