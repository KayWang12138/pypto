...
private:
    ...
    void DumpTensorContents(const KernelArgs &kArgs,
    ...
    void RunCostModel(KernelArgs *kArgs) {
    ...
    void RunTestMode(KernelArgs *kArgs) {
        (void) kArgs;
    ...
    void InitKernelInOuts(KernelArgs &kArgs, const std::vector<RawTensorDataPtr> &inputTensors,
