...
Status ExpandFunctionChecker::DoPostCheck(Function &function) {
    ...
    if (!function.OperationLoopCheck()) {
        APASS_LOG_ERROR_F(Elements::Function, "Operation Loop detected after expand function; Please review the error "
                                              "messages generated during the processing procedure.");
        return FAILED;
    }
