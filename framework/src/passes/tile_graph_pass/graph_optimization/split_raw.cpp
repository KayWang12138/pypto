        ...
        if (viewOpAttribute != nullptr) {
            ...
            if (!viewOpAttribute->GetFromDynOffset().empty()) {
                ...
                if (!tensorOffset.GetDynOffset().empty()) {
                    ...
                    fromDynOffset = UpdateDynOffset(fromDynOffset, OpImmediate::ToSpecified(OpImmediate::Specified(tensorOffset.GetOffset())));
                }
            }
        }
        ...
        if (assembleOpAttribute != nullptr) {
            ...
            if ( && !assembleOpAttribute->GetToDynOffset().empty()) {
                ...
                if (!tensorOffset.GetDynOffset().empty()) {
                    ...
                    toDynOffset = UpdateDynOffset(toDynOffset, OpImmediate::ToSpecified(OpImmediate::Specified(tensorOffset.GetOffset())));
                }
            }
        }
