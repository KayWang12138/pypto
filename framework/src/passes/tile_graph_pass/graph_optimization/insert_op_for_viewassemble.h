...
private:
    ...
    void InsertCopyUBOp(Function &function, Operation *cons, LogicalTensorPtr &input);
    void InsertCopyDDROp(Function &function, Operation *cons, LogicalTensorPtr &input);
