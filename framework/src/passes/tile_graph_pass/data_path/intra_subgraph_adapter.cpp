...
LogicalTensorPtr IntraSubgraphAdapter::InsertOpBetween(Function &function, Opcode opcode,
    ...
    ASSERT(ERROR_CODE_UNDEFINED, opcode == Opcode::OP_ASSEMBLE) << "[IntraSubgraphAdapter][Operation][ERROR]: Opcode for IntraSubgraphAdapter::InsertOpBetween must be OP_ASSEMBLE.";
...
LogicalTensorPtr IntraSubgraphAdapter::InsertOpBetween(Function &function, Opcode opcode,
    ...
    */
    ...
    ASSERT(ERROR_CODE_UNDEFINED, opcode == Opcode::OP_VIEW || opcode == Opcode::OP_ASSEMBLE) << "[IntraSubgraphAdapter][Operation][ERROR]: Opcode for IntraSubgraphAdapter::InsertOpBetween must be OP_VIEW or OP_ASSEMBLE.";
    auto newRawTensor = std::make_shared<RawTensor>(tensor->Datatype(),
        tensor->GetRawTensor()->rawshape, tensor->Format());
    LogicalTensorPtr newTensor = std::make_shared<LogicalTensor>(function, newRawTensor,
