...
public:
    ...
    bool ForwardFindAssembleInsertedCopy(LogicalTensorPtr input, std::unordered_set<Operation*> &concurrentAssembles) const;
    bool BackwardFindAssembleInsertedCopy(LogicalTensorPtr input, std::unordered_set<Operation*> &concurrentAssembles) const;
