 ...
 */
void CommonOperationEliminate::InsertCopyUBOp(Function &function, Operation *needInsertCopyAssOp, LogicalTensorPtr &input) {
 ...
 */
void CommonOperationEliminate::InsertCopyDDROp(Function &function, Operation *needInsertCopyAssOp, LogicalTensorPtr &input) {
    auto copyShape = input->GetShape();
    auto copyDynShape = input->GetDynValidShape();
    Offset offset(copyShape.size(), 0);
 ...
 */
void CommonOperationEliminate::FindNeedToCopyAssemble(std::unordered_set<Operation*> &needInsertCopyAssOps, std::unordered_set<int> &visitedAssOps, Operation &op) {
 ...
 *         ---> Assemble ---> Tensor4
 */
void CommonOperationEliminate::InsertAssembleCopy(Function &function) {
