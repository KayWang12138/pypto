...
public:
    ...
    /**
     * @brief Get last-dimension alignment base in elements, fallback to 1.
     *
     * @param tensor input logical tensor.
     * @return alignment base in elements; return 1 when unable to infer.
     */
    static int64_t GetLastDimAlignBaseOrOne(const LogicalTensorPtr& tensor);
