...
private:
    ...
    Operation* PickReusableCopyOut(const std::vector<Operation*> &consumers, LogicalTensorPtr spillTensor);
    bool IsFullCopyOut(const std::shared_ptr<CopyOpAttribute> &attr, LogicalTensorPtr spillTensor);
