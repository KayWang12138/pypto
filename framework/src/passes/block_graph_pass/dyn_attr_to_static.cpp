        ...
        std::vector<std::vector<SymbolicScalar>>& callopArglistOneDim)
{
    ...
    // 3. 刷新新的COA宏
    APASS_LOG_INFO_F(Elements::Operation, "BuildNewCoa update dynScalar[%s] with isConst=%d, value=%d.", dynParamExpr.c_str(), scalarValue.isConst, scalarValue.attrValue);
