...
void MemUsedCalculation(uint64_t &memUsed, Operation* op, Shape& vectorTilesNew, Shape& vectorTilesOut) 
{
...
void AdjustTileToUB(Operation* op, Shape& vectorTilesNew) 
{
    ...
    uint64_t memUsed = 0;
    MemUsedCalculation(memUsed, op, vectorTilesNew, vectorTilesOut);
