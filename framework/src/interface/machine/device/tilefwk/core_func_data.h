...
struct MixTaskData {
    ...
    uint64_t opWrapList[MAX_WRAP_FUNC_NUM]; // 指针数组，指向每个function的callop对应的wrapId
    uint64_t opWrapTaskNumList[MAX_WRAP_FUNC_NUM]; // 指针数组，指向每个function的callop对应的wrapTaskNum
};
