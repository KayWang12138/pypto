...
#define RT_INIT_ADDR(name, primType, space, addr, size) RT_##primType RT_##space *name##_S = (RT_##primType RT_##space *)get_imm(addr);\
...
#define RT_OPERATION_OP_SCALAR_CALL_3_RETVOID(ret, arg0, arg1, arg2, callee) ret = callee(arg0, arg1, arg2)
...
#define RT_OPERATION_OP_ADD(dst, src0, src1, combineAxis) TAdd(dst, src0, src1)
