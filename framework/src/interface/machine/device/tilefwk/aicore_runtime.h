...
#define GET_PARAM_STRIDE_2(val0) (val0), 1
...
#define GET_PARAM_STRIDE_3(val0, val1) (val0) * (val1), (val1), 1
...
#define GET_PARAM_STRIDE_4(val0, val1, val2) (val0) * (val1) * (val2), (val1) * (val2), (val2), 1
...
#define GET_PARAM_STRIDE_5(val0, val1, val2, val3) (val0) * (val1) * (val2) * (val3), (val1) * (val2) * (val3), (val2) * (val3), (val3), 1
...
#define RUNTIME_COA_GET_PARAM_RAW_SHAPE(dim, base, idx)                             GET_PARAM_RAWSHAPE_BY_IDX(param, 0, base, dim, idx)
...
#define RUNTIME_COA_GET_PARAM_RAW_SHAPE_MAYBE_CONST_0(value, dim, base, idx)           RUNTIME_COA_GET_PARAM_RAW_SHAPE(dim, base, idx)
#define RUNTIME_COA_GET_PARAM_RAW_SHAPE_MAYBE_CONST_1(value, dim, base, idx)           value
#define RUNTIME_COA_GET_PARAM_RAW_SHAPE_MAYBE_CONST(isConst, value, dim, base, idx)    RUNTIME_COA_GET_PARAM_RAW_SHAPE_MAYBE_CONST_##isConst(value, dim, base, idx)
