...
#if defined(__DAV_M300__) || defined(__DAV_310R6__) || \
    defined(__DAV_L510__) || (__NPU_ARCH__ == 5102) || \
    (__NPU_ARCH__ == 9201) || (__NPU_ARCH__ == 3801) || (__NPU_ARCH__ == 3101)
typedef float8_e4m3_t float8_t;
#define __FLOAT8_T_AVAILABLE__ 1
#endif
#endif
