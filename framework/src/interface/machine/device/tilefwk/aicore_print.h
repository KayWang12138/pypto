...
namespace Fp8E8M0Const {
    ...
    constexpr uint8_t EXP_MASK   = 0x7F;
...
INLINE float DecodeFp8E8M0(uint8_t bits) {
    ...
    const int8_t exp   = static_cast<int8_t>(bits & Fp8E8M0Const::EXP_MASK);
...
#undef AICORE_STATIC_PRINT_WRAPPER
    ...
    __aicore__ void EncodeTyped(AicorePrint::DataType ty, [[maybe_unused]]PtrT val, short valLen, __gm__ const char* fmt, int fmtLen) {
