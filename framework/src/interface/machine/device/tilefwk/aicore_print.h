...
inline uint32_t BF16_TO_FP32_SHIFT = 16;
inline uint16_t F16_SIGN_MASK = 0x8000u;
inline uint16_t F16_EXP_MASK = 0x7C00u;
inline uint16_t F16_MANT_MASK = 0x03FFu;
inline uint16_t F16_NORM_HIDDEN_BIT = 0x0400u;
inline uint16_t F16_EXP_INF_NAN = 0x1Fu;
inline uint16_t FP32_EXP_INF_NAN = 0xFFu;

inline uint32_t F16_SIGN_SHIFT = 15;
inline uint32_t F16_EXP_SHIFT = 10;
inline uint32_t FP32_SIGN_SHIFT = 31;
inline uint32_t FP32_EXP_SHIFT = 23;
inline uint32_t F16_TO_FP32_MANT_SHIFT = 13;

inline uint32_t F16_EXP_BIAS = 15;
inline uint32_t FP32_EXP_BIAS = 127;
inline uint32_t F16_SUBNORMAL_FP32_EXP_BASE = FP32_EXP_BIAS - (F16_EXP_BIAS - 1);
