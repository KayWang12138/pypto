...
template <typename T, typename PtrT>
INLINE void __AiCorePrintTensorImplNamed(LogContext* ctx, PtrT data, int64_t end,
...
{
    __AiCorePrintTensorImplNamed<T>(ctx, data, end, begin, name);
}
