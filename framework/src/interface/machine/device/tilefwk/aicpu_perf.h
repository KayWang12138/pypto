...
#define PERF_TRACES                             \
    ...
    XDEVTASK(DEV_TASK_RUN_CORE_TASK)   \
    XDEVTASK(DEV_TASK_SEND_CALLOP_TASK)   \
    XDEVTASK(DEV_TASK_DISPATCH_TASK)   \
    XDEVTASK(DEV_TASK_DISPATCH_RESOL_TASK)   \
    XDEVTASK(DEV_TASK_DISPATCH_RESOL_REG_TASK)   \
    XDEVTASK(DEV_TASK_ENTER_DISPATCH_TASK)   \
    XDEVTASK(DEV_TASK_ENTER_RESOLVE_DEP_DYN)   \
    XDEVTASK(DEV_TASK_OUT_RESOLVE_DEP_DYN)   \
...
inline constexpr uint32_t PERF_TRACE_COUNT_DEVTASK_MAX_NUM = 35;
