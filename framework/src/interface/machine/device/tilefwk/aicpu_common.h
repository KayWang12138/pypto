...
inline const char *AicorePerfTraceName[] = {"BEGIN", "INIT", "DEV_TASK_RCV_MODEL",
    "DEV_TASK_WAIT_RCV_FIRST_CALLOP_TASK", "DEV_TASK_ALL_CALLOP_TASK_EXEC", "DEV_TASK_WAIT_SYNC_STOP_NOTIFY",
    "WAIT_ALL_DEV_TASK_CALLOP_EXEC_FINISH", "WAIT_EXIT_NOTIFY"};
