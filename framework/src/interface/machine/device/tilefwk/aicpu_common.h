...
struct DeviceArgs {
    ...
    uint64_t generalAddr{0};     // aicpu meta addr
    uint64_t stitchPoolAddr{0};  // aicpu meta addr
    uint64_t aicpuPerAddr{0};    // aicpuPer Gm addr
...
struct AicpuMetrPer {
    uint64_t perfAicpuTrace[npu::tile_fwk::dynamic::MAX_USED_AICPU_NUM][npu::tile_fwk::dynamic::PERF_TRACE_MAX];
    uint64_t perfAicpuTraceDevTask[npu::tile_fwk::dynamic::MAX_USED_AICPU_NUM][npu::tile_fwk::dynamic::DEVTASK_PERF_TYPE_NUM][npu::tile_fwk::dynamic::PERF_TRACE_COUNT_DEVTASK_MAX_NUM]; // 每个devTask 的对应type的数据
    uint8_t perfAicpuTraceDevTaskCnt[npu::tile_fwk::dynamic::MAX_USED_AICPU_NUM][npu::tile_fwk::dynamic::DEVTASK_PERF_TYPE_NUM];
};
