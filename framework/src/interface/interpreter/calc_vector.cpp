...
void ExecuteOpBinaryScalar(ExecuteOperationContext *ctx) {
    ...
    switch (opcode) {
        ...
        case Opcode::OP_SBITWISERIGHTSHIFT: calc::SBitwiseRightShiftS(ret, element, lhs); break;
        case Opcode::OP_SBITWISELEFTSHIFT: calc::SBitwiseLeftShiftS(ret, element, lhs); break;
        default: ASSERT(false);
    }
}
...
REGISTER_CALC_OP(OP_SBITWISERIGHTSHIFT, Opcode::OP_SBITWISERIGHTSHIFT, ExecuteOpBinaryScalar<Opcode::OP_SBITWISERIGHTSHIFT>);
REGISTER_CALC_OP(OP_SBITWISELEFTSHIFT, Opcode::OP_SBITWISELEFTSHIFT, ExecuteOpBinaryScalar<Opcode::OP_SBITWISELEFTSHIFT>);
