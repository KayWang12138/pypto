...
void ExecuteOpAssemble(ExecuteOperationContext *ctx) {
    ASSERT(ExecuteOperationScene::INVALID_OP_CONTEXT,
           ctx->ooperandInplaceDataViewList->size() == 1);
    ASSERT(ExecuteOperationScene::INVALID_OP_CONTEXT,
           ctx->ioperandDataViewList->size() <= NUM_VALUE_2);
    ASSERT(ExecuteOperationScene::INVALID_OP_CONTEXT, ctx->op != nullptr);
...
void ExecuteOpViewType(ExecuteOperationContext *ctx) {
    ...
    auto &oop = ctx->ooperandInplaceDataViewList->at(0);
    auto &iop = ctx->ioperandDataViewList->at(0);
    ASSERT(ExecuteOperationScene::INVALID_OP_CONTEXT, oop != nullptr && iop != nullptr);
    ...
    ASSERT(ExecuteOperationScene::INVALID_TENSOR_SIZE, srcBytes == dstBytes);
...
void ExecuteOpCopyOut(ExecuteOperationContext *ctx) {
    ...
    auto &oop = ctx->ooperandInplaceDataViewList->at(0);
    auto iop = ctx->ioperandDataViewList->at(0);
    ASSERT(ExecuteOperationScene::INVALID_OP_CONTEXT, iop != nullptr && oop != nullptr);
    ...
    ASSERT(ExecuteOperationScene::INVALID_OP_CONTEXT, oopValid != nullptr);
