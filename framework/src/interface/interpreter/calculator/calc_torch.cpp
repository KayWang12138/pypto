...
static void PhiloxRandom(const TensorData &out, const std::vector<uint32_t> &key,
    ...
    std::vector<uint32_t> currentKey = key;
    std::vector<uint32_t> currentCounter = counter;
