...
DEFINE_BINARY_S_OPS(SBitwiseRightShiftS, bitwise_right_shift_out)
DEFINE_BINARY_S_OPS(SBitwiseLeftShiftS, bitwise_left_shift_out)
...
static struct CalcOps calcOps = {
    ...
    .SBitwiseRightShiftS = SBitwiseRightShiftS,
    .SBitwiseLeftShiftS = SBitwiseLeftShiftS,
};
