...
inline void Topk(LogicalTensorDataPtr out, LogicalTensorDataPtr self, int k, int axis, bool descending) {
    GetCalcOps()->Topk(out, self, k, axis, descending);
}

inline void TopK(LogicalTensorDataPtr outValue, LogicalTensorDataPtr outIndex, LogicalTensorDataPtr self, int64_t axis, int64_t k, bool descending) {
