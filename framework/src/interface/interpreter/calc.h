...
inline void SBitwiseRightShiftS(LogicalTensorDataPtr out, const Element &scalar, LogicalTensorDataPtr other) {
    GetCalcOps()->SBitwiseRightShiftS(out, scalar, other);
}
inline void BitwiseLeftShiftS(LogicalTensorDataPtr out, const Element &scalar, LogicalTensorDataPtr other) {
    GetCalcOps()->SBitwiseLeftShiftS(out, scalar, other);
}
