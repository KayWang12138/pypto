...
struct CalcOps {
    ...
    void (*SBitwiseRightShiftS)(LogicalTensorDataPtr, const Element &, LogicalTensorDataPtr);
    void (*SBitwiseLeftShiftS)(LogicalTensorDataPtr, const Element &, LogicalTensorDataPtr);
};
