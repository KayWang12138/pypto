...
struct CalcOps {
    ...
    void (*BitwiseRightShiftS)(LogicalTensorDataPtr, LogicalTensorDataPtr, const Element &, bool);
    void (*BitwiseLeftShiftS)(LogicalTensorDataPtr, LogicalTensorDataPtr, const Element &, bool);
};
