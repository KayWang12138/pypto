...
FlowVerifier::CompareResult FlowVerifier::VerifyResult(
    ...
    switch (goldenDataView->GetDataType()) {
        ...
        case DT_FP16: return CompareData<npu::tile_fwk::float32>(goldenDataView, outputDataView, rtol, atol);
        case DT_FP32: return CompareData<double>(goldenDataView, outputDataView, rtol, atol);
        case DT_BF16: return CompareData<npu::tile_fwk::float32>(goldenDataView, outputDataView, rtol, atol);
