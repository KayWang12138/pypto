...
public:
    ...
    size_t GetStackWorkespaceSize() const { return stackWorkespaceSize_; }
    void SetStackWorkespaceSize(size_t size) { stackWorkespaceSize_ = size; }
