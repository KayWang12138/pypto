...
public:
    ...
    {
        ASSERT(FError::EINTERNAL, opImm.IsSpecified());
        ...
        int coaIndex, bool valueToIndex)
    {
        ...
        for (auto& op : opImmList) {
            ASSERT(FError::EINTERNAL, op.IsSpecified());
    ...
    {
        ASSERT(FError::EINTERNAL, IsSpecified());
    ...
    {
        ASSERT(FError::EINTERNAL, IsParameter());
    ...
    {
        ASSERT(FError::EINTERNAL, IsSpecified() && rhs.IsSpecified());
