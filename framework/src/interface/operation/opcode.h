...
const std::unordered_set<Opcode> BINARY_OPS{
    ...
    Opcode::OP_COLEXPANDEXPDIF,
    Opcode::OP_ROWEXPANDEXPDIF,
};
...
const std::unordered_set<Opcode> SUPPORT_DYNAMIC_UNALIGNED_OPS{Opcode::OP_RANGE, Opcode::OP_TRANSPOSE_VNCHWCONV,
    ...
    Opcode::OP_SBITWISERIGHTSHIFT, Opcode::OP_SBITWISELEFTSHIFT, Opcode::OP_COLEXPANDEXPDIF, Opcode::OP_ROWEXPANDEXPDIF};
