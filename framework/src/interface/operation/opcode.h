...
const std::unordered_set<Opcode> UNSUPPORT_BF16_OPS{Opcode::OP_EXP, Opcode::OP_RSQRT, Opcode::OP_SQRT, Opcode::OP_RELU,
    ...
    Opcode::OP_ROWPRODLINE, Opcode::OP_FLOORDIV, Opcode::OP_FLOORDIVS, Opcode::OP_ROWARGMIN_SINGLE, Opcode::OP_ROWARGMINLINE,
    Opcode::OP_ROWARGMAX_SINGLE, Opcode::OP_ROWARGMAXLINE};
