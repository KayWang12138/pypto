...
const std::unordered_set<Opcode> UNSUPPORT_BF16_OPS{Opcode::OP_EXP, Opcode::OP_RSQRT, Opcode::OP_SQRT, Opcode::OP_RELU,
    ...
    Opcode::OP_ROWEXPSUM, Opcode::OP_ROWSUMLINE, Opcode::OP_ROWARGMAXLINE, Opcode::OP_ROWMAXLINE, Opcode::OP_ROWMINLINE, Opcode::OP_ROWMAX_SINGLE,
    ...
    Opcode::OP_ROWPRODLINE, Opcode::OP_ROWARGMIN_SINGLE, Opcode::OP_ROWARGMINLINE, Opcode::OP_ROWARGMAX_SINGLE};
