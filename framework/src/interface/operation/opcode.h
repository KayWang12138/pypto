...
public:
    ...
    inline bool IsCopyOut(Opcode opCode) const {
        return opCode == Opcode::OP_COPY_OUT || opCode == Opcode::OP_UB_COPY_OUT || opCode == Opcode::OP_L0C_COPY_OUT ||
               ...
               opCode == Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL || opCode == Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPANDX ||
    ...
    inline bool IsSharedMemory(Opcode opCode) const {
        return opCode == Opcode::OP_SHMEM_WAIT_UNTIL || opCode == Opcode::OP_SHMEM_PUT ||
            ...
            opCode == Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL || opCode == Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_COMBINEINFO ||
...
const std::unordered_set<Opcode> DISTRIBUTED_OPS{Opcode::OP_MOE_DISTRIBUTED_DISPATCH_SEND_ROUTED,
    ...
    Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPANDX, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_COMBINEINFO, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_EXPERT_TOKEN_NUM,
...
inline bool IsCopyOut(const Opcode &op) {
    return (op == Opcode::OP_COPY_OUT || op == Opcode::OP_L0C_COPY_OUT || op == Opcode::OP_TRANSPOSE_MOVEOUT || op == Opcode::OP_INDEX_PUT ||
            op == Opcode::OP_INDEX_OUTCAST || op == Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL || op == Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPANDX ||
