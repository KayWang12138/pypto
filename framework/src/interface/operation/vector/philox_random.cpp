...
void TiledPhiloxRandomBuildIn(Function &function, const TileShape &tileShape, size_t cur,
    ...
    if (cur == result->shape.size()) {
        ...
        auto keyTile = keyTensor->View(function, resultTileInfo.shape, resultTileInfo.offset);
        auto counterTile = counterTensor->View(function, resultTileInfo.shape, resultTileInfo.offset);
