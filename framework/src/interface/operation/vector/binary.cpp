...
Tensor FloorDiv(const Tensor &self, const Tensor &other) {
    ...
    ASSERT(
        ...
        std::find(FLOORDIV_SUPPORT_TYPES.begin(), FLOORDIV_SUPPORT_TYPES.end(), self.GetDataType()) != FLOORDIV_SUPPORT_TYPES.end())
...
Tensor FloorDiv(const Tensor &self, const Element &other) {
    ...
    ASSERT(
        self.GetDataType() == other.GetDataType() &&
        std::find(FLOORDIV_SUPPORT_TYPES.begin(), FLOORDIV_SUPPORT_TYPES.end(), self.GetDataType()) != FLOORDIV_SUPPORT_TYPES.end()) << "FloorDiv only supports same data type for self and other! And it should be in DT_INT32";
