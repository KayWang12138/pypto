...
void TiledInnerPermute(Function& function, const TileShape& tileShape, int cur,
    ...
    if (cur == shapeSize) {
        ...
        auto& op = function.AddOperation(Opcode::OP_PERMUTE_GATHER, {srcTile, idxTile}, {resultTile, tempTensor});
...
void TensorInnerPermute(Function& function, const LogicalTensorPtr& self, const LogicalTensorPtr& result,
    ...
    auto &operation = function.AddOperation(Opcode::OP_PERMUTE, {self, tmpBuffer}, {result});
