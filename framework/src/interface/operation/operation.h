...
public:
    ...
    void SetOpAttribute(const std::shared_ptr<OpAttribute> &attr) {
        ...
        static std::unordered_set<Opcode> copyOpAttrOpTypes{Opcode::OP_L1_COPY_IN, Opcode::OP_L1_COPY_OUT,
            ...
            Opcode::OP_RESHAPE_COPY_IN, Opcode::OP_RESHAPE_COPY_OUT, Opcode::OP_INDEX_OUTCAST, Opcode::OP_INDEX_PUT,
            Opcode::OP_TRANSPOSE_MOVEIN, Opcode::OP_TRANSPOSE_MOVEOUT, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPAND_X,
            Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_ASSIST_INFO_FOR_COMBINE, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_EXPERT_TOKEN_NUM, Opcode::OP_SHMEM_PUT, Opcode::OP_SHMEM_PUT_UB2GM,
            ...
            Opcode::OP_GATHER_IN_UB, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_LOCAL_COPY_OUT};
