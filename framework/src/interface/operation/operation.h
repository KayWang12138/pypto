...
public:
    ...
    void SetOpAttribute(const std::shared_ptr<OpAttribute> &attr) {
        ...
        static std::unordered_set<Opcode> copyOpAttrOpTypes{Opcode::OP_L1_COPY_IN, Opcode::OP_L1_COPY_OUT,
            ...
            Opcode::OP_TRANSPOSE_MOVEIN, Opcode::OP_TRANSPOSE_MOVEOUT, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_FLAG, Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPANDX,
