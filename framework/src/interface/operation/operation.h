...
public:
    ...
    void SetOpAttribute(const std::shared_ptr<OpAttribute> &attr) {
        ...
        static std::unordered_set<Opcode> copyOpAttrOpTypes{Opcode::OP_L1_COPY_IN, Opcode::OP_L1_COPY_OUT,
            ...
            Opcode::OP_TRANSPOSE_MOVEIN, Opcode::OP_TRANSPOSE_MOVEOUT, Opcode::OP_MOE_DISPATCH_WAIT_FLAG, Opcode::OP_MOE_DISPATCH_ASSEMBLE_EXPANDX,
            Opcode::OP_MOE_DISPATCH_ASSEMBLE_COMBINEINFO, Opcode::OP_MOE_DISPATCH_EXPERT_TOKEN_NUM, Opcode::OP_SHMEM_PUT, Opcode::OP_SHMEM_PUT_UB2GM,
            ...
            Opcode::OP_GATHER_IN_UB, Opcode::OP_MOE_DISPATCH_LOCAL_COPY_OUT};
