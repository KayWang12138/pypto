...
void CheckTensorDataType(const LogicalTensorPtr& tensor, const std::vector<DataType>& supportedTypes,
                         const std::string& opName)
{
    auto dtype = tensor->tensor->dtype;
    bool isSupported = std::find(supportedTypes.begin(), supportedTypes.end(), dtype) != supportedTypes.end();
