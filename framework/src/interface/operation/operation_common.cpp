...
inline const DTypeCheckSet &GetSupportDTypeSet(const std::string &op) {
    ...
    static const dtype_bool_uint8 = {DT_BOOL, DT_UINT8};
    ...
    static const dtype_base_8 = {DT_FP32, DT_FP16, DT_BF16, DT_BOOL, DT_INT8, DT_UINT8};
    static const dtype_base_int32 = {DT_FP32, DT_INT32, DT_FP16, DT_BF16};
    static const dtype_base_int32_8 = {DT_FP32, DT_INT32, DT_FP16, DT_BF16, DT_INT8};
    static const dtype_base_int16_8 = {DT_FP32, DT_FP16, DT_BF16, DT_INT16, DT_INT8};
    static const dtype_base_int32_16 = {DT_FP32, DT_INT32, DT_FP16, DT_BF16, DT_INT16};
    static const dtype_base_int32_16_8 = {DT_FP32, DT_INT32, DT_FP16, DT_BF16, DT_INT16, DT_INT8};
    ...
    static const std::unordered_map<std::string, DTypeCheckSet> op_2_dtype = {
        ...
        {                "CMP",                                   ({dtype_base, dtype_base},  true,        {dtype_bool_uint8}, false)},
        {               "CMPS",                                   ({dtype_base, dtype_base},  true,        {dtype_bool_uint8}, false)},
