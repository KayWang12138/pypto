...
void PhiloxRandomInferFunc(Operation *op, std::vector<std::vector<SymbolicScalar>> &outValidShapes) {
    std::vector<SymbolicScalar> outValidShape;
    auto shapeAttr = op->GetVectorInt64Attribute(OP_ATTR_PREFIX + "SHAPE");
...
REGISTER_INFER_SHAPE_FUNC(OP_PHILOX_RANDOM, Opcode::OP_PHILOX_RANDOM, PhiloxRandomInferFunc);
