...
const std::unordered_map<const Opcode, const TypeConstraint> OpInputsChecker::dtype_constraints_ = {
    // unary
    {                Opcode::OP_ABS,                                                                 std::make_tuple({dtype_base},       {})},
    {                Opcode::OP_EXP,                                                                 std::make_tuple({dtype_base},       {})},
    {                 Opcode::OP_LN,                                                                 std::make_tuple({dtype_base},       {})},
    {               Opcode::OP_SQRT,                                                                 std::make_tuple({dtype_base},       {})},
    {              Opcode::OP_RSQRT,                                                                 std::make_tuple({dtype_base},       {})},
    // one input
    {               Opcode::OP_CAST,                                                             std::make_tuple({dtype_base_i32},       {})},
    {            Opcode::OP_BITSORT,                                                                 std::make_tuple({dtype_fp32},       {})},
    {            Opcode::OP_EXTRACT,                                                                 std::make_tuple({dtype_fp32},       {})},
    {            Opcode::OP_MRGSORT,                                                                 std::make_tuple({dtype_fp32},       {})},
    {                Opcode::OP_NEG,                                                               std::make_tuple({dtype_b_i3_1},       {})},
    {      Opcode::OP_ROWMAX_SINGLE,                                                                 std::make_tuple({dtype_base},       {})},
    {      Opcode::OP_ROWMIN_SINGLE,                                                                 std::make_tuple({dtype_base},       {})},
    {      Opcode::OP_ROWSUM_SINGLE,                                                                 std::make_tuple({dtype_base},       {})},
    {         Opcode::OP_ROWMAXLINE,                                                               std::make_tuple({dtype_binary},       {})},
    {         Opcode::OP_ROWMINLINE,                                                               std::make_tuple({dtype_binary},       {})},
    {         Opcode::OP_ROWSUMLINE,                                                               std::make_tuple({dtype_binary},       {})},
    {               Opcode::OP_TOPK,                                                                 std::make_tuple({dtype_fp32},       {})},
    {   Opcode::OP_TRANSPOSE_MOVEIN,                                                                std::make_tuple({dtype_32_16},       {})},
    {  Opcode::OP_TRANSPOSE_MOVEOUT,                                                                std::make_tuple({dtype_32_16},       {})},
    {Opcode::OP_TRANSPOSE_VNCHWCONV,                                                                std::make_tuple({dtype_32_16},       {})},
    // binary
    {                Opcode::OP_ADD,                                                 std::make_tuple({dtype_binary, dtype_binary}, {{0, 1}})},
    {                Opcode::OP_SUB,                                                 std::make_tuple({dtype_binary, dtype_binary}, {{0, 1}})},
    {                Opcode::OP_MUL,                                                 std::make_tuple({dtype_binary, dtype_binary}, {{0, 1}})},
    {                Opcode::OP_DIV,                                                     std::make_tuple({dtype_base, dtype_base}, {{0, 1}})},
    {               Opcode::OP_ADDS,                                                               std::make_tuple({dtype_binary},       {})},
    {               Opcode::OP_SUBS,                                                               std::make_tuple({dtype_binary},       {})},
    {               Opcode::OP_MULS,                                                               std::make_tuple({dtype_binary},       {})},
    {               Opcode::OP_DIVS,                                                               std::make_tuple({dtype_binary},       {})},
    {               Opcode::OP_MAXS,                                                               std::make_tuple({dtype_binary},       {})},
    {               Opcode::OP_MINS,                                                               std::make_tuple({dtype_binary},       {})},
    {            Opcode::OP_MAXIMUM,                                                 std::make_tuple({dtype_binary, dtype_binary}, {{0, 1}})},
    {            Opcode::OP_MINIMUM,                                                 std::make_tuple({dtype_binary, dtype_binary}, {{0, 1}})},
    // two input
    {                Opcode::OP_CMP,                                                     std::make_tuple({dtype_base, dtype_base}, {{0, 1}})},
    {               Opcode::OP_CMPS,                                                                 std::make_tuple({dtype_base},       {})},
    {             Opcode::OP_GATHER,                                            std::make_tuple({dtype_b_i3_1_8, dtype_i64_32_16},       {})},
    {     Opcode::OP_GATHER_ELEMENT,                                                 std::make_tuple({dtype_b_i3_1, dtype_i64_32},       {})},
    {            Opcode::OP_VEC_DUP,                                                               std::make_tuple({dtype_binary},       {})},
    {            Opcode::OP_SCATTER,                                       std::make_tuple({dtype_base, dtype_i64_32, dtype_base}, {{0, 2}})},
    {    Opcode::OP_SCATTER_ELEMENT,                                                   std::make_tuple({dtype_base, dtype_i64_32},       {})},
    {      Opcode::OP_INDEX_OUTCAST,                                std::make_tuple({dtype_b_i3_1, dtype_i64_32_16, dtype_b_i3_1}, {{0, 2}})},
    {           Opcode::OP_WHERE_TT,                                         std::make_tuple({dtype_u8_b, dtype_base, dtype_base}, {{1, 2}})},
    {           Opcode::OP_WHERE_TS,                                                     std::make_tuple({dtype_u8_b, dtype_base},       {})},
    {           Opcode::OP_WHERE_ST,                                                     std::make_tuple({dtype_u8_b, dtype_base},       {})},
    {           Opcode::OP_WHERE_SS,                                                                 std::make_tuple({dtype_u8_b},       {})},
    {         Opcode::OP_LOGICALAND,                                               std::make_tuple({dtype_logical, dtype_logical},       {})},
    {         Opcode::OP_LOGICALNOT,                                                              std::make_tuple({dtype_logical},       {})},
    {              Opcode::OP_RANGE,                                   std::make_tuple({dtype_binary, dtype_binary, dtype_binary},       {})},
    {      Opcode::OP_REGISTER_COPY,                                             std::make_tuple({dtype_b_i3_1_8, dtype_b_i3_1_8}, {{0, 1}})},
    {             Opcode::OP_EXPAND,                                                           std::make_tuple({dtype_base_i_u_b},       {})},
    {          Opcode::OP_INDEX_ADD,                                   std::make_tuple({dtype_b_i3_1, dtype_b_i3_1, dtype_i64_32}, {{0, 1}})},
    {             Opcode::OP_ONEHOT,                                                            std::make_tuple({dtype_i64_32_16},       {})},
    {          Opcode::OP_INDEX_PUT, std::make_tuple({dtype_base_i_u, dtype_base_i_u, dtype_i_u, dtype_i_u, dtype_i_u, dtype_i_u},
     {{0, 1}, {2, 3, 4, 5}})                                                                                                                },
    {            Opcode::OP_CUM_SUM,                                                               std::make_tuple({dtype_binary},       {})},
};
...
const TypeConstraint &OpInputsChecker::Getstd::make_tuple() const {
...
void OpInputsChecker::CheckType() const {
    const auto &dtype_con = std::get<0>(Getstd::make_tuple());
    size_t index = 0;
    ...
    const auto index_cons = std::get<1>(Getstd::make_tuple());
