...
bool IsSFANonDB(
    ...
    const bool aMatrixValid = (aMatrixM == dimM && aMatrixK == dimKScene1);
    const bool bMatrixValid = (bMatrixK == dimKScene1 && bMatrixN == dimNScene1);
    const bool IsInputValid = aMatrixValid1 && bMatrixValid1;
