...
Status CheckMXMatmulOperands(
    ...
    const MatmulAttrParam& attrParam)
{
    ASSERT(MatmulErrorCode::ERR_RUNTIME_NULLPTR, aMatrix.GetStorage() != nullptr) << "aMatrix cannot be nullptr";

    ASSERT(MatmulErrorCode::ERR_RUNTIME_NULLPTR, bMatrix.GetStorage() != nullptr) << "bMatrix cannot be nullptr";

    ASSERT(MatmulErrorCode::ERR_RUNTIME_NULLPTR, aScale.GetStorage() != nullptr) << "aScale cannot be nullptr";
    ASSERT(MatmulErrorCode::ERR_RUNTIME_NULLPTR, bScale.GetStorage() != nullptr) << "bScale cannot be nullptr";
    ASSERT(
        MatmulErrorCode::ERR_PARAM_MISMATCH,
