    ...
    const MatmulAttrParam& attrParam)
{
    ...
    for (int64_t kIdx = 0; kIdx < kLoop; ++kIdx) {
        ...
        Tensor tensorA;
        if (attrParam.transA) {
            tensorA = View(aMatrix, {kValidShape, mSize}, {kValidShape, mValidShape}, {kValidShape * kIdx, 0});
        } else {
            tensorA = View(aMatrix, {mSize, kValidShape}, {mValidShape, kValidShape}, {0, kValidShape * kIdx});
        }
        Tensor scaleA;
        ...
        Tensor tensorB;
        if (attrParam.transB) {
            tensorB = View(bMatrix, {nSize, kValidShape}, {nValidShape, kValidShape}, {0, kValidShape * kIdx});
        } else {
            tensorB = View(bMatrix, {kValidShape, nSize}, {kValidShape, nValidShape}, {kValidShape * kIdx, 0});
        }
        Tensor scaleB;
