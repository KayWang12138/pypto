...
{
    int64_t paddingMode = PaddingMode::NO_PADDING;
    if (attrParam.hasMXScale) {
...
LogicalTensorPtr LinkTensorAScale(Function &function, const MatmulGraphNodes &tensorGraphNodes,
    ...
    int64_t tileKAScaleL1Size = CeilAlign(iterInfo.kAL1Size, ALIGN_SIZE_64) / ALIGN_SIZE_64;
    int64_t tileKAScaleL0Size = CeilAlign(iterInfo.kL0Size, ALIGN_SIZE_64) / ALIGN_SIZE_64;
...
LogicalTensorPtr LinkTensorBScale(Function &function, const MatmulGraphNodes &tensorGraphNodes,
    ...
    int64_t tileKBScaleL1Size = CeilAlign(iterInfo.kBL1Size, ALIGN_SIZE_64) / ALIGN_SIZE_64;
    int64_t tileKBScaleL0Size = CeilAlign(iterInfo.kL0Size, ALIGN_SIZE_64) / ALIGN_SIZE_64;
    ...
    std::vector<int64_t> bScaleL0Offset =
        std::vector<int64_t>{iterInfo.kOffset % tileInfo.tileKBL1 / ALIGN_SIZE_32, 0, 0};
