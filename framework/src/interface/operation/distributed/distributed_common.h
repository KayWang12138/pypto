...
inline std::string AtomicTypeToString(AtomicType type) {
    switch (type) {
        case AtomicType::SET: return "TileOp::Distributed::AtomicType::SET";
        case AtomicType::ADD: return "TileOp::Distributed::AtomicType::ADD";
        default: return "";
    }
}
...
inline std::string OpTypeToString(OpType type) {
    switch (type) {
        case OpType::EQ: return "OpType::EQ";
        case OpType::NE: return "OpType::NE";
        case OpType::LT: return "OpType::LT";
        case OpType::LE: return "OpType::LE";
        case OpType::GT: return "OpType::GT";
        case OpType::GE: return "OpType::GE";
        default: return "";
    }
}
