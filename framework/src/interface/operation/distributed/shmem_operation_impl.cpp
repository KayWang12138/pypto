    ...
    Tensor& out)
{
    ...
    ValidateShapeAndType(out, in.GetDataType(), {row * worldSize, col});
    ...
    DistReduceType reduceType, Tensor& out)
{
    ...
    ValidateShapeAndType(shmemSignal, DataType::DT_INT32, {worldSize, worldSize, worldSize, rowOut, col});
    ...
    Tensor& shmemSignal, Tensor& out)
{
    ...
    AllReduceValidate(predToken, in, shmemData, group, out);
    ValidateShapeAndType(shmemData, out.GetDataType(), {worldSize, worldSize, rowPerRank, col});
