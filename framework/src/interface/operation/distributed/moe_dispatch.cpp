...
void CreateShmemDispatchLoop(Tensor& shmemData, Tensor& shmemFlag, const Tensor& tokenTensor, const char *group,
...
void MoeDistributedDispatchV1(const Tensor &tokenTensor, const Tensor &tokenExpertTable, Tensor &expandX,
    Tensor &validCnt, Tensor &combineInfo, const char *group, const MoeConfig &moeConfig)
{
    ...
    Tensor shmemData;
    Tensor shmemFlag;
    CreateShmemDispatchLoop(shmemData, shmemFlag, tokenTensor, group, moeConfig, shmemDataCol, flagCol);
