...
void ExpandOperationInto(Function &function, const TileShape &tileShape, Opcode opCode,
    ...
    switch (opCode) {
        ...
        case Opcode::OP_MOE_DISTRIBUTED_DISPATCH_SET_SIGNAL: {
            npu::tile_fwk::Distributed::TiledDispatchSetRecvSignals(function, tileShape, iOperand, oOperand, op);
            break;
        }
        case Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL: {
            npu::tile_fwk::Distributed::TiledDispatchWaitRecvFlags(function, tileShape, iOperand, oOperand, op);
            break;
        }
        case Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPAND_X: {
            npu::tile_fwk::Distributed::TiledDispatchAssembleExpandX(function, tileShape, iOperand, oOperand, op);
            break;
        }
        case Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_ASSIST_INFO_FOR_COMBINE: {
