...
OpcodeManager::OpcodeManager() {
    ...
    registerInfo(Opcode::OP_CMP, OpCoreType::AIV, "CMP", {MemoryType::MEM_UB, MemoryType::MEM_UB}, {MemoryType::MEM_UB, MemoryType::MEM_UB}, {"TileOp::Compare", PIPE_V, PIPE_V, CoreType::AIV}, OpCalcType::BROADCAST, {OP_ATTR_PREFIX + "cmp_operation", OP_ATTR_PREFIX + "cmp_mode"});
    ...
    registerInfo(Opcode::OP_WHERE_SS, OpCoreType::AIV, "WHERE_SS",
        ...
        {"TileOp::Where_SS", PIPE_V, PIPE_V, CoreType::AIV}, OpCalcType::ELMWISE, {OpAttributeKey::vectorScalar});
    // AIC
