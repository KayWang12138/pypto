...
void OpcodeManager::RegisterDistribute() {
    ...
    RegisterInfo(Opcode::OP_MOE_DISTRIBUTED_COMBINE_RECEIVE, OpCoreType::ANY, "MOE_DISTRIBUTED_COMBINE_RECEIVE",
        ...
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_SEND_ROUTED, OpCoreType::ANY, "MOE_DISPATCH_SEND_ROUTED",
        ...
        {OP_ATTR_PREFIX + "distributed"});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_SEND_SHARED, OpCoreType::ANY, "MOE_DISPATCH_SEND_SHARED",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR}, {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_UB},
        {"TileOp::Distributed::SendToSharedExpert", PIPE_S, PIPE_S, CoreType::AIV}, OpCalcType::DISTRIBUTED,
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_LOCAL_COPY_OUT, OpCoreType::ANY, "MOE_DISPATCH_LOCAL_COPY_OUT",
        {MemoryType::MEM_DEVICE_DDR}, {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_UB},
        {"TileOp::Distributed::CopyToLocalExpert", PIPE_S, PIPE_S, CoreType::AIV}, OpCalcType::DISTRIBUTED,
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_SET_FLAG, OpCoreType::ANY, "MOE_DISPATCH_SET_FLAG",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR},
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_UB, MemoryType::MEM_UB, MemoryType::MEM_UB},
        {"TileOp::Distributed::DispatchSetRecvFlags", PIPE_S, PIPE_S, CoreType::AIV}, OpCalcType::DISTRIBUTED,
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_WAIT_FLAG, OpCoreType::ANY, "MOE_DISPATCH_WAIT_FLAG",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR}, {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_UB},
        {"TileOp::Distributed::DispatchWaitRecvFlags", PIPE_S, PIPE_S, CoreType::AIV}, OpCalcType::DISTRIBUTED,
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_ASSEMBLE_EXPANDX, OpCoreType::ANY, "MOE_DISPATCH_ASSEMBLE_EXPANDX",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR},
        ...
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_ASSEMBLE_COMBINEINFO, OpCoreType::ANY, "MOE_DISPATCH_ASSEMBLE_COMBINEINFO",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR},
        ...
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISPATCH_EXPERT_TOKEN_NUM, OpCoreType::ANY, "MOE_DISPATCH_EXPERT_TOKEN_NUM",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR}, {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_UB},
