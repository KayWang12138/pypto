...
void OpcodeManager::RegisterVector() {
    ...
    RegisterInfo(Opcode::OP_PHILOX_RANDOM, OpCoreType::AIV, "PHILOX_RANDOM", {MemoryType::MEM_UB, MemoryType::MEM_UB}, {MemoryType::MEM_UB},
        {"TileOp::TPhiloxRandomOp", PIPE_V, PIPE_V, CoreType::AIV}, OpCalcType::OTHER,
        {OP_ATTR_PREFIX + "ROUNDS", OP_ATTR_PREFIX + "SHAPE"}, TileShapeVerifier::Verify);
