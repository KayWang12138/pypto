...
void OpcodeManager::RegisterVector() {
    ...
    RegisterInfo(Opcode::OP_TRIUL, OpCoreType::AIV, "TRIUL", {MemoryType::MEM_UB}, {MemoryType::MEM_UB},
        {"TileOp::TTriUL", PIPE_V, PIPE_V, CoreType::AIV}, OpCalcType::OTHER, {OP_ATTR_PREFIX + "diagonal", OP_ATTR_PREFIX + "flag", 
        OP_ATTR_PREFIX + "rowIdx", OP_ATTR_PREFIX + "colIdx", OpAttributeKey::excludeBufferReuse});
...
void OpcodeManager::RegisterCube() {
    ...
    registerInfo(Opcode::OP_TRIUL, OpCoreType::AIV, "TRIUL", {MemoryType::MEM_UB}, {MemoryType::MEM_UB},
        {"TileOp::TTriUL", PIPE_V, PIPE_V, CoreType::AIV}, OpCalcType::OTHER, {OP_ATTR_PREFIX + "diagonal", OP_ATTR_PREFIX + "flag", OP_ATTR_PREFIX + "rowIdx", OP_ATTR_PREFIX + "colIdx", OpAttributeKey::excludeBufferReuse});
