...
void OpcodeManager::RegisterInfo(Opcode opcode, OpCoreType coreType, std::string str, std::vector<MemoryType> inputsMemType,
...
void OpcodeManager::RegisterCommon() {
    ...
    RegisterInfo(Opcode::OP_DUPLICATE, OpCoreType::ANY, "DUPLICATE", {}, {MemoryType::MEM_DEVICE_DDR}, {}, OpCalcType::MOVE_LOCAL);
