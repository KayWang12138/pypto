...
void OpcodeManager::RegisterDistribute() {
    ...
    RegisterInfo(Opcode::OP_MOE_DISTRIBUTED_DISPATCH_LOCAL_COPY_OUT, OpCoreType::ANY, "MOE_DISPATCH_LOCAL_COPY_OUT",
        ...
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISTRIBUTED_DISPATCH_SET_SIGNAL, OpCoreType::ANY, "MOE_DISPATCH_SET_FLAG",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR},
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_UB, MemoryType::MEM_UB, MemoryType::MEM_UB},
    ...
    RegisterInfo(Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL, OpCoreType::ANY, "MOE_DISPATCH_WAIT_FLAG",
        ...
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPANDX, OpCoreType::ANY, "MOE_DISPATCH_ASSEMBLE_EXPANDX",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR},
        ...
        {OpAttributeKey::requiresBoundaryCopy});
    RegisterInfo(Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_COMBINEINFO, OpCoreType::ANY, "MOE_DISPATCH_ASSEMBLE_COMBINEINFO",
        {MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR, MemoryType::MEM_DEVICE_DDR},
