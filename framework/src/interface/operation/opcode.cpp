...
void OpcodeManager::RegisterVector()
{
    ...
    RegisterInfo(Opcode::OP_UNIFORM, OpCoreType::AIV, "UNIFORM", {}, {MemoryType::MEM_UB, MemoryType::MEM_UB},
        ...
        {OP_ATTR_PREFIX + "KEY", OP_ATTR_PREFIX + "COUNTER0", OP_ATTR_PREFIX + "COUNTER1", OP_ATTR_PREFIX + "ROUNDS", OP_ATTR_PREFIX + "SHAPE", OP_ATTR_PREFIX + "DTYPE"}, TileShapeVerifier::Verify);
    RegisterInfo(
