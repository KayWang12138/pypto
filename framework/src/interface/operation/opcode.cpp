...
OpcodeManager::OpcodeManager() {
    ...
    registerInfo(Opcode::OP_L1_TO_FIX_QUANT_PRE, OpCoreType::AIC, "FIX_COPY_IN_QUANT_PRE", {MemoryType::MEM_L1}, {MemoryType::MEM_FIX_QUANT_PRE}, {"TileOp::L1ToFB", PIPE_MTE1, PIPE_MTE1, CoreType::AIC}, OpCalcType::MOVE_LOCAL, {FixpOpAttributeKey::fbAddrSpace});
