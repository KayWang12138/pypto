...
const int64_t ALL_COMPLETE = 0;
const int64_t TENSOR_GRAPH = 1;
const int64_t TILE_GRAPH = 2;
const int64_t EXECUTION_GRAPH = 3;
const int64_t CODEGEN_INSTRUCTION = 4;
const int64_t CODEGEN_BINARY = 5;
