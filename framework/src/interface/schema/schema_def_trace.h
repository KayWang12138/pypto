...
SCHEMA_DEF_TYPE_UNION(CtrlActType, ThreadStart, ThreadFinish, ControlFlowCacheFullRunCache,
    ...
    ControlFlowCachePartRunControlContinue, RawWorkspace, Workspace, WorkspaceMetadataGeneral, WorkspaceMetadataStitch,
    WorkspaceInnerTensor, WorkspacePartialOutcast, WorkspaceInDeviceTaskOutcast, WorkspaceCrossDeviceTaskOutcast,
    WorkspaceSpill, InputTensorCount, InputTensorRange, InputTensorElement, OutputTensorCount, OutputTensorRange,
    OutputTensorElement);
