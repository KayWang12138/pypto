  ...
  msgpack::object SerializeTileView(const std::optional<TileView>& tile_view, msgpack::zone& zone) {
    ...
    switch (tile_view->blayout) {
      ...
      case TileLayout::col_major:
        ...
        break;
      default:
        INTERNAL_CHECK(false) << "Unknown TileLayout for blayout";
        break;
    }
    ...
    switch (tile_view->slayout) {
      ...
      case TileLayout::col_major:
        ...
        break;
      default:
        INTERNAL_CHECK(false) << "Unknown TileLayout for slayout";
        break;
    }
    ...
    switch (tile_view->pad) {
      ...
      case TilePad::min:
        ...
        break;
      default:
        INTERNAL_CHECK(false) << "Unknown TilePad";
        break;
    }
    ...
    switch (tile_view->compact) {
      ...
      default:
        INTERNAL_CHECK(false) << "Unknown CompactMode";
        break;
    }
  ...
  msgpack::object SerializeTensorView(const std::optional<TensorView>& tensor_view, msgpack::zone& zone) {
    ...
    switch (tensor_view->layout) {
      ...
      case TensorLayout::NZ:
        ...
        break;
      default:
        INTERNAL_CHECK(false) << "Unknown TensorLayout";
        break;
    }
