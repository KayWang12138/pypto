...
TILEOP void TExtract(T &dst, U &src, V &fixbuf, const Coord &l1Coord, const Coord &locCoord, uint64_t scaleValue = 0) {
    ...
    if (dstShape0 < srcShape0 || dstShape1 < srcShape1) {
        TExtractHeavy<l1TileData, l0cTileData, V>(dstL1, srcL0C, fixbuf, locOffset0, locOffset1, scaleValue);
    } else {
        TExtractLight<l1TileData, l0cTileData, V>(dstL1, srcL0C, fixbuf, l1Offset0, l1Offset1, scaleValue);
    }
    return;
}
