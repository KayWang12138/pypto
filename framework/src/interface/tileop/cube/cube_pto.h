...
TILEOP void TExtract(T& dst, U& src, const Coord& dstCoord, const Coord& srcCoord)
{
    ...
    if constexpr (staticUBH - 1 >= staticL1H && staticUBW >= staticL1W) {
        ...
        using tileUBTensor = pto::Tile<
            pto::TileType::Vec, typename U::Type, staticUBH, staticUBW, pto::BLayout::ColMajor, -1, -1,
            pto::SLayout::RowMajor>;
...
template <typename ubData, typename l0cData>
TILEOP void TExtractL0CToUB(
    ubData& ubTile, l0cData& l0cTile, int64_t l0cOffset0, int64_t l0cOffset1, int16_t subblockId = 0)
{
    if (subblockId == 0) {
...
TILEOP void TInsertL0CToUB(
    ubData& ubTile, l0cData& l0cTile, int64_t ubOffset0, int64_t ubOffset1, int16_t subblockId = 0)
{
    if (subblockId == 0) {
        pto::TEXTRACT<tileUBTensor, tileL0CTensor, pto::AccToVecMode::SingleModeVec0>(
...
TILEOP void TExtract(T& dst, U& src, const Coord& dstCoord, const Coord& srcCoord, int16_t subblockId)
{
    ...
    static_assert(shapeSize == SHAPE_DIM2 && expect_size == SHAPE_DIM2, "Shape Size should be 2 Dim");
    if constexpr (T::FORMAT == Hardware::UB && U::FORMAT == Hardware::L0C) {
        ...
        using tileL0CTensor = pto::Tile<
            pto::TileType::Acc, typename U::Type, staticL0CH, staticL0CW, pto::BLayout::ColMajor, -1, -1,
