...
// 普通功能实现
#include "impl/load_common.h"
#include "impl/extract_common.h"
#include "impl/matmul_common.h"
#include "impl/store_common.h"
// MX功能实现（仅A5架构）
#if defined PTO_NPU_ARCH_A5
#include "impl/arch35/load_mx.h"
#include "impl/arch35/extract_mx.h"
#include "impl/arch35/matmul_mx.h"
#endif

// ==================== 以下为所有原代码中的TILEOP接口，100%保留 ====================
