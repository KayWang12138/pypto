...
INLINE void TLoadAMXStatic(T& dst, U& src, const Coord& coord)
{
    constexpr int64_t shapeSize = Std::tuple_size<typename T::Shape>::value;
    int64_t srcShape0 = GetShape<0>(src);
    int64_t srcShape1 = GetShape<1>(src);
    ...
    constexpr int64_t staticL1H = Std::tuple_element<shapeSize - SHAPE_DIM3, typename T::TileShape>::type::value;
    constexpr int64_t staticL1W =
    ...
    using tileData = pto::Tile<
        pto::TileType::Mat, typename T::Type, staticL1H, staticL1W, pto::BLayout::RowMajor, staticDstShape0,
        staticDstShape1 * SHAPE_DIM2, pto::SLayout::RowMajor, pto::TileConfig::alignedSize>;
...
template <CopyInMode mode, typename Coord, typename T, typename U>
INLINE void TLoadAMXDynamic(T& dst, U& src, const Coord& coord)
{
    constexpr int64_t shapeSize = Std::tuple_size<typename T::Shape>::value;
    int64_t offset0 = TileOp::GetTupleElement<Coord, DIM_1ST, SHAPE_DIM3, 0>(coord);
    int64_t offset1 = TileOp::GetTupleElement<Coord, DIM_2ND, SHAPE_DIM3, 0>(coord);
...
template <CopyInMode mode, typename Coord, typename T, typename U>
INLINE void TLoadBMXStatic(T& dst, U& src, const Coord& coord)
{
    constexpr int64_t shapeSize = Std::tuple_size<typename T::Shape>::value;
    int64_t offset0 = TileOp::GetTupleElement<Coord, DIM_1ST, SHAPE_DIM3, 0>(coord);
    int64_t offset1 = TileOp::GetTupleElement<Coord, DIM_2ND, SHAPE_DIM3, 0>(coord);
    ...
    constexpr int64_t staticL1W = Std::tuple_element<shapeSize - SHAPE_DIM2, typename T::TileShape>::type::value;

    using shapeDim2 = pto::Shape<1, 1, -1, -1, SHAPE_DIM2>;
    using strideDim3 = pto::Stride<-1, -1, -1, SHAPE_DIM2, 1>;
    using tileData = pto::Tile<
        pto::TileType::Mat, typename T::Type, staticL1H, staticL1W, pto::BLayout::ColMajor,
...
template <CopyInMode mode, typename Coord, typename T, typename U>
INLINE void TLoadBMXDynamic(T& dst, U& src, const Coord& coord)
{
    constexpr int64_t shapeSize = Std::tuple_size<typename T::Shape>::value;
    int64_t dstShape0 = GetShape<0>(dst);
    int64_t dstShape1 = GetShape<1>(dst);
...
TILEOP void TMatmul(T0& c, T1& a, T2& b, T3& bias)
{
    ...
    constexpr int64_t shapeSizeB = Std::tuple_size<typename T2::Shape>::value;
    ...
    constexpr int64_t staticL0BH = Std::tuple_element<shapeSizeB - SHAPE_DIM2, typename T2::TileShape>::type::value;
    constexpr int64_t staticL0BW = Std::tuple_element<shapeSizeB - 1, typename T2::TileShape>::type::value;
...
INLINE void ExecuteMatmulMXPipeline(
    ...
    tileL0CTensor& l0c, T0& c, T1& a, T2& aScale, T3& b, T4& bScale, T5 bias = nullptr, tileBiasTensor biasT = nullptr)
{
    pto::TASSIGN(l0a, (uint64_t)a.GetAddr());
...
template <
    bool isZeroC, bool hasBias, typename T0, typename T1, typename T2, typename T3, typename T4, typename T5 = void*>
TILEOP void MatmulMXStatic(T0& c, T1& a, T2& aScale, T3& b, T4& bScale, T5 bias = nullptr)
{
    constexpr int64_t shapeSizeC = Std::tuple_size<typename T0::Shape>::value;
    constexpr int64_t shapeSizeA = Std::tuple_size<typename T1::Shape>::value;
    constexpr int64_t shapeSizeAScale = Std::tuple_size<typename T2::Shape>::value;
    constexpr int64_t shapeSizeB = Std::tuple_size<typename T3::Shape>::value;
    constexpr int64_t shapeSizeBScale = Std::tuple_size<typename T4::Shape>::value;
    static_assert(
    ...
    constexpr int64_t staticL0AH = Std::tuple_element<shapeSizeA - SHAPE_DIM2, typename T1::TileShape>::type::value;
    constexpr int64_t staticL0AW = Std::tuple_element<shapeSizeA - 1, typename T1::TileShape>::type::value;
    constexpr int64_t staticL0AScaleW =
    ...
    constexpr int64_t staticL0BScaleH =
    ...
    using tileL0CTensor = pto::TileAcc<typename T0::Type, staticL0CH, staticL0CW, staticValidM, staticValidN>;
    using tileL0ATensor = pto::TileLeft<typename T1::Type, staticL0AH, staticL0AW, staticValidM, staticValidK>;
    using tileL0AScaleTensor = pto::TileLeftScale<
        typename T1::Type, staticL0AH, staticL0AScaleW * SHAPE_DIM2, staticValidM, staticValidScaleK>;
    using tileL0BTensor = pto::TileRight<typename T3::Type, staticL0BH, staticL0BW, staticValidK, staticValidN>;
    using tileL0BScaleTensor = pto::TileRightScale<
        typename T3::Type, staticL0BScaleH * SHAPE_DIM2, staticL0BW, staticValidScaleK, staticValidN>;
    tileL0ATensor l0a;
    ...
    if constexpr (hasBias) {
        using tileBiasTensor =
            pto::Tile<pto::TileType::Bias, typename T5::Type, 1, staticL0BW, pto::BLayout::RowMajor, 1, staticValidN>;
        tileBiasTensor biasT;
...
{
    constexpr int64_t shapeSize = Std::tuple_size<typename U::Shape>::value;
    constexpr int64_t staticL1H = Std::tuple_element<shapeSize - SHAPE_DIM2, typename U::TileShape>::type::value;
    constexpr int64_t staticL1W = Std::tuple_element<shapeSize - 1, typename U::TileShape>::type::value;
    int64_t dstShape0 = GetShape<0>(dst);
    int64_t dstShape1 = GetShape<1>(dst);
...
{
    constexpr int64_t shapeSize = Std::tuple_size<typename DstT::Shape>::value;
