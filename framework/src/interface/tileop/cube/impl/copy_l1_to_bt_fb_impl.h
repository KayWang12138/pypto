...
#ifndef TILEOP_TILE_OPERATOR_EXTRACT_BT_FB__H
#define TILEOP_TILE_OPERATOR_EXTRACT_BT_FB__H

#include "cube_tools.h"

template <bool isTrans, typename T, typename U>
INLINE void TExtractL1ToBiasTableOrFixBuffer(T& dst, U& src)
{
...
#endif // TILEOP_TILE_OPERATOR_EXTRACT_BT_FB__H