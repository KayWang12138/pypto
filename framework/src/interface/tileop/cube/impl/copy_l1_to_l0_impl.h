...
#ifndef TILEOP_TILE_OPERATOR_COPY_L1_TO_L0__H
#define TILEOP_TILE_OPERATOR_COPY_L1_TO_L0__H
...
INLINE void TExtractL1ToL0Impl(DstTileData& dst, SrcTileData& src, const int64_t& offset0, const int64_t& offset1)
{
    ...
    // FP32场景时，当输入shape的内轴不满足c0size=32对齐时，会向16元素补齐，需设置SetKAligned表示跳过填充的数据
...
#endif // TILEOP_TILE_OPERATOR_COPY_L1_TO_L0__H