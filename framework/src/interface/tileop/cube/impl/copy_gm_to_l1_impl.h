...
#ifndef TILEOP_TILE_OPERATOR_COPY_GM_TO_L1__H
#define TILEOP_TILE_OPERATOR_COPY_GM_TO_L1__H
...
INLINE void TLoadND2NZ(TileData& dst, GlobalData& src, const int64_t& offset0, const int64_t& offset1)
{
    ...
    globalData src0Global(
        (__gm__ typename GlobalData::Type*)(src.GetAddr() + gmOffset), shapeDim2(staticL1H, staticL1W),
...
INLINE void TLoadNZ2NZ(
    TileData& dst, GlobalData& src, const int64_t& offset0, const int64_t& offset1, const int64_t& curH,
    const int64_t& curW)
{
...
#endif // TILEOP_TILE_OPERATOR_COPY_GM_TO_L1__H