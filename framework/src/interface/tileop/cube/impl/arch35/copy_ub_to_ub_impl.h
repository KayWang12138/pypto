...
#ifndef TILEOP_TILE_OPERATOR_ARCH35_COPY_UB_TO_UB__H
#define TILEOP_TILE_OPERATOR_ARCH35_COPY_UB_TO_UB__H
...
#endif // TILEOP_TILE_OPERATOR_ARCH35_COPY_UB_TO_UB__H