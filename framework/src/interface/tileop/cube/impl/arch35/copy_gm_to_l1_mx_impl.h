 ...
 * \brief MX矩阵乘Scale数据DDR->L1加载内部实现（仅A5架构）
 */

#ifndef TILEOP_TILE_OPERATOR_ARCH35_LOAD_MX__H
#define TILEOP_TILE_OPERATOR_ARCH35_LOAD_MX__H
...
#endif // TILEOP_TILE_OPERATOR_ARCH35_LOAD_MX__H