...
#ifndef TILEOP_TILE_OPERATOR_COPY_L0C_TO_GM__H
#define TILEOP_TILE_OPERATOR_COPY_L0C_TO_GM__H

#include "cube_utils.h"

template <typename config, typename globalData, typename tileData, typename TileData, typename FpTileData>
INLINE void TStoreExecute(globalData dstGlobal, tileData srcL0C, FpTileData& fixbuf, uint64_t scaleValue)
{
    constexpr bool isQuant = !std::is_same_v<typename TileData::DType, typename FpTileData::DType>;
    ...
    uint64_t scaleValue = 0)
{
    ...
    TStoreExecute<config, globalData, tileData, TileData, FpTileData>(dstGlobal, srcL0C, fixbuf, scaleValue);
}
...
#endif // TILEOP_TILE_OPERATOR_COPY_L0C_TO_GM__H