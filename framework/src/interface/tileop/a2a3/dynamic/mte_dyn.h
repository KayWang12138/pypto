...
template <typename T, unsigned UBS1, unsigned UBS2, unsigned UBS3, unsigned UBS4, bool IN_CORE_ASSEMBLE = false>
...
TILEOP void DynUBCopyIn(__ubuf__ T *dst, __gm__ T *src, unsigned T0, unsigned T1, unsigned T2, unsigned T3, unsigned T4,
    ...
    DynUBCopyIn<T, UBS1, UBS2, UBS3, UBS4, IN_CORE_ASSEMBLE>(
