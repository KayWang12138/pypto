...
TILEOP void DynL0CToL1(__cbuf__ L1T *dst, __cc__ L0CT *src, unsigned oriTShape0, unsigned oriTShape1, unsigned l1Shape0,
    ...
    int64_t l0cOffset = l0cShape0 * l1Offset1;  //大搬小
    if(l0cShape0 < l1Shape0){    //小搬大
        l0cOffset = 0;
    }   
    copy_matrix_cc_to_cbuf((__cbuf__ L1T *)(dst + l1Offset), (__cc__ L0CT *)(src + l0cOffset), 0, nSize, mSize, dstStrideDstD,
