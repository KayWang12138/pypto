...
TILEOP void SignInt(DstTile dstTile, SrcTile srcTile)
{
    ...
    PTO_WITH_LAST_USE(pto::TMINS(srcTile, srcTile, static_cast<T>(1)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMAXS(dstTile, srcTile, static_cast<T>(-1)), n1, n2);
}
...
TILEOP void SignHalf(DstTile dstTile, SrcTile srcTile)
{
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    PTO_WITH_LAST_USE(pto::TMINS(srcTile, srcTile, static_cast<T>(5.960464e-08f)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMAXS(srcTile, srcTile, static_cast<T>(-5.960464e-08f)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMULS(srcTile, srcTile, static_cast<T>(4.096000e+03f)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMULS(dstTile, srcTile, static_cast<T>(4.096000e+03f)), n1, n2);
}
...
TILEOP void SignFloat(DstTile dstTile, SrcTile srcTile)
{
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    PTO_WITH_LAST_USE(pto::TMINS(srcTile, srcTile, static_cast<T>(1.1754943508222875e-38f)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMAXS(srcTile, srcTile, static_cast<T>(-1.1754943508222875e-38f)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMULS(srcTile, srcTile, static_cast<T>(4.6116860184273879e+18f)), n1, n2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMULS(srcTile, srcTile, static_cast<T>(4.6116860184273879e+18f)), n1, n2);
    ...
    pipe_barrier(PIPE_V);
#endif
    PTO_WITH_LAST_USE(pto::TMULS(dstTile, srcTile, static_cast<T>(4.0000000000000000e+00f)), n1, n2);
}
    ...
    for (LoopVar n0Index = 0; n0Index < dstShape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                SignImpl<LastUse, typename T0::Type, DstTileDefine, SrcTileDefine>(dstTile, srcTile);
            }
        }
    }
}
