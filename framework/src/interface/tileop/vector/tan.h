...
TILEOP void TanImpl(DstTile dstTile, SrcTile srcTile, TmpTile tmpTile, TmpInt32Tile tmpInt32Tile)
{
    ...
    pipe_barrier(PIPE_V);
#endif
    pto::TMULS(dstTile, tmpTile, PI_HIGH);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TSUB(dstTile, srcTile, dstTile);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TMULS(srcTile, tmpTile, PI_CORR_1);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TSUB(dstTile, dstTile, srcTile);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TADDS(srcTile, dstTile, HALF_PI);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TMULS(dstTile, tmpTile, PI_CORR_2);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TSUB(srcTile, srcTile, dstTile);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TADDS(srcTile, srcTile, EPS_NEG);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TMULS(dstTile, tmpTile, PI_CORR_3);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TSUB(srcTile, srcTile, dstTile);
    ...
    pipe_barrier(PIPE_V);
#endif
    pto::TMULS(dstTile, tmpTile, PI_CORR_4);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    pto::TSUB(srcTile, srcTile, dstTile);
    ...
    pipe_barrier(PIPE_V);
#endif
    pto::TMUL(dstTile, srcTile, srcTile);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
    ...
    pipe_barrier(PIPE_V);
#endif
    pto::TMUL(tmpTile, tmpTile, srcTile);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
...
template <typename LastUse, typename DstTile, typename SrcTile, typename TmpTile, typename TmpFp32Tile, typename TmpInt32Tile>
TILEOP void TanHalfImpl(DstTile dstTile, SrcTile srcTile, TmpTile tmpTile, TmpFp32Tile tmpFp32Tile, TmpInt32Tile tmpInt32Tile)
{
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    ...
    pipe_barrier(PIPE_V);
#endif
    TanImpl<LastUse, TmpFp32Tile, TmpFp32Tile, TmpFp32Tile, TmpInt32Tile>(tmpFp32Tile, tmpFp32Tile, tmpFp32Tile, tmpInt32Tile);
#ifdef __DAV_V220
    pipe_barrier(PIPE_V);
#endif
        ...
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                if constexpr (std::is_same<typename T1::Type, float>::value) {
                    TanImpl<LastUse, DstTile, SrcTile, TmpFp32Tile, TmpInt32Tile>(dstTile, srcTile, tmpFp32Tile, tmpInt32Tile);
                } else if constexpr (std::is_same<typename T1::Type, half>::value ||
                                     std::is_same<typename T1::Type, bfloat16_t>::value) {
                    TanHalfImpl<LastUse, DstTile, SrcTile, TmpFp32Tile, TmpFp32Tile, TmpInt32Tile>(dstTile, srcTile, tmpFp32Tile, tmpFp32Tile, tmpInt32Tile);
                }
            }
        }
    }
