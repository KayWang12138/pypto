...
template <TrigtOp op, typename T0, typename T1, typename T2, typename T3>
TILEOP void TrigCompute(T0 dst, T1 src0, T2 tmp0, T3 tmp1)
{
    ...
    auto tmp0Tile = PtoTile<T2>(tmp0);
    auto tmp1Tile = PtoTile<T3>(tmp1);
    for (LoopVar n0Index = 0; n0Index < shape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < shape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < shape2; ++n2Index) {
                ...
                SyncV();
                using TmpTile = pto::Tile<pto::TileType::Vec, typename T1::Type, tmp1TileH, tmp1TileW, pto::BLayout::RowMajor, -1, -1>;
...
TILEOP void TSin(T0 dst, T1 src0, T2 tmp0, T3 tmp1)
{
    TrigCompute<TrigtOp::SIN>(dst, src0, tmp0, tmp1);
}

#define OP_TILE_OP_COS TCos
template <typename T0, typename T1, typename T2, typename T3>
TILEOP void TCos(T0 dst, T1 src0, T2 tmp0, T3 tmp1)
{
    TrigCompute<TrigtOp::COS>(dst, src0, tmp0, tmp1);
}
#endif