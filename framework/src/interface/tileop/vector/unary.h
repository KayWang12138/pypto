...
template <UnaryOp op, auto PrecisionType = void, typename LastUse, typename T0, typename T1>
...
template <auto PrecisionType = pto::LogAlgorithm::DEFAULT, typename LastUse = LastUse2Dim<0, 0>, typename T0, typename T1>
