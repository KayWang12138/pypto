...
TILEOP void UnaryCompute(T0 dst, T1 src) {
    ...
    if constexpr (op == UnaryOp::BRCB) {
        ...
        constexpr auto srcTileH = TileOp::GetTensorTileShapeDim<T1, DIM_4TH, expectSize>();
        constexpr auto srcTileW = TileOp::GetTensorTileShapeDim<T1, DIM_5TH, expectSize>();
        constexpr auto dstTileH = TileOp::GetTensorTileShapeDim<T0, DIM_4TH, expectSize>();
        constexpr auto dstTileW = TileOp::GetTensorTileShapeDim<T0, DIM_5TH, expectSize>();
        ...
        using SrcTileDefine = typename std::conditional<(srcTileW == 1), 
            ...
            pto::Tile<pto::TileType::Vec, typename T1::Type, srcTileH, srcTileW, pto::BLayout::RowMajor>>::type;
