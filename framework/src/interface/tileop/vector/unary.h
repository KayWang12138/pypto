    ...
    for (LoopVar n0Index = 0; n0Index < shape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < shape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < shape2; ++n2Index) {
                ...
                UnaryComputeImpl<op, PrecisionType, LastUse, decltype(dstTile.Data()), decltype(srcTile.Data())>(dstTile.Data(), srcTile.Data());
            }
        }
    }
}
...
{
    UnaryCompute<UnaryOp::LN, void, LastUse2Dim<0, 0>, T0, T1>(dst, src);
}
