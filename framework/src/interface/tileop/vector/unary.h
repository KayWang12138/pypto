...
TILEOP void TIsFinite(DstTileTensor dst, SrcTileTensor src, BufferTileTensor buffer) {
    ...
    using TileDefineDst = pto::Tile<pto::TileType::Vec, DstType, tileH, tileDstW, pto::BLayout::RowMajor, -1, -1>;
    using HalfTileDefineSrc = pto::Tile<pto::TileType::Vec, half, tileH, tileSrcW * sizeof(SrcType) / sizeof(half), pto::BLayout::RowMajor, -1, -1>;
    using B16TileDefineSrc = pto::Tile<pto::TileType::Vec, int16_t, tileH, tileSrcW * sizeof(SrcType) / sizeof(int16_t), pto::BLayout::RowMajor, -1, -1>;
