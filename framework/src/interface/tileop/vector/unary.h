...
TILEOP void UnaryCompute(T0 dst, T1 src)
{
    if constexpr (TileOp::IsConstContinous<T0, T1>() == true) {
        ...
        UnaryComputeImpl<op, PrecisionType, LastUse, decltype(dstTile), decltype(srcTile)>(dstTile, srcTile);
        return;
    }
    ...
    for (LoopVar n0Index = 0; n0Index < shape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < shape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < shape2; ++n2Index) {
                ...
                UnaryComputeImpl<op, PrecisionType, LastUse, decltype(dstTile.Data()), decltype(srcTile.Data())>(
    ...
    for (LoopVar n0Index = 0; n0Index < shape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < shape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < shape2; ++n2Index) {
                ...
                UnaryComputeImpl<UnaryOp::BRCB, void, LastUse, SrcTileDefine, DstTileDefine>(dstTile, srcTile);
            }
        }
    }
}
...
{
    UnaryCompute<UnaryOp::EXP, PrecisionType, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::RSQRT, void, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::SQRT, PrecisionType, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::ABS, void, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::BITWISENOT, void, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::LN, PrecisionType, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::RECIPROCAL, void, LastUse, T0, T1>(dst, src);
}
...
{
    UnaryCompute<UnaryOp::RELU, void, LastUse, T0, T1>(dst, src);
}
#endif
