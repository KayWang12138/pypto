...
template<typename T, typename TileDefineDst, typename B16TileDefineSrc>
TILEOP void IsFiniteCalcImpl(TileDefineDst dst, B16TileDefineSrc src, pto::Tile bufferB16, pto::Tile bufferFP16) {
    int16_t mask = 0;
