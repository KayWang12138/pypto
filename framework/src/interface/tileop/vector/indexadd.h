...
template <typename T0, typename T2, typename dstTileDefine, typename tempTileDefine, typename src1TileDefine, typename Scalar>
TILEOP void IndexAddNotLastAxisCompute(dstTileDefine dstTile, tempTileDefine tempTile, src1TileDefine src1Tile, Scalar alpha,
    __ubuf__ typename T0::Type *dstAddr, __ubuf__ bfloat16_t *tempAddr, __ubuf__ typename T2::Type *src1Addr, size_t dstOffset, size_t src1Offset) {
...
TILEOP void TIndexAdd(T0 dst, T1 src0, T2 src1, T3 src2, T4 tmpTensor, Scalar alpha) {   // T0: tileTensor
    ...
    auto dstAddr = (__ubuf__ typename T0::Type *)((uint64_t)(dst.GetAddr()));
    auto tempAddr = (__ubuf__ typename T4::Type *)((uint64_t)(tmpTensor.GetAddr()));
    auto src1Addr = (__ubuf__ typename T2::Type *)((uint64_t)(src1.GetAddr()));
    auto idxAddr = (__ubuf__ typename T3::Type *)((uint64_t)(src2.GetAddr()));
    ...
    // } else if constexpr (axis == 3) {
        ...
        tempTileDefine tempTile(1, dstShape4);
