...
template <
    BinaryScalarOp op, DivAlgorithm PrecisionType = DivAlgorithm::HIGH_PRECISION, typename LastUse, typename T0,
...
template <
    DivAlgorithm PrecisionType = DivAlgorithm::HIGH_PRECISION, typename LastUse = LastUse2Dim<0, 0>, typename Scalar,
