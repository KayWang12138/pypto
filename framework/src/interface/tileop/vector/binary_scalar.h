...
template <
    BinaryScalarOp op, DivAlgorithm PrecisionType = DivAlgorithm::INTRINSIC, typename LastUse, typename T0,
...
template <
    DivAlgorithm PrecisionType = DivAlgorithm::INTRINSIC, typename LastUse = LastUse2Dim<0, 0>, typename Scalar,
