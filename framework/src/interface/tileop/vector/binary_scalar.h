...
template <BinaryScalarOp op, DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, typename LastUse, typename T0,
...
TILEOP void BinaryScalarComputeImpl(T0 dst, T1 src0, Scalar src1)
{
    ...
    if constexpr (op == BinaryScalarOp::DIV) {
        if constexpr (PrecisionType == DivAlgorithm::HIGH_PRECISION) {
            PTO_WITH_LAST_USE(pto::TDIVS<pto::DivAlgorithm::HIGH_PRECISION>(dst, src0, src1), n1, n2);
        } else {
            PTO_WITH_LAST_USE(pto::TDIVS<pto::DivAlgorithm::DEFAULT>(dst, src0, src1), n1, n2);
        }
        return;
    }
...
template <
    BinaryScalarOp op, DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, typename LastUse, typename T0,
    typename T1, typename Scalar>
...
{
    BinaryScalarCompute<BinaryScalarOp::ADD, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::SUB, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::MUL, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}

#define OP_TILE_OP_DIVS TDivS
template <
    DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, typename LastUse = LastUse2Dim<0, 0>, typename Scalar,
...
{
    BinaryScalarCompute<BinaryScalarOp::MAX, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::MIN, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::LRELU, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::BITWISEAND, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::BITWISEOR, DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
