...
TILEOP void BinaryScalarComputeImpl(T0 dst, T1 src0, Scalar src1)
{
    ...
    if constexpr (op == BinaryScalarOp::DIV) {
        if constexpr (PrecisionType == pto::DivAlgorithm::HIGH_PRECISION) {
...
{
    BinaryScalarCompute<BinaryScalarOp::ADD, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::SUB, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::MUL, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::MAX, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::MIN, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::LRELU, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::BITWISEAND, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
...
{
    BinaryScalarCompute<BinaryScalarOp::BITWISEOR, pto::DivAlgorithm::HIGH_PRECISION, LastUse>(dst, src0, src1);
}
