...
TILEOP void TSignbit(T0 dst, T1 src, T2 tmp) {
    ...
    using SrcInt32Tile =
        pto::Tile<pto::TileType::Vec, int32_t, srcTileH, srcTileW, pto::BLayout::RowMajor, -1, -1>;
    using SrcInt16Tile =
        pto::Tile<pto::TileType::Vec, int16_t, srcTileH, srcTileW, pto::BLayout::RowMajor, -1, -1>;
    using SrcUint8Tile =
        pto::Tile<pto::TileType::Vec, uint8_t, srcTileH, srcTileW, pto::BLayout::RowMajor, -1, -1>;
    using SrcInt8Tile =
        pto::Tile<pto::TileType::Vec, int8_t, srcTileH, srcTileW, pto::BLayout::RowMajor, -1, -1>;
        ...
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                if constexpr (std::is_same<typename T1::Type, uint8_t>::value) {
                    ...
                    pto::TASSIGN(srcUint32Tile, (uint64_t)src.GetAddr());
                    pto::TASSIGN(srcInt32Tile, (uint64_t)src.GetAddr());
                    ...
                    pto::TASSIGN(srcUint16Tile, (uint64_t)src.GetAddr());
                    ...
                    pto::TASSIGN(srcInt8Tile, (uint64_t)src.GetAddr());
