...
TILEOP void SignbitInt32(DstTile dstTile, SrcTile srcTile) {
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    pto::TSHRS(dstTile, srcTile, static_cast<T>(31));
}

template <typename LastUse, typename T, typename DstTile, typename SrcTile>
TILEOP void SignbitInt16(DstTile dstTile, SrcTile srcTile) {
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    pto::TSHRS(dstTile, srcTile, static_cast<T>(15));
}

template <typename LastUse, typename T, typename DstTile, typename SrcTile>
TILEOP void SignbitInt8(DstTile dstTile, SrcTile srcTile) {
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    pto::TSHRS(dstTile, srcTile, static_cast<T>(7));
}

template <typename LastUse, typename T, typename DstTile, typename SrcTile>
TILEOP void SignbitFloat16(DstTile dstTile, SrcTile srcTile) {
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    ...
    pipe_barrier(PIPE_V);
#endif
    pto::TSHRS(dstTile, dstTile, static_cast<T>(15));
}

template <typename LastUse, typename T, typename DstTile, typename SrcTile, typename TmpTile>
TILEOP void SignbitFloat32(DstTile dstTile, SrcTile srcTile, TmpTile tmpTile) {
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
...
template <typename LastUse, typename T, typename DstTile, typename SrcTile, typename TmpTile>
TILEOP void SignbitImpl(DstTile dstTile, SrcTile srcTile, TmpTile tmpTile) {
    if constexpr (std::is_same<T, int32_t>::value) {
        SignbitInt32<LastUse, T, DstTile, SrcTile>(dstTile, srcTile);
    } else if constexpr (std::is_same<T, int16_t>::value) {
        SignbitInt16<LastUse, T, DstTile, SrcTile>(dstTile, srcTile);
    } else if constexpr (std::is_same<T, int8_t>::value) {
        SignbitInt8<LastUse, T, DstTile, SrcTile>(dstTile, srcTile);
    } else if constexpr (std::is_same<T, half>::value) {
        SignbitFloat16<LastUse, T, DstTile, SrcTile>(dstTile, srcTile);
    } else if constexpr (std::is_same<T, float>::value || std::is_same<T, bfloat16_t>::value) {
        SignbitFloat32<LastUse, T, DstTile, SrcTile, TmpTile>(dstTile, srcTile, tmpTile);
    }
    return;
}
    ...
    for (LoopVar n0Index = 0; n0Index < dstShape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                SignbitImpl<LastUse, typename T1::Type, DstTile, SrcTile, TmpTile>(dstTile, srcTile, tmpTile);
            }
        }
    }
}
