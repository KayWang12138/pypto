...
TILEOP void SignbitImpl(DstTile dstTile, SrcTile srcTile)
{
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    constexpr auto shiftAmount = 7;
    pto::TShr(dstTile, srcTile, static_cast<T>(shiftAmount));
}

template <typename LastUse, typename T, typename DstTile, typename SrcTile, typename TmpTile>
TILEOP void SignbitHalf(DstTile dstTile, SrcTile srcTile, TmpTile tmpTile)
{
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
...
#endif
    constexpr auto shiftAmount = 7;
    pto::TShr(dstTile, tmpTile, static_cast<half>(shiftAmount));
}

template <typename LastUse, typename T, typename DstTile, typename SrcTile, typename TmpTile>
TILEOP void SignbitFloat(DstTile dstTile, SrcTile srcTile, TmpTile tmpTile)
{
    constexpr auto n1 = Std::tuple_element<DIM_1ST, LastUse>::type::value;
    constexpr auto n2 = Std::tuple_element<DIM_2ND, LastUse>::type::value;
    pto::TCVT(tmpTile, srcTile, pto::RoundMode::CAST_NONE);
...
{
    if constexpr (std::is_same<T, int32_t>::value || std::is_same<T, int16_t>::value || std::is_same<T, int8_t>::value) {
        SignbitImpl<LastUse, T, DstTile, SrcTile>(dstTile, srcTile);
    } else if constexpr (std::is_same<T, half>::value) {
        SignbitImpl<LastUse, T, DstTile, SrcTile>(dstTile, srcTile);
    } else if constexpr (std::is_same<T, float>::value || std::is_same<T, bfloat16_t>::value) {
        SignbitFloat<LastUse, T, DstTile, SrcTile, TmpTile>(dstTile, srcTile, tmpTile);
    }
    return;
}
    ...
    for (LoopVar n0Index = 0; n0Index < dstShape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                SignbitImpl<LastUse, typename T0::Type, DstTile, SrcTile, TmpTile>(dstTile, srcTile, tmpTile);
            }
        }
    }
}
