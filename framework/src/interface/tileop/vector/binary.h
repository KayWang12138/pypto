...
{
    BinaryCompute<BinaryOp::ADD, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::SUB, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MUL, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MAX, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MIN, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::BITWISEAND, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::BITWISEOR, pto::DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
