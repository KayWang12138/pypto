...
template <
    BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::HIGH_PRECISION, typename LastUse, typename T0, typename T1,
    typename T2>
...
template <
    BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::HIGH_PRECISION, BrcMode brcmode, typename LastUse,
