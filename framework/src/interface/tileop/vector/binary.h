...
template <BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::INTRINSIC, typename LastUse, typename T0, typename T1, typename T2>
TILEOP void BinaryComputeImpl(T0 dst, T1 src0, T2 src1)
{
    ...
    if constexpr (op == BinaryOp::DIV) {
        if constexpr (PrecisionType == DivAlgorithm::HIGH_PRECISION) {
            PTO_WITH_LAST_USE(pto::TDIV<pto::DivAlgorithm::HIGH_PRECISION>(dst, src0, src1), n1, n2, n3);
        } else {
            PTO_WITH_LAST_USE(pto::TDIV<pto::DivAlgorithm::DEFAULT>(dst, src0, src1), n1, n2, n3);
        }
        return;
    }
...
template <BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::INTRINSIC, BrcMode brcmode, typename LastUse, typename T0, typename T1, typename T2>
...
template <
    BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::INTRINSIC, TileOp::BroadcastOperand WBrcSide,
...
{
    BinaryCompute<BinaryOp::ADD, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::SUB, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MUL, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}

#define OP_TILE_OP_DIV TDiv
template <
    DivAlgorithm PrecisionType = DivAlgorithm::INTRINSIC, typename LastUse = LastUse3Dim<0, 0, 0>,
...
{
    BinaryCompute<BinaryOp::MAX, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MIN, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::BITWISEAND, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::BITWISEOR, DivAlgorithm::HIGH_PRECISION, WBrcSide, HBrcSide, LastUse>(dst, src0, src1);
}
