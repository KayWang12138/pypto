...
template <
    BinaryOp op, pto::DivAlgorithm PrecisionType = pto::DivAlgorithm::DEFAULT, typename LastUse, int... BrcOperands,
...
{
    BinaryCompute<BinaryOp::ADD, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::SUB, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MUL, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MAX, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MIN, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::BITWISEAND, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::BITWISEOR, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
{
    BinaryCompute<BinaryOp::MOD, pto::DivAlgorithm::DEFAULT, LastUse, BrcOperands...>(dst, src0, src1);
}
...
template <BinaryOp op, typename T0, typename T1, typename T2, typename T3>
...
template <BinaryOp op, int... BrcOperands, typename T0, typename T1, typename T2, typename T3>
TILEOP void BinaryTmpCompute(T0 dst, T1 src0, T2 src1, T3 tmp)
{
    if constexpr (TileOp::IsConstContinous<T0, T1, T2, T3>() == true) {
        ...
        BinaryTmpComputeImpl<op>(dstTile, src0Tile, src1Tile, tmpTile);
        return;
    }
    const auto dstLayout = dst.GetLayout();
    auto shape0 = dstLayout.template GetShapeDim<DIM_1ST, MAX_DIMS>();
    ...
    for (LoopVar n0Index = 0; n0Index < shape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < shape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < shape2; ++n2Index) {
                ...
                BinaryTmpComputeImpl<op>(dstTile.Data(), src0Tile.Data(), src1Tile.Data(), tmpTile.Data());
            }
        }
    }
}
...
{
    BinaryTmpCompute<BinaryOp::BITWISEXOR, BrcOperands...>(dst, src0, src1, tmp);
}
...
TILEOP void TPow(T0 dst, T1 src0, T2 src1, T3 tmp)
{
    ...
    BinaryTmpCompute<BinaryOp::POW, BrcOperands...>(dst, src0, src1, tmp);
}
...
{
    BinaryTmpCompute<BinaryOp::REM, BrcOperands...>(dst, src0, src1, tmp);
}
