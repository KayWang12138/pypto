...
template <BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, typename LastUse, typename T0, typename T1, typename T2>
...
template <BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, BrcMode brcmode, typename LastUse, typename T0, typename T1, typename T2>
...
template <
    BinaryOp op, DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, TileOp::BroadcastOperand WBrcSide,
...
template <
    DivAlgorithm PrecisionType = DivAlgorithm::DEFAULT, typename LastUse = LastUse3Dim<0, 0, 0>,
