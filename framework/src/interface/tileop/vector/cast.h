...
template <typename LastUse = LastUse2Dim<0, 0>, unsigned Mode, typename T0, typename T1, typename T2>
TILEOP void TCast(T0 dst, T1 src, T2 tmp, pto::SaturationMode satmode = pto::SaturationMode::OFF) {
    ...
    constexpr auto tmpTileH = srcTileH;
    constexpr auto tmpTileW = srcTileW;
    using TmpTile = pto::Tile<pto::TileType::Vec, int32_t, tmpTileH, tmpTileW, pto::BLayout::RowMajor, -1, -1>;
