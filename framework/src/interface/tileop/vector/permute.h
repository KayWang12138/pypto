...
TILEOP void Tpermute(T0 dst, T1 src, C0 srcCoordinate) {
    ...
    if constexpr (dimCount == 2 && axis0 == 1 && axis1 == 0) {
        ...
        for (LoopVar i0 = 0; i0 < d0; ++i0) {
            ...
            GlobalData srcGlobal(srcAddr + gmOff, pto::Shape(1, 1, 1, 1, d1), pto::Stride(0, 0, 0, 0, srcStride4));
        ...
        for (LoopVar i0 = 0; i0 < d0; ++i0) {
            ...
            for (LoopVar i1 = 0; i1 < d1; ++i1) {
                ...
                GlobalData srcGlobal(srcAddr + gmOff, pto::Shape(1, 1, 1, 1, d2), pto::Stride(0, 0, 0, 0, srcStride4));
            ...
            for (LoopVar i1 = 0; i1 < d1; ++i1) {
                ...
                for (LoopVar i2 = 0; i2 < d2; ++i2) {
                    ...
                    GlobalData srcGlobal(
                        srcAddr + gmOff, pto::Shape(1, 1, 1, 1, d3), pto::Stride(0, 0, 0, 0, srcStride4));
            ...
            for (LoopVar i1 = 0; i1 < d1; ++i1) {
                ...
                for (LoopVar i2 = 0; i2 < d2; ++i2) {
                    ...
                    for (LoopVar i3 = 0; i3 < d3; ++i3) {
                        ...
                        GlobalData srcGlobal(
                            srcAddr + gmOff, pto::Shape(1, 1, 1, 1, d4), pto::Stride(0, 0, 0, 0, srcStride4));
