...
/*!
 * \file permute.h
 * \brief Permute operation implementation using PTO-ISA interfaces
 */
...
template <int axis0, int axis1, int axis2, int axis3, int axis4, typename T0, typename T1, typename T2>
    ...
    for (LoopVar n0Index = 0; n0Index < dstShape0; ++n0Index) {
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                auto srcOffset = 0;
                if (axis0 >= 0) {
                    srcOffset += n0Index * srcStride0;
                }
                if (axis1 >= 0) {
                    srcOffset += n1Index * srcStride1;
                }
                if (axis2 >= 0) {
                    srcOffset += n2Index * srcStride2;
                }
