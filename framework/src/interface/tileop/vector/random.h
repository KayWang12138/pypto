...
TILEOP void TRandomOp(TDst dst, uint64_t key, uint64_t *counter, uint16_t rounds, int64_t tileOffset) {
    ...
    RandomCounter randomCounter = {static_cast<uint32_t>(tileCounter[0] & 0xFFFFFFFF),
