...
template <typename T0, typename T1, typename T2, typename T3, int axis>
    ...
    if constexpr (axis == 4) {
        ...
        for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
            for (LoopVar n3Index = 0; n3Index < dstShape3; ++n3Index) {
                ...
                auto negative_slope = *(weight.GetAddr() + n3Index * weightTypeSize);
        ...
        for (LoopVar n1Index = 0; n1Index < dstShape1; ++n1Index) {
            for (LoopVar n2Index = 0; n2Index < dstShape2; ++n2Index) {
                ...
                auto negative_slope = *(weight.GetAddr() + n2Index * weightTypeSize);
