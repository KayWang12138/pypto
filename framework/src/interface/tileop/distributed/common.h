...
template<typename T>
TILEOP __gm__ T* MapVirtualAddrV2(__gm__ int64_t *hcclContext, __gm__ T* vAddr, uint32_t dstRankId)
{
    (void) hcclContext;
    __gm__ TileOp::CommContext *commCtxParam = (__gm__ TileOp::CommContext *)(((__gm__ TileOp::ShmemAddrDesc *)vAddr)->contextAddr);
