...
TILEOP void MoeDistributedCombineSend(CoreFuncParam *param, __ubuf__ T *dataBuffer,
    __ubuf__ int32_t *assistInfoForCombineBuffer, __ubuf__ int32_t *signalBuffer, __gm__ T *expandX,
    __gm__ int32_t *assistInfoForCombine, __ubuf__ int32_t *recvCounts, __gm__ T *shmemDataBaseAddr,
    __gm__ int32_t *shmemSignalBaseAddr, uint64_t expandXOffset0, uint64_t expandXOffset1,
...
TILEOP void MoeDistributedCombineCompute(__ubuf__ T *out, __ubuf__ float *mulFp32Buffer, __ubuf__ float *sumFp32Buffer,
    __ubuf__ float *expertScales, __gm__ T *winDataAddr) {
...
template <typename T, uint32_t topK, uint16_t rowShape, uint16_t colShape, uint16_t paddedColShape>
TILEOP void MoeDistributedCombineReceive(CoreFuncParam *param, __gm__ T *out, __ubuf__ float *mulFp32Buffer,
    __ubuf__ float *sumFp32Buffer, __ubuf__ T *outBuffer, __ubuf__ float *expertScales, __gm__ T *shmemDataBaseAddr,
