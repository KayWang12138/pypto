...
template<typename HcclContextType, typename T, uint32_t shmemTensorRawShape1, uint32_t shmemTensorRawShape2,
...
template<typename HcclContextType, typename NonShmemType, typename ShmemType, uint32_t tileRowShape, uint32_t tileColShape,
    uint32_t bufferRowShape,
...
template<typename HcclContextType, typename InShmemType, typename OutShmemType, uint32_t tileRowShape, uint32_t tileColShape,
    ...
    uint32_t shmemDataRawShape0, uint32_t shmemDataRawShape1, uint32_t shmemDataRawShape2, uint32_t shmemDataRawShape3, __gm__ int64_t *hcclContext)
{
    ...
    __gm__ InShmemType* inShmemDataAddr =
        MapVirtualAddr<HcclContextType, InShmemType>(hcclContext, inShmemDataBaseAddr, inShmemDataOffset0) +
        inShmemDataOffset1 * inShmemDataRawShape2 * inShmemDataRawShape3 +
        inShmemDataOffset2 * inShmemDataRawShape3 + inShmemDataOffset3;
    __gm__ OutShmemType* shmemDataAddr = 
        MapVirtualAddr<HcclContextType, OutShmemType>(hcclContext, shmemDataBaseAddr, shmemDataOffset0) +
        shmemDataOffset1 * shmemDataRawShape2 * shmemDataRawShape3 +
...
template<typename HcclContextType, typename UBType, typename ShmemType, uint32_t tileRowShape, uint32_t tileColShape,
    ...
    uint32_t shmemDataRawShape0, uint32_t shmemDataRawShape1, uint32_t shmemDataRawShape2, uint32_t shmemDataRawShape3, __gm__ int64_t *hcclContext)
{
    ...
    __gm__ ShmemType* shmemDataAddr =
        MapVirtualAddr<HcclContextType, ShmemType>(hcclContext, shmemDataBaseAddr, shmemDataOffset0) +
        shmemDataOffset1 * shmemDataRawShape2 * shmemDataRawShape3 +
        shmemDataOffset2 * shmemDataRawShape3 + shmemDataOffset3;
    ...
    uint32_t shmemSignalShape0, uint32_t shmemSignalShape1, uint32_t shmemSignalShape2, uint32_t shmemSignalShape3, uint32_t shmemSignalShape4, __gm__ int64_t *hcclContext)
{
    ...
    for (uint32_t rankId = shmemSignalOffset0; rankId < shmemSignalOffset0 + shmemSignalShape0; rankId++) {
        __gm__ int32_t* shmemSignalAddr = 
            MapVirtualAddr<HcclContextType, int32_t>(hcclContext, shmemSignalBaseAddr, rankId) +
