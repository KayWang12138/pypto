...
TILEOP void ShmemPutUb2Gm(__ubuf__ Type* UBDataBaseAddr, __gm__ Type* shmemDataBaseAddr, uint32_t UBDataOffset0, uint32_t UBDataOffset1, uint32_t UBDataRawShape0,
    ...
    uint32_t shmemDataRawShape0, uint32_t shmemDataRawShape1, uint32_t shmemDataRawShape2, uint32_t shmemDataRawShape3, __gm__ int64_t *hcclContext)
{
    ...
    __gm__ Type* shmemDataAddr = MapAndOffsetShmem(
        hcclContext, shmemDataBaseAddr, shmemDataOffset0, shmemDataOffset1, shmemDataOffset2, shmemDataOffset3,
        shmemDataRawShape2, shmemDataRawShape3);
    ...
    ShmemGlobalTensor<TargetType, tileRowShape, tileColShape> dstGlobal(target, shape, dstStrideDyn);
    ShmemUbTile<SourceType, tileRowShape, tileColShape> ubTile(tileRowShape, tileColShape);
