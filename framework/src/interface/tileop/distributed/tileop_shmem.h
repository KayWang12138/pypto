...
TILEOP void ShmemSet(CoreFuncParam* param, __ubuf__ T* buffer, __gm__ T* shmemTensorBaseAddr, uint32_t shmemTensorOffset0,
    uint32_t shmemTensorOffset1, uint32_t shmemTensorOffset2, uint32_t targetRank, __gm__ int64_t *hcclContext)
{
    __gm__ T* shmemTensorAddr = MapVirtualAddr<T>(hcclContext, shmemTensorBaseAddr, targetRank) +
...
TILEOP void ShmemSet(CoreFuncParam* param, __ubuf__ T* buffer, __gm__ T* shmemTensorBaseAddr, uint32_t shmemTensorOffset0,
    ...
    uint32_t shmemTensorShape2, uint32_t shmemTensorShape3, uint32_t targetRank, __gm__ int64_t *hcclContext)
{
...
TILEOP void ShmemPut(CoreFuncParam* param, __ubuf__ NonShmemType* buffer, __gm__ NonShmemType* nonShmemDataBaseAddr, __gm__ ShmemType* shmemDataBaseAddr,
    ...
    uint32_t shmemDataRawShape0, uint32_t shmemDataRawShape1, uint32_t shmemDataRawShape2, uint32_t shmemGetTensorDataOffset, uint32_t targetRank, __gm__ int64_t *hcclContext)
{
    ...
    __gm__ ShmemType* dstAddr = MapVirtualAddr<ShmemType>(hcclContext, shmemDataBaseAddr, targetRank) +
...
TILEOP void ShmemPutUb2Gm(CoreFuncParam* param, __ubuf__ Type* UBDataBaseAddr, __gm__ Type* shmemDataBaseAddr, uint32_t UBDataOffset0, uint32_t UBDataOffset1, uint32_t UBDataRawShape0,
    ...
    uint32_t shmemDataRawShape0, uint32_t shmemDataRawShape1, uint32_t shmemDataRawShape2, uint32_t targetRank, __gm__ int64_t *hcclContext)
{
    ...
    __gm__ Type* shmemDataAddr = MapVirtualAddr<Type>(hcclContext, shmemDataBaseAddr, targetRank) +
        CalcLinearOffset(shmemDataRawShape1, shmemDataRawShape2, shmemDataOffset0, shmemDataOffset1, shmemDataOffset2);
...
TILEOP void ShmemSignal(CoreFuncParam* param, __ubuf__ int32_t* buffer, __gm__ int32_t* shmemSignalBaseAddr,
    ...
    uint32_t shmemSignalShape0, uint32_t shmemSignalShape1, uint32_t shmemSignalShape2, uint32_t shmemSignalShape3, uint32_t targetRank, __gm__ int64_t *hcclContext)
{
    ...
    uint32_t sRank = notifyAll ? 0 : targetRank;
    ...
    uint32_t shmemDataRawShape0, uint32_t shmemDataRawShape1, uint32_t shmemDataRawShape2, uint32_t targetRank, __gm__ int64_t *hcclContext)
{
    ...
    __gm__ NonShmemType* nonShmemDataAddr = nonShmemDataBaseAddr + TileOp::CalcLinearOffset(nonShmemDataRawShape1,
        nonShmemDataOffset0, nonShmemDataOffset1);
    __gm__ ShmemType* shmemDataAddr = MapVirtualAddr<ShmemType>(hcclContext, shmemDataBaseAddr, targetRank) +
        CalcLinearOffset(shmemDataRawShape1, shmemDataRawShape2, shmemDataOffset0, shmemDataOffset1, shmemDataOffset2);
