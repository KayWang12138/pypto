...
enum class BinaryOp : uint8_t { ADD = 0, SUB, MUL, DIV, AND, OR, MAX, MIN, SUM, AMAX, MOD, REM, POW, BITWISEAND, BITWISEOR, BITWISEXOR };
...
enum class BinaryScalarOp : uint8_t { ADD = 0, SUB, MUL, DIV, MAX, MIN, MOD, REMS, BITWISEAND, BITWISEOR, BITWISEXOR };
