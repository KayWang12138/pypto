...
#define FUNCTION_ASSERT_WITHOUT_ERR(cond) ASSERT(FError::UNKNOWN, cond)
#define FUNCTION_ASSERT_WITH_ERR(errcode, cond) ASSERT(errcode, cond)
#define FUNCTION_ASSERT(...) \
    FUNCTION_ASSERT_SELECT(__VA_ARGS__, FUNCTION_ASSERT_WITH_ERR, FUNCTION_ASSERT_WITHOUT_ERR)(__VA_ARGS__)
#endif
