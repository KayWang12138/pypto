...
static std::vector<std::string> SplitExtraCflags(const std::string& extraCflag)
{
    ...
    std::istringstream iss(extraCflag);
    std::string token;
    while (iss >> token) {
...
std::string CompileSourceCode(const std::string& sourceFilePath, const std::string& gcc, const std::string& extraCflag)
{
    ...
    FUNCTION_LOGI("[RunCmd] %s", std::accumulate(argsGcc.begin(), argsGcc.end(), std::string(),
    ...
    FUNCTION_LOGI("[RunCmd] %s", std::accumulate(argsAs.begin(), argsAs.end(), std::string(),
        [](const std::string& a, const std::string& b) { return a.empty() ? b : a + " " + b; }).c_str());
    ...
    const std::string& sectionName, bool needDump, const std::string& extraCflag)
{
    ...
    FUNCTION_LOGI("[RunCmd] %s", std::accumulate(argsLd.begin(), argsLd.end(), std::string(),
        [](const std::string& a, const std::string& b) { return a.empty() ? b : a + " " + b; }).c_str());
    ...
    FUNCTION_LOGI("[RunCmd] %s", std::accumulate(argsObjcopy.begin(), argsObjcopy.end(), std::string(),
        [](const std::string& a, const std::string& b) { return a.empty() ? b : a + " " + b; }).c_str());
