...
struct SymbolicExpressionTable {
    ...
    static std::string BuildExpressionByRaw(const RawSymbolicScalarPtr &raw, const std::unordered_map<RawSymbolicScalarPtr, std::string> &exprDict,
        std::vector<std::string> *dependArgs = nullptr);
    static std::string BuildExpression(const SymbolicScalar &ss, std::vector<std::string> *dependArgs = nullptr);
    static std::string BuildExpression(const RawSymbolicScalarPtr &ss, std::vector<std::string> *dependArgs = nullptr);
private:
