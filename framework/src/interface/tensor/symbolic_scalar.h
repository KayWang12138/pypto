...
struct SymbolicExpressionTable {
    ...
    static std::string BuildExpressionByRaw(const RawSymbolicScalarPtr &raw, const std::unordered_map<RawSymbolicScalarPtr, std::string> &exprDict,
        std::set<std::string> *dependArgs = nullptr);
    static std::string BuildExpression(const SymbolicScalar &ss, std::set<std::string> *dependArgs = nullptr);
    static std::string BuildExpression(const RawSymbolicScalarPtr &ss, std::set<std::string> *dependArgs = nullptr);
private:
