...
SymbolicScalar CodeGenOpLiteNPU::GetOperandStartOffsetLite(int operandIdx) const {
...
std::vector<std::string> CodeGenOpLiteNPU::BuildStride(const std::vector<int64_t> &input) {
    if (input.empty()) {
        return {};
    }
