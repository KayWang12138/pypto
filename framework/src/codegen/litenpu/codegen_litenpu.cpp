...
void CodeGenLiteNPU::GenInclude(const Function &topFunc, std::ostringstream &oss) const {
...
void CodeGenLiteNPU::GenCommentBeforeFuncHeader(Function &subFunc, std::ostringstream &oss) const {
...
void CodeGenLiteNPU::GenFuncBodyBefore(const std::pair<uint64_t, Function *> &subFuncPair, Function &topFunc,
...
void CodeGenLiteNPU::GenFuncEnd(std::ostringstream &oss) const {
    oss << "}\n";
}
...
void CodeGenLiteNPU::DumpCCE(const std::string &fileName, std::ostringstream &oss) const {
