...
std::string CodeGenOpCloudNPU::PrintPadTileTensor() const {
    ...
    std::string rowKey = OP_ATTR_PREFIX + "src_valid_row";
    std::string colKey = OP_ATTR_PREFIX + "src_valid_col";

    srcValidRowStr = std::to_string(AnyCast<int64_t>(rowAttr));
    srcValidColStr = std::to_string(AnyCast<int64_t>(colAttr));
