...
std::string CodeGenOpCloudNPU::GenTemplateParamsForMoeFfnFused() const
{
    DistOpAttr distOpAttr = npu::tile_fwk::AnyCast<DistOpAttr>(opAttrs.at(OpAttributeKey::distOpAttr));
    int64_t secondToLastIndex = 2;
...
std::string CodeGenOpCloudNPU::GenTemplateParams() const
{
    static const std::unordered_map<Opcode,
        ...
        {Opcode::OP_MOE_FFN_FUSED, [](const CodeGenOpCloudNPU* self) { return self->GenTemplateParamsForMoeFfnFused(); }},
...
std::string CodeGenOpCloudNPU::GenOffsetsAndRawShapesForMoeFfnFused() const
{
    return "";
}
...
std::string CodeGenOpCloudNPU::GenExtraParamsStr() const
{
    static const std::unordered_map<Opcode,
        ...
        {Opcode::OP_MOE_FFN_FUSED, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForMoeFfnFused(); }},
