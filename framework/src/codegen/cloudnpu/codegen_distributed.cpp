...
std::string CodeGenOpCloudNPU::GetTemplateDType() const
{
    static const std::unordered_map<Opcode, int32_t> dTypeOperandIndexMap = {
        {Opcode::OP_MOE_DISPATCH_ASSEMBLE_EXPANDX, 0},
        {Opcode::OP_MOE_DISTRIBUTED_COMBINE_RECEIVE, 0},
        {Opcode::OP_MOE_DISPATCH_LOCAL_COPY_OUT, 0},
        {Opcode::OP_MOE_DISPATCH_SEND_ROUTED, 1},
        {Opcode::OP_MOE_DISPATCH_SEND_SHARED, 1},
        {Opcode::OP_MOE_DISPATCH_WAIT_FLAG, 1},
        {Opcode::OP_MOE_DISPATCH_ASSEMBLE_EXPANDX, 1},
        {Opcode::OP_MOE_DISPATCH_EXPERT_TOKEN_NUM, 1},
        ...
        {Opcode::OP_MOE_DISPATCH_ASSEMBLE_COMBINEINFO, 2},
        {Opcode::OP_SHMEM_SET, 3},
        {Opcode::OP_MOE_DISPATCH_SET_FLAG, 4},
    };
...
std::string CodeGenOpCloudNPU::GenExtraParamsStr() const
{
    static const std::unordered_map<Opcode,
        ...
        {Opcode::OP_MOE_DISPATCH_SEND_ROUTED, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForDispatchSendToRoutingExperts(); }},
        {Opcode::OP_MOE_DISPATCH_SEND_SHARED, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForSendToSharedExpert(); }},
        {Opcode::OP_MOE_DISPATCH_LOCAL_COPY_OUT, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForCopyToLocalExpert(); }},
        {Opcode::OP_MOE_DISPATCH_SET_FLAG, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForDispatchSetRecvFlags(); }},
        {Opcode::OP_MOE_DISPATCH_WAIT_FLAG, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForFfnOperations(); }},
        {Opcode::OP_MOE_DISPATCH_ASSEMBLE_EXPANDX, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForFfnOperations(); }},
        {Opcode::OP_MOE_DISPATCH_EXPERT_TOKEN_NUM, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForFfnOperations(); }},
        {Opcode::OP_MOE_DISPATCH_ASSEMBLE_COMBINEINFO, [](const CodeGenOpCloudNPU* self) { return self->GenOffsetsAndRawShapesForDispatchAssembleCombineInfo(); }},
