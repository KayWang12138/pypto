...
std::vector<std::string> CodeGenOpCloudNPU::GenTileOpParamForNormalCopyTileTensor(unsigned gmIdx) const
{
...
std::vector<std::string> CodeGenOpCloudNPU::GetGmOffsetForTileTensor(unsigned gmIdx) const
{
