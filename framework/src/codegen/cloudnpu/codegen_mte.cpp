...
std::string CodeGenOpCloudNPU::PrintGatherInUBLayout() const {
    ...
    ASSERT(opAttrs.find("op_attr_blocksize") != opAttrs.end()) << "GenGatherOp: There is nop axis attribute here";
    const int64_t blockSize = npu::tile_fwk::AnyCast<int64_t>(opAttrs.at("op_attr_blocksize"));
    paramList.push_back(std::to_string(blockSize));
    std::string templateParam = JoinString(paramList, CONN_COMMA);
...
std::string CodeGenOpCloudNPU::PrintGatherInUBDynamicUnaligned() const {
    ...
    auto paramGMStride = GenParamIdxExprByIndex(paramIndex, 2, PREFIX_STR_RAW_SHAPE);
    auto paramStartOffsets = GenParamIdxExprByIndex(paramIndex, 2, PREFIX_STR_OFFSET);
    ...
    auto indicesGMStride = GenParamIdxExprByIndex(indicesIndex, 2, PREFIX_STR_RAW_SHAPE);
    auto indicesStartOffsets = GenParamIdxExprByIndex(indicesIndex, 2, PREFIX_STR_OFFSET);
    ...
    auto blockTableGMStride = GenParamIdxExprByIndex(blockTableIndex, 2, PREFIX_STR_RAW_SHAPE);
    auto blockTableStartOffsets = GenParamIdxExprByIndex(blockTableIndex, 2, PREFIX_STR_OFFSET);
