...
CodeGenOpCloudNPU::CodeGenOpCloudNPU(const std::shared_ptr<SymbolManager> &symbolManager, FunctionType funcType,
    ...
    : CodeGenOp(symbolManager, funcType, locToOffset, isUnderDynamicFunc, isMainBlk),
      ...
      distributeOps_({
          // distribute op
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_WAIT_SIGNAL, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_EXPAND_X, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_ASSEMBLE_ASSIST_INFO_FOR_COMBINE, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_EXPERT_TOKEN_NUM, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_SEND_ROUTED, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_SEND_SHARED, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_SET_SIGNAL, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISTRIBUTED_DISPATCH_LOCAL_COPY_OUT, [this]() { return GenDistOp(); }},
