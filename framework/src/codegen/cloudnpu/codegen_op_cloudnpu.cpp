...
CodeGenOpCloudNPU::CodeGenOpCloudNPU(const std::shared_ptr<SymbolManager> &symbolManager, FunctionType funcType,
    ...
    : CodeGenOp(symbolManager, funcType, locToOffset, isUnderDynamicFunc, isMainBlk),
      ...
      distributeOps_({
          // distribute op
          {Opcode::OP_MOE_DISPATCH_WAIT_FLAG, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_ASSEMBLE_EXPANDX, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_ASSEMBLE_COMBINEINFO, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_EXPERT_TOKEN_NUM, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_SEND_ROUTED, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_SEND_SHARED, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_SET_FLAG, [this]() { return GenDistOp(); }},
          {Opcode::OP_MOE_DISPATCH_LOCAL_COPY_OUT, [this]() { return GenDistOp(); }},
