...
private:
    ...
    std::string PrintRoundDynamicUnaligned(const PrintUnaryParam &param, float powDecimals) const;
    std::string PrintRoundStatic(const PrintUnaryParam &param, float powDecimals) const;
