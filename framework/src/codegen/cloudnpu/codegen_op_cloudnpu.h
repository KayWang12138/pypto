...
private:
    ...
    void FillParamWithFullShape(std::vector<std::string> &paramList, const std::vector<int64_t> &shape);
    void FillParamWithShapeExceptFirst(std::vector<std::string> &paramList, const std::vector<int64_t> &shape);
