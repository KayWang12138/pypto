...
private:
    ...
    std::string PrintRound(const PrintUnaryParam &param) const;
    std::string PrintRoundLayout(float powDecimals) const;
    std::string PrintRoundDynamicUnaligned(const PrintUnaryTmpBuffParam &param, float powDecimals) const;
    std::string PrintRoundStatic(const PrintUnaryTmpBuffParam &param, float powDecimals) const;
