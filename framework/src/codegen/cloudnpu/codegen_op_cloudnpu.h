...
public:
    ...
    std::string GenMrgSortToGMOp() const;
    std::string GenTileMrgSortInGMOp() const;
...
private:
    ...
    std::string PrintMrgSortToGMDynamicUnaligned() const;
    std::string PrintTileMrgSortInGMDynamicUnaligned() const;
