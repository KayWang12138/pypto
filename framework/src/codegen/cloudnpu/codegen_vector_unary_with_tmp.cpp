...
std::string CodeGenOpCloudNPU::PrintReduceLastAxis(const PrintUnaryTmpBuffParam &param) const {
    ...
    ASSERT(ret >= 0) << GenErrorCode(GenCodeErr::PRINT_FAILED) << "PrintReduceLastAxis"
...
std::string CodeGenOpCloudNPU::PrintExp2() const {
    ASSERT(isSupportLayout) << GenErrorCode(GenCodeErr::PRINT_MODE_ERROR) << "Exp2 only support tile tensor";
...
std::string CodeGenOpCloudNPU::PrintRound() const {
    ASSERT(isSupportLayout) << GenErrorCode(GenCodeErr::PRINT_MODE_ERROR) << "Round only support tile tensor";
...
std::string CodeGenOpCloudNPU::PrintExpm1() const {
    ASSERT(isSupportLayout) << GenErrorCode(GenCodeErr::PRINT_MODE_ERROR) << "Expm1 only support tile tensor";
...
std::string CodeGenOpCloudNPU::PrintRowSumlineStatic(const PrintUnaryTmpBuffParam &param) const {
    ...
    ASSERT(((reduceAxis >= 0) && (reduceAxis < (int(rawShape[ID2].size()) - 1))))
        << GenErrorCode(OperErr::ATTRIBUTE_INVALID) << "unsupported reduce axis" << reduceAxis;
...
std::string CodeGenOpCloudNPU::PrintRowSumlineTileTensor() const {
    ...
    ASSERT(((reduceAxis >= 0) && (reduceAxis < (int(rawShape[ID2].size()) - 1))))
        << GenErrorCode(OperErr::ATTRIBUTE_INVALID) << "unsupported reduce axis";
