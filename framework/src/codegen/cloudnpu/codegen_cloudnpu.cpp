...
std::string CodeGenCloudNPU::GenInclude(const Function &topFunc) const {
    ...
    // expression fusion generated by machine, controlled by CompileStage::HOST_COMPILE_END
    if (config::GetHostOption<int64_t>(COMPILE_STAGE) != npu::tile_fwk::CompileStage::HOST_COMPILE_END &&
