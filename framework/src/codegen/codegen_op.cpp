...
void CodeGenOp::UpdateOffsetForInput(const Operation& oper, const LogicalTensor& logicalTensor, int operandIdx)
{
    static const std::set<Opcode> cubeMDLOpCode = {
        ...
        Opcode::OP_L1_TO_L0B_SCALE, Opcode::OP_L0C_COPY_UB_DUAL_DST};
...
{
    static const std::set<Opcode> cubeMDLOutOpCode = {Opcode::OP_L0C_TO_L1, Opcode::OP_L0C_COPY_UB_DUAL_DST};
