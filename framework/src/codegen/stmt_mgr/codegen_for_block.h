...
public:
    explict ForBlockManager(const std::shared_ptr<SymbolManager> &symbolManager) : sm_(symbolManager) {
...
private:
    std::string PrintForHeader(std::ostringstream &os) const;
    std::string PrintForBody(std::ostringstream &os) const;
    std::string PrintForEnd(std::ostringstream &os) const;
    std::string PrintOffsetDef(std::ostringstream &os) const;
    std::string PrintSetAddrs(std::ostringstream &os) const;
    std::string PrintSetAddrSingle(std::ostringstream &os, const std::string &tensor) const;
    std::string PrintTileOps(std::ostringstream &os) const;
