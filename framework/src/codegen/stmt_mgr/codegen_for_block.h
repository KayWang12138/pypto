...
public:
    ...
    void AddTensorInLoopBody(size_t tensorFullDimHash, const TileTensor &tileTensor, Opcode opCode);
...
private:
    ...
    void UpdateTensorOffsetInLoop(Opcode opCode, size_t tensorFullDimHash, const std::string &tensorNameInLoop);
