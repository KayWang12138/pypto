...
public:
    ...
    void AddTensorInLoopBody(size_t tensorFullDimHash, const TileTensor &tileTensor);
...
private:
    ...
    void UpdateTensorOffsetInLoop(size_t tensorFullDimHash, const std::string &tensorNameInLoop);
