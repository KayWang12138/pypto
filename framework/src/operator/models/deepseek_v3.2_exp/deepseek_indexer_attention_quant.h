...
void DeepSeekIndexerAttentionQuant(const Tensor &tokenX, const Tensor &wDq, const Tensor &wUqQr, const Tensor &wUk,
    ...
    Tensor &attentionOut, DiaQuantAttr &attrs, const DSIASimpleParams &params, Tensor &debugQNopeOut,
    Tensor &debugQRopeOut, Tensor &debugRmsNormOut, Tensor &debugRmsNormScaleOut, Tensor &debugQInt8Out,
    Tensor &debugQScaleOut, Tensor &debugWeightsOut, Tensor &indexerTopkResTmp, Tensor &topkValueTmp,
    Tensor &topkTmpOut);
