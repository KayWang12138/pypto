...
void DeepSeekIndexerAttentionQuant(
        ...
        })
    {
        ...
        config::SetPassOption(COPYIN_THRESHOLD, NUM_100 * NUM_1024 * NUM_1024);
        config::SetPassOption(SG_CYCLE_LOWER_BOUND, NUM_1024);
        config::SetPassOption(SG_CYCLE_UPPER_BOUND, NUM_1024 * NUM_1024);
        config::SetPassOption(L1_REUSE, NUM_32);
