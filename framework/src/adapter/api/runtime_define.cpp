...
static_assert(std::is_same<RtFuncHandle, rtFuncHandle_t>::value);
static_assert(std::is_same<RtBinHandle, rtBinHandle_t>::value);
...
static_assert(sizeof(RtTimeoutUs) == sizeof(rtTimeoutUs_t));
