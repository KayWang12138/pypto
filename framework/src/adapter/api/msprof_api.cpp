...
int32_t MspfReportApi(uint32_t nonPersistantFlag, const struct MsprofApi *api) {
#ifdef EXECUTE_WITH_CANN
...
int32_t MspfReportCompactInfo(uint32_t nonPersistantFlag, const VOID_PTR data, uint32_t length) {
#ifdef EXECUTE_WITH_CANN
...
int32_t MspfReportAdditionalInfo(uint32_t nonPersistantFlag, const VOID_PTR data, uint32_t length) {
#ifdef EXECUTE_WITH_CANN
...
int32_t MspfRegisterCallback(uint32_t moduleId, ProfCommandHandle handle) {
#ifdef EXECUTE_WITH_CANN
