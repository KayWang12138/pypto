...
#include "adapter/manager/types/acl_types.h"
#include "adapter/manager/types/hccl_types.h"
#include "adapter/manager/types/msprof_types.h"
#include "adapter/manager/types/runtime_types.h"
