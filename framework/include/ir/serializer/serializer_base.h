...
private:
    ...
    static inline void Append(std::vector<std::string> &holder, long double data) {
        holder.push_back(std::to_string(data));
    }
    static inline void Append(std::vector<std::string> &holder, long long data) {
        holder.push_back(std::to_string(data));
    }
    ...
    static inline void Append(std::vector<std::string> &holder, const std::vector<std::string> &data) {
