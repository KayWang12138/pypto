...
inline std::string DataType2String(DataType t) {
    switch (t) {
        ...
        case DT_FP8E5: return "DT_FP8E5";
        case DT_FP8E4: return "DT_FP8E4";
        case DT_FP8E8: return "DT_FP8E8";
...
[[maybe_unused]] inline std::string BriefDataType2String(DataType t) {
    switch (t) {
        ...
        case DT_FP8E5: return "FP8E5"
        case DT_FP8E4: return "FP8E4"
        case DT_FP8E8: return "FP8E8"
        default: throw std::invalid_argument("Unknown DataType");
    }
}
...
inline std::string DataType2CCEStr(DataType t) {
    switch (t) {
        ...
        case DT_FP8E5: return "flaot8_e4m3_t"
        case DT_FP8E4: return "flaot8_e5m2_t"
        case DT_FP8E8: return "flaot8_e8m0_t"
        default: throw std::invalid_argument("Unknown DataType");
    }
}
