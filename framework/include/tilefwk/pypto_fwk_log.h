...
#define CODEGEN_LOGE_E(errCode, fmt, ...) PYPTO_HOST_LOGE_WITH_ERRCODE(CODEGEN, errCode, fmt, ##__VA_ARGS__)
...
#define DISTRIBUTED_LOGE_E(errCode, fmt, ...) PYPTO_HOST_LOGE_WITH_ERRCODE(DISTRIBUTED, errCode, fmt, ##__VA_ARGS__)
...
#define SIMULATION_LOGE_E(errCode, fmt, ...) PYPTO_SIM_LOGE_WITH_ERRCODE(SIMULATION, errCode, fmt, ##__VA_ARGS__)
...
#define PLATFORM_LOGE_E(errCode, fmt, ...) PYPTO_HOST_LOGE_WITH_ERRCODE(PLATFORM, errCode, fmt, ##__VA_ARGS__)
...
#define MATMUL_LOGE_E(errCode, fmt, ...) PYPTO_HOST_LOGE_WITH_ERRCODE(MATMUL, errCode, fmt, ##__VA_ARGS__)
