...
#define PASS_LOGE(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(PASS, errCode, fmt, ##__VA_ARGS__)
...
#define ADAPTER_LOGE(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(ADAPTER, errCode, fmt, ##__VA_ARGS__)
...
#define CONV_LOGE(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(CONV, errCode, fmt, ##__VA_ARGS__)
...
#define VECTOR_LOGE(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(VECTOR, errCode, fmt, ##__VA_ARGS__)
