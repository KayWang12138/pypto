...
#define FUNCTION_LOGE_E(errCode, fmt, ...) PYPTO_HOST_LOGE_WITH_ERRCODE(FUNCTION, errCode, fmt, ##__VA_ARGS__)
...
#define COMPILER_LOGE_E(errCode, fmt, ...) PYPTO_HOST_LOGE_WITH_ERRCODE(COMPILER_MONITOR, errCode, fmt, ##__VA_ARGS__)
