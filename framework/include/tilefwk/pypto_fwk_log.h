...
#define PYPTO_HOST_LOGE_C(module, errCode, fmt, ...) \
    PYPTO_HOST_LOG(DLOG_ERROR, module, "ErrCode: F%u! " fmt, static_cast<uint32_t>(errCode), ##__VA_ARGS__)

#define PYPTO_SIM_LOGE_C(module, errCode, fmt, ...) \
    PYPTO_SIM_LOG(DLOG_ERROR, module, "ErrCode: F%u! " fmt, static_cast<uint32_t>(errCode), ##__VA_ARGS__)
...
#define FUNCTION_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(FUNCTION, errCode, fmt, ##__VA_ARGS__)
...
#define PASS_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(PASS, errCode, fmt, ##__VA_ARGS__)
...
#define CODEGEN_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(CODEGEN, errCode, fmt, ##__VA_ARGS__)
...
#define MACHINE_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(MACHINE, errCode, fmt, ##__VA_ARGS__)
...
#define DISTRIBUTED_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(DISTRIBUTED, errCode, fmt, ##__VA_ARGS__)
...
#define SIMULATION_LOGE_C(errCode, fmt, ...) PYPTO_SIM_LOGE_C(SIMULATION, errCode, fmt, ##__VA_ARGS__)
...
#define VERIFY_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(VERIFY, errCode, fmt, ##__VA_ARGS__)
...
#define COMPILER_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(COMPILER_MONITOR, errCode, fmt, ##__VA_ARGS__)
...
#define PLATFORM_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(PLATFORM, errCode, fmt, ##__VA_ARGS__)
...
#define MATMUL_LOGE_C(errCode, fmt, ...) PYPTO_HOST_LOGE_C(MATMUL, errCode, fmt, ##__VA_ARGS__)
