...
#define PLATFORM_EVENT(...) PYPTO_HOST_LOG_WITHOUT_LEVEL_CHECK(DLOG_INFO, "PLATFORM", __VA_ARGS__)
#define PLATFORM_LOGD_FULL(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "PLATFORM", __VA_ARGS__)
#endif