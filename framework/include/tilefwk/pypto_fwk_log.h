...
#define PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(module, errCode, fmt, ...)                                               \
...
#define PYPTO_SIM_ERROR_LOG_WITH_ERRCODE(module, errCode, fmt, ...)                                               \
...
#define FUNCTION_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(FUNCTION, errCode, fmt, ##__VA_ARGS__)
...
#define PASS_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(PASS, errCode, fmt, ##__VA_ARGS__)
...
#define CODEGEN_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(CODEGEN, errCode, fmt, ##__VA_ARGS__)
...
#define MACHINE_LOGE(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(MACHINE, errCode, fmt, ##__VA_ARGS__)
...
#define DISTRIBUTED_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(DISTRIBUTED, errCode, fmt, ##__VA_ARGS__)
...
#define SIMULATION_LOGE_E(errCode, fmt, ...) PYPTO_SIM_ERROR_LOG_WITH_ERRCODE(SIMULATION, errCode, fmt, ##__VA_ARGS__)
...
#define VERIFY_LOGE(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(VERIFY, errCode, fmt, ##__VA_ARGS__)
...
#define COMPILER_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(COMPILER_MONITOR, errCode, fmt, ##__VA_ARGS__)
...
#define ADAPTER_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(ADAPTER, errCode, fmt, ##__VA_ARGS__)
...
#define PLATFORM_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(PLATFORM, errCode, fmt, ##__VA_ARGS__)
...
#define CONV_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(CONV, errCode, fmt, ##__VA_ARGS__)

#define MATMUL_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(MATMUL, errCode, fmt, ##__VA_ARGS__)
...
#define VECTOR_LOGE_E(errCode, fmt, ...) PYPTO_HOST_ERROR_LOG_WITH_ERRCODE(VECTOR, errCode, fmt, ##__VA_ARGS__)
