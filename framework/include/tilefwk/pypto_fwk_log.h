...
constexpr uint32_t ERROR_CODE_UNDEFINED = 00000U;
...
#define FUNCTION_LOGE(errCode, fmt, ...) PYPTO_HOST_LOGE(FUNCTION, errCode, fmt, ##__VA_ARGS__)
...
#define PASS_LOGE(errCode, fmt, ...) PYPTO_HOST_LOGE(PASS, errCode, fmt, ##__VA_ARGS__)
...
#define CODEGEN_LOGE(errCode, fmt, ...) PYPTO_HOST_LOGE(CODEGEN, errCode, fmt, ##__VA_ARGS__)
...
#define DISTRIBUTED_LOGE(errCode, fmt, ...) PYPTO_HOST_LOGE(DISTRIBUTED, errCode, fmt, ##__VA_ARGS__)
...
#define SIMULATION_LOGE(errCode, fmt, ...) PYPTO_SIM_LOGE(SIMULATION, errCode, fmt, ##__VA_ARGS__)
...
#define PLATFORM_LOGE(errCode, fmt, ...) PYPTO_HOST_LOGE(PLATFORM, errCode, fmt, ##__VA_ARGS__)
...
#define MATMUL_LOGE(errCode, fmt, ...) PYPTO_HOST_LOGE(MATMUL, errCode, fmt, ##__VA_ARGS__)
