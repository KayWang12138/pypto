...
#define FUNCTION_LOGD_F(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "FUNCTION", __VA_ARGS__)
...
#define PASS_LOGD_F(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "PASS", __VA_ARGS__)
...
#define CODEGEN_LOGD_F(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "CODEGEN", __VA_ARGS__)
...
#define MACHINE_LOGD_F(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "MACHINE", __VA_ARGS__)
...
#define DISTRIBUTED_LOGD_F(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "DISTRIBUTED", __VA_ARGS__)
...
#define VERIFY_LOGD_F(...) PYPTO_HOST_SPLIT_LOG(DLOG_DEBUG, "VERIFY", __VA_ARGS__)
