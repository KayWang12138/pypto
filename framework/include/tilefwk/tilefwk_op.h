...
Tensor Div(const Tensor& self, const Tensor& other, DivAlgorithm precisionType = DivAlgorithm::INTRINSIC);
...
Tensor Div(const Tensor& self, const Element& other, DivAlgorithm precisionType = DivAlgorithm::INTRINSIC);
