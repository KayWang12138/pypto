...
const std::string KEY_ENABLE_SOURCE_LOCATION = "ENABLE_SOURCE_LOCATION";

/* flow virifer tools KEYs */
const std::string KEY_EXTRACT_TENSOR_GRAPH_THEN_COMPILE = "EXTRACT_TENSOR_GRAPH_THEN_COMPILE";
const std::string KEY_VERIFY_TENSOR_GRAPH = "VERIFY_TENSOR_GRAPH";
const std::string KEY_VERIFY_TENSOR_GRAPH_DUMP_OPERATION = "VERIFY_TENSOR_GRAPH_DUMP_OPERATION";
const std::string KEY_VERIFY_TENSOR_GRAPH_DUMP_TENSOR = "VERIFY_TENSOR_GRAPH_DUMP_TENSOR";
const std::string KEY_VERIFY_TENSOR_GRAPH_CHECK_PRECISION = "VERIFY_TENSOR_GRAPH_CHECK_PRECISION";
const std::string KEY_VERIFY_PASS = "VERIFY_PASS";
const std::string KEY_VERIFY_PASS_SELECT = "VERIFY_PASS_SELECT";
const std::string KEY_VERIFY_PASS_DUMP_OPERATION = "VERIFY_PASS_DUMP_OPERATION";
const std::string KEY_VERIFY_PASS_DUMP_OPERATION_SELECT = "VERIFY_PASS_DUMP_OPERATION_SELECT";
const std::string KEY_VERIFY_PASS_DUMP_TENSOR = "VERIFY_PASS_DUMP_TENSOR";
const std::string KEY_VERIFY_PASS_DUMP_TENSOR_SELECT = "VERIFY_PASS_DUMP_TENSOR_SELECT";
const std::string KEY_VERIFY_PASS_CHECK_PRECISION = "VERIFY_PASS_CHECK_PRECISION";
const std::string KEY_VERIFY_EXECUTE_GRAPH = "VERIFY_EXECUTE_GRAPH";
const std::string KEY_VERIFY_EXECUTE_GRAPH_DUMP_OPERATION = "VERIFY_EXECUTE_GRAPH_DUMP_OPERATION";
const std::string KEY_VERIFY_EXECUTE_GRAPH_DUMP_TENSOR = "VERIFY_EXECUTE_GRAPH_DUMP_TENSOR";
const std::string KEY_VERIFY_EXECUTE_GRAPH_CHECK_PRECISION = "VERIFY_EXECUTE_GRAPH_CHECK_PRECISION";
const std::string KEY_VERIFY_THREAD_NUMBER   = "VERIFIER_THREAD_NUMBER";
const std::string KEY_VERIFY_DUMP_PERF_DATA = "VERIFY_DUMP_PERF_DATA";
