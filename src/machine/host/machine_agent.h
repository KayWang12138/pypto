...
struct MachineDeviceAgentInfo {
    ...
    void FreeDevMemory() const {
        ...
        //machine::GetRA()->FreeTensor(workspaceGmAddr); //  stub out raw tensor addr 依赖此，暂时不能释放
        npu::tile_fwk::machine::GetRA()->FreeTensor(invokeEntryOffsetsGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(topoGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(functionBinGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyStateGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(coreFuncWsAddrGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(deviceTaskGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyAicQueElmGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyAivQueElmGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyAicpuQueElmGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyAicQueGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyAivQueGmAddr);
        npu::tile_fwk::machine::GetRA()->FreeTensor(readyAicpuQueGmAddr);
#endif
    }
};
