...
private:
    ...
    const std::unordered_map<Opcode, std::function<std::string()>> opsGenMap_ = {
        ...
        {                     Opcode::OP_S_ADD,                 [this]() { return GenBinaryOp(); }},
        {                     Opcode::OP_S_SUB,                 [this]() { return GenBinaryOp(); }},
        {                     Opcode::OP_S_MUL,                 [this]() { return GenBinaryOp(); }},
        {                     Opcode::OP_S_DIV,                 [this]() { return GenBinaryOp(); }},
        {                     Opcode::OP_S_MAX,                 [this]() { return GenBinaryOp(); }},
        {                     Opcode::OP_S_MIN,                 [this]() { return GenBinaryOp(); }},
