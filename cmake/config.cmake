...
if (ENABLE_FEATURE_PYTHON_FRONT_END)
    ...
    if ("${PY3_MOD_NANOBIND_CMAKE_DIR}x" STREQUAL "x")
        message(FATAL_ERROR "Can't get nanobind cmake dir, Python Frontend can't build.")
    endif ()
    find_package(Python COMPONENTS Interpreter Development.Module REQUIRED)
    find_package(nanobind 2.0.0 CONFIG REQUIRED PATHS ${PY3_MOD_NANOBIND_CMAKE_DIR} NO_DEFAULT_PATH)
endif ()
