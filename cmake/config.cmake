...
if (NOT SHMEM_HOME_PATH)
    message(FATAL_ERROR "SHMEM_HOME_PATH is not set. Please export SHMEM_HOME_PATH to the shmem root that contains include/shmem.h.")
endif ()
if (NOT EXISTS "${SHMEM_HOME_PATH}/include/shmem.h")
    if (EXISTS "${SHMEM_HOME_PATH}/shmem/include/shmem.h")
        set(SHMEM_HOME_PATH "${SHMEM_HOME_PATH}/shmem")
        get_filename_component(SHMEM_HOME_PATH "${SHMEM_HOME_PATH}" REALPATH)
    else ()
        message(FATAL_ERROR "SHMEM_HOME_PATH=${SHMEM_HOME_PATH} does not contain include/shmem.h. Please set SHMEM_HOME_PATH to the shmem root.")
    endif ()
endif ()
