...
if (NOT ENABLE_BUILD_PTO_FWK_PYTHON)
    if (ENABLE_TESTS_UTEST_PYTHON)
        set(ENABLE_TESTS_UTEST_PYTHON OFF)
        message(WARNING "ENABLE_BUILD_PTO_FWK_PYTHON=OFF, Auto turn off ENABLE_TESTS_UTEST_PYTHON")
    endif ()
    if (ENABLE_TESTS_STEST_PYTHON)
        set(ENABLE_TESTS_STEST_PYTHON OFF)
        message(WARNING "ENABLE_BUILD_PTO_FWK_PYTHON=OFF, Auto turn off ENABLE_TESTS_STEST_PYTHON")
    endif ()
endif ()
...
string(REPLACE "," ":" ENABLE_TESTS_UTEST_PYTHON "${ENABLE_TESTS_UTEST_PYTHON}")
...
string(REPLACE "," ":" ENABLE_TESTS_STEST_PYTHON "${ENABLE_TESTS_STEST_PYTHON}")
if (ENABLE_TESTS_UTEST OR ENABLE_TESTS_STEST OR ENABLE_TESTS_STEST_DISTRIBUTED OR ENABLE_TESTS_UTEST_PYTHON OR ENABLE_TESTS_STEST_PYTHON)
    set(ENABLE_TESTS ON)
else ()
...
if (BUILD_OPEN_PROJECT)
    ...
    if (NOT (EXISTS "${BoundsCheck_Dir}" AND EXISTS "${BoundsCheck_Dir}/CMakeLists.txt"))
        ...
        get_filename_component(BoundsCheck_Prefix_Dir "${CMAKE_CURRENT_BINARY_DIR}/3rd/${BoundsCheck_DirName}" REALPATH)
