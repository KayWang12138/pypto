...
from integration.benchmark.verifier.__main__ import _collect_pypto_source_files as cli_collect
from integration.benchmark.verifier.kernel_verifier import KernelVerifier
from integration.benchmark.verifier_runner import collect_pypto_source_files as runner_collect
...
if __name__ == "__main__":
    test_collect_pypto_source_files_preserves_imports()
    test_kernel_verifier_writes_multiple_source_files()
