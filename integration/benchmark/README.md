...
`integration/benchmark/scripts/local/test-integration.sh` 用于批量运行
...
- 可以写 `FULL=1 nohup bash integration/benchmark/scripts/local/test-integration.sh ...`。
- 更推荐写 `nohup env FULL=1 ... bash integration/benchmark/scripts/local/test-integration.sh ...`。
