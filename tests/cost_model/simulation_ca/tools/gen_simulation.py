...
tileop_dict = {"UB_ALLOC":"PIPE_S",
               ...
               "TileOp::TtransposeDataMove":"PIPE_MTE3",
    ...
    for line in lines:
        ...
        if line.strip().startswith("TileOp::"):
            ...
            cmd = (f"g++ -w -std=c++17 {file_path} -o {file_path[0:-4]} "
                   f"-I {project_dir}/src/codegen/tileop -I {project_dir}/tests/cost_model/simulation/arch/mock")
            ...
            simulation_exe = project_dir + "/build/src/get_cce_simulation"
