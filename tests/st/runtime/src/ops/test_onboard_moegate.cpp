...
TEST_F(MoegateOnBoardTest, test_moegate_graph3_case1) {
    ...
    runtime::GetRA()->AllocDevAddr(&outTensorAddr, capacity3 * sizeof(float));
    ...
    runtime::GetRA()->CopyFromTensor((uint8_t *)dev_res.data(), (uint8_t *)outTensorAddr, capacity3 * sizeof(float));
...
TEST_F(MoegateOnBoardTest, test_moegate_graph3_graph4_case_32_1_7168) {
    ...
    /* torch prepare args device memory and run  */
    uint8_t* outTensorAddr = nullptr;
    runtime::GetRA()->AllocDevAddr(&outTensorAddr, capacity4 * sizeof(float));
    ...
    runtime::GetRA()->CopyFromTensor((uint8_t *)dev_res.data(), (uint8_t *)outTensorAddr, capacity4 * sizeof(float));
    readInput(GetGoldenDir() + "/z_golden.bin", golden);
