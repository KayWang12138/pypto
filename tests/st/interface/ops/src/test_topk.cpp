...
void TopKOnBoardFunc(TopKParams& params){
    ...
    runtime::GetRA()->CopyFromTensor((uint8_t *)dev_val.data(), (uint8_t *)out_ptr, outputSize);
    runtime::GetRA()->CopyFromTensor((uint8_t *)dev_idx.data(), (uint8_t *)out_ptr1, outputSize);
