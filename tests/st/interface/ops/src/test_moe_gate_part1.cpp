...
TEST_F(MoEGatePart1OnBoardTest, test_moe_gate_part1) {
    ...
    runtime::GetRA()->CopyFromTensor((uint8_t *)res_scores.data(), out_score_ptr, outputCapacity);
    runtime::GetRA()->CopyFromTensor((uint8_t *)res_scores4choice.data(), out_score4choice_ptr, outputCapacity);
