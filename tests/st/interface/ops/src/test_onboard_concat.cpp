...
TEST_F(ConcatOnBoardTest, test_concat_dim4_float32) {
    ...
    PROGRAM("Concat") {
        ...
        FUNCTION("CONCAT_T", FunctionType::STATIC, {input_x, input_y, output}) {
...
TEST_F(ConcatOnBoardTest, test_concat_exp_dim4_float32) {
    ...
    PROGRAM("Concat") {
        ...
        FUNCTION("CONCAT_T", FunctionType::STATIC, {input_x, input_y, output2}) {
...
TEST_F(ConcatOnBoardTest, test_concat_100_inputs_float32) {
    ...
    PROGRAM("Concat") {
        ...
        FUNCTION("CONCAT_T", FunctionType::STATIC, paras) {
