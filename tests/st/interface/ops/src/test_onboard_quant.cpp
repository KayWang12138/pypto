...
void TestQuant(std::vector<int>& inputShape) {
    ...
    PROGRAM("Quant") {
        ...
        FUNCTION("Quant", FunctionType::STATIC, {input, output, scaleDeQuant}) {
...
void TestQuantWithSmoothFactor(std::vector<int>& inputShape) {
    ...
    PROGRAM("Quant") {
        ...
        FUNCTION("Quant", FunctionType::STATIC, {input, output, smoothFactor, scaleDeQuant}) {
...
void TestQuantMM(std::vector<int>& shapeA, std::vector<int>& shapeW) {
    ...
    PROGRAM("QUANTMM") {
        ...
        FUNCTION("QUANTMM", FunctionType::STATIC, {matA, matW, matScaleW, matRes}) {
