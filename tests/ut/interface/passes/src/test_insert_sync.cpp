...
TEST_F(InsertSyncTest, TestFindDep) {
    ...
    tensor1->memorymap[tensor1->GetSubgraphID()].end = IS_NUM100;
    auto tensor2 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape1);
    tensor2->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor2->memorymap[tensor2->GetSubgraphID()].start = 0;
    tensor2->memorymap[tensor2->GetSubgraphID()].end = IS_NUM200;
    auto tensor3 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape2);
    tensor3->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor3->memorymap[tensor3->GetSubgraphID()].start = IS_NUM300;
    tensor3->memorymap[tensor3->GetSubgraphID()].end = IS_NUM499;
    auto tensor4 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape2);
    tensor4->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor4->memorymap[tensor4->GetSubgraphID()].start = IS_NUM500;
    tensor4->memorymap[tensor4->GetSubgraphID()].end = IS_NUM699;
    auto tensor5 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape2);
    tensor5->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor5->memorymap[tensor5->GetSubgraphID()].start = IS_NUM700;
    tensor5->memorymap[tensor5->GetSubgraphID()].end = IS_NUM900;
    auto tensor6 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape2);
    tensor6->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor6->memorymap[tensor6->GetSubgraphID()].start = IS_NUM150;
    tensor6->memorymap[tensor6->GetSubgraphID()].end = IS_NUM200;
...
TEST_F(InsertSyncTest, TestUpdateDep) {
    ...
    auto tensor2 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor2->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor2->memorymap[tensor2->GetSubgraphID()].start = IS_NUM200;
    tensor2->memorymap[tensor2->GetSubgraphID()].end = IS_NUM300;
    auto tensor3 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor3->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor3->memorymap[tensor3->GetSubgraphID()].start = IS_NUM200;
    tensor3->memorymap[tensor3->GetSubgraphID()].end = IS_NUM300;
    auto tensor4 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor4->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor4->memorymap[tensor4->GetSubgraphID()].start = IS_NUM200;
    tensor4->memorymap[tensor4->GetSubgraphID()].end = IS_NUM300;
    auto tensor5 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor5->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor5->memorymap[tensor5->GetSubgraphID()].start = IS_NUM500;
    tensor5->memorymap[tensor5->GetSubgraphID()].end = IS_NUM600;
    auto tensor6 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor6->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor6->memorymap[tensor6->GetSubgraphID()].start = IS_NUM500;
    tensor6->memorymap[tensor6->GetSubgraphID()].end = IS_NUM600;
    auto tensor7 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor7->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor7->memorymap[tensor7->GetSubgraphID()].start = 0;
    tensor7->memorymap[tensor7->GetSubgraphID()].end = IS_NUM100;
    auto tensor8 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor8->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor8->memorymap[tensor8->GetSubgraphID()].start = IS_NUM101;
    tensor8->memorymap[tensor8->GetSubgraphID()].end = IS_NUM199;
    std::vector<Operation *> opLogPtr;
...
TEST_F(InsertSyncTest, TestHandleEventID) {
    ...
    tensor1->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor1->memorymap[tensor1->GetSubgraphID()].start = 0;
    tensor1->memorymap[tensor1->GetSubgraphID()].end = IS_NUM99;
    auto tensor2 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor2->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor2->memorymap[tensor2->GetSubgraphID()].start = IS_NUM100;
    tensor2->memorymap[tensor2->GetSubgraphID()].end = IS_NUM199;
    auto tensor3 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor3->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor3->memorymap[tensor3->GetSubgraphID()].start = IS_NUM200;
    tensor3->memorymap[tensor3->GetSubgraphID()].end = IS_NUM300;
    ...
    tensor4->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor4->memorymap[tensor4->GetSubgraphID()].start = IS_NUM500;
    tensor4->memorymap[tensor4->GetSubgraphID()].end = IS_NUM600;
    auto tensor5 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor5->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor5->memorymap[tensor5->GetSubgraphID()].start = IS_NUM700;
    tensor5->memorymap[tensor5->GetSubgraphID()].end = IS_NUM800;
    std::vector<Operation *> opLogPtr;
...
TEST_F(InsertSyncTest, TestRelaxFakeDataDep) {
    ...
    tensor1->memorymap[tensor1->GetSubgraphID()].end = IS_NUM109;
    auto tensor2 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor2->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor2->memorymap[tensor2->GetSubgraphID()].start = 0;
    tensor2->memorymap[tensor2->GetSubgraphID()].end = IS_NUM9;
    auto tensor3 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor3->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor3->memorymap[tensor3->GetSubgraphID()].start = IS_NUM10;
    tensor3->memorymap[tensor3->GetSubgraphID()].end = IS_NUM19;
    auto tensor4 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor4->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor4->memorymap[tensor4->GetSubgraphID()].start = IS_NUM20;
    tensor4->memorymap[tensor4->GetSubgraphID()].end = IS_NUM29;
    auto tensor5 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor5->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor5->memorymap[tensor5->GetSubgraphID()].start = IS_NUM30;
    tensor5->memorymap[tensor5->GetSubgraphID()].end = IS_NUM39;
    auto tensor6 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor6->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor6->memorymap[tensor6->GetSubgraphID()].start = IS_NUM40;
    tensor6->memorymap[tensor6->GetSubgraphID()].end = IS_NUM49;
    auto tensor7 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor7->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor7->memorymap[tensor7->GetSubgraphID()].start = IS_NUM50;
    tensor7->memorymap[tensor7->GetSubgraphID()].end = IS_NUM59;
    auto tensor8 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor8->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor8->memorymap[tensor8->GetSubgraphID()].start = IS_NUM60;
    tensor8->memorymap[tensor8->GetSubgraphID()].end = IS_NUM69;
    auto tensor9 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor9->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor9->memorymap[tensor9->GetSubgraphID()].start = IS_NUM70;
    tensor9->memorymap[tensor9->GetSubgraphID()].end = IS_NUM79;
    auto tensor10 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor10->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor10->memorymap[tensor10->GetSubgraphID()].start = IS_NUM80;
    tensor10->memorymap[tensor10->GetSubgraphID()].end = IS_NUM89;
    auto tensor11 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor11->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor11->memorymap[tensor11->GetSubgraphID()].start = IS_NUM90;
    tensor11->memorymap[tensor11->GetSubgraphID()].end = IS_NUM99;
    auto tensor12 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor12->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor12->memorymap[tensor12->GetSubgraphID()].start = IS_NUM200;
    tensor12->memorymap[tensor12->GetSubgraphID()].end = IS_NUM209;
    auto tensor13 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor13->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor13->memorymap[tensor13->GetSubgraphID()].start = IS_NUM210;
    tensor13->memorymap[tensor13->GetSubgraphID()].end = IS_NUM219;
    auto tensor14 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor14->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor14->memorymap[tensor14->GetSubgraphID()].start = IS_NUM220;
    tensor14->memorymap[tensor14->GetSubgraphID()].end = IS_NUM229;
    auto tensor15 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor15->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor15->memorymap[tensor15->GetSubgraphID()].start = IS_NUM230;
    tensor15->memorymap[tensor15->GetSubgraphID()].end = IS_NUM239;
    auto tensor16 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor16->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor16->memorymap[tensor16->GetSubgraphID()].start = IS_NUM240;
    tensor16->memorymap[tensor16->GetSubgraphID()].end = IS_NUM249;
    auto tensor17 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor17->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor17->memorymap[tensor17->GetSubgraphID()].start = IS_NUM250;
    tensor17->memorymap[tensor17->GetSubgraphID()].end = IS_NUM259;
    auto tensor18 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor18->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor18->memorymap[tensor18->GetSubgraphID()].start = IS_NUM260;
    tensor18->memorymap[tensor18->GetSubgraphID()].end = IS_NUM269;
    auto tensor19 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor19->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor19->memorymap[tensor19->GetSubgraphID()].start = IS_NUM270;
    tensor19->memorymap[tensor19->GetSubgraphID()].end = IS_NUM279;
    auto tensor20 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor20->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor20->memorymap[tensor20->GetSubgraphID()].start = IS_NUM280;
    tensor20->memorymap[tensor20->GetSubgraphID()].end = IS_NUM289;
    auto tensor21 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor21->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor21->memorymap[tensor21->GetSubgraphID()].start = IS_NUM290;
    tensor21->memorymap[tensor21->GetSubgraphID()].end = IS_NUM299;
    auto tensor22 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor22->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor22->memorymap[tensor22->GetSubgraphID()].start = IS_NUM110;
    tensor22->memorymap[tensor22->GetSubgraphID()].end = IS_NUM119;
    auto tensor23 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor23->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor23->memorymap[tensor23->GetSubgraphID()].start = IS_NUM120;
    tensor23->memorymap[tensor23->GetSubgraphID()].end = IS_NUM129;
    auto tensor24 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor24->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor24->memorymap[tensor24->GetSubgraphID()].start = IS_NUM130;
    tensor24->memorymap[tensor24->GetSubgraphID()].end = IS_NUM139;
    auto tensor25 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor25->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor25->memorymap[tensor25->GetSubgraphID()].start = IS_NUM140;
    tensor25->memorymap[tensor25->GetSubgraphID()].end = IS_NUM149;
    auto tensor26 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor26->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor26->memorymap[tensor26->GetSubgraphID()].start = IS_NUM150;
    tensor26->memorymap[tensor26->GetSubgraphID()].end = IS_NUM159;
    auto tensor27 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor27->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor27->memorymap[tensor27->GetSubgraphID()].start = IS_NUM160;
    tensor27->memorymap[tensor27->GetSubgraphID()].end = IS_NUM169;
    auto tensor28 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor28->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor28->memorymap[tensor28->GetSubgraphID()].start = IS_NUM170;
    tensor28->memorymap[tensor28->GetSubgraphID()].end = IS_NUM179;
    auto tensor29 = std::make_shared<LogicalTensor>(*currFunctionPtr, DT_FP32, shape);
    tensor29->SetMemoryTypeBoth(MemoryType::MEM_UB);
    tensor29->memorymap[tensor29->GetSubgraphID()].start = IS_NUM180;
    tensor29->memorymap[tensor29->GetSubgraphID()].end = IS_NUM189;
    std::vector<Operation *> opLogPtr;
    auto &copyin1 = currFunctionPtr->AddRawOperation(Opcode::OP_COPY_IN, {tensor1}, {tensor2});
    opLogPtr.emplace_back(&copyin1);
