...
TEST_F(TestGlobalMemoryReuse, TestLargeBitmap) {
    LargeBitmap largeBitmap1(256);
    LargeBitmap largeBitmap2(256);
    LargeBitmap largeBitmap3(128);
    largeBitmap1.SetValues(1);
    EXPECT_EQ(largeBitmap1 == largeBitmap2, false);
    EXPECT_EQ(largeBitmap1 != largeBitmap2, true);
    EXPECT_EQ(largeBitmap1 == largeBitmap3, false);
    EXPECT_EQ(largeBitmap1 != largeBitmap3, true);
    largeBitmap2.SetValues(1);
    largeBitmap3.SetValues(1);
    EXPECT_EQ(largeBitmap1 == largeBitmap2, true);
    EXPECT_EQ(largeBitmap1 != largeBitmap2, false);
    EXPECT_EQ(largeBitmap1 == largeBitmap3, false);
    EXPECT_EQ(largeBitmap1 != largeBitmap3, true);
    for (int i = 0; i < 256; i++) {
        if (i == 0 || i == 64 || i == 128 || i == 192) {
            EXPECT_EQ(largeBitmap1.GetBit(i), 1) << "i = "<< i;
        } else {
            EXPECT_EQ(largeBitmap1.GetBit(i), 0) << "i = "<< i;
        }
    }
    largeBitmap3.SetValues(3);
    largeBitmap1.Or(largeBitmap3);
    for (int i = 0; i < 256; i++) {
        if (i == 0 || i == 1 || i == 64 || i == 65 || i == 128 || i == 192) {
            EXPECT_EQ(largeBitmap1.GetBit(i), 1) << "i = "<< i;
        } else {
            EXPECT_EQ(largeBitmap1.GetBit(i), 0) << "i = "<< i;
        }
    }
    largeBitmap3.SetValues(2);
    largeBitmap1.And(largeBitmap3);
    for (int i = 0; i < 256; i++) {
        if (i == 1 || i == 65 || i == 128 || i == 192) {
            EXPECT_EQ(largeBitmap1.GetBit(i), 1) << "i = "<< i;
        } else {
            EXPECT_EQ(largeBitmap1.GetBit(i), 0) << "i = "<< i;
        }
    }
    largeBitmap1.SetBit(20);
    for (int i = 0; i < 256; i++) {
        if (i == 1 || i == 20 || i == 65 || i == 128 || i == 192) {
            EXPECT_EQ(largeBitmap1.GetBit(i), 1) << "i = "<< i;
        } else {
            EXPECT_EQ(largeBitmap1.GetBit(i), 0) << "i = "<< i;
        }
    }
    largeBitmap1.ClearBit(65);
    for (int i = 0; i < 256; i++) {
        if (i == 1 || i == 20|| i == 128 || i == 192) {
            EXPECT_EQ(largeBitmap1.GetBit(i), 1) << "i = "<< i;
        } else {
            EXPECT_EQ(largeBitmap1.GetBit(i), 0) << "i = "<< i;
        }
    }
    largeBitmap1.ResizeBits(512);
    for (int i = 0; i < 512; i++) {
        if (i == 1 || i == 20|| i == 128 || i == 192) {
            EXPECT_EQ(largeBitmap1.GetBit(i), 1) << "i = "<< i;
        } else {
...
TEST_F(TestGlobalMemoryReuse, TestConnectionMatrix) {
    ...
    mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add op
    ...
    LargeBitmap largeBitmap0(3);
    LargeBitmap largeBitmap1(3);
    LargeBitmap largeBitmap2(3);
    largeBitmap0.SetValues(0b001);
    largeBitmap1.SetValues(0b011);
    largeBitmap2.SetValues(0b101);
    EXPECT_EQ(connectionMatrix.GetBitMap(0) == largeBitmap0, true);
    EXPECT_EQ(connectionMatrix.GetBitMap(1) == largeBitmap1, true);
    EXPECT_EQ(connectionMatrix.GetBitMap(2) == largeBitmap2, true);
}
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseNormal) {
    ...
    Function leafFunc1(Program::GetInstance(), leafFunc1Name, leafFunc1Name, G.GetFunction());
    leafFunc1.rootFunc_ = function;
    ComputationalGraphBuilder leafG1(&leafFunc1);
    Function leafFunc2(Program::GetInstance(), leafFunc2Name, leafFunc2Name, G.GetFunction());
    leafFunc2.rootFunc_ = function;
    ComputationalGraphBuilder leafG2(&leafFunc2);
    Function leafFunc3(Program::GetInstance(), leafFunc3Name, leafFunc3Name, G.GetFunction());
    ...
    leaffunc1_mat_a->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG1.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc1_mat_b");
    auto leaffunc1_mat_b = leafG1.GetTensor("leaffunc1_mat_b");
    leaffunc1_mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG1.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc1_mat_c");
    auto leaffunc1_mat_c = leafG1.GetTensor("leaffunc1_mat_c");
    leaffunc1_mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc1_mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc2_mat_a->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG2.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc2_mat_b");
    auto leaffunc2_mat_b = leafG2.GetTensor("leaffunc2_mat_b");
    leaffunc2_mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG2.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc2_mat_c");
    auto leaffunc2_mat_c = leafG2.GetTensor("leaffunc2_mat_c");
    leaffunc2_mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc2_mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc3_mat_a->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc3_mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG3.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc3_mat_c");
    auto leaffunc3_mat_c = leafG3.GetTensor("leaffunc3_mat_c");
    leaffunc3_mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc3_mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    Function *leafFunction1 = leafG1.GetFunction();
    EXPECT_NE(leafFunction1, nullptr);
    FunctionHash calleeHashFunction1 = leafFunction1->ComputeHash();
     ...
     */
    symbolicScalarFunction1.push_back({SymbolicScalar(leaffunc1_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction1.push_back({SymbolicScalar(leaffunc1_mat_d->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    auto opAttributeCall1 = std::make_shared<CallOpAttribute>(calleeHashFunction1, symbolicScalarFunction1);
    G.GetOp("call1")->SetOpAttribute(opAttributeCall1);

    Function *leafFunction2 = leafG2.GetFunction();
    EXPECT_NE(leafFunction2, nullptr);
    FunctionHash calleeHashFunction2 = leafFunction2->ComputeHash();
     ...
     * [3*dim+1, 4*dim]: validshape
     */
    symbolicScalarFunction2.push_back({SymbolicScalar(leaffunc2_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction2.push_back({SymbolicScalar(leaffunc2_mat_d->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    auto opAttributeCall2 = std::make_shared<CallOpAttribute>(calleeHashFunction2, symbolicScalarFunction2);
    G.GetOp("call2")->SetOpAttribute(opAttributeCall2);
    
    Function *leafFunction3 = leafG3.GetFunction();
    EXPECT_NE(leafFunction3, nullptr);
    FunctionHash calleeHashFunction3 = leafFunction3->ComputeHash();
     ...
     * [3*dim+1, 4*dim]: validshape
     */
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_d->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    auto opAttributeCall3 = std::make_shared<CallOpAttribute>(calleeHashFunction3, symbolicScalarFunction3);
    G.GetOp("call3")->SetOpAttribute(opAttributeCall3);
    
    function->programs_.emplace(1, leafFunction1);
    function->programs_.emplace(2, leafFunction2);
    function->programs_.emplace(3, leafFunction3);

    auto &cache = Program::GetInstance().GetFunctionCache();
    leafFunction1->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction2->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction3->SetGraphType(GraphType::LEAF_GRAPH);
    cache.Insert(calleeHashFunction1, *leafFunction1);
    cache.Insert(calleeHashFunction2, *leafFunction2);
    cache.Insert(calleeHashFunction3, *leafFunction3);
    // run pass
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseOutputActualRawmagic) {
    ...
    G.AddTensor(DataType::DT_FP16, {64, 128}, "mat_c");
    auto mat_c = G.GetTensor("mat_c");
    mat_c->tensor->actualRawmagic = 10;
    mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    G.AddTensor(DataType::DT_FP16, {64, 128}, "mat_d");
    auto mat_d = G.GetTensor("mat_d");
    mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseInputActualRawmagic) {
    ...
    G.AddTensor(DataType::DT_FP16, {64, 128}, "mat_b");
    auto mat_b = G.GetTensor("mat_b");
    mat_b->tensor->actualRawmagic = 10;
    mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    G.AddTensor(DataType::DT_FP16, {64, 128}, "mat_c");
    auto mat_c = G.GetTensor("mat_c");
    mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseNormal2) {
    ...
    leafFunc3.rootFunc_ = function;
    ComputationalGraphBuilder leafG3(&leafFunc3);
    Function leafFunc4(Program::GetInstance(), leafFunc4Name, leafFunc4Name, G.GetFunction());
    ...
    mat_e->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add tensor for leaf func1
    leafG1.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc1_mat_a");
    auto leaffunc1_mat_a = leafG1.GetTensor("leaffunc1_mat_a");
    leaffunc1_mat_a->tensor = mat_a->tensor;
    ...
    auto leaffunc3_mat_e = leafG3.GetTensor("leaffunc3_mat_e");
    leaffunc3_mat_e->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc3_mat_f->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc4_mat_a->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG4.AddTensor(DataType::DT_FP16, {64, 64}, "leaffunc4_mat_b");
    auto leaffunc4_mat_b = leafG4.GetTensor("leaffunc4_mat_b");
    leaffunc4_mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG4.AddTensor(DataType::DT_FP16, {64, 64}, "leaffunc4_mat_c");
    auto leaffunc4_mat_c = leafG4.GetTensor("leaffunc4_mat_c");
    leaffunc4_mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc4_mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add op for root func
    G.AddOp(Opcode::OP_CALL, {"mat_a"}, {"mat_b"}, "call1");
    G.AddOp(Opcode::OP_CALL, {"mat_b"}, {"mat_c"}, "call2");
    ...
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64)});
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_b->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64)});
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_e->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
    ...
    Function *leafFunction4 = leafG4.GetFunction();
    EXPECT_NE(leafFunction4, nullptr);
    FunctionHash calleeHashFunction4 = leafFunction4->ComputeHash();
     ...
     * [3*dim+1, 4*dim]: validshape
     */
    symbolicScalarFunction4.push_back({SymbolicScalar(leaffunc4_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64)});
    symbolicScalarFunction4.push_back({SymbolicScalar(leaffunc4_mat_d->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(64)});
    auto opAttributeCall4 = std::make_shared<CallOpAttribute>(calleeHashFunction4, symbolicScalarFunction4);
    G.GetOp("call4")->SetOpAttribute(opAttributeCall4);
    
    function->programs_.emplace(1, leafFunction1);
    function->programs_.emplace(2, leafFunction2);
    function->programs_.emplace(3, leafFunction3);
    function->programs_.emplace(4, leafFunction4);

    auto &cache = Program::GetInstance().GetFunctionCache();
    leafFunction1->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction2->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction3->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction4->SetGraphType(GraphType::LEAF_GRAPH);
    cache.Insert(calleeHashFunction1, *leafFunction1);
    cache.Insert(calleeHashFunction2, *leafFunction2);
    cache.Insert(calleeHashFunction3, *leafFunction3);
    cache.Insert(calleeHashFunction4, *leafFunction4);
    // run pass
    GlobalMemoryReuse passLocal;
    passLocal.Run(*function, "", "", 0);
    // check after pass
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseNormal4) {
    ...
    mat_f->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add tensor for leaf func1
    leafG1.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc1_mat_a");
    auto leaffunc1_mat_a = leafG1.GetTensor("leaffunc1_mat_a");
    leaffunc1_mat_a->tensor = mat_a->tensor;
    ...
    leaffunc1_mat_e->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc1_mat_f->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add tensor for leaf func2
    leafG2.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc2_mat_a");
    auto leaffunc2_mat_a = leafG2.GetTensor("leaffunc2_mat_a");
    leaffunc2_mat_a->tensor = mat_b->tensor;
    ...
    auto leaffunc2_mat_e = leafG2.GetTensor("leaffunc2_mat_e");
    leaffunc2_mat_e->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG2.AddTensor(DataType::DT_FP16, {16, 128}, "leaffunc2_mat_f");
    auto leaffunc2_mat_f = leafG2.GetTensor("leaffunc2_mat_f");
    leaffunc2_mat_f->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG2.AddTensor(DataType::DT_FP16, {8, 128}, "leaffunc2_mat_g");
    auto leaffunc2_mat_g = leafG2.GetTensor("leaffunc2_mat_g");
    leaffunc2_mat_g->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc2_mat_h->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc2_mat_i->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add tensor for leaf func3
    ...
    symbolicScalarFunction1.push_back({SymbolicScalar(leaffunc1_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction1.push_back({SymbolicScalar(leaffunc1_mat_e->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction1.push_back({SymbolicScalar(leaffunc1_mat_f->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
    ...
    symbolicScalarFunction2.push_back({SymbolicScalar(leaffunc2_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction2.push_back({SymbolicScalar(leaffunc2_mat_b->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(32), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(32), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction2.push_back({SymbolicScalar(leaffunc2_mat_h->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(16), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(16), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction2.push_back({SymbolicScalar(leaffunc2_mat_i->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(8), 
                                       SymbolicScalar(128), 
    ...
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_b->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction3.push_back({SymbolicScalar(leaffunc3_mat_f->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
...
TEST_F(TestGlobalMemoryReuse, TestGlobalMemoryReuseMultiOpSerialConn) {
    ...
    std::string leafFunc3Name = "leafFunc3";
    std::string leafFunc4Name = "leafFunc4";
    std::string leafFunc5Name = "leafFunc5";
    std::string leafFunc6Name = "leafFunc6";
    Function leafFunc1(Program::GetInstance(), leafFunc1Name, leafFunc1Name, G.GetFunction());
    leafFunc1.rootFunc_ = function;
    ComputationalGraphBuilder leafG1(&leafFunc1);
    Function leafFunc2(Program::GetInstance(), leafFunc2Name, leafFunc2Name, G.GetFunction());
    ...
    leafFunc4.rootFunc_ = function;
    ComputationalGraphBuilder leafG4(&leafFunc4);
    Function leafFunc5(Program::GetInstance(), leafFunc5Name, leafFunc5Name, G.GetFunction());
    leafFunc5.rootFunc_ = function;
    ComputationalGraphBuilder leafG5(&leafFunc5);
    Function leafFunc6(Program::GetInstance(), leafFunc6Name, leafFunc6Name, G.GetFunction());
    ...
    mat_g->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add tensor for leaf func1
    leafG1.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc1_mat_a");
    auto leaffunc1_mat_a = leafG1.GetTensor("leaffunc1_mat_a");
    leaffunc1_mat_a->tensor = mat_a->tensor;
    ...
    leaffunc5_mat_a->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leaffunc5_mat_a->tensor = mat_e->tensor;
    leafG5.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc5_mat_b");
    auto leaffunc5_mat_b = leafG5.GetTensor("leaffunc5_mat_b");
    leaffunc5_mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG5.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc5_mat_c");
    auto leaffunc5_mat_c = leafG5.GetTensor("leaffunc5_mat_c");
    leaffunc5_mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc5_mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc6_mat_a->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leaffunc6_mat_a->tensor = mat_f->tensor;
    leafG6.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc6_mat_b");
    auto leaffunc6_mat_b = leafG6.GetTensor("leaffunc6_mat_b");
    leaffunc6_mat_b->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    leafG6.AddTensor(DataType::DT_FP16, {64, 128}, "leaffunc6_mat_c");
    auto leaffunc6_mat_c = leafG6.GetTensor("leaffunc6_mat_c");
    leaffunc6_mat_c->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    ...
    leaffunc6_mat_d->SetMemoryTypeBoth(MemoryType::MEM_DEVICE_DDR, true);
    // add op for root func
    G.AddOp(Opcode::OP_CALL, {"mat_a"}, {"mat_b"}, "call1");
    G.AddOp(Opcode::OP_CALL, {"mat_b"}, {"mat_c"}, "call2");
    G.AddOp(Opcode::OP_CALL, {"mat_c"}, {"mat_d"}, "call3");
    ...
    Function *leafFunction5 = leafG5.GetFunction();
    EXPECT_NE(leafFunction5, nullptr);
    FunctionHash calleeHashFunction5 = leafFunction5->ComputeHash();
     ...
     * [3*dim+1, 4*dim]: validshape
     */
    symbolicScalarFunction5.push_back({SymbolicScalar(leaffunc5_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction5.push_back({SymbolicScalar(leaffunc5_mat_d->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    auto opAttributeCall5 = std::make_shared<CallOpAttribute>(calleeHashFunction5, symbolicScalarFunction5);
    G.GetOp("call5")->SetOpAttribute(opAttributeCall5);
    
    Function *leafFunction6 = leafG6.GetFunction();
    EXPECT_NE(leafFunction6, nullptr);
    FunctionHash calleeHashFunction6 = leafFunction6->ComputeHash();
     ...
     * [3*dim+1, 4*dim]: validshape
     */
    symbolicScalarFunction6.push_back({SymbolicScalar(leaffunc6_mat_a->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    symbolicScalarFunction6.push_back({SymbolicScalar(leaffunc6_mat_d->GetRawTensor()->GetTensorInfo().tensorIndex), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(0), 
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128), 
                                       ...
                                       SymbolicScalar(64), 
                                       SymbolicScalar(128)});
    auto opAttributeCall6 = std::make_shared<CallOpAttribute>(calleeHashFunction6, symbolicScalarFunction6);
    ...
    function->programs_.emplace(3, leafFunction3);
    function->programs_.emplace(4, leafFunction4);
    function->programs_.emplace(5, leafFunction5);
    function->programs_.emplace(6, leafFunction6);
    ...
    leafFunction3->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction4->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction5->SetGraphType(GraphType::LEAF_GRAPH);
    leafFunction6->SetGraphType(GraphType::LEAF_GRAPH);
    cache.Insert(calleeHashFunction1, *leafFunction1);
    cache.Insert(calleeHashFunction2, *leafFunction2);
    cache.Insert(calleeHashFunction3, *leafFunction3);
    cache.Insert(calleeHashFunction4, *leafFunction4);
    cache.Insert(calleeHashFunction5, *leafFunction5);
    cache.Insert(calleeHashFunction6, *leafFunction6);
    // run pass
    GlobalMemoryReuse passLocal;
    passLocal.Run(*function, "", "", 0);
    // check after pass
