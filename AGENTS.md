...
- `pypto-operator-reference-development`: 参考 transformer 仓和 torch_npu 仓开发 PyPTO 算子
...
| pypto-operator-reference-development | 需要参考其他仓库开发算子时 | 指导如何参考 transformer 仓和 torch_npu 仓开发 PyPTO 算子 |
| **性能分析** |||
