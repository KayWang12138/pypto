...
if __name__ == "__main__":
    test_gmm_mxfp8(
        ShapeConfig(
            ori_shape=[768, 6144, 4096], num_groups=32,
            m_tile_shape=[128, 128], k_tile_shape=[128, 512], n_tile_shape=[256, 512],
    ...
    test_gmm_mxfp8(
        ShapeConfig(
            ori_shape=[2048, 6144, 7168], num_groups=8,
            m_tile_shape=[64, 64], k_tile_shape=[64, 192], n_tile_shape=[512, 2048],
