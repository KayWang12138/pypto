...
Example:
    See deepseekv33_sparse_compress_flash_attention.py for usage examples.
"""
...
def npu_sparse_compress_flash_attention(query_npu, q_act_seqs_npu, ori_kv_npu, cmp_kv_npu, ori_block_table_npu, cmp_block_table_npu, atten_sink_npu,
    ...
    sparse_compress_flash_attention_kernel(*tensors, nq, n_kv, softmax_scale, topk, block_size, win_size, cmp_ratio, tile_config)
...
def sparse_compress_flash_attention_graph(query_npu, q_act_seqs_npu, ori_kv_npu, cmp_kv_npu, ori_block_table_npu, cmp_block_table_npu, atten_sink_npu,
                                    seqused_kv_npu, cmp_sparse_indices_npu, softmax_scale, win_size, cmp_ratio):
