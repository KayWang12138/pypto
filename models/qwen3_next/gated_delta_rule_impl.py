...
def chunk_gated_delta_rule(b, nqk, nv, d, l):
    ...
    @pypto.frontend.jit(
        runtime_options={
            ...
            "device_sched_parallism": 8
        },
        pass_options={
            "vec_nbuffer_setting": {9: 32, 2: 16, 29:32, 7: 4, 26: 32, 27: 8,
                3: 8, 4: 8, 11: 32, 6: 4, 8: 16, 10: 16, 1: 4, 5: 4, -2: 1}
        }
    )
    def kernel(
...
def chunk_gated_delta_rule_unaligned(b, nqk, nv, d, l):
    ...
    @pypto.frontend.jit(
        ...
        pass_options={
            "vec_nbuffer_setting": {10: 32, 2: 32, 29: 32, 7: 4, 26: 32, 27: 8,
                3: 8, 4: 8, 11: 32, 6: 4, 8: 16, 9: 16, 1: 4, 5: 4, 184: 8, 200: 8, -2: 1}
        }
    )
    def kernel(
            query: pypto.Tensor(query_shape, pypto.DT_FP32),
