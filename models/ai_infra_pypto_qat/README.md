...
**对 W 的梯度**：
$$
\frac{\partial\text{Loss}}{\partial W} = \frac{\partial\text{Loss}}{\partial W_q}\odot\begin{cases} 1, & V_{\text{min}}\leq W_{\text{quant}}\leq V_{\text{max}}\\ 0, &\text{otherwise}\end{cases}\cdot\frac{1}{s'}
$$
