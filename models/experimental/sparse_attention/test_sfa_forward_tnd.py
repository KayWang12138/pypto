...
def gen_sfa_tnd_golden(dtype, b, nq, n_kv, npu_actual_q_len_list, npu_actual_kv_len_list,
    ...
    # core_attn_golden, sm_max_golden, sm_sum_golden = None, None, None
    input_params = {
        'b': b, 'nq': nq, 'n_kv': n_kv,
...
def do_test_sfa_tnd(input_params, input_tensors, core_attn_golden,
    ...
    # logging.info(npu_actual_q_len_npu)
...
if __name__ == "__main__":
    ...
    test_sfa_tnd_v2_bf16_b2_s3_seq4k()
    test_sfa_tnd_v2_bf16_b1_s2_seq4k()
    test_sfa_tnd_v2_bf16_b1_s2_seq64k()
    test_sfa_tnd_v2_bf16_b1_seq_4k()
    test_sfa_tnd_v2_bf16_b4_s4_seq128k()
    # test_sfa_32k()
