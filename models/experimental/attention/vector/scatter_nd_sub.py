...
def create_scatter_nd_sub_kernel(target_shape: tuple, indices_shape: tuple, updates_shape: tuple, run_mode: str = "npu", dynamic: bool = True):
    if dynamic:
...
def test_scatter_nd_sub(device_id: int = None, run_mode: str = "npu", dynamic: bool = False) -> None:
    ...
    for idx, (target_shape_list, indices_shape_list, updates_shape_list) in enumerate(input_scenarios):
        ...
        create_scatter_nd_sub_kernel(target_shape, indices_shape, updates_shape, 
                                    run_mode)(target, indices, updates)
