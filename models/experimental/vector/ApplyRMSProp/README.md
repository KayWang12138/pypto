...
| 名称 | 类型 | 形状 | 数据类型 | 说明 |
|------|------|------|----------|------|
| `var_out` | Tensor | `[rows, cols]` | `fp32` | 更新后的参数 |
| `ms_out` | Tensor | `[rows, cols]` | `fp32` | 更新后的平方梯度移动平均 |
| `mom_out` | Tensor | `[rows, cols]` | `fp32` | 更新后的动量项 |
...
```bash
python3 custom/apply_rms_prop/apply_rms_prop.py
```
...
# 运行单个测试
python3 custom/apply_rms_prop/apply_rms_prop.py level0

# 查看测试列表
python3 custom/apply_rms_prop/apply_rms_prop.py --list
```
