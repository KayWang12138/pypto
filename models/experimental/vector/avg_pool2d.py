...
def avg_pool_2d(shape, kernel_size, stride=None, padding_mode=None, run_mode="npu", dynamic=True):
    ...
    @pypto.frontend.jit(pass_options={"vec_nbuffer_setting":{-1:2, 0:8}}, runtime_options={"run_mode": mode, "stitch_function_num_initial": 128,
    ...
    def avg_pool_2d_kernel(
        ...
        for bc_idx, unroll_length in pypto.loop_unroll(0, bc_total, 1, name="LOOP_BC", idx_name="bc_idx", unroll_list=[16, 4, 2, 1]):
