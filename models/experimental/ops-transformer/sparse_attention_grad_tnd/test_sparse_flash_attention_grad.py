...
def do_test_sfa_grad_npu_eager(case_name, actual_q_lens, actual_kv_lens,
    ...
    torch.npu.set_device(int(os.environ.get('TILE_FWK_DEVICE_ID', 6)))
...
@pytest.mark.skip(reason="large test case")
def test_level2_t1k():
    """Level 2: batch=1, S1=1k, S2=32768, n_1=2, d=512, dr=64, k=2048"""
    do_test_sfa_grad_npu("level2_b1_s4",
...
def test_level2_t256():
    """Level 2: batch=1, S1=256, S2=32768, n_1=64, d=512, dr=64, k=2048"""
    do_test_sfa_grad_npu("level2_b1_s4",
...
def test_level2_t128():
    """Level 2: batch=1, S1=128, S2=32768, n_1=32, d=512, dr=64, k=2048"""
    do_test_sfa_grad_npu("level2_b1_s4",
                      actual_q_lens=[128], actual_kv_lens=[32768],
