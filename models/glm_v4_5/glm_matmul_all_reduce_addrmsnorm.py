    ...
    def kernel(
        ...
        for bs_idx in pypto.loop(bs_loop, name="LOOP_MM_ALLREDUCE_ADDRMSNORM", idx_name="bs_idx"):
            ...
            for _ in pypto.loop(1, name="LOOP_MM_AR_ARMS_L0", idx_name="_"):
                ...
                wait_dummy = pypto.distributed.shmem_wait(shmem_signal, [shmem_shape], [[0, 0, 0]], WORLD_SIZE, [tile_in_tensor], True)
...
def mm_allreduce_addrmsnorm(
    ...
    inputs = [hidden_states, weight, residual, input_norm_weight, bias, hidden_states_res, residual_res]
