...
This module implements the fused matrix multiplication, all-reduce, and RMS normalization operation for large-scale distributed models.
It efficiently combines computation and communication, reducing memory overhead and accelerating training and inference.

Main Functions:
- matmul_allreduce_add_rmsnorm: Main function for fused matmul, all-reduce, addition, and RMSNorm computation
"""
