...
template <typename T, typename T2, unsigned src0OriShape0, unsigned src0OriShape1, unsigned src0OriShape3,
    unsigned src0rawShape2, unsigned src0rawShape3, unsigned src1OriShape1, unsigned src1rawShape3, unsigned cacheMode, unsigned blockSize>
TILEOP void DynTIndexoutcast(__gm__ T *dst, __ubuf__ T *src0, __ubuf__ T2 *src1, unsigned GmShape0, unsigned GmShape1,
    ...
    for (int i = 0; i < src0OriShape0; ++i) {
        for (int j = 0; j < src0OriShape1; ++j) {
            TileOp::TIndexoutcastBase<T, T2, src0OriShape3, src1OriShape1, src0rawShape3, cacheMode, blockSize>(dst, src0, src1, GmShape3);
        }
        src0 += alignTS2TS3;
        src1 += alignSrc1;
...
// src1=index [1,2] , src0: [TShape0,TShape1,TShape2,TShape3],  dst [GmShape0,GmShape1,GmShape2,GmShape3]
template <typename T, typename T2, unsigned src0rawShape2, unsigned src0rawShape3, unsigned src1rawShape3, unsigned cacheMode, unsigned blockSize>
TILEOP void DynTIndexoutcast(__gm__ T *dst, __ubuf__ T *src0, __ubuf__ T2 *src1, unsigned src0OriShape0,
    unsigned src0OriShape1, unsigned src0OriShape3, unsigned src1OriShape1, unsigned GmShape0, unsigned GmShape1,
    unsigned GmShape2, unsigned GmShape3, unsigned Offset0, unsigned Offset1, unsigned Offset2, unsigned Offset3) {
    dst += CalcLinearOffset(GmShape1, GmShape2, GmShape3, Offset0, Offset1, Offset2, Offset3);
    ...
    for (int i = 0; i < src0OriShape0; ++i) {
        for (int j = 0; j < src0OriShape1; ++j) {
            TileOp::TIndexoutcastBase<T, T2, src0rawShape3, cacheMode, blockSize>(dst, src0, src1, src0OriShape3, src1OriShape1, GmShape3);
        }
        src0 += alignTS2TS3;
        src1 += alignSrc1;
        dst += GmShape2 * GmShape3;
